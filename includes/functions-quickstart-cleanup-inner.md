...
1. Nel portale di Azure passare alla pagina **Gruppo di risorse**. 
   ...
   Per ottenere tale pagina dal dashboard, selezionare gruppi di **risorse** e quindi selezionare il gruppo di risorse usato per questo articolo.
