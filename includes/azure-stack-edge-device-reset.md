...
2. Selezionare **Reimposta dispositivo**.
    ...
    ![Reimpostare il dispositivo](media/azure-stack-edge-device-reset/device-reset-1.png)

3. Quando viene chiesta conferma, esaminare l'avviso e selezionare **Sì** per continuare.

    ![Conferma della reimpostazione](media/azure-stack-edge-device-reset/device-reset-2.png)  
