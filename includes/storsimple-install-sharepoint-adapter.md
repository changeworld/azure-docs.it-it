...
2. Usare un account con privilegi di amministratore per l'accesso al server front-end Web.
3. Fare doppio clic sul programma di installazione. L’adattatore StorSimple per l’installazione guidata di SharePoint inizia. Fare clic su **Avanti** per iniziare l'installazione.
...
6. Fare clic su **Fine** per uscire dalla procedura di installazione guidata.
