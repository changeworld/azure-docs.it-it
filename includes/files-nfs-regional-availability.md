...
ms.locfileid: "100551888"
---
NFS è supportato in **tutte le** 30 aree in cui è disponibile l'archiviazione dei file Premium.

Si aggiungono continuamente aree. Per l'elenco più aggiornato, usare l'esempio seguente per eseguire una query sull'elenco delle aree con supporto per NFS. È anche possibile verificare il supporto per l'area in [prodotti Azure disponibili in base all'area](https://azure.microsoft.com/global-infrastructure/services/?products=storage&regions=all) in **archiviazione file Premium**.
