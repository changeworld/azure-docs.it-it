...
- Usare l'ambiente bash in [Azure cloud Shell](../articles/cloud-shell/quickstart.md).
   ...
   [![Avviare Cloud Shell in una nuova finestra](media/cloud-shell-try-it/hdi-launch-cloud-shell.png)](https://shell.azure.com)
- Se si preferisce, [installare](/cli/azure/install-azure-cli) l'interfaccia della riga di comando di Azure per eseguire i relativi comandi di riferimento.
  ...
  - Se si usa un'installazione locale, accedere all'interfaccia della riga di comando di Azure con il comando [az login](/cli/azure/reference-index#az_login).  Per completare il processo di autenticazione, seguire la procedura visualizzata nel terminale.  Per altre opzioni di accesso, vedere [Accedere tramite l'interfaccia della riga di comando di Azure](/cli/azure/authenticate-azure-cli).
