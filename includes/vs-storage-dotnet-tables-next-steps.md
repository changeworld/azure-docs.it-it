...
* Vedere la documentazione di riferimento del servizio tabelle nella [libreria client di archiviazione di Azure per .NET](/dotnet/api/overview/azure/storage) per informazioni dettagliate sulle API disponibili.
