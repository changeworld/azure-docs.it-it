...
| Nodo  | [EventHubConsumerClientOptions](/javascript/api/@azure/event-hubs/eventhubconsumerclientoptions) dispone di una `webSocketOptions` Proprietà. |
