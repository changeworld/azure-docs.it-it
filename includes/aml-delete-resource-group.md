...
1. Selezionare **Elimina gruppo di risorse**.
   ...
   ![Screenshot delle opzioni da selezionare per eliminare un gruppo di risorse nel portale di Azure.](./media/aml-delete-resource-group/delete-resources.png)
