...
4. Compilare il modulo dei dettagli del nuovo server con le informazioni seguenti:
   ...
   - Attivare la casella di controllo **Abilita funzionalità di anteprima**.
...
5. Fare clic su **Configura gruppo di server**.
   - Selezionare il pulsante di opzione di **base** per il **livello**.
   - Fare clic su **Salva**.
