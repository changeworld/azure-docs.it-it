...
ms.locfileid: "102511065"
---
Le voci del documento `deploymentconfig.json` vengono mappate ai parametri di [AksWebservice.deploy_configuration](/python/api/azureml-core/azureml.core.webservice.aks.aksservicedeploymentconfiguration). La tabella seguente descrive il mapping tra le entità nel documento JSON e i parametri per il metodo:
