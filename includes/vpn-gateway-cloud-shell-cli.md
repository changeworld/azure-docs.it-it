...
Per aprire Cloud Shell, basta selezionare **Prova** nell'angolo superiore destro di un blocco di codice. È anche possibile avviare Cloud Shell in una scheda del browser separata selezionando [https://shell.azure.com](https://shell.azure.com) e impostando l'elenco a discesa nell'angolo sinistro per riflettere bash o PowerShell. Selezionare **Copia** per copiare i blocchi di codice, incollarli in Cloud Shell e premere INVIO per eseguirli.
