...
L'accesso ad Archiviazione di Azure viene eseguito esclusivamente tramite un account di archiviazione. Per questa guida introduttiva, creare rapidamente un account di archiviazione usando il [portale di Azure](https://portal.azure.com/), Azure PowerShell o l'interfaccia della riga di comando di Azure. Per informazioni sulla creazione di un account di archiviazione, vedere [creare un account di archiviazione](../articles/storage/common/storage-account-create.md).
