...
Quando non è più necessario, è possibile usare il cmdlet [Remove-AzResourceGroup](/powershell/module/az.resources/remove-azresourcegroup) di Azure PowerShell per rimuovere il gruppo di risorse e tutte le risorse correlate.
