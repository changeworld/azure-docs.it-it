...
I limiti della proprietà Gen1 dipendono dall'ambiente SKU selezionato. Le proprietà dell'evento fornite presentano colonne JSON, CSV e del grafico corrispondenti che possono essere visualizzate all'interno di [esplora Azure Time Series Insights](../articles/time-series-insights/time-series-quickstart.md).
...
* Informazioni su come [aggiungere un'origine di hub eventi](../articles/time-series-insights/how-to-ingest-data-event-hub.md).
* Configurare [un'origine Hub](../articles/time-series-insights/how-to-ingest-data-iot-hub.md)Internet delle cose.

### <a name="api-limits"></a>Limiti API

I limiti dell'API REST per Azure Time Series Insights Gen1 sono specificati nella [documentazione di riferimento dell'API REST](/rest/api/time-series-insights/dataaccess(preview)/query/getavailability).