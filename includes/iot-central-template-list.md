...
| IOTC-MFC                 | Centro di micro-evasione | Consente di creare un'applicazione per la connessione digitale e la gestione di un centro evasione completamente automatizzato. |
| IOTC-Video-Analytics-om  | Analisi video - rilevamento movimento e oggetti | Usa le fotocamere come un sensore nelle soluzioni di analisi video intelligenti basate su Azure IoT Edge, AI e servizi multimediali di Azure. |
...
**Modello applicazione personalizzata**

Se è stato creato un modello di applicazione personalizzato, è possibile usarlo per creare una nuova applicazione. Quando viene richiesto un modello di applicazione, immettere l'ID app visualizzato nel collegamento URL condivisibile dell'app esportata nella sezione [esportazione modello di applicazione](../articles/iot-central/core/howto-use-app-templates.md#create-an-application-template) dell'app. 
