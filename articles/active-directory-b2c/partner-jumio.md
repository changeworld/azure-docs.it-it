...
Distribuire il [codice API](https://github.com/azure-ad-b2c/partner-integrations/tree/master/samples/Jumio/API/Jumio.Api) fornito a un servizio di Azure. È possibile pubblicare il codice da Visual Studio seguendo [queste istruzioni](/visualstudio/deployment/quickstart-deploy-to-azure).
...
2. Seguire [questo articolo](tutorial-create-user-flows.md?pivots=b2c-custom-policy#custom-policy-starter-pack) per scaricare lo [Starter Pack di le LocalAccounts](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack/tree/master/LocalAccounts).
