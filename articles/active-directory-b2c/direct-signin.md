...
Per supportare il parametro hint di dominio, è possibile configurare il nome di dominio usando l' `<Domain>domain name</Domain>` elemento XML di Any `<ClaimsProvider>` .
