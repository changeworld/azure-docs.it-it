...
È possibile abilitare il [codice lato client JavaScript](javascript-and-page-layout.md) inserendo `contract` tra `elements` e il tipo di pagina. Ad esempio: `urn:com:microsoft:aad:b2c:elements:contract:page-name:version`.
...
Nell'esempio seguente vengono illustrati gli identificatori delle definizioni di contenuto e il **DataUri** corrispondente con la versione più recente della pagina: 
...
[Personalizzare l'interfaccia utente dell'applicazione usando un criterio personalizzato](customize-ui-with-html.md)
