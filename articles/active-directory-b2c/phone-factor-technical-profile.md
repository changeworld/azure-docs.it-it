...
È possibile [localizzare](localization-string-ids.md#phone-factor-authentication-page-user-interface-elements)gli elementi dell'interfaccia utente della pagina di autenticazione del telefono.
