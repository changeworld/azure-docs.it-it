---
title: Panoramica dei criteri personalizzati Azure Active Directory B2C | Microsoft Docs
...
![Diagramma che mostra il flusso di esecuzione dei criteri](./media/custom-policy-overview/custom-policy-execution.png)
...
![percorso utente personalizzato](media/custom-policy-overview/user-journey-flow.png)
...
![Percorso utente Azure AD B2C](media/custom-policy-overview/user-journey-diagram.png)
...
![Diagramma profilo tecnico di convalida](media/custom-policy-overview/validation-technical-profile.png)
...
![Diagramma che mostra il modello di ereditarietà dei criteri di Framework attendibilità](media/custom-policy-overview/policies.png)
...
1. Aggiungere le [chiavi dei criteri](tutorial-create-user-flows.md?pivots=b2c-custom-policy#add-signing-and-encryption-keys) necessarie e [registrare le applicazioni del Framework dell'esperienza di identità](tutorial-create-user-flows.md?pivots=b2c-custom-policy#register-identity-experience-framework-applications).
1. [Ottenere lo Starter Pack per i criteri di Azure ad B2C](tutorial-create-user-flows.md?pivots=b2c-custom-policy#get-the-starter-pack) e caricarlo nel tenant. 
1. Dopo aver caricato il pacchetto Starter, [testare i criteri di iscrizione o di accesso](tutorial-create-user-flows.md?pivots=b2c-custom-policy#test-the-custom-policy).
