...
Gli sviluppatori o gli amministratori IT possono usare i connettori API per integrare i flussi utente di iscrizione con le API Web per personalizzare l'esperienza di iscrizione e l'integrazione con sistemi esterni. Con i connettori API, ad esempio, è possibile:
