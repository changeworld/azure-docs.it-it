...
Questo articolo illustra come il [portale di Azure](https://portal.azure.com/) Visualizza le [istanze Baremetal](concepts-baremetal-infrastructure-overview.md). Questo articolo illustra anche le attività che è possibile eseguire nel portale di Azure con le unità di istanza BareMetal distribuite. 
