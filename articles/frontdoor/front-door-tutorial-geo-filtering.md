...
description: Questa esercitazione descrive come creare un criterio WAF di filtro geografico e associarlo all'host front-end di Frontdoor.
services: frontdoor
documentationcenter: ''
author: duongau
