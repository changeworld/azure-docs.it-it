...
:::image type="content" source="media/quickstart-create-front-door/environment-diagram.png" alt-text="Diagramma del diagramma dell'ambiente di Front door con PowerShell." border="false":::
