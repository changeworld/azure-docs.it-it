---
title: Abilita un'identità gestita per il routing degli eventi (anteprima)
titleSuffix: Azure Digital Twins
description: Vedere come abilitare un'identità assegnata dal sistema per i dispositivi gemelli digitali di Azure e usarla per l'invio di eventi.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948876"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Abilitare un'identità gestita per il routing degli eventi di Azure Digital gemelli (anteprima)
...
In questa sezione si userà il [portale di Azure](https://portal.azure.com) per aggiungere un'identità gestita dal sistema a un'istanza di Azure Digital Twins già esistente.
