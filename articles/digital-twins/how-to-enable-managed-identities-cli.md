...
Per ulteriori esempi di assegnazioni di ruolo con questo comando, vedere la [documentazione di riferimento **AZ DT create** Reference](/cli/azure/dt#az_dt_create).
