...
description: Informazioni sul livello di code coverage disponibile in diverse aree geografiche per routing, routing con traffico e routing di camion.
author: anastasia-ms
ms.author: v-stharr
ms.date: 04/04/2019
ms.topic: conceptual
