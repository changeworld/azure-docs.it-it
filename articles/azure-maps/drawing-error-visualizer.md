...
description: In questo articolo si apprenderà come visualizzare gli avvisi e gli errori restituiti dall'API di conversione dell'autore (anteprima).
author: anastasia-ms
ms.author: v-stharr
ms.date: 12/07/2020
ms.topic: conceptual
...
ms.locfileid: "96903582"
---
# <a name="using-the-azure-maps-drawing-error-visualizer-with-creator-preview"></a>Uso del Visualizzatore errori di disegno di mappe di Azure con Creator (anteprima)
...
1. Caricare il pacchetto di disegno nel servizio Azure Maps Creator (anteprima) per ottenere un `udid` per il pacchetto caricato. Per istruzioni su come caricare un pacchetto, vedere [Caricare un pacchetto di disegno](tutorial-creator-indoor-maps.md#upload-a-drawing-package).
