...
1. Creare una funzione nell'portale di Azure. Per altre informazioni, vedere [creare funzioni di Azure](../azure-functions/functions-get-started.md).
