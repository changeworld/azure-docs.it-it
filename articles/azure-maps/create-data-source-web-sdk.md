...
> [!TIP]
> Quando si aggiungono livelli alla mappa utilizzando la `map.layers.add` funzione, l'ID o l'istanza di un livello esistente può essere passata come secondo parametro. Questo indicherebbe a map di inserire il nuovo livello aggiunto al di sotto del livello esistente. Oltre a passare un ID livello, questo metodo supporta anche i valori seguenti.
>
