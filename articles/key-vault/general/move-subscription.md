---
title: Azure Key Vault lo spostamento di un insieme di credenziali in un'altra sottoscrizione | Microsoft Docs
...
> Se si usano le identità del servizio gestito, leggere le istruzioni post-spostamento alla fine del documento. 
...
Per altre informazioni sulle Azure Key Vault e Azure Active Directory, vedere
...
* Gruppo di risorse nella nuova sottoscrizione. È possibile crearne uno [usando](../../azure-resource-manager/management/manage-resource-groups-portal.md)portale di Azure, [PowerShell](../../azure-resource-manager/management/manage-resource-groups-powershell.md)o l'interfaccia della riga [di comando di Azure.](../../azure-resource-manager/management/manage-resource-groups-cli.md)

È possibile controllare i ruoli esistenti [usando](../../role-based-access-control/role-assignments-list-portal.md)portale di Azure, [PowerShell,](../../role-based-access-control/role-assignments-list-powershell.md)l'interfaccia della riga di comando di [Azure](../../role-based-access-control/role-assignments-list-cli.md)o [l'API REST.](../../role-based-access-control/role-assignments-list-rest.md)
...
> [!NOTE]
> Se Key Vault usa il modello [di autorizzazione del controllo degli accessi in](../../role-based-access-control/overview.md) base al ruolo di Azure. È anche necessario rimuovere le assegnazioni di ruolo dell'insieme di credenziali delle chiavi. È possibile rimuovere le assegnazioni di ruolo usando il portale [di Azure,](../../role-based-access-control/role-assignments-portal.md) [l'interfaccia della riga di comando](../../role-based-access-control/role-assignments-cli.md)di Azure o [PowerShell.](../../role-based-access-control/role-assignments-powershell.md) 

Ora che l'insieme di credenziali è associato all'ID tenant corretto e le voci dei criteri di accesso precedenti o le assegnazioni di ruolo vengono rimosse, impostare nuove voci di criteri di accesso o assegnazioni di ruolo.

Per l'assegnazione di criteri, vedere:
- [Assegnare un criterio di accesso tramite il portale](assign-access-policy-portal.md)
- [Assegnare un criterio di accesso tramite l'interfaccia della riga di comando di Azure](assign-access-policy-cli.md)
- [Assegnare un criterio di accesso tramite PowerShell](assign-access-policy-powershell.md)
...
Se si trasferisce l'intera sottoscrizione e si usa un'identità gestita per le risorse di Azure, sarà necessario aggiornarla anche al nuovo tenant Azure Active Directory servizio. Per altre informazioni sulle identità gestite, vedere [Panoramica delle identità gestite.](../../active-directory/managed-identities-azure-resources/overview.md)
...
* [Trasferire la sottoscrizione in una nuova directory](../../role-based-access-control/transfer-subscription.md)

## <a name="next-steps"></a>Passaggi successivi

- Vedere altre informazioni su [chiavi, segreti e certificati](about-keys-secrets-certificates.md)
- Per informazioni concettuali, inclusa la modalità di interpretazione Key Vault log, vedere Key Vault [registrazione](logging.md)
