...
>  ```
> 
Per altre informazioni sui parametri, vedere [az keyvault certificate](/cli/azure/keyvault/certificate#az_keyvault_certificate_set_attributes).
