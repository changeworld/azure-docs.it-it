...
- **[Azure container Registry](../container-registry/container-registry-vnet.md)** (*Microsoft. ContainerRegistry*): anteprima disponibile in aree di Azure limitate in cui è disponibile Azure container Registry.
