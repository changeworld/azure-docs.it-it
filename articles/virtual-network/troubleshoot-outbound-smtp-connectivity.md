...
Dopo che una sottoscrizione è stata esentata e le macchine virtuali sono state arrestate e avviate nella portale di Azure, tutte le macchine virtuali della sottoscrizione verranno esentate in futuro. L'esenzione si applica solo alla sottoscrizione richiesta e solo al traffico delle macchine virtuali indirizzato direttamente a Internet.
...
Se è ancora necessaria assistenza, [contattare il supporto](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) **tecnico** per risolvere rapidamente il problema usando il tipo di problema seguente: la connettività di  >  **rete virtuale** tecnica  >  **Connectivity**  >  **non può inviare messaggi di posta elettronica (SMTP/porta 25)**.
