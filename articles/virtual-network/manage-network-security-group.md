...
L'elenco contiene le regole create e le [regole di sicurezza predefinite](./network-security-groups-overview.md#default-security-rules)del gruppo di sicurezza di rete.
