...
5. Nella pagina **Crea indirizzo IP pubblico** immettere o selezionare le informazioni seguenti: 
    ...
    | Località                | Seleziona **Stati Uniti orientali 2**      |
...
\* = Il livello è correlato alla funzionalità di [Load Balancer tra aree](https://docs.microsoft.com/azure/load-balancer/cross-region-overview) , attualmente in anteprima.
