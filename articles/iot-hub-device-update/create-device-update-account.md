...
ms.locfileid: "101692603"
---
# <a name="device-update-for-iot-hub-resource-management"></a>Aggiornamento del dispositivo per la gestione delle risorse dell'hub Internet
...
[Importare un aggiornamento usando l'aggiornamento del dispositivo per l'hub Internet.](import-update.md)
