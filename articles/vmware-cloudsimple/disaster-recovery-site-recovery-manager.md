...
description: Viene descritto come configurare il cloud privato CloudSimple come sito di ripristino di emergenza utilizzando VMware Site Recovery Manager.
author: Ajayan1008
ms.author: v-hborys
ms.date: 08/20/2019
ms.topic: article
...
2. Creare un utente nel cloud privato per la replica vSphere e l'installazione di SRM. Come illustrato di seguito nell'interfaccia utente di [vCenter: creare un utente nel cloud privato per lrv & l'installazione di SRM](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation).
...
* [Calcolo dei requisiti di larghezza di banda per la replica vSphere](https://docs.vmware.com/en/vSphere-Replication/6.5/com.vmware.vsphere.replication-admin.doc/GUID-4A34D0C9-8CC1-46C4-96FF-3BF7583D3C4F.html)
