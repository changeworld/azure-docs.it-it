...
VMware richiede l'uso di uno strumento del server di gestione delle chiavi di terze parti compatibile con KMIP 1,1 esterno quando si usa la crittografia rete VSAN. È possibile utilizzare qualsiasi KMS supportato certificato da VMware ed è disponibile per Azure.

Questa guida descrive come usare il servizio di gestione delle chiavi di HyTrust in esecuzione in una rete virtuale di Azure. Un approccio simile può essere usato per qualsiasi altra soluzione di gestione delle chiavi di terze parti certificata per rete VSAN.
...
![.. cluster/media/KMS nella rete virtuale di Azure](media/vsan-kms-cluster.png)
...
1. [Verificare che siano soddisfatti i prerequisiti](#verify-prerequisites-are-met)
2. [Portale di CloudSimple: ottenere informazioni sul peering di ExpressRoute](#cloudsimple-portal-obtain-expressroute-peering-information)
...
4. [Portale di Azure: distribuire un cluster HyTrust di controllo della rete virtuale nella rete virtuale](#azure-portal-deploy-a-hytrust-keycontrol-cluster-in-the-azure-resource-manager-in-your-virtual-network)
...
### <a name="verify-prerequisites-are-met"></a>Verificare che siano soddisfatti i prerequisiti
...
### <a name="cloudsimple-portal-obtain-expressroute-peering-information"></a>Portale di CloudSimple: ottenere informazioni sul peering di ExpressRoute

Per continuare l'installazione, sono necessari la chiave di autorizzazione e l'URI del circuito peer per ExpressRoute e l'accesso alla sottoscrizione di Azure. Queste informazioni sono disponibili nella pagina connessione della rete virtuale nel portale di CloudSimple. Per istruzioni, vedere [configurare una connessione di rete virtuale al cloud privato](virtual-network-connection.md). Se si verificano problemi durante il recupero delle informazioni, aprire una [richiesta di supporto](https://portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/newsupportrequest).

### <a name="azure-portal-connect-your-virtual-network-to-your-private-cloud"></a>Portale di Azure: connettere la rete virtuale al cloud privato
...
### <a name="azure-portal-deploy-a-hytrust-keycontrol-cluster-in-the-azure-resource-manager-in-your-virtual-network"></a>Portale di Azure: distribuire un cluster di controllo di HyTrust di un sistema di gestione delle operazioni nel Azure Resource Manager nella rete virtuale
...
Passare a https://*Public-IP*, dove *Public-IP* è l'indirizzo IP pubblico della VM del nodo di controllo delle macchine virtuali. Seguire questa procedura dalla [documentazione di HyTrust](https://docs.hytrust.com/DataControl/Admin_Guide-4.0/Default.htm#OLH-Files/Azure.htm%3FTocPath%3DHyTrust%2520DataControl%2520and%2520Microsoft%2520Azure%7C_____0).
