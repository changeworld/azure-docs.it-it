...
1. Creare la Azure Resource Graph query condivisa usando il **modulo Az.ResourceGraph** di PowerShell e il cmdlet [New-AzResourceGraphQuery:](/powershell/module/az.resourcegraph/new-azresourcegraphquery)
