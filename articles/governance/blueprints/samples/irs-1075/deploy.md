...
ms.locfileid: "100571915"
---
# <a name="deploy-the-irs-1075-blueprint-sample"></a>Distribuire l'esempio di progetto IRS 1075

Per distribuire l'esempio di progetto IRS 1075 (rev. 11-2016) di Azure Blueprints, seguire questa procedura:
...
1. Trovare l'esempio di progetto **IRS 1075 (rev. 11-2016)** in _Altri esempi_ e selezionare **Usa questo esempio**.

1. Immettere le _informazioni di base_ dell'esempio di progetto:

   - **Nome progetto**: specificare un nome per la copia dell'esempio di progetto IRS 1075 (rev. 11-2016).
...
Dopo aver esaminato i passaggi per distribuire l'esempio di progetto IRS 1075 (rev. 11-2016), vedere gli articoli seguenti per informazioni sul progetto e sul mapping dei controlli:
