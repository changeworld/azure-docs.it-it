...
L'articolo seguente illustra in dettaglio come il progetto di esempio Azure Blueprints Canada Federal Protected B, Medium Integrity, Medium Availability (PBMM) è mappato ai controlli Canada Federal PBMM. Per altre informazioni sui controlli, vedere [Canada Federal PBMM](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html).
...
Questo progetto consente di limitare la località per la distribuzione di tutte le risorse e dei gruppi di risorse a "Canada centrale" e "Canada orientale" assegnando le definizioni di Criteri di Azure seguenti:

- Località consentite (impostate come hardcoded in "Canada centrale" e "Canada orientale")
- Località consentite per i gruppi di risorse (impostate come hardcoded in "Canada centrale" e "Canada orientale")
...
## <a name="sc-28-1-protection-of-information-at-rest"></a>SC-28 (1) Protezione delle informazioni inattive
