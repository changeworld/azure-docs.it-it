---
title: Distribuire un esempio di progetto Media
...
ms.locfileid: "106386393"
---
# <a name="deploy-the-media-blueprint-sample"></a>Distribuire l'esempio di progetto Media

Per distribuire l'esempio di progetto Media, seguire questa procedura:
...
1. Trovare l'esempio di progetto **Media** in _Altri esempi_ e selezionare **Usa questo esempio**.
...
Dopo aver esaminato la procedura per la distribuzione dell'esempio di progetto Media, vedere gli articoli seguenti per informazioni generali e sul mapping dei controlli:

> [!div class="nextstepaction"]
> [Progetti Media - Panoramica](./index.md)
> [Progetti Media - Mapping dei controlli](./control-mapping.md)
