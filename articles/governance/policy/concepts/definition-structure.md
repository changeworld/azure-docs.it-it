...
- `allowedValues`: (Facoltativo) Fornisce una matrice di valori accettati dal parametro durante l'assegnazione. Per i confronti di valori consentiti viene fatta distinzione tra maiuscole 
