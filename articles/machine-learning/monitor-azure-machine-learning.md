...
>
> Se si desidera monitorare le informazioni generate dai modelli distribuiti come servizi Web o moduli IoT Edge, vedere [raccogliere dati del modello](how-to-enable-data-collection.md) e [monitorarli con Application Insights](how-to-enable-app-insights.md).
...
> [!TIP]
> Per comprendere i costi associati a monitoraggio di Azure, vedere [utilizzo e costi stimati](../azure-monitor//usage-estimated-costs.md). Per informazioni sul tempo necessario per la visualizzazione dei dati in monitoraggio di Azure, vedere [tempo di inserimento dei dati di log](../azure-monitor/logs/data-ingestion-time.md).
...
È possibile accedere agli avvisi per Azure Machine Learning aprendo gli **avvisi** dal menu **monitoraggio di Azure** . Per informazioni dettagliate sulla creazione di avvisi [, vedere creare, visualizzare e gestire gli avvisi delle metriche con monitoraggio di Azure](../azure-monitor/alerts/alerts-metric.md) .
