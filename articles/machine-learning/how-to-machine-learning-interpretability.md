...
Le classi di interpretazione del modello vengono rese disponibili tramite il pacchetto SDK seguente: (informazioni su come [installare i pacchetti SDK per Azure Machine Learning](/python/api/overview/azure/ml/install))
