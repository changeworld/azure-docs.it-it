...
Per ulteriori informazioni, vedere la documentazione relativa all' [aggiornamento del servizio AZ ml](/cli/azure/ext/azure-cli-ml/ml/service#ext-azure-cli-ml-az-ml-service-update) .
