...
> 
> [!NOTE]
> Per un'introduzione completa all'archiviazione BLOB di Azure, vedere [nozioni di base sui BLOB](../../storage/blobs/storage-quickstart-blobs-dotnet.md) di Azure e [servizio BLOB di Azure](/rest/api/storageservices/Blob-Service-Concepts).   
> 
> 
