...
## <a name="introduction-what-is-adf-and-when-should-it-be-used-to-migrate-data"></a><a name="intro"></a>Introduzione: che cos'è l’ADF e quando deve essere utilizzato per la migrazione dei dati?
...
* Quando i dati devono essere trasformati o la logica di business viene aggiunta durante la migrazione.
...
## <a name="define-and-create-tables-to-specify-how-to-access-the-datasets"></a><a name="adf-tables"></a>Definire e creare tabelle per specificare la modalità di accesso al set di dati
...
### <a name="blob-table"></a><a name="adf-table-blob-store"></a>Tabella BLOB 
...
### <a name="sql-azure-table"></a><a name="adf-table-azure-sql"></a>Tabella SQL Azure
...
## <a name="define-and-create-the-pipeline"></a><a name="adf-pipeline"></a>Definire e creare la pipeline
...
## <a name="start-the-pipeline"></a><a name="adf-pipeline-start"></a>Avviare la pipeline
...
Non è stata sfruttata la funzionalità fornita da ADF per inviare i dati in modo incrementale. Per ulteriori informazioni su come eseguire questa e altre funzionalità fornite da ADF, vedere la [documentazione ADF](https://azure.microsoft.com/services/data-factory/).