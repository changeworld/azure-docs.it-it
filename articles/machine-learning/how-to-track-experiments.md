...
1. Creare uno script di training che include la logica di registrazione, `train.py`.
   ...
   [! codice-Python](~/MachineLearningNotebooks/how-to-use-azureml/training/train-on-local/train.py)
...
[! INCLUDERE AML-clone-in-Azure-notebook](https://github.com/MicrosoftDocs/azure-docs-pr/blob/live/includes/aml-clone-for-examples.md)
