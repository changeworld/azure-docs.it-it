...
description: Informazioni su come usare il modulo Execute Python script in Azure Machine Learning Designer per eseguire il codice Python.
...
Il modulo Execute Python script supporta il caricamento di file tramite il [Azure Machine Learning Python SDK](/python/api/azureml-core/azureml.core.run%28class%29#upload-file-name--path-or-stream-).
