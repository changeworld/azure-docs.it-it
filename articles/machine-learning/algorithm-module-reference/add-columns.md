...
description: Informazioni su come usare il modulo Aggiungi colonne nella finestra di progettazione del trascinamento della selezione Azure Machine Learning per concatenare due set di impostazioni.
