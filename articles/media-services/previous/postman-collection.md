...
description: Informazioni sulla raccolta di post che contiene le richieste HTTP raggruppate che chiamano le API REST di servizi multimediali di Azure.
