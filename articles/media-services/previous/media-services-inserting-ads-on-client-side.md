...
## <a name="inserting-ads-into-your-media"></a><a id="insert_ads_into_media"></a>Inserimento di annunci nei file multimediali
...
In questo esempio una risposta annuncio inline è specificata con un elemento `<VASTAdData>` che contiene una risposta annuncio VAST. Per altre informazioni sugli altri elementi, vedere [VMAP](https://www.iab.net/guidelines/508676/digitalvideo/vsuite/vmap).
...
Un annuncio eseguibile può essere inizializzato mediante l'elemento `<AdParameters>` negli elementi `<Linear>` o `<NonLinear>` in una risposta VAST. Per altre informazioni sull'elemento `<AdParameters>`, vedere [VAST 3.0](https://www.iab.net/media/file/VASTv3.0.pdf). Per altre informazioni sull'API VPAID, vedere [VPAID 2.0](https://www.iab.net/media/file/VPAID_2.0_Final_04-10-2012.pdf).
...
Per altre informazioni su AdSchedulerPlugin, vedere la pagina relativa all' [inserimento di annunci in Player Framework su Windows 8 e Windows Phone 8](https://playerframework.codeplex.com/wikipage?title=Advertising&referringTitle=Windows%208%20Player%20Documentation)
...
Microsoft Media Platform: Player Framework per iOS contiene una raccolta di applicazioni di esempio che illustrano come implementare un'applicazione per la lettura di video tramite il framework. È possibile scaricare Player Framework e i relativi esempi dalla pagina relativa a [Media Player Framework di Azure](https://github.com/CloudMetal/azure-media-player-framework). La pagina GitHub include un collegamento a un wiki che contiene informazioni aggiuntive su Player Framework e un'introduzione all'esempio di Player: [Azure Media Player wiki](https://github.com/CloudMetal/azure-media-player-framework/wiki/How-to-player-use-azure-media-player-how-to-framework).
