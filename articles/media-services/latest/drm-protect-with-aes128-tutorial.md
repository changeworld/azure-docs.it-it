...
> [!NOTE]
> Anche se l'esercitazione usa esempi di [.NET SDK](/dotnet/api/microsoft.azure.management.media.models.liveevent), i passaggi generali sono gli stessi per [API REST](/rest/api/media/liveevents), [CLI](/cli/azure/ams/live-event) o altri [SDK](media-services-apis-overview.md#sdks) supportati.
...
È possibile crittografare ogni asset con più tipi di crittografia (AES-128, PlayReady, Widevine, FairPlay). Per informazioni su come combinarli efficacemente, vedere [Streaming protocols and encryption types](drm-content-protection-concept.md#streaming-protocols-and-encryption-types) (Protocolli di streaming e tipi di crittografia). Vedere anche [Come proteggere con DRM](drm-protect-with-drm-tutorial.md).
...
> [Proteggere con DRM](drm-protect-with-drm-tutorial.md)
