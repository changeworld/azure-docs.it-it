...
Caricare ed elaborare il contenuto come descritto in [Caricamento, codifica e streaming di contenuto con il portale](asset-create-asset-upload-portal-quickstart.md)
...
* [Modello di licenza di Google Widevine](drm-widevine-license-template-concept.md)
...
* [Modello di licenza PlayReady](drm-playready-license-template-concept.md)
...
![Chiave non crittografata AES](./media/drm-encrypt-content-how-to/aes-clear-key-policy.png)
...
![Localizzatore di streaming](./media/drm-encrypt-content-how-to/multi-drm.png)
...
[Gestire le risorse](asset-create-asset-upload-portal-quickstart.md)
