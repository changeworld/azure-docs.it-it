...
È possibile usare un set di impostazioni predefinito EncoderNamedPreset oppure usare set di impostazioni personalizzati. Per altre informazioni, vedere [How to customize encoder presets](encode-custom-presets-how-to.md) (Come personalizzare i set di impostazioni del codificatore).
