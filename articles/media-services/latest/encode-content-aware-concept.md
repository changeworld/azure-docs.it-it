---
title: Set di impostazioni per la codifica compatibile con il contenuto
...
![Curva di distorsione della velocità (RD) con PSNR](media/encode-content-aware-concept/msrv1.png)

**Figura 1: curva della velocità di distorsione (RD) con la metrica PSNR per un'origine di complessità elevata**

![Curva di distorsione della velocità (RD) con VMAF](media/encode-content-aware-concept/msrv2.png)
...
![Curva RD con PSNR](media/encode-content-aware-concept/msrv3.png)

**Figura 3: curva RD con PSNR per l'input di bassa qualità (a 1080p)**

![Curva RD con VMAF](media/encode-content-aware-concept/msrv4.png)
