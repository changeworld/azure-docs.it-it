---
title: Un sistema di protezione del contenuto con DRM multiplo
...
![Sottosistema DRM con CENC](./media/architecture-design-multi-drm-system/media-services-generic-drm-subsystem-with-cenc.png)
...
![Crittografia CENC in Servizi multimediali](./media/architecture-design-multi-drm-system/media-services-cenc-subsystem-on-AMS-platform.png)
...
* L'URL dell'autorità di certificazione deve terminare con "/". Il destinatario deve essere l'ID client dell'applicazione lettore. Inoltre, aggiungere "/" alla fine dell'URL dell'autorità di certificazione.
    ...
    ![Token JSON Web](./media/architecture-design-multi-drm-system/media-services-1st-gotcha.png)
...
* Aggiungere autorizzazioni all'applicazione in Azure AD nella scheda **Configura** dell'applicazione. Le autorizzazioni sono obbligatorie per ogni applicazione, indipendentemente dal tipo di versione: locale e distribuita.
    ...
    ![Autorizzazioni](./media/architecture-design-multi-drm-system/media-services-perms-to-other-apps.png)
...
![Account dominio del tenant di Azure AD personalizzato - Uno](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain1.png)
...
![Account dominio del tenant di Azure AD personalizzato - Due](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain2.png)

**Account Microsoft**: pagina di accesso dell'account Microsoft per gli utenti.

![Account dominio del tenant di Azure AD personalizzato - Tre](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain3.png)
...
![Usare EME per PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready1.png)
...
![Plug-in del lettore per PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready2.png)
...
![Usare EME per Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine1.png)

Widevine non impedisce di acquisire schermate da un video protetto.

![Plug-in del lettore per Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine2.png)
...
![Utenti senza diritti](./media/architecture-design-multi-drm-system/media-services-unentitledusers.png)
...
![Servizio token di sicurezza personalizzato con una chiave simmetrica](./media/architecture-design-multi-drm-system/media-services-running-sts1.png)
...
![Servizio token di sicurezza personalizzato con una chiave asimmetrica](./media/architecture-design-multi-drm-system/media-services-running-sts2.png)
