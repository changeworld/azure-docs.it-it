...
title: sviluppare con le API V3: Descrizione di servizi multimediali di Azure: informazioni sulle regole applicabili a entità e API durante lo sviluppo con servizi multimediali V3. Servizi: Media-Services documentationcenter:'' Author: IngridAtMicrosoft Manager: FEMila Editor:''
...
|---|---|
|[.NET SDK](https://aka.ms/ams-v3-dotnet-sdk)|[Informazioni di riferimento su .NET](/dotnet/api/overview/azure/mediaservices/management)|
|[SDK per Java](https://aka.ms/ams-v3-java-sdk)|[Informazioni di riferimento su Java](/java/api/overview/azure/mediaservices/management)|
|[Python SDK](https://aka.ms/ams-v3-python-sdk)|[Informazioni di riferimento su Python](/python/api/overview/azure/mediaservices/management)|
...
Vedere [Applicazione di filtri, ordinamento e paging delle entità di Servizi multimediali di Azure](filter-order-page-entitites-how-to.md).
