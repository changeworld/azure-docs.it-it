...
È possibile inviare il feed di contributi a risoluzioni fino a 4K e a una frequenza pari a 60 fotogrammi al secondo, con codec video H.264/AVC o H.265/HEVC e codec audio AAC (AAC-LC, HE-AACv1 o HE-AACv2). Per altre informazioni, vedere [confronto tra tipi di eventi live](live-event-types-comparison-reference.md).
...
Per ulteriori informazioni, vedere [gli Stati degli eventi live e la fatturazione](live-event-states-billing-concept.md).
...
* Quando si crea l'evento, è possibile scegliere di attivare le trascrizioni in tempo reale. Per impostazione predefinita, la trascrizione in tempo reale è disabilitata. Per altre informazioni sulla [trascrizione Live di Read](live-event-live-transcription-how-to.md)trascrizione Live.
...
## <a name="live-event-output-questions"></a>Domande sull'output dell'evento Live

Vedere l'articolo relativo alle [domande sull'output di eventi live](questions-collection.md#live-streaming) .
