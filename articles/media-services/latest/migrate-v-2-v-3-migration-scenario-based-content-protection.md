...
Per altre informazioni sulla protezione del contenuto nell'API V3, vedere l'articolo [proteggere i contenuti con la crittografia dinamica di servizi multimediali.](https://docs.microsoft.com/azure/media-services/latest/content-protection-overview)
