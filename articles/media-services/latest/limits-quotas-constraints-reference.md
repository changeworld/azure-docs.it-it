...
| --- | --- |
| [Account di servizi multimediali](account-move-account-how-to.md) in una singola sottoscrizione | 100 (fisso) |
...
| Risorsa | Limite predefinito | 
| --- | --- | 
| [Processi](transform-jobs-concept.md) per account di servizi multimediali | 500.000 <sup>(3)</sup> (fisso)|
| Input di processi per processo | 50 (fisso)|
| Output di processi per processo | 20 (fisso) |
| [Trasformazioni](transform-jobs-concept.md) per ogni account di servizi multimediali | 100 (fisso)|
...
| Risorsa | Limite predefinito | 
| --- | --- | 
| [Eventi live](live-event-outputs-concept.md) <sup>(4)</sup> per account di servizi multimediali |5|
| Output live per evento live |3 <sup>(5)</sup> |
| Durata max degli output live | [Dimensioni della finestra DVR](live-event-cloud-dvr-time-how-to.md) |

<sup>4</sup> per informazioni dettagliate sui limiti degli eventi live, vedere [confronto e limiti di tipi di eventi live](live-event-types-comparison-reference.md).
...
| Risorsa | Limite predefinito |
| --- | --- |
| [Endpoint di streaming](stream-streaming-endpoint-concept.md) (arrestati o in esecuzione) per ogni account di servizi multimediali | 2 |
| Unità di streaming Premium | 10 |
| [Filtri manifesto dinamico](filters-dynamic-manifest-concept.md)|100|
| [Criteri di streaming](stream-streaming-policy-concept.md) | 100 <sup>(6)</sup> |
| [Localizzatori di streaming](stream-streaming-locators-concept.md) univoci associati a un asset in una sola volta | 100<sup>(7)</sup> (fisso) |
...
| Risorsa | Limite predefinito |
| --- | --- |
| Opzioni per [criterio chiave](drm-content-key-policy-concept.md) simmetrica |30 |
