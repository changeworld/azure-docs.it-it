...
Si consiglia di acquisire familiarità con le trasformazioni personalizzate leggendo [come codificare con una trasformazione personalizzata-Rest](transform-custom-preset-rest-how-to.md).
...
[Generare anteprime usando .NET](transform-generate-thumbnails-dotnet-how-to.md)