...
* È consigliabile progettare un set limitato di criteri per l'account del servizio multimediale e riutilizzarli per i localizzatori di streaming ogni volta che sono necessarie le stesse opzioni. Per altre informazioni, vedere [quote e limiti](limits-quotas-constraints.md).
