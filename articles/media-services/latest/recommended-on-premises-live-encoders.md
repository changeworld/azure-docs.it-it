...
Per informazioni sulle impostazioni valide per il tipo specifico di evento live, vedere [Confronto tra tipi di eventi live](live-event-types-comparison-reference.md).
...
[Streaming live con Servizi multimediali v3](stream-live-streaming-concept.md)

## <a name="next-steps"></a>Passaggi successivi

[Come verificare il codificatore](encode-on-premises-encoder-partner.md)
