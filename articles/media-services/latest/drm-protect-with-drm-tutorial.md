...
È possibile usare Servizi multimediali di Azure per distribuire i flussi crittografati con licenze Microsoft PlayReady, Google Widevine o Apple FairPlay. Per una spiegazione approfondita, vedere [Protezione del contenuto con la crittografia dinamica](drm-content-protection-concept.md).
...
![AMS con video protetto con DRM in Azure Media Player](./media/drm-protect-with-drm-tutorial/ams_player.png)
...
* Vedere l'articolo [Panoramica della protezione del contenuto](drm-content-protection-concept.md).
* Fare riferimento a [Progettare un sistema di protezione del contenuto con DRM multiplo e controllo di accesso](architecture-design-multi-drm-system.md).
* Installare Visual Studio Code o Visual Studio.
* Creare un nuovo account di Servizi multimediali in Azure, come descritto in [questa guida introduttiva](./account-create-how-to.md).
...
Una chiave simmetrica consente l'accesso sicuro agli asset. È necessario creare [criteri di chiave simmetrica](drm-content-key-policy-concept.md) durante la crittografia del contenuto con DRM. I criteri configurano la modalità di distribuzione della chiave simmetrica ai client finali. La chiave simmetrica è associata a un localizzatore di streaming. Servizi multimediali fornisce anche il servizio di distribuzione delle chiavi che distribuisce chiavi di crittografia e licenze agli utenti autorizzati.
...
* Configurazione
    ...
    Le licenze [PlayReady](drm-playready-license-template-concept.md) e [Widevine](drm-widevine-license-template-concept.md) sono configurate in modo che possano essere distribuite dal servizio di distribuzione delle licenze di Servizi multimediali. Anche se questa app di esempio non configura la licenza [FairPlay](drm-fairplay-license-overview.md), contiene un metodo che è possibile usare per configurare FairPlay. È possibile aggiungere la configurazione di FairPlay come un'altra opzione.
...
1. Creare un [localizzatore di streaming](stream-streaming-locators-concept.md).
...
![Proteggere con DRM](./media/drm-protect-with-drm-tutorial/playready_encrypted_url.png)
...
> [Proteggere con AES-128](drm-playready-license-template-concept.md)
