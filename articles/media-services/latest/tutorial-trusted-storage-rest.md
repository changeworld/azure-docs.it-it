...
Se non si sa come ottenere l'ID tenant e l'ID sottoscrizione, vedere [come trovare l'](how-to-set-azure-tenant.md) ID tenant e [trovare l'ID tenant](how-to-set-azure-tenant.md).
