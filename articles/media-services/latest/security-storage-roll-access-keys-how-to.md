...
L'articolo seguente illustra come aggiungere gli account di archiviazione all'account AMS: [Collegare più account di archiviazione a un account di Servizi multimediali](storage-managing-multiple-storage-accounts-how-to.md).
