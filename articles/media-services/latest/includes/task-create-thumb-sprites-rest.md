...
ms.locfileid: "101705471"
---
<!--Create a thumbnail sprites REST-->

Il comando REST di Azure seguente crea una trasformazione sprite di anteprima. Sostituire i valori `subscriptionID` , `resourceGroup` e `accountName` con i valori attualmente in uso. 

Assegnare un nome alla trasformazione impostando `transformName` .
