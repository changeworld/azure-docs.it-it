...
L'applicazione di servizi multimediali V2 potrebbe essere univoca. Per questo motivo, sono state fornite indicazioni basate su come è *possibile* usare servizi multimediali in passato e i passaggi per ogni funzionalità del servizio, ad esempio:
