---
title: Gestione di asset di servizi multimediali V3 tra più account di archiviazione | Microsoft Docs
description: Questo articolo fornisce indicazioni su come gestire le risorse di servizi multimediali V3 tra più account di archiviazione.
...
ms.locfileid: "106282042"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>Gestione di asset di servizi multimediali V3 tra più account di archiviazione  
...
Questo articolo illustra come aggiungere più account di archiviazione a un account di servizi multimediali usando [api Azure Resource Manager](/rest/api/media/operations/azure-media-services-rest-api-reference) e [PowerShell](/powershell/module/az.media). Spiega inoltre come specificare diversi account di archiviazione durante la creazione di asset mediante l'SDK di Servizi multimediali.
