...
Si consiglia di acquisire familiarità con le trasformazioni personalizzate leggendo [come codificare con una trasformazione personalizzata-Rest](encode-custom-preset-rest-how-to.md).
