---
title: Errori di creazione e creazione di pacchetti di servizi multimediali di Azure
...
ms.locfileid: "106282142"
---
# <a name="streaming-endpoint-origin-errors"></a>Errori dell'endpoint di streaming (Origine)

Questo argomento descrive gli errori che possono essere ricevuti dal [servizio di endpoint di streaming](stream-streaming-endpoint-concept.md)di servizi multimediali di Azure.
...
- [Concetto: criteri di streaming](stream-streaming-policy-concept.md)
