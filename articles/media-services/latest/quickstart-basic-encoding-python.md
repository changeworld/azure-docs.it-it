---
title: Guida introduttiva alla codifica Basic di Python per servizi multimediali
description: Questa Guida introduttiva illustra come eseguire la codifica di base con Python e servizi multimediali di Azure.
...
Questa Guida introduttiva illustra come eseguire la codifica di base con Python e servizi multimediali di Azure. Usa l'API 2020-05-01 Media Service V3.

## <a name="prerequisites"></a>Prerequisiti

- Se non si ha una sottoscrizione di Azure, creare un [account gratuito](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) prima di iniziare.
- Creare un gruppo di risorse da usare con questa Guida introduttiva.
- Creare un account di servizi multimediali V3.
...
Creare un fork e clonare l'esempio disponibile nel [repository di esempi Python](https://github.com/Azure-Samples/media-services-v3-python). Per questa Guida introduttiva si sta lavorando con l'esempio BasicEncoding.

## <a name="create-the-env-file"></a>Creare il file con estensione ENV

Per creare un file con *estensione ENV* , ottenere i valori dall'account. A questo proposito, salvarlo senza nome, ma solo con l'estensione.  Usare *Sample. env* come modello, quindi salvare il file con *estensione ENV* nella cartella BasicEncoder del clone locale.

## <a name="try-the-code"></a>Prova il codice

Il codice riportato di seguito viene commentato in modo approfondito.  Usare l'intero script o usare parti di esso per uno script personalizzato.

In questo esempio viene generato un numero casuale per la denominazione di elementi, in modo da poterli identificare come un gruppo creato insieme quando è stato eseguito lo script.  Il numero casuale è facoltativo e può essere rimosso al termine del test dello script.

In questo esempio non viene usato l'URL di firma di accesso condiviso per l'asset di input.
...
Al termine della Guida introduttiva, eliminare le risorse create nel gruppo di risorse.

## <a name="next-steps"></a>Passaggi successivi

Acquisire familiarità con l' [SDK di servizi multimediali per Python](/python/api/azure-mgmt-media/)