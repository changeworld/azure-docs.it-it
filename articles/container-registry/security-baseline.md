...
- [Informazioni sull'intelligence sulle minacce integrata nel Centro sicurezza di Azure](../security-center/security-center-alerts-service-layer.md)
...
- [Informazioni sull'area di lavoro Log Analytics](/azure/azure-monitor/log-query/get-started-portal)
...
- [Accesso singolo a un registro contenitori](https://docs.microsoft.com/azure/container-registry/container-registry-authentication#admin-account)
...
- [Integrazione del Registro Azure Container con il Centro sicurezza (anteprima)](/azure/security-center/azure-container-registry-integration)
