...
| OS                  | Compilatore                          |
|---------------------|-----------------------------------|
| Linux               | Python 2,7. *, 3,6 o versione successiva |
| macOS High Sierra   | Python 2,7. *, 3,6 o versione successiva |
| Famiglia Windows 10   | Python 2,7. *, 3,6 o versione successiva |
