...
1. Cercare e selezionare **Microsoft. Azure. Devices. client**, quindi selezionare **Install (installa**).
    ...
    ![Screenshot che mostra il pulsante "Microsoft. Azure. Devices. client" selezionato e il pulsante "Installa" evidenziato.](./media/iot-hub-csharp-csharp-module-twin-getstarted/install-client-sdk.png)
