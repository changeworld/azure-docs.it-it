...
* [Creare l'identità del modulo e il modulo gemello dell'hub IoT usando il backup .NET e l'SDK per dispositivi .NET](iot-hub-csharp-csharp-module-twin-getstarted.md)
