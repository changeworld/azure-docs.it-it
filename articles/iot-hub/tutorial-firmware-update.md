---
title: "Esercitazione: aggiornare il firmware del dispositivo tramite l'hub di Azure. Microsoft Docs"
description: "Esercitazione: informazioni su come implementare un processo di aggiornamento del firmware del dispositivo che può essere attivato da un'applicazione back-end connessa all'hub Internet."
services: iot-hub
author: wesmc7777
ms.author: wesmc
ms.service: iot-hub
...
Si crea una [configurazione di gestione automatica](iot-hub-automatic-device-management.md#create-a-configuration) dei dispositivi nell'applicazione back-end per avviare il processo di aggiornamento del firmware su tutti i dispositivi contrassegnati con un **tipo di dispositivo** chiller. In questa sezione verrà illustrato come:
