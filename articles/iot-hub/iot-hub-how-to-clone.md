...
1. Per le code del bus di servizio, ottenere la chiave di accesso condivisa corrispondente a SharedAccessKeyName. Ecco la chiave e la `SharedAccessKeyName` in JSON:
...
1. Usare gli esempi C# di questa pagina: [esempi di Azure per c#](https://azure.microsoft.com/resources/samples/azure-iot-samples-csharp/). Scaricare il file con estensione zip e decomprimerlo nel computer. 
