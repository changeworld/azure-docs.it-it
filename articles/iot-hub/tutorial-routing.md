---
title: "Esercitazione: configurare il routing dei messaggi per l'hub Internet Azure con l'interfaccia della riga di comando"
description: "Esercitazione: configurare il routing dei messaggi per l'hub Azure Internet tramite l'interfaccia della riga di comando di Azure e il portale di Azure"
author: robinsh
manager: philmea
ms.service: iot-hub
services: iot-hub
