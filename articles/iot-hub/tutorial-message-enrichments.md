...
Per rimuovere il gruppo di risorse, usare il comando [eliminazione del gruppo az](/cli/azure/group#az-group-delete). Ricordare che `$resourceGroup` è stato impostato su **ContosoResourcesMsgEn** all'inizio di questa esercitazione.
