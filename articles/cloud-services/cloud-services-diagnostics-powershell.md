...
* Lo [Schema di configurazione della diagnostica](../azure-monitor/platform/diagnostics-extension-schema-windows.md) illustra le varie opzioni di configurazione xml per l'estensione della diagnostica.
