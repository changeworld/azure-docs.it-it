---
title: Introduzione a Python e servizi cloud di Azure (versione classica) | Microsoft Docs
...
Questo articolo offre una panoramica dell'uso dei ruoli Web e di lavoro con [Python Tools for Visual Studio][Python Tools for Visual Studio]. Informazioni su come usare Visual Studio per creare e distribuire un servizio cloud di base che usa Python.
...
* [Python 2,7 32][Python 2.7 32-bit] bit o [Python 3,8 32 bit][Python 3.8 32-bit]
...
Gli script seguenti sono stati scritti come destinazione Python 3,8. Per usare la versione 2.x di Python, impostare il file di variabile **PYTHON2** su **on** per le due attività di avvio e l'attività di runtime: `<Variable name="PYTHON2" value="<mark>on</mark>" />`.
...
* [Progetti di servizi cloud][Cloud Service Projects]
