...
```
Sarà disponibile a breve la possibilità di scegliere BLOB o locale come percorso di caricamento dei file con estensione csdef e cscfg. Usare [New-AzureDeployment](/powershell/module/servicemanagement/azure.service/new-azuredeployment) per impostare il valore di ciascuna posizione.
...
Servizi cloud non supporta il modello di controllo degli accessi in base al ruolo di Azure (RBAC di Azure), perché non è un servizio basato su Azure Resource Manager.
