...
Per altre domande, visitare la [pagina delle domande di Domande e risposte Microsoft per Servizi cloud](/answers/topics/azure-cloud-services.html) o [contattare il supporto tecnico di Azure](https://azure.microsoft.com/support/options/).
...
Per trovare la famiglia di sistemi operativi in esecuzione sui servizi cloud, è possibile eseguire lo script seguente in Azure PowerShell, anche se prima è necessario [configurare Azure PowerShell](/powershell/azure/). Per altre informazioni sullo script, vedere [Azure Guest OS Family 1 End of Life: June 2014](/archive/blogs/ryberry/azure-guest-os-family-1-end-of-life-june-2014) (Fine vita della famiglia di sistemi operativi guest di Azure: 1° giugno 2014).
