---
title: Archiviazione e spostamento dati per il rendering
description: Informazioni sulle diverse opzioni di archiviazione e spostamento dati per i carichi di lavoro dei file di asset e output del rendering.
services: batch
ms.service: batch
author: mscurrell
ms.author: markscu
...
* [Archiviazione BLOB di Azure](../storage/blobs/storage-blobs-introduction.md):
...
* Archiviazione di Azure come file system con [Blobfuse](../storage/blobs/storage-how-to-mount-container-linux.md):
...
Per copiare i file da e verso Archiviazione di Azure, è possibile usare vari meccanismi tra cui l'API del BLOB di archiviazione, la [libreria di Azure Storage Data Movement](https://github.com/Azure/azure-storage-net-data-movement), lo strumento da riga di comando azcopy per [Windows](../storage/common/storage-use-azcopy-v10.md) o [Linux](../storage/common/storage-use-azcopy-v10.md), [Azure Storage Explorer](https://azure.microsoft.com/features/storage-explorer/) e [Azure Batch Explorer](https://azure.github.io/BatchExplorer/).
...
* Quando sono presenti file univoci per un processo, ma questi sono necessari per tutte le attività di un processo, è possibile specificare un'[attività di preparazione del processo](/rest/api/batchservice/job/add#jobpreparationtask) per copiare tutti i file.  L'attività di preparazione del processo viene eseguita una volta alla prima esecuzione dell'attività di processo su una VM, ma non viene ripetuta per le attività di processo successive.
* È consigliabile specificare anche un'[attività di rilascio del processo](/rest/api/batchservice/job/add#jobreleasetask) per rimuovere i file al termine di ogni processo. In questo modo si evita che il disco della VM venga riempito con tutti i file di asset di processo.
...
* [File di Azure](../storage/files/storage-files-introduction.md)
