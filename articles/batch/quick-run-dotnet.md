...
- [Visual Studio 2017](https://www.visualstudio.com/vs)o versione successiva o [.NET Core 2.1 SDK](https://dotnet.microsoft.com/download/dotnet/2.1) per Linux, macOS o Windows. 
