...
description: Questa guida di avvio rapido illustra come creare un account Batch ed eseguire un processo batch con l'interfaccia della riga di comando di Azure.
ms.topic: quickstart
ms.date: 08/13/2020
...
- Questa guida di avvio rapido richiede l'interfaccia della riga di comando di Azure versione 2.0.20 o successiva. Se si usa Azure Cloud Shell, la versione più recente è già installata.
