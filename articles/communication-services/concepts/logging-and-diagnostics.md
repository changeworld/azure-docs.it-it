...
Per altre informazioni sulla configurazione della diagnostica, vedere la panoramica dei [log delle risorse di Azure](../../azure-monitor/platform/platform-logs-overview.md).
