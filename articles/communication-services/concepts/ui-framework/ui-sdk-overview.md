...
|Libreria client/SDK|Complessità di implementazione|    Funzionalità di personalizzazione|  Chiamata| Chat| [Interoperabilità team](./../voice-video-calling/teams-interop.md)
|---|---|---|---|---|---|---|
