---
title: Panoramica della documentazione di riferimento per Servizi di comunicazione di Azure
titleSuffix: An Azure Communication Services concept document
description: Informazioni sulla documentazione di riferimento di Servizi di comunicazione.
author: mikben
manager: jken
...
ms.locfileid: "101655854"
---
# <a name="reference-documentation-overview"></a>Panoramica della documentazione di riferimento

La tabella seguente fornisce informazioni dettagliate sui pacchetti di Servizi di comunicazione disponibili insieme alla documentazione di riferimento corrispondente:
...
| Chiamata        | [npm](https://www.npmjs.com/package/@azure/communication-calling)         | -      | -      | -     | [GitHub](https://github.com/Azure/Communication/releases) ([documentazione](/objectivec/communication-services/calling/))     | [Maven](https://search.maven.org/artifact/com.azure.android/azure-communication-calling/)            | -                              |
