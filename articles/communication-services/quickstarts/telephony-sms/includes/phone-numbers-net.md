...
I client dei numeri di telefono possono essere autenticati usando la stringa di connessione acquisita da risorse di comunicazione di Azure in [portale di Azure] [azure_portal].
