...
Per questo esempio si firmerà una richiesta per creare una nuova identità usando l'API di autenticazione di servizi di comunicazione (versione `2020-07-20-preview2` )
