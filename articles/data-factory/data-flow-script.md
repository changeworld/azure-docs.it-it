...
### <a name="persist-column-data-types"></a>Mantieni tipi di dati di colonna
Aggiungere questo script all'interno di una definizione di colonna derivata per archiviare i nomi di colonna e i tipi di dati dal flusso di dati a un archivio permanente usando un sink.
...
### <a name="moving-average"></a>Media mobili
La media mobili può essere implementata molto facilmente nei flussi di dati tramite una trasformazione Windows. Nell'esempio seguente viene creata una media di 15 giorni per i prezzi azionari per Microsoft.
