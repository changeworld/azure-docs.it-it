...
description: Elenca le definizioni dei criteri predefiniti di criteri di Azure per Data Factory. Queste definizioni di criteri predefinite forniscono approcci comuni alla gestione delle risorse di Azure.
ms.author: lle
author: lrtoyou1223
...
ms.locfileid: "100372842"
---
# <a name="azure-policy-built-in-definitions-for-data-factory-preview"></a>Definizioni predefinite dei criteri di Azure per Data Factory (anteprima)
[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

Questa pagina è un indice delle definizioni dei criteri predefiniti di [criteri di Azure](../governance/policy/overview.md) per data factory. Per informazioni su altre definizioni predefinite di Criteri di Azure per altri servizi, vedere [Definizioni di criteri predefiniti di Criteri di Azure](../governance/policy/samples/built-in-policies.md).
