...
Per usare questa funzionalità, [scaricare](/sql/ssms/download-sql-server-management-studio-ssms) e installare la versione più recente di SQL Server Management Studio (SSMS). Dettagli supporto versione come riportato di seguito:
