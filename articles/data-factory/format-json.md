...
```
Se è selezionato **documento per riga** , il mapping dei flussi di dati legge un documento JSON da ogni riga in un file. 
...
File3.json
 ...
 {"time":"2015-04-29T07:13:21.4370000Z","callingimsi":"466923101048691","callingnum1":"678901578","callingnum2":"345626404","switch1":"Germany","switch2":"UK"}
```
Se è selezionata la **matrice di documenti** , il mapping dei flussi di dati legge una matrice di documenti da un file. 
