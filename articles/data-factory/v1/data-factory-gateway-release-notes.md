...
- È possibile aggiungere voci DNS per consentire il bus di servizio anziché consentire tutti gli indirizzi IP di Azure dal firewall (se necessario). È possibile trovare la rispettiva voce DNS in portale di Azure (Data Factory->' Author and deploy '->' Gateway '-> "serviceUrls" (in JSON)
...
### <a name="enhancements-"></a>Miglioramenti
-    È possibile aggiungere voci DNS per consentire il bus di servizio anziché consentire tutti gli indirizzi IP di Azure dal firewall (se necessario). Altri dettagli sono disponibili qui.
...
*  Possibilità di "aggiornare ora" dal client
...
*  Supportare Azure sinapsi Analytics per Azure Data Factory
