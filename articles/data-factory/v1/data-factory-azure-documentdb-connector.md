...
| nestingSeparator |Carattere speciale per indicare che il documento è nidificato |Qualsiasi carattere. <br/><br/>Azure Cosmos DB è un archivio NoSQL per i documenti JSON, dove sono consentite strutture nidificate. Azure Data Factory consente all'utente di indicare la gerarchia tramite nestingSeparator, ovvero "." negli esempi precedenti. Con il separatore, l'attività di copia genererà l'oggetto "Name" con tre elementi figlio First, Middle e Last, in base a "Name. First", "Name. Middle" e "Name. Last" nella definizione della tabella. |No |
...
Impostando "External": "true" e specificando le informazioni sui criteri externalData, il Azure Data Factory servizio che la tabella è esterna al data factory e non produsse da un'attività nel data factory.
...
L'esempio copia i dati in una raccolta denominata "person".
