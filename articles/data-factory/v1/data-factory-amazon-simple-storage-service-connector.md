...
> [!NOTE]
> Le informazioni di questo articolo sono valide per la versione 1 di Data Factory. Se si usa la versione corrente del servizio Data Factory, vedere le informazioni sul [connettore Amazon S3 nella versione 2](../connector-amazon-simple-storage-service.md).
