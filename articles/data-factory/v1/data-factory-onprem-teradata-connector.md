...
La sezione **typeProperties** è diversa per ogni tipo di set di dati e fornisce informazioni sul percorso dei dati nell'archivio dati. Attualmente non sono disponibili proprietà di tipo supportate per il set di dati Teradata.
