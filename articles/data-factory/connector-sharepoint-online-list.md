...
> [!NOTE]
> Anche se un'applicazione Azure AD dispone di `FullControl` autorizzazioni in SharePoint Online, non è possibile copiare i file dalle raccolte documenti con IRM abilitato.
