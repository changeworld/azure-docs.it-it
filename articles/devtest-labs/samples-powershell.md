...
|[Impostare le dimensioni di VM consentite in un lab](scripts/set-allowed-vm-sizes-in-lab.md)| Questo script di PowerShell imposta le dimensioni di macchina virtuale (VM) consentite in un lab. |
