...
1. Configurare le attività in questo modo:
   ...
   |VM del Lab di **origine**  >  **ID macchina virtuale Lab di origine**|Se è stato modificato il nome predefinito della variabile LabVMId, immetterlo qui. Il valore predefinito è **$(labVMId)**.|
