...
1. Passare al home page della raccolta del team (ad esempio, `https://contoso-web-team.visualstudio.com` ) e quindi selezionare il progetto.
...
7. Nella scheda **Security > Personal Access Tokens** selezionare **+ nuovo token**.
...
| ArtifactRepositoryDisplayName | Nome visualizzato per il repository di artefatti. Si tratta del nome che viene visualizzato nella portale di Azure ( https://portal.azure.com) quando si visualizzano tutti i repository di elementi per un Lab. |
