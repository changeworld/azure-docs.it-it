...
Per configurare un indirizzo IP dedicato o riservato per le chiamate in ingresso al sito Web dell'app di Azure, installare e configurare un certificato TLS/SSL basato su IP.
