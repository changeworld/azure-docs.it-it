---
title: Risolvere i problemi di riduzione del livello delle prestazioni
description: Informazioni su come risolvere i problemi di rallentamento delle prestazioni delle app in Servizio app Azure, tra cui il monitoraggio del comportamento delle app, la raccolta di dati e l'attenuazione del problema.
...
È anche possibile gestire l'app usando Azure PowerShell. Per altre informazioni, vedere [Uso di Azure PowerShell con Gestione risorse di Azure](../azure-resource-manager/management/manage-resources-powershell.md).