...
1. Nella finestra **git Gestione credenziali** immettere le credenziali dell'ambito utente o dell'applicazione [e](#configure-a-deployment-user)non le credenziali di accesso di Azure.
