...
In Cloud Shell abilitare CORS per l'URL del client usando il comando [`az webapp cors add`](/cli/azure/webapp/cors#az_webapp_cors_add). Sostituire i segnaposto _\<back-end-app-name>_ e _\<front-end-app-name>_ .
