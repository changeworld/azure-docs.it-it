...
In Cloud Shell abilitare CORS per l'URL del client usando il comando [`az webapp cors add`](/cli/azure/webapp/cors#az_webapp_cors_add). Sostituire il segnaposto _&lt;app-name>_ .
