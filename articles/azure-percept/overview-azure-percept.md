...
ms.locfileid: "102435461"
---
# <a name="introduction-to-azure-percept"></a>Introduzione ad Azure Percept

Azure Percept è una famiglia di componenti hardware, software e servizi progettati per accelerare la trasformazione aziendale usando Internet delle cose e intelligenza artificiale al perimetro. Azure Percept copre lo stack completo da Silicon ai servizi per risolvere i problemi di integrazione dell'intelligenza artificiale perimetrale su larga scala.  

Le difficoltà di integrazione che si verificano quando si tenta di distribuire soluzioni di intelligenza artificiale su larga scala possono essere riassunte in tre punti principali di attrito:
