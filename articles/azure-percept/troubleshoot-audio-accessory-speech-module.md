...
[percorso file host locale] indica il percorso nel computer host in cui si desidera copiare il file con estensione txt. [nomeutente remoto] è il nome utente SSH scelto durante l' [installazione](./quickstart-percept-dk-set-up.md). Se durante la configurazione guidata non è stato configurato un account di accesso SSH, il nome utente remoto è root.
...
:::image type="content" source="./media/troubleshoot-audio-accessory-speech-module/firmware-desired-status-stopped.png" alt-text="Impostare la schermata dei moduli nell'portale di Azure.":::
...
1. 1 luce verde sinistra: il dispositivo è acceso. 
2. 1 luce verde sinistra e LED centrale lampeggiante verde-l'autenticazione è in corso. 
3. Quando il dispositivo viene autenticato e pronto per l'uso, tutti e tre i LED cambieranno in blu.

|Stato del LED                  |Stato SoM Ear            |
|----------------------------|---------------------------|
|1x verde (LED a sinistra)         |accensione |
|1x verde (LED a sinistra) <br> 1x verde lampeggiante (LED centrale) |autenticazione in corso |
|3x disattivato                      |inizializzazione completata |
|blu 3x                     |pronto per l'uso |
|3 lampeggio blu            |parola chiave riconosciuta |
|Blu Racing 3x              |elaborazione |
|rosso 3x                      |mute |
