...
- **Ricerca di asset**. Se si dispone già di un modello 3D di un oggetto nello spazio fisico, gli ancoraggi degli oggetti possono consentire all'utente di individuare e rilevare le istanze dell'oggetto nell'ambiente fisico.
