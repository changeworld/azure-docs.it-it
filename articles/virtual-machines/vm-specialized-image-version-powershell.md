...
Quando si dispone di una versione di immagine specializzata, è possibile creare una o più macchine virtuali nuove usando il cmdlet [New-AzVM](/powershell/module/az.compute/new-azvm) . 
