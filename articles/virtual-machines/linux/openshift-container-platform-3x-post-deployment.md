...
Leggere le [istruzioni](../../azure-monitor/containers/containers.md#configure-a-log-analytics-agent-for-red-hat-openshift) complete per altri dettagli.
