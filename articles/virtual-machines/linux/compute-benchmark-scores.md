...
| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | AMD EPYC 7452 32-processore Core | 2 | 1 | 15.7 | 29.217 | 654 | 2,24% | 42 |
| Standard_E4as_v4 | AMD EPYC 7452 32-processore Core | 4 | 1 | 31,4 | 58.356 | 480 | 0,82% | 42 |
| Standard_E8as_v4 | AMD EPYC 7452 32-processore Core | 8 | 1 | 62,9 | 115.943 | 3.526 | 3,04% | 35 |
| Standard_E16as_v4 | AMD EPYC 7452 32-processore Core | 16 | 2 | 125,9 | 227.383 | 5.619 | 2,47% | 35 |
| Standard_E32as_v4 | AMD EPYC 7452 32-processore Core | 32 | 4 | 251,9 | 454.609 | 12.746 | 2,80% | 35 |
| Standard_E48as_v4 | AMD EPYC 7452 32-processore Core | 48 | 6 | 377,9 | 682.769 | 9.257 | 1,36% | 35 |
| Standard_E64as_v4 | AMD EPYC 7452 32-processore Core | 64 | 8 | 503,9 | 881.311 | 28.357 | 3,22% | 35 |
| Standard_E96as_v4 | AMD EPYC 7452 32-processore Core | 96 | 12 | 661,4 | 1.299.233 | 14.997 | 1,15% | 70 |
...
| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | AMD EPYC 7452 32-processore Core | 2 | 1 | 15.7 | 29.561 | 422 | 1,43% | 42 |
| Standard_E4a_v4 | AMD EPYC 7452 32-processore Core | 4 | 1 | 31,4 | 58.303 | 1.280 | 2,20% | 42 |
| Standard_E8a_v4 | AMD EPYC 7452 32-processore Core | 8 | 1 | 62,9 | 114.650 | 2.726 | 2,38% | 42 |
| Standard_E16a_v4 | AMD EPYC 7452 32-processore Core | 16 | 2 | 125,9 | 226.947 | 4.661 | 2,05% | 35 |
| Standard_E32a_v4 | AMD EPYC 7452 32-processore Core | 32 | 4 | 251,9 | 453.666 | 10.058 | 2,22% | 42 |
| Standard_E48a_v4 | AMD EPYC 7452 32-processore Core | 48 | 6 | 377,9 | 665.200 | 18.714 | 2,81% | 35 |
| Standard_E64a_v4 | AMD EPYC 7452 32-processore Core | 64 | 8 | 503,9 | 894.718 | 25.214 | 2,82% | 35 |
| Standard_E96a_v4 | AMD EPYC 7452 32-processore Core | 96 | 12 | 661,4 | 1.298.074 | 15.948 | 1,23% | 35 |
...
>
> CoreMark è un test di breve durata che in genere viene completato entro i crediti di espansione disponibili.  Pertanto, i numeri precedenti rappresentano in genere le prestazioni di aumento della macchina virtuale, riflettendo in genere le prestazioni dei carichi di lavoro brevi, con picchi di carico (tipici sulle serie B).
...
| Standard_D32s_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 3 a 2,40 GHz | 32 | 2 | 125,9 | 315.457 | 2.647 | 0,84% | 105 |
| Standard_D32s_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 4 a 2,30 GHz | 32 | 1 | 125,9 | 312.058 | 1.661 | 0.53% | 595 |
| Standard_D64s_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 4 a 2,30 GHz | 64 | 2 | 251,9 | 627.378 | 4.447 | 0,71% | 700 |
...
| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 3 a 2,40 GHz | 2 | 1 | 7.8 | 20.359 | 799 | 3,93% | 154 |
| Standard_D2_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 4 a 2,30 GHz | 2 | 1 | 7.8 | 20.737 | 1.422 | 6,86% | 546 |
| Standard_D4_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 3 a 2,40 GHz | 4 | 1 | 15.7 | 40.095 | 1.501 | 3,74% | 147 |
...
| Standard_D64_v3 | Intel(R) Xeon(R) CPU E5-2673 vers. 4 a 2,30 GHz | 64 | 2 | 251,9 | 627.470 | 9.651 | 1,54% | 700 |

## <a name="dsv2---storage-optimized"></a>DSv2 - Con ottimizzazione per l'archiviazione
(3/15/2019 12:53:13 AM PBI 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_DS1_v2 | Intel(R) Xeon(R) CPU E5-2673 vers. 3 a 2,40 GHz | 1 | 1 | 3.4 | 14.642 | 600 | 4,10% | 259 |
...
## <a name="lv2---storage-optimized"></a>LV2-ottimizzato per l'archiviazione
(3/14/2019 5:49:04 PM PBI 3897709)

| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32-processore Core | 8 | 1 | 62,9 | 80.528 | 404 | 0,50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32-processore Core | 16 | 2 | 125,9 | 154.829 | 3.708 | 2,40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32-processore Core | 32 | 4 | 251,9 | 310.811 | 7.751 | 2,49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32-processore Core | 64 | 8 | 503,9 | 595.140 | 14.572 | 2,45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32-processore Core | 80 | 10 | 629,9 | 773.171 | 19.559 | 2,53% | 119 |
...
| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L4s | Intel(R) Xeon(R) CPU E5-2698B vers. 3 a 2,00 GHz | 4 | 1 | 31,4 | 56.488 | 2.916 | 5,16% | 287 |
| Standard_L8s | Intel(R) Xeon(R) CPU E5-2698B vers. 3 a 2,00 GHz | 8 | 1 | 62,9 | 107.017 | 2.323 | 2,17% | 287 |
| Standard_L16s | Intel(R) Xeon(R) CPU E5-2698B vers. 3 a 2,00 GHz | 16 | 1 | 125,9 | 210.865 | 3.653 | 1,73% | 280 |
| Standard_L32s | Intel(R) Xeon(R) CPU E5-2698B vers. 3 a 2,00 GHz | 32 | 2 | 251,9 | 399.963 | 9.254 | 2,31% | 287 |
...
| Dimensioni macchina virtuale | CPU | vCPU | Nodi NUMA | Memoria (GiB) | Punteggio AVG | Deviazione standard | % Dev std | N. esecuzioni |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_M8-2ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 2 | 1 | 215,2 | 22.605 | 29 | 0.13% | 42 |
| Standard_M8-4ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 4 | 1 | 215,2 | 44.488 | 183 | 0,41% | 42 |
| Standard_M16-4ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 4 | 1 | 430,6 | 44.451 | 269 | 0,61% | 42 |
| Standard_M16-8ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 8 | 1 | 430,6 | 88.238 | 1.243 | 1,41% | 42 |
| Standard_M32-8ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 8 | 1 | 861,2 | 88.521 | 1.353 | 1,53% | 42 |
| Standard_M32-16ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 16 | 1 | 861,2 | 174.674 | 3.104 | 1,78% | 42 |
| Standard_M64 | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 64 | 2 | 1.007,9 | 683.022 | 11.929 | 1,75% | 42 |
| Standard_M64-16ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 16 | 2 | 1.763,9 | 169.386 | 4.737 | 2,80% | 42 |
| Standard_M64-32ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 32 | 2 | 1.763,9 | 337.599 | 4.738 | 1,40% | 42 |
| Standard_M64m | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 64 | 2 | 1.763,9 | 677.466 | 14.478 | 2,14% | 42 |
| Standard_M64ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 64 | 2 | 1.763,9 | 675.342 | 16.577 | 2,45% | 42 |
| Standard_M64s | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 64 | 2 | 1.007,9 | 674.785 | 15.983 | 2.37% | 42 |
| Standard_M128 | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 128 | 4 | 2.015,9 | 1.334.218 | 21.126 | 1,58% | 42 |
| Standard_M128-32ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 32 | 4 | 3.831,1 | 334.873 | 5.005 | 1,49% | 42 |
| Standard_M128-64ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 64 | 4 | 3.831,1 | 667.808 | 18.145 | 2,72% | 42 |
| Standard_M128m | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 128 | 4 | 3.831,1 | 1.335.873 | 19.642 | 1,47% | 42 |
| Standard_M128ms | Intel(R) Xeon(R) CPU E7-8890 vers. 3 da 2,50 GHz | 128 | 4 | 3.831,1 | 1.329.151 | 24.295 | 1,83% | 42 |
