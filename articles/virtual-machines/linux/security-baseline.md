...
* [Per acquisire i dati syslog per il monitoraggio, è necessario abilitare l'estensione Log Analytics](../../azure-monitor/vm/quick-collect-azurevm.md#enable-the-log-analytics-vm-extension)
