---
title: Creare una VM con zona con l'interfaccia della riga di comando di Azure
description: Creare una macchina virtuale in una zona di disponibilità con l'interfaccia della riga di comando di Azure
author: cynthn
...
ms.locfileid: "102558373"
---
# <a name="create-a-virtual-machine-in-an-availability-zone-using-azure-cli"></a>Creare una macchina virtuale in una zona di disponibilità usando l'interfaccia della riga di comando di Azure
