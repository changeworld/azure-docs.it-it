...
L'esempio seguente usa il comando [az vm run-command](/cli/azure/vm/run-command#az_vm_run_command_invoke) per eseguire uno script della shell su una macchina virtuale Linux di Azure.
