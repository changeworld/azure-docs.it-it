...
Questa sezione illustra come preparare una macchina virtuale [RHEL 6](#rhel-6-using-hyper-v-manager) o [RHEL 7](#rhel-7-using-hyper-v-manager) con la console di gestione di Hyper-V.
