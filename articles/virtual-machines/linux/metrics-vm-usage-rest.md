...
Usare la richiesta GET seguente per raccogliere la [metrica Percentuale CPU](../../azure-monitor/essentials/metrics-supported.md#microsoftcomputevirtualmachines) da una macchina virtuale
