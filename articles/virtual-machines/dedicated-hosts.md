...
> [!NOTE]
> Quando un host dedicato è spazio, non è possibile modificare le dimensioni o il tipo. Se sono necessarie dimensioni diverse del tipo, sarà necessario creare un nuovo host.  
