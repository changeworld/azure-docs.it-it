...
- Per la latenza più bassa, usare i gruppi di posizionamento di prossimità insieme alla rete accelerata. Per altre informazioni, vedere [creare una macchina virtuale Linux con rete accelerata](../virtual-network/create-vm-accelerated-networking-cli.md) o [creare una macchina virtuale Windows con rete accelerata](../virtual-network/create-vm-accelerated-networking-powershell.md).
...
Distribuire una macchina virtuale in un gruppo di posizionamento di prossimità usando l'interfaccia della riga di comando di [Azure](./linux/proximity-placement-groups.md) o [PowerShell](./windows/proximity-placement-groups.md)

Informazioni su come [testare la latenza di rete](../virtual-network/virtual-network-test-latency.md).

Informazioni su come [ottimizzare la velocità effettiva della rete](../virtual-network/virtual-network-optimize-network-bandwidth.md).  

Informazioni su come [usare i gruppi di posizionamento di prossimità con le applicazioni SAP](./workloads/sap/sap-proximity-placement-scenarios.md).