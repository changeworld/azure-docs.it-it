...
I dischi condivisi supportano diversi sistemi operativi. Vedere le sezioni [Windows](./disks-shared.md#windows) e [Linux](./disks-shared.md#linux) dell'articolo concettuale per i sistemi operativi supportati.
