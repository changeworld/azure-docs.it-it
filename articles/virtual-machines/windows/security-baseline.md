---
title: Baseline della sicurezza di Azure per macchine virtuali Windows
...
Questa linea di base di sicurezza applica le indicazioni della [versione 1,0 del benchmark di sicurezza di Azure](../../security/benchmarks/overview-v1.md) a macchine virtuali Windows. Azure Security Benchmark offre consigli sulla protezione delle soluzioni cloud in Azure. Il contenuto viene raggruppato in base ai **controlli di sicurezza** definiti dal benchmark di sicurezza di Azure e alle linee guida correlate applicabili a macchine virtuali Windows.

> [!NOTE]
> I **controlli** non applicabili a macchine virtuali Windows o per i quali la responsabilità è Microsoft, sono stati esclusi. Per informazioni su come macchine virtuali Windows viene eseguito il mapping completo al benchmark di sicurezza di Azure, vedere il **[file di mapping di base macchine virtuali Windows sicurezza completo](https://github.com/MicrosoftDocs/SecurityBenchmarks/blob/master/Azure%20Offer%20Security%20Baselines/1.1/windows-virtual-machines-security-baseline-v1.1.xlsx)**.
...
- [Se l'organizzazione desidera conservare i dati del registro eventi di sicurezza dalla macchina virtuale, è possibile archiviarli in un livello di raccolta dati, a questo punto è possibile eseguire query in Log Analytics. Sono disponibili livelli diversi: minimo, comune e tutti, descritti in dettaglio nel collegamento seguente](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection#data-collection-tier)
...
- [Come raccogliere i log e le metriche della piattaforma con monitoraggio di Azure](https://docs.microsoft.com/azure/azure-monitor/essentials/activity-log#view-the-activity-log)
...
**Linee guida**: macchine virtuali Windows e Azure Active Directory (Azure ad) non hanno il concetto di password predefinite. Cliente responsabile di applicazioni di terze parti e servizi del Marketplace che possono usare password predefinite.
...
### <a name="36-use-secure-azure-managed-workstations-for-administrative-tasks"></a>3,6: usare le workstation gestite di Azure sicure per le attività amministrative 
...
- [Crittografia lato server dei dischi gestiti di Azure](/azure/virtual-machines/windows/disk-encryption)

- [Crittografia dischi di Azure per macchine virtuali Windows](/azure/virtual-machines/windows/disk-encryption-overview)
...
- [Come caricare un disco rigido virtuale di una macchina virtuale personalizzata in Azure](upload-generalized-managed.md)
