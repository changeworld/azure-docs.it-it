...
Creare un secondo oggetto di personalizzazione del generatore di immagini di Azure.
...
## <a name="verify-the-customizations"></a>Verificare le personalizzazioni
...
Dalla stessa sessione di PowerShell, verificare che la seconda personalizzazione sia stata completata correttamente verificando la presenza del file, `c:\buildArtifacts\index.html` come illustrato nell'esempio seguente:

```azurepowershell-interactive
Get-ChildItem c:\buildArtifacts\
```

Il risultato deve essere un elenco di directory che mostra il file scaricato durante il processo di personalizzazione delle immagini.
