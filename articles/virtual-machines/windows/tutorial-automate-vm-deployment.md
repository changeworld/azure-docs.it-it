...
Impostare il nome utente e la password dell'amministratore per la VM con [Get-Credential](/powershell/module/microsoft.powershell.security/get-credential?view=powershell-5.1&preserve-view=true):
