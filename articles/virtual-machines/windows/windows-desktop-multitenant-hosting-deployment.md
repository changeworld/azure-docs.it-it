...
Per le distribuzioni di PowerShell, CLI e Azure Resource Manager modello, le immagini di Windows 10 sono reperibili usando `PublisherName: MicrosoftWindowsDesktop` e `Offer: Windows-10` .
