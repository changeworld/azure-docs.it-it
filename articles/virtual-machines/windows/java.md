...
Una [macchina virtuale di Azure](overview.md) (VM) richiede diverse risorse di supporto di Azure. Questo articolo descrive come creare, gestire ed eliminare le risorse della macchina virtuale usando Java. Si apprenderà come:
...
1. Installare [Java](/azure/developer/java/fundamentals/java-jdk-long-term-support), se non lo si è già fatto.
2. Installare [Maven](https://maven.apache.org/download.cgi).
...
* Altre informazioni sull'uso delle [librerie di Azure per Java](/java/azure/java-sdk-azure-overview).