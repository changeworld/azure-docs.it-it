---
title: Creare e gestire una macchina virtuale Windows in Azure usando Python
...
Una [macchina virtuale di Azure](overview.md) (VM) richiede diverse risorse di supporto di Azure. Questo articolo descrive come creare, gestire ed eliminare le risorse della macchina virtuale usando Python. Si apprenderà come:
...
Prima di iniziare questo passaggio, verificare di disporre di un'[entità servizio Active Directory](../../active-directory/develop/howto-create-service-principal-portal.md). È inoltre necessario registrare l'ID dell'applicazione, la chiave di autenticazione e l'ID del tenant che saranno necessari in un passaggio successivo.
...
Le macchine virtuali possono disporre di uno o più [dischi dati](../managed-disks-overview.md) archiviati in dischi rigidi virtuali.
...
- Altre informazioni sulla [libreria Python di Azure](/python/api/overview/azure/)
