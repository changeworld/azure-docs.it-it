...
Per distribuire l'estensione per gli script personalizzati in un set di scalabilità, vedere [Add-AzVmssExtension](/powershell/module/az.compute/add-azvmssextension)
