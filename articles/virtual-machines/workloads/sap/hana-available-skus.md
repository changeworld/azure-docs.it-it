...
ms.locfileid: "107718738"
---
# <a name="available-skus-for-hana-large-instances"></a>SKU disponibili per istanze Large di HANA

Il servizio BareMetal Infrastructure (certificato SAP HANA carichi di lavoro) basato su Rev 4.2* è disponibile nelle aree seguenti:
- Europa occidentale
- Europa settentrionale
- Germania centro-occidentale con supporto delle zone
- Stati Uniti orientali con supporto delle zone
- Stati Uniti orientali 2
- Stati Uniti centro-meridionali
- Stati Uniti occidentali 2 con supporto zone

Il servizio BareMetal Infrastructure (certificato SAP HANA carichi di lavoro) basato su Rev 3* ha una disponibilità limitata nelle aree seguenti:
...
Di seguito è riportato un elenco delle istanze Di grandi dimensioni di Azure disponibili.

> [!IMPORTANT]
> Tenere presente la prima colonna che rappresenta lo stato della certificazione HANA per ognuno dei tipi di istanze Large nell'elenco. La colonna deve essere correlata alla [directory SAP HANA hardware](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure) per gli SKU di Azure che iniziano con la lettera **S**.



| SAP HANA certificato | Modellare | Memoria totale | DRAM di memoria | Memory Optane | Archiviazione | Disponibilità |
| --- | --- | --- | --- | --- | --- | --- |
...
| NO | SAP HANA in Azure S224oo<br /> – 4 x processore Intel® Xeon® Platinum 8276 <br /> 112 core CPU e 224 thread CPU | 7,5 TB |  1,5 TB |  6 TB | 12,7 TB | Disponibile |
...
| YES <br /> [OLAP,](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas;ve:24&id=s:2411) [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2378) | SAP HANA in Azure S448<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 6 TB |  6 TB |  --- | 10,5 TB | Disponibile (solo Versione 4.2) |
| YES <br /> [OLAP,](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas;ve:24&id=s:2410) [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2377) | SAP HANA in Azure S448m<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 12 TB |  12 TB |  --- | 18,9 TB | Disponibile (solo versione 4.2) |
| NO | SAP HANA in Azure S448oo<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 9,0 TB |  3 TB |  6 TB | 14,8 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S448om<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 12 TB |  6 TB |  6 TB | 18,9 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S448oo<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 15,0 TB |  3 TB |  12 TB | 23,2 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S448oom<br /> – 8 x processore Intel® Xeon® Platinum 8276 <br /> 224 core CPU e 448 thread CPU | 18,0 TB |  6 TB |  12 TB | 27,4 TB  | Disponibile (solo Rev 4.2) |
| YES <br /> [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2049) | SAP HANA in Azure S576m<br /> – 12 x processore Intel® Xeon® E7-8890 v4<br /> 288 core CPU e 576 thread CPU |  12 TB | 12 TB | --- | 28 TB | Disponibile (solo Rev 4.2) |
...
| YES <br /> [OLAP,](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas;ve:24&id=s:2409) [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2380) | SAP HANA in Azure S672<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 9,0 TB |  9,0 TB |  --- | 14,7 TB | Disponibile (solo Versione 4.2) |
| YES <br /> [OLAP,](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas;ve:24&id=s:2408) [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2379) | SAP HANA in Azure S672m<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 18,0 TB |  18,0 TB |  --- | 27,4 TB | Disponibile (solo Versione 4.2) |
| NO | SAP HANA in Azure S672oo<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 13,5 TB |  4,5 TB |  9,0 TB | 21,1 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S672om<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 18,0 TB |  9,0 TB |  9,0 TB | 27,4 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S672oo<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 22.5 TB |  4,5 TB |  18,0 TB | 33,7 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S672oom<br /> – 12 x processore Intel® Xeon® Platinum 8276 <br /> 336 core CPU e 672 thread CPU | 27,0 TB |  9,0 TB |  18,0 TB | 40,0 TB  | Disponibile (solo Versione 4.2) |
...
|  YES <br /> [OLAP,](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=iaas;ve:24&id=s:2407) [OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=2376)  | SAP HANA in Azure S896<br /> – 16 x processore Intel® Xeon® Platinum 8276 <br /> 448 core CPU e 896 thread CPU | 12 TB |  12 TB |  --- | 18,9 TB | Disponibile (solo Versione 4.2) |
...
| NO | SAP HANA in Azure S896oo<br /> – 16 x processore Intel® Xeon® Platinum 8276 <br /> 448 core CPU e 896 thread CPU | 18,0 TB |  6 TB |  12 TB | 27,4 TB  | Disponibile (solo versione 4.2) |
| NO | SAP HANA in Azure S896om<br /> – 16 x processore Intel® Xeon® Platinum 8276 <br /> 448 core CPU e 896 thread CPU | 24,0 TB |  12 TB |  12 TB | 35,8 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S896oo<br /> – 16 x processore Intel® Xeon® Platinum 8276 <br /> 448 core CPU e 896 thread CPU | 30,0 TB |  6 TB |  24,0 TB | 44,3 TB  | Disponibile (solo Rev 4.2) |
| NO | SAP HANA in Azure S896oom<br /> – 16 x processore Intel® Xeon® Platinum 8276 <br /> 448 core CPU e 896 thread CPU | 36,0 TB |  12 TB |  24,0 TB | 52,7 TB  | Disponibile (solo Rev 4.2) |
| YES <br />[OLTP](https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/iaas.html#categories=Microsoft%20Azure&recordid=1986) | SAP HANA in Azure S960m<br /> – 20 x processore Intel® Xeon® E7-8890 v4<br /> 480 core CPU e 960 thread CPU |  20 TB | 20 TB | -- | 46 TB | Disponibile (solo Rev 4.2) |
...
> [!IMPORTANT]
> Gli SKU seguenti, anche se ancora supportati, non possono più essere acquistati: S72, S72m, S144, S144m, S192 e S192m 
...
- S72, S72m, S96, S144, S144m, S192, S192m, S192xm, S224 e S224m, S224oo, S224om, S224oo, S224ooo, S224oom sono indicati come "classe type I" degli SKU.
- Tutti gli altri SKU sono definiti "classe II di tipo" di SKU.
- Se si è interessati agli SKU non ancora elencati nella directory hardware SAP, contattare il team account Microsoft per ottenere altre informazioni. 
...
- **Rete:** isolamento tramite reti virtuali all'interno dello stamp di istanze Large di HANA.
- **Archiviazione:** isolamento tramite macchine virtuali di archiviazione a cui sono assegnati volumi di archiviazione e isolamento dei volumi di archiviazione tra tenant.
...
- Vedere [Ridimensionamento di HLI.](hana-sizing.md)
