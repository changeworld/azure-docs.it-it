...
1. Selezionare Panoramica. Annotare l'ID applicazione. che viene usato come nome utente per l'entità servizio
...
> [!NOTE]
> L'opzione ' pcmk_host_map ' è obbligatoria solo nel comando, se i nomi host e i nomi delle macchine virtuali di Azure non sono identici. Specificare il mapping nel formato **hostname: VM-Name**.
> Vedere la sezione in grassetto nel comando.
