...
> [!NOTE]
> L'opzione ' pcmk_host_map ' è obbligatoria solo nel comando, se i nomi host RHEL e i nomi delle macchine virtuali di Azure non sono identici. Specificare il mapping nel formato **hostname: VM-Name**.
> Vedere la sezione in grassetto nel comando. Per altre informazioni, vedere il [formato da usare per specificare i mapping dei nodi ai dispositivi STONITH in pcmk_host_map](https://access.redhat.com/solutions/2619961)
