...
Un altro comando _ *CRM** ottiene la configurazione del cluster completa in un editor, in modo che sia possibile modificarla. Dopo il salvataggio delle modifiche, il cluster avvia le azioni appropriate:
