...
> [!NOTE]
> Questa guida descrive le distribuzioni di SAP HANA in macchine virtuali di Azure. Per informazioni su come distribuire SAP HANA in istanze large di HANA, vedere [come installare e configurare SAP Hana (istanze large) in Azure](./hana-installation.md).
...
* I concetti e le procedure documentati in:
   * Pianificazione per la distribuzione di SAP in Azure, che include la pianificazione della rete virtuale di Azure e l'utilizzo di archiviazione di Azure. Vedere [SAP NetWeaver in macchine virtuali di Azure-Guida alla pianificazione e all'implementazione](./planning-guide.md)
   * Principi di distribuzione e modalità di distribuzione delle macchine virtuali in Azure. Vedere [distribuzione di macchine virtuali di Azure per SAP](./deployment-guide.md)
   * Concetti relativi alla disponibilità elevata per SAP HANA come documentati in [SAP Hana disponibilità elevata per macchine virtuali di Azure](./sap-hana-availability-overview.md)
...
* [Backup di SAP HANA di Azure a livello di file](./sap-hana-backup-file-level.md)
