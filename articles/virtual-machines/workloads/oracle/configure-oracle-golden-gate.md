...
> | --- | --- | --- |
> | **Versione Oracle** |Oracle 12c Release 2 – (12.1.0.2) |Oracle 12c Release 2 – (12.1.0.2)|
...
1. Scaricare il file **fbo_ggs_Linux_x64_shiphome.zip** dalla [pagina di download di Oracle Golden Gate](https://www.oracle.com/technetwork/middleware/goldengate/downloads/index.html). Sotto il titolo di download **Oracle GoldenGate 12.x.x.x for Oracle Linux x86-64** è presente un set di file ZIP da scaricare.
...
1. Scaricare PuTTY e Xming sul computer Windows:
   ...
   * [Scaricare PuTTY](https://www.putty.org/)
...
1. Accedere come oracle. (Dovrebbe essere possibile accedere senza che venga richiesta una password). Assicurarsi che Xming sia in esecuzione prima di iniziare l'installazione.
...
[Esplorare gli esempi dell'interfaccia della riga di comando per la distribuzione della VM](https://github.com/Azure-Samples/azure-cli-samples/tree/master/virtual-machine)