...
Posizionare l'annotazione [TwilioSmsOutput](/java/api/com.microsoft.azure.functions.annotation.twiliosmsoutput) su un [`OutputBinding<T>`](/java/api/com.microsoft.azure.functions.outputbinding) parametro `T` , dove può essere qualsiasi tipo Java nativo, ad esempio `int` , `String` , `byte[]` o un tipo POJO.
