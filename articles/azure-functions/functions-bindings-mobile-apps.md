...
Questo articolo descrive come usare le associazioni di [app per dispositivi mobili](/previous-versions/azure/app-service-mobile/app-service-mobile-value-prop) in Funzioni di Azure. Funzioni di Azure supporta le associazioni di input e output per App per dispositivi mobili.
