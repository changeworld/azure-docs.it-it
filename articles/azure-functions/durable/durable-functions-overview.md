...
* **Python**: richiede la versione 2.3.1 o successiva dell'estensione Durable Functions. Il supporto di Durable Functions è attualmente disponibile in anteprima pubblica.
