---
title: Creare una funzione TypeScript usando Visual Studio Code - Funzioni di Azure
description: Informazioni su come creare una funzione TypeScript e quindi pubblicare il progetto Node.js locale nell'hosting serverless in Funzioni di Azure usando l'estensione Funzioni di Azure in Visual Studio Code.
ms.topic: quickstart
ms.date: 11/04/2020
...
ms.locfileid: "99493539"
---
# <a name="quickstart-create-a-function-in-azure-with-typescript-using-visual-studio-code"></a>Avvio rapido: Creare una funzione in Azure con TypeScript usando Visual Studio Code
...
È inoltre disponibile una [versione di questo articolo basata sull'interfaccia della riga di comando](create-first-function-cli-typescript.md).
...
In questa sezione si userà Visual Studio Code per creare un progetto di Funzioni di Azure locale in TypeScript. Più avanti in questo articolo verrà pubblicato il codice della funzione in Azure. 
...
> [Connettersi a una coda di Archiviazione di Azure](functions-add-output-binding-storage-queue-vs-code.md?pivots=programming-language-typescript)
