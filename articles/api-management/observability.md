...
| Strumento        | Utile per    | Ritardo dati | Conservazione | campionamento | Tipo di dati | Abilitato|
|:------------- |:-------------|:---- |:----|:---- |:--- |:---- 
| **[Controllo API](api-management-howto-api-inspector.md)** | Test e debug | Adesso | Ultime 100 tracce | Attivato per richiesta | Tracce delle richieste | Always
| **Analisi predefinita** | Monitoraggio e creazione di report | Minuti | Durata | 100% | Report e log | Always |
| **[Metriche di Monitoraggio di Azure](api-management-howto-use-azure-monitor.md)** | Monitoraggio e creazione di report | Minuti | 93 giorni (aggiornamento da estendere) | 100% | Metriche | Always |
