...
![Diagramma che illustra la metrica della capacità.](./media/api-management-capacity/capacity-ingredients.png)
...
+ Processi del sistema operativo selezionati, inclusi i processi che comportano il costo di handshake TLS sulle nuove connessioni.
...
La **capacità** è la metrica per prendere decisioni sull'opportunità di ridimensionare un'istanza di Gestione API per gestire un carico maggiore. Tenere in considerazione:
