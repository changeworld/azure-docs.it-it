---
title: Modelli del portale per sviluppatori di Gestione API di Azure | Microsoft Docs
...
-   [Applicazioni](api-management-application-templates.md)  
    -   [Elenco applicazioni](api-management-application-templates.md#ProductList)  
    -   [Applicazione](api-management-application-templates.md#Application)  
