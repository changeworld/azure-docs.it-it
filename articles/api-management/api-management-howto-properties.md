...
Per informazioni dettagliate sugli attributi del valore denominato, vedere le informazioni di API Management [sull'API REST.](/rest/api/apimanagement/2020-06-01-preview/namedvalue/createorupdate)
...
* È [possibile applicare criteri di](../key-vault/general/security-features.md#privileged-access) accesso granulari ai segreti
...
1. Creare o importare un segreto nell'insieme di credenziali delle chiavi. Vedere [Avvio rapido: Impostare e recuperare un segreto da Azure Key Vault usando portale di Azure](../key-vault/secrets/quick-create-portal.md).
