...
description: Informazioni sugli script di esempio di Azure PowerShell disponibili per Gestione API di Azure come 'Aggiungere un utente' e 'Importare un'API'.
...
| Effettuare il provisioning e gestire | Descrizione |
| -------------------- | ----------- |
