...
- [Pianificare e gestire i costi per gestione API](plan-manage-costs.md)
- [Limiti relativi a Gestione API](../azure-resource-manager/management/azure-subscription-service-limits.md#api-management-limits)