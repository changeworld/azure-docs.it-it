...
| ----- | ----- | ------ | ----- |
| [PostgreSQL 9,5 (ritirato)](https://www.postgresql.org/about/news/postgresql-132-126-1111-1016-9621-and-9525-released-2165/)| [Funzionalità](https://www.postgresql.org/docs/9.5/release-9-5.html)  | 18 aprile 2018   | 11 febbraio 2021
...
È possibile continuare a eseguire la versione ritirata in database di Azure per PostgreSQL. Tuttavia, dopo la data di ritiro per ogni versione del database PostgreSQL si notino le seguenti restrizioni:
