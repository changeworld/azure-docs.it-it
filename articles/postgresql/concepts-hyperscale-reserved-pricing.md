...
* È necessario avere il ruolo di proprietario per almeno un Contratto Enterprise (EA) o una sottoscrizione singola con tariffe con pagamento in base al consumo.
* Per Contratto Enterprise sottoscrizioni, è necessario abilitare l' **aggiunta di istanze riservate** nel [portale EA](https://ea.azure.com/). In alternativa, se tale impostazione è disabilitata, è necessario essere un amministratore Contratto Enterprise nella sottoscrizione.
...
Per informazioni su come Contratto Enterprise clienti e clienti con pagamento in base al consumo vengono addebitati sugli acquisti di prenotazione, vedere:
- [Informazioni sull'utilizzo della prenotazione di Azure per la registrazione Contratto Enterprise](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
...
* [Informazioni sull'utilizzo della prenotazione per la registrazione Contratto Enterprise](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
