...
## <a name="2-validate-microsoft-peering-is-enabled"></a><a name="validate"></a>2. convalida del peering Microsoft abilitato
...
## <a name="3-configure-and-attach-a-route-filter-to-the-circuit"></a><a name="routefilter"></a>3. configurare e alleghiare un filtro di route al circuito
