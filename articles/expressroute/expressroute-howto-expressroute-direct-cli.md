...
description: Informazioni su come usare l'interfaccia della riga di comando di Azure per configurare Azure ExpressRoute Direct per connettersi direttamente alla rete globale di Microsoft.
...
3. Elencare tutte le località in cui è supportato ExpressRoute Direct:
   ...
   **Output di esempio**
   ...
   ```
4. Determinare se una delle località elencate nel passaggio precedente ha larghezza di banda disponibile:
   ...
   **Output di esempio**
   ...
   ```
5. Creare una risorsa di ExpressRoute Direct basata sulla località scelta nei passaggi precedenti.
...
## <a name="generate-the-letter-of-authorization-loa"></a><a name="resources"></a>Genera la lettera di autorizzazione (LOA)
