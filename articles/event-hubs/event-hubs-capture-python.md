...
- Python con PIP e i pacchetti seguenti installati. Il codice riportato nell'articolo è stato testato con queste versioni. 
    - Python 3.7
...
1. Aprire un prompt dei comandi con un percorso contenente Python, quindi eseguire questi comandi per installare i pacchetti dei prerequisiti di Python:
   ...
   ```
    ...
    > [!NOTE]
    > Il codice riportato nell'articolo è stato testato con queste versioni. 
    > - Python 3.7
    > - azure-eventhub 5.2.0
    > - azure-storage-blob 12.6.0
    > - avro-python3 1.10.1
