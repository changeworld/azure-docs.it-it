...
4. In Eclipse creare un nuovo progetto Maven, fare clic su **File**, **New** (Nuovo) e infine su **Project** (Progetto).
    ...
    ![File -> New (Nuovo) -> Project (Progetto)][12]
