---
title: Inviare e ricevere eventi da Hub eventi di Azure usando .NET (versione precedente)
description: Questo articolo fornisce una procedura dettagliata per la creazione di un'app .NET Core che invia/riceve eventi da e verso Hub eventi di Azure usando il pacchetto Microsoft.Azure.EventHubs precedente.
ms.topic: quickstart
ms.date: 06/23/2020
...
ms.locfileid: "107877463"
---
# <a name="send-events-to-or-receive-events-from-azure-event-hubs-using-net-core-microsoftazureeventhubs"></a>Inviare o ricevere eventi da Hub eventi di Azure usando .NET Core (Microsoft.Azure.EventHubs)
Questa guida introduttiva illustra come inviare e ricevere eventi da un hub eventi usando la **libreria Microsoft.Azure.EventHubs** .NET Core.

> [!WARNING]
> Questa guida introduttiva usa il pacchetto **Microsoft.Azure.EventHubs** precedente. Per una guida introduttiva che usa la libreria **Azure.Messaging.EventHubs** più recente, vedere Inviare e ricevere eventi usando la [libreria Azure.Messaging.EventHubs.](event-hubs-dotnet-standard-getstarted-send.md) Per spostare l'applicazione dall'uso della libreria precedente a una nuova, vedere la Guida alla migrazione da [Microsoft.Azure.EventHubs ad Azure.Messaging.EventHubs.](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/eventhub/Azure.Messaging.EventHubs/MigrationGuide.md)
...
Aggiungere il [`Microsoft.Azure.EventHubs`](https://www.nuget.org/packages/Microsoft.Azure.EventHubs/) pacchetto NuGet della libreria .NET Core al progetto seguendo questa procedura: 
...
> [!NOTE]
> È possibile scaricare questa guida introduttiva come esempio da [GitHub,](https://github.com/Azure/azure-event-hubs/tree/master/samples/DotNet/Microsoft.Azure.EventHubs/SampleEphReceiver)sostituire le stringhe , , e con i valori `EventHubConnectionString` `EventHubName` dell'hub eventi ed `StorageAccountName` `StorageAccountKey` `StorageContainerName` eseguirla. In alternativa, è possibile seguire la procedura illustrata in questa esercitazione per creare una soluzione propria.
...
![Nuovo progetto per la ricezione](./media/event-hubs-dotnet-standard-getstarted-receive-eph/netcorercv.png)
...
- [Esempi di controllo degli accessi in base al ruolo di Azure](https://github.com/Azure/azure-event-hubs/tree/master/samples/DotNet/Microsoft.Azure.EventHubs/Rbac). 
