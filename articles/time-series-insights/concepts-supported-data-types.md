...
ms.locfileid: "106505179"
---
# <a name="supported-data-types"></a>Tipi di dati supportati

Nella tabella seguente sono elencati i tipi di dati supportati da Azure Time Series Insights Gen2

| Tipo di dati | Descrizione | Esempio | [Sintassi delle espressioni Time Series](/rest/api/time-series-insights/reference-time-series-expression-syntax) | Nome della colonna proprietà in parquet
|---|---|---|---|---|
