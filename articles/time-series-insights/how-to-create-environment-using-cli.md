...
Per [eliminare un Time Series Insights ambienti](/cli/azure/ext/timeseriesinsights/tsi/environment#ext_timeseriesinsights_az_tsi_environment_delete), eseguire il comando seguente:
