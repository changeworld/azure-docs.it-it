...
> [!TIP]
> Per le applicazioni e le funzioni .NET, il modo più semplice per usare un'identità gestita è tramite la [libreria client di identità di Azure](/dotnet/api/overview/azure/identity-readme) per .NET. 
