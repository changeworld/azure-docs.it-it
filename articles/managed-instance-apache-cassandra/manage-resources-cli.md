...
Creare una Istanza gestita di Azure per un cluster Apache Cassandra:
...
Aggiornare o ridimensionare un Data Center (per ridimensionare il valore di nodeCount):
