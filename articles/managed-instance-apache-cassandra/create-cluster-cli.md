...
1. Applicare alcune autorizzazioni speciali per la rete virtuale e la subnet, necessarie per l'istanza gestita. A tale scopo, è necessario ottenere l'ID risorsa per la rete virtuale esistente. Eseguire il comando seguente e copiare il valore del `Resource ID` parametro:
