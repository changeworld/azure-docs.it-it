...
1. Al termine della distribuzione, è possibile passare all'app Web facendo clic sul collegamento _URL_ visualizzato nella pagina _Overview (panoramica_ ).
