...
In questo articolo è stato illustrato come associare l'applicazione Azure Spring Cloud alla cache di Azure per Redis. Per altre informazioni sul binding di servizi all'applicazione, vedere [Eseguire il binding a un'istanza di Database di Azure per MySQL](spring-cloud-howto-bind-mysql.md).
