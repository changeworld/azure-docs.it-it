...
Per informazioni su come configurare la registrazione del servizio per un'app Steeltoe, vedere [preparare un'applicazione Java Spring per la distribuzione nel cloud Spring di Azure](how-to-prepare-app-deployment.md).
::: zone-end
