...
ms.locfileid: "104878012"
---
# <a name="tutorial-bind-an-azure-cosmos-db-database-to-your-azure-spring-cloud-application"></a>Esercitazione: associare un database di Azure Cosmos DB all'applicazione Azure Spring cloud
...
In questo articolo è stato illustrato come associare l'applicazione Azure Spring Cloud a un database di Azure Cosmos DB. Per altre informazioni sul binding di servizi all'applicazione, vedere [Eseguire il binding a una cache di Azure per Redis](spring-cloud-howto-bind-redis.md).