...
Per configurare l'istanza del servizio cloud Spring di Azure usando l' [interfaccia](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli)della riga di comando di Azure, verificare che:
...
Per configurare l'istanza del servizio cloud Spring di Azure usando il modello di Gestione risorse, vedere [comprendere la struttura e la sintassi dei modelli Azure Resource Manager](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-authoring-templates).
...
[Risolvere i problemi comuni relativi al cloud Spring di Azure](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-troubleshoot).