...
* [Panoramica della scalabilità automatica in Microsoft Azure](../azure-monitor/autoscale/autoscale-overview.md)
* [Scalabilità automatica con il monitoraggio dell'interfaccia della riga di comando di Azure](/cli/azure/monitor/autoscale)
