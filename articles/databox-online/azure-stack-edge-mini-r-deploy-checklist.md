---
title: Elenco di controllo pre-distribuzione per la distribuzione di un dispositivo Mini R Azure Stack Edge
description: Questo articolo descrive le informazioni che è possibile raccogliere prima di distribuire il dispositivo Mini R Azure Stack Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
Questo articolo descrive le informazioni che possono essere raccolte in anticipo rispetto alla distribuzione effettiva del dispositivo Mini R Azure Stack Edge. 

Usare l'elenco di controllo seguente per assicurarsi di avere queste informazioni dopo aver effettuato un ordine per un dispositivo Mini R Azure Stack Edge e prima di aver ricevuto il dispositivo. 
