---
title: Definizioni di criteri predefiniti per Azure Stack Edge
description: Elenca Criteri di Azure definizioni di criteri predefiniti per Azure Stack Edge. Queste definizioni di criteri predefinite forniscono approcci comuni alla gestione delle risorse di Azure.
ms.date: 04/21/2021
ms.topic: reference
...
ms.locfileid: "107878381"
---
# <a name="azure-policy-built-in-definitions-for-azure-stack-edge"></a>Criteri di Azure definizioni incorporate per Azure Stack Edge

Questa pagina è un indice delle [Criteri di Azure](../governance/policy/overview.md) di criteri predefiniti per Azure Stack Edge. Per informazioni su altre definizioni predefinite di Criteri di Azure per altri servizi, vedere [Definizioni di criteri predefiniti di Criteri di Azure](../governance/policy/samples/built-in-policies.md).
