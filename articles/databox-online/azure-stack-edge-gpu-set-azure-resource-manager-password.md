...
3. Nel pannello **Reimposta password utente EdgeArm** specificare una password per connettersi alle API locali del dispositivo tramite il Azure Resource Manager. Confermare la password e selezionare **Reimposta**.
    ...
    ![Reimposta password utente EdgeARM 3](media/azure-stack-edge-gpu-set-azure-resource-manager-password/set-edgearm-password-3.png)
...
[Connettersi ad Azure Resource Manager](azure-stack-edge-gpu-connect-resource-manager.md)
