...
> [!IMPORTANT] 
> È consigliabile abilitare l'autenticazione a più fattori per l'utente che gestisce le macchine virtuali distribuite nel dispositivo dal cloud.
