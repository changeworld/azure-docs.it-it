...
1. Passare alla pagina seguente e inviare una richiesta di attesa per l'accesso al servizio Azure NetApp Files:  
    [**Pagina di invio Azure NetApp Files Waiting**](https://aka.ms/azurenetappfiles) 
