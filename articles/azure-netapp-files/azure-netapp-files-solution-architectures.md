...
* [Azure NetApp Files con la soluzione VMware di Azure-montaggi del sistema operativo guest](../azure-vmware/net-app-files-with-azure-vmware-solution.md)
