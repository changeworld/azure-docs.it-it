...
Potrebbe essere necessario limitare l'ambito dell'entità servizio AzAcSnap.  Per altri dettagli sulla gestione degli accessi con granularità fine delle risorse di Azure, vedere la [documentazione relativa a RBAC di Azure](../role-based-access-control/index.yml) .  
