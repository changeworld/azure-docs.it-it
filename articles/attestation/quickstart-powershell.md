...
- Microsoft.Attestation/attestationProviders/attestation/read
 ...
 Per eseguire questa azione, un Azure AD deve avere il **ruolo Lettore** attestazione nel provider di attestazione. L'autorizzazione di lettura può essere ereditata anche con ruoli come **Lettore** (autorizzazioni con caratteri jolly) nella sottoscrizione o nel gruppo di risorse.  
