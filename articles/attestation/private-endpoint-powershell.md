---
title: Creare un endpoint privato con Azure PowerShell
description: Creare un endpoint privato per Attestazione di Azure con Azure PowerShell
...
> [!NOTE]
> L'implementazione corrente include solo l'opzione di approvazione automatica. La sottoscrizione deve essere aggiunta a un elenco di elementi consentiti per poter procedere con la creazione di endpoint privati. Contattare il team del servizio o inviare una [](https://azure.microsoft.com/support/options/) supporto tecnico di Azure richiesta nella pagina supporto tecnico di Azure prima di procedere con i passaggi seguenti.

## <a name="prerequisites"></a>Prerequisiti

* Vedere informazioni su [collegamento privato di Azure](../private-link/private-link-overview.md)
...
9. Immettere `nslookup <provider-name>.attest.azure.net`. Sostituire **\<provider-name>** con il nome dell'istanza del provider di attestazioni creata nei passaggi precedenti. Si riceverà un messaggio simile al seguente:
