...
description: Inviare un messaggio di posta elettronica usando SendGrid da Java in una distribuzione di Azure. L'applicazione risultante chiede all'utente i valori di posta elettronica.
services: ''
...
1. Ottenere i file JAR javax.mail, ad esempio da <https://www.oracle.com/technetwork/java/javamail/index.html>.
...
Se non si usa Eclipse, è inoltre consigliabile consultare l'argomento [Creazione di un'applicazione Hello World per Azure in Eclipse](/azure/developer/java/toolkit-for-eclipse/create-hello-world-web-app)o acquisire familiarità con altre tecniche per l'hosting di applicazioni Java in Azure.
