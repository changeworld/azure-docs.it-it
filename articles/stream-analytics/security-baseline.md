...
* [Servizi e scenari supportati in disponibilità generale](../security/fundamentals/customer-lockbox-overview.md#supported-services-and-scenarios-in-general-availability)
...
* [Protezione dei dati in analisi di flusso di Azure](./data-protection.md#private-data-assets-that-are-stored)
...
* [Impostare e gestire i criteri di immutabilità per l'archiviazione BLOB](../storage/blobs/storage-blob-immutability-policies-manage.md?tabs=azure-portal)
