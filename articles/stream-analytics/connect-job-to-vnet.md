...
1. [Archiviazione BLOB o Azure Data Lake storage Gen2](./blob-output-managed-identity.md) -può essere l'account di archiviazione del processo, l'input o l'output di streaming.
2. [Hub eventi di Azure](./event-hubs-managed-identity.md) : può essere l'input o l'output del processo di streaming.
...
* [Creare e rimuovere endpoint privati nei cluster di analisi di flusso](./private-endpoints.md)
* [Connettersi a hub eventi in una VNet usando l'autenticazione di identità gestita](./event-hubs-managed-identity.md)
* [Connettersi all'archiviazione BLOB e ADLS Gen2 in una VNet usando l'autenticazione di identità gestita](./blob-output-managed-identity.md)