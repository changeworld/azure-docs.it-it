...
description: Informazioni sui passaggi necessari per eseguire il failover di un dispositivo fisico StorSimple serie 8000 in caso di emergenza.
services: storsimple
documentationcenter: ''
author: alkohli
manager: timlt
