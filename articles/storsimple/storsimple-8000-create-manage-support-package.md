...
3. Nella sessione avviata immettere il comando appropriato.
   ...
   * Per le condivisioni di rete protette da password, immettere:
       ...
       Verranno richieste la password e una passphrase di crittografia (perché il pacchetto per il supporto è crittografato). Viene quindi creato un pacchetto per il supporto nella cartella predefinita (viene aggiunto il nome del dispositivo con la data e l'ora correnti).
...
2. [Scaricare lo script](https://gallery.technet.microsoft.com/scriptcenter/Script-to-decrypt-a-a8d1ed65) localmente nel client.
...
* Informazioni su come [utilizzare i pacchetti per il supporto e i log del dispositivo per risolvere i problemi di distribuzione del dispositivo](storsimple-8000-troubleshoot-deployment.md#support-packages-and-device-logs-available-for-troubleshooting).
