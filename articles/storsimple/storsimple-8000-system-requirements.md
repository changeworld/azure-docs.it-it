---
title: Requisiti di sistema StorSimple serie 8000 | Microsoft Docs
...
| `https://crl.microsoft.com/pki/*`<br>`https://www.microsoft.com/pki/*` |Revoca del certificato |Interfacce di rete abilitate per il cloud |
...
* Isolare il traffico iSCSI e cloud prevedendo nel dispositivo interfacce di rete dedicate per l'accesso iSCSI e cloud. Per altre informazioni, vedere la procedura per [modificare le interfacce di rete](storsimple-8000-modify-device-config.md#modify-network-interfaces) sul dispositivo StorSimple.
...
Per altre informazioni sul monitoraggio e la manutenzione dei componenti hardware del dispositivo StorSimple, vedere [Usare il servizio Gestione dispositivi StorSimple per monitorare i componenti hardware e lo stato](storsimple-8000-monitor-hardware-status.md) e [Sostituzione dei componenti hardware di StorSimple](storsimple-8000-hardware-component-replacement.md).
...
* Non rimuovere più di un'unità SSD o HDD dal sistema in qualsiasi momento.
  Un errore di due o più dischi di un determinato tipo (HDD, SSD) o più errori consecutivi in un breve intervallo di tempo possono provocare un problema di funzionamento del sistema e una potenziale perdita di dati. In questo caso, [contattare il supporto tecnico Microsoft](storsimple-8000-contact-microsoft-support.md) per assistenza.
* Durante la sostituzione, monitorare i **Componenti condivisi** nel pannello **Integrità hardware** delle unità SSD e HDD. Un segno di spunta verde indica che i dischi funzionano correttamente, mentre un punto esclamativo rosso indica un problema di funzionamento di un'unità SSD o HDD.
...
* Durante la sostituzione di un modulo controller EBOD, monitorare costantemente lo stato del componente nel servizio gestione dispositivi di StorSimple accedendo a **monitoraggio**  >  **integrità hardware**.
...
* [Ulteriori informazioni sui Limiti di StorSimple](storsimple-8000-limits.md).
