...
Lo `Invoke-AzureADIPDismissRiskyUser.ps1` script incluso nel repository consente alle organizzazioni di ignorare tutti gli utenti a rischio nella propria directory.
