...
Usare la visualizzazione **Tutti i dispositivi** nel portale di Azure. In alternativa, è possibile usare un cmdlet [Get-MsolDevice](/powershell/module/msonline/get-msoldevice) di PowerShell.
