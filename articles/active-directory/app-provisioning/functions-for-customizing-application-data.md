...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **attributo** |Obbligatorio |Attributo |Attributo multivalore che avrà elementi conteggiati|
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **value** |Obbligatorio | Date | Data di annuncio da convertire nel tipo DateTime |
...
| --- | --- | --- | --- |
| **source** |Obbligatorio |string |In genere è il nome dell'attributo dell'oggetto di origine. |
| **inputFormat** |Obbligatorio |string |Formato previsto del valore source. Per i formati supportati, vedere [/DotNet/standard/base-types/Custom-date-and-Time-Format-Strings](/dotnet/standard/base-types/custom-date-and-time-format-strings). |
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **condizione** |Obbligatorio |Variabile o espressione |Qualsiasi valore o espressione che possa restituire true o false. |
| **valueIfTrue** |Obbligatorio |Variabile o stringa | se la condizione restituisce true, il valore restituito. |
| **valueIfFalse** |Obbligatorio |Variabile o stringa |se la condizione restituisce false, il valore restituito.|
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **attributo** |Obbligatorio |Attributo |Attributo multivalore da cercare |
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **value** |Obbligatorio | string | Stringa data/ora nel formato supportato. Per informazioni sui formati supportati, vedere https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx. |
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **attributo** |Obbligatorio |Attributo multivalore |Attributo multivalore in cui vengono rimossi i duplicati|
...
| Name | Obbligatorio/Ripetuto | Type | Note |
| --- | --- | --- | --- |
| **source** |Obbligatorio |string |In genere il nome dell'attributo dall'oggetto di **origine** . |
...
| **delimitatore** |Obbligatorio |string |Specifica il carattere che verrà usato per dividere la stringa (esempio: ",") |
