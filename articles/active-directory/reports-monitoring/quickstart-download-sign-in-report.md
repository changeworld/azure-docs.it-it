...
* Un utente che si trova nel ruolo **amministratore** della sicurezza, **lettore di sicurezza**, **lettore report** o **amministratore globale** per il tenant. Qualsiasi utente nel tenant, inoltre, può visualizzare i propri accessi.
