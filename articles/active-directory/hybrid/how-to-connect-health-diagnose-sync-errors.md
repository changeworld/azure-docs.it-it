...
Le impostazioni specifiche, ad esempio UserWriteback, non sono supportate [in Azure ad Connect](./how-to-connect-preview.md#user-writeback) . Disabilitare nelle impostazioni. 
