...
ms.locfileid: "87019676"
---
# <a name="azure-ad-connect-sync-technical-concepts"></a>Servizio di sincronizzazione Azure AD Connect: Concetti tecnici
Questo articolo è un riepilogo dell'argomento [Informazioni sull'architettura](how-to-connect-sync-technical-concepts.md).
...
Basandosi su MIIS (Microsoft Identity Integration Server), ILM (Identity Lifecycle Manager) e FIM (Forefront Identity Manager), i servizi di Azure Active Directory Sync forniscono la piattaforma successiva per la connessione a origini dati, la sincronizzazione dei dati tra le origini dati, nonché il provisioning e il deprovisioning delle identità.

![Concetti tecnici](./media/how-to-connect-sync-technical-concepts/scenario.png)
