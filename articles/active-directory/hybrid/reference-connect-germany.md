...
description: Azure AD Connect integra le directory locali con Azure Active Directory. Questo consente di fornire un'identità comune per Microsoft 365, Azure e applicazioni SaaS integrate con Azure AD.
