...
* [Microsoft System Center](/previous-versions/system-center/developer/cc817313(v=msdn.10)) consentono di acquisizione e consolidare le conoscenze su infrastruttura, criteri, processi e procedure consigliate in modo che il personale IT possa creare sistemi gestibili e automatizzare le operazioni.
* [Microsoft Intune](/mem/intune/) è un servizio di gestione di dispositivi basato sul cloud che consente di gestire computer e dispositivi mobili e proteggere le informazioni della società.
* [MDM per Microsoft 365](/microsoft-365/admin/basic-mobility-security/overview) consente di gestire e proteggere i dispositivi mobili quando sono connessi all'organizzazione Microsoft 365. È possibile usare MDM per Microsoft 365 per impostare i criteri di sicurezza e le regole di accesso dei dispositivi e per cancellarne i dispositivi mobili in caso di smarrimento o furto.
...
* [Blog di Microsoft In The Cloud](https://cloudblogs.microsoft.com/)
* [Blog di Microsoft Intune](https://techcommunity.microsoft.com/t5/intune-customer-success/welcome-to-the-new-intune-customer-success-blog/ba-p/281367)
* [Blog di Microsoft Endpoint Configuration Manager](https://techcommunity.microsoft.com/t5/Configuration-Manager-Blog/bg-p/ConfigurationManagerBlog)
