...
Se si è interessati a delegare l'accesso alle risorse di Azure anziché l'accesso amministrativo in Azure AD, vedere [assegnare i ruoli di Azure usando il portale di Azure](../../role-based-access-control/role-assignments-portal.md).
