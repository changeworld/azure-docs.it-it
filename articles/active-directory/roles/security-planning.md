...
![Fasi della roadmap con sequenze temporali](./media/security-planning/roadmap-timeline.png)
...
![Fase 1 Elementi critici da gestire per primi](./media/security-planning/stage-one.png)
...
![Fase 2 Attenuare gli attacchi usati di frequente](./media/security-planning/stage-two.png)
...
![Fase 3: assumere il controllo delle attività amministrative](./media/security-planning/stage-three.png)
...
Il [Centro sicurezza di Azure](../../security-center/security-center-introduction.md):
...
![Fase 4: adottare un comportamento di sicurezza attivo](./media/security-planning/stage-four.png)
...
![Account per l'accesso in situazioni di emergenza](./media/security-planning/emergency.jpeg)
