...
description: Informazioni su come creare un ambiente Active Directory e Azure AD di base.
author: billmath
manager: daveba
...
![Diagramma che mostra un ambiente di base di Azure AD.](media/tutorial-single-forest/diagram-2.png)
...
![Screenshot che mostra la pagina di Azure Active Directory nel portale di Azure.](media/tutorial-single-forest/create-1.png)</br>
...
![Screenshot che mostra il menu "Panoramica" con l'opzione "Utenti" selezionata.](media/tutorial-single-forest/administrator-1.png)</br>
...
![Creare](media/tutorial-single-forest/administrator-2.png)</br>
...
Di seguito è riportata una sezione facoltativa che illustra la procedura per la creazione di un server e/o di una foresta aggiuntiva,  Questo può essere usato in alcune delle esercitazioni più avanzate, ad esempio il [progetto pilota per la sincronizzazione da Azure ad Connect a cloud](tutorial-pilot-aadc-aadccp.md).
...
A questo punto si dispone di un ambiente che può essere usato per le esercitazioni esistenti e per testare funzionalità aggiuntive fornite da Cloud Sync.
