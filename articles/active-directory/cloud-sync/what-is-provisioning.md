...
![Diagramma che mostra il provisioning nel cloud con Azure Active Directory.](media/what-is-provisioning/cloud-1.png)
...
![Diagramma che mostra il provisioning basato su risorse umane con il sistema di gestione delle risorse umane nel cloud, in locale e in Azure Active Directory.](media/what-is-provisioning/cloud-2.png)
...
![Diagramma che mostra il provisioning delle app con app locali, app nel cloud non Microsoft e Azure Active Directory.](media/what-is-provisioning/cloud-3.png)
...
![Provisioning cloud](media/what-is-provisioning/cloud-4.png)
