...
![Provisioning oggetti](media/concept-attributes/attribute-1.png)
...
> [!WARNING]
> La configurazione di sincronizzazione cloud crea un'entità servizio. L'entità servizio è visibile nel portale di Azure. Non modificare i mapping degli attributi usando l'esperienza dell'entità servizio nel portale di Azure.  Questo non è supportato.
...
1. Questa query restituisce lo schema.
   ...
   ![Schema restituito](media/concept-attributes/schema-1.png)
