...
- Si dispone di un numero sufficiente di licenze disponibili per il piano di licenza che si sta assegnando. Se non si dispone di un numero sufficiente di licenze, a alcuni utenti potrebbe non essere assegnato il nuovo piano di licenza. È possibile verificare il numero di licenze disponibili.
...
1. Selezionare la casella di controllo per Office 365 E3 e assicurarsi che siano selezionati almeno tutti i servizi E1 assegnati all'utente.
...
1. Selezionare la casella di controllo per Office 365 E3. Per mantenere la continuità del servizio, assicurarsi di selezionare tutti i servizi E1 già assegnati all'utente.
1. Deselezionare la casella di controllo per Office 365 E1.
...
- [Come eseguire la migrazione di singoli utenti con licenza alle licenze di gruppo in Azure Active Directory](licensing-groups-migrate-users.md)
- [Scenari aggiuntivi di gestione licenze del gruppo Azure Active Directory](licensing-group-advanced.md)
- [Esempi di PowerShell per le licenze di gruppo in Azure Active Directory](licensing-ps-examples.md)
