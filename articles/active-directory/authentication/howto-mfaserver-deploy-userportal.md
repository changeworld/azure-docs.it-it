---
title: Portale utenti per il server Azure MFA - Azure Active Directory
...
* Proteggere Azure Multi-Factor Authentication Web Service SDK con un certificato TLS/SSL.
...
* Proteggere il portale utenti con un certificato TLS/SSL.
* Proteggere Azure Multi-Factor Authentication Web Service SDK con un certificato TLS/SSL.
* Assicurarsi che il portale utenti possa connettersi ad Azure Multi-Factor Authentication Web Service SDK tramite TLS/SSL.
