...
Quando l'assegnazione utente non è *necessaria,* gli utenti non assegnati non vedono l'app nel proprio App personali, ma possono comunque accedere all'applicazione stessa (nota anche come  accesso avviato da SP) oppure possono usare **l'URL** di accesso utente nella pagina Proprietà dell'applicazione (nota anche come accesso avviato da IDP).
...
È possibile determinare se gli utenti assegnati a un'app aziendale possono visualizzare l'app App personali e Microsoft 365 di avvio delle applicazioni.
...
In questo caso, per tutti gli utenti assegnati viene eseguito il provisioning automatico in Salesforce e, mentre vengono aggiunti a gruppi diversi, in Salesforce viene aggiornata la relativa assegnazione al ruolo. Gli utenti sarebbero in grado di individuare e accedere a Salesforce tramite App personali, client Web di Office o anche passando alla pagina di accesso di Salesforce dell'organizzazione. Gli amministratori potranno visualizzare facilmente lo stato di assegnazione e utilizzo mediante la funzionalità di creazione di report di Azure AD.
...
- Per le applicazioni nel Microsoft 365 o in altre suite a  pagamento, agli utenti viene concesso l'accesso tramite l'assegnazione delle licenze direttamente al proprio account utente o tramite un gruppo usando la funzionalità di assegnazione delle licenze basata sui gruppi.
...
Alcune applicazioni combinano questi metodi. Ad esempio, alcune applicazioni Microsoft fanno parte di una sottoscrizione Microsoft 365, ma richiedono comunque il consenso.

Gli utenti possono accedere Microsoft 365 applicazioni tramite i portali di Office 365. È anche possibile visualizzare o nascondere Microsoft 365 applicazioni nel App personali con l'interruttore Visibilità di [Office 365](hide-application-from-user-portal.md) nelle **impostazioni utente della directory.** 
