...
Dopo l'accesso, gli utenti esterni possono accedere alle applicazioni Web locali usando un URL familiare o [le mie app](../user-help/my-apps-portal-end-user-access.md) dai dispositivi desktop o iOS/Mac. Application Proxy può ad esempio consentire l'accesso remoto e Single Sign-On a Desktop remoto, siti SharePoint, Tableau, Qlik, Outlook sul Web e applicazioni line-of-business.
...
* App rich client integrate con [Microsoft Authentication Library (MSAL)](../develop/v2-overview.md)
...
* [**Autenticazione basata su intestazione**](./application-proxy-configure-single-sign-on-with-headers.md). Questo metodo di accesso usa un servizio di autenticazione di terze parti chiamato PingAccess e viene usato quando l'applicazione usa le intestazioni per l'autenticazione. In questo scenario l'autenticazione viene gestita da PingAccess.
...
* **Integrazione di Intune**. Con Intune, il traffico aziendale viene instradato separatamente da quello personale. Application Proxy garantisce che il traffico aziendale sia autenticato. È inoltre possibile usare [Application Proxy insieme alla funzionalità Intune Managed Browser](/intune/app-configuration-managed-browser#how-to-configure-application-proxy-settings-for-protected-browsers) per consentire agli utenti remoti di accedere in modo sicuro a siti Web interni da dispositivi iOS e Android.
...
* L'accesso Single Sign-on a tutte le applicazioni è Microsoft 365 o altre app SaaS e incluse le applicazioni locali
* Sicurezza a livello di cloud in cui Azure AD sfrutta Microsoft 365 la telemetria per impedire accessi non autorizzati
