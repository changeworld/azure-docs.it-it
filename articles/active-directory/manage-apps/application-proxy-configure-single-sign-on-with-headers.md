...
ms.locfileid: "103198251"
---
# <a name="header-based-single-sign-on-for-on-premises-apps-with-azure-ad-app-proxy"></a>Single Sign-On basata su intestazione per le app locali con App Azure AD proxy
