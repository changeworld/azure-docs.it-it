...
3. Eseguire `(Get-MgUserAppRoleAssignment -UserId "<userId>" -Top 999).Count` per determinare il numero di assegnazioni di ruolo dell'app che l'utente ha attualmente concesso.
