...
1. Impostare le impostazioni di crittografia del token usando il comando **[set-AzureApplication](/powershell/module/azuread/set-azureadapplication?view=azureadps-2.0-preview)** .
