...
- [Gestione traffico virtuale Pulse Secure (VTM)](../saas-apps/pulse-secure-virtual-traffic-manager-tutorial.md)
...
- [Protezione globale di Palo Alto Networks](../saas-apps/paloaltoadmin-tutorial.md)

- [Pulse Secure Pulse Connect (PC)](../saas-apps/pulse-secure-pcs-tutorial.md)

I fornitori SDP seguenti offrono soluzioni predefinite e linee guida dettagliate per l'integrazione con Azure AD.

- [Broker di accesso Datawiza](./add-application-portal-setup-oidc-sso.md)

- [Perimeter 81](../saas-apps/perimeter-81-tutorial.md)


- [Piattaforma di autenticazione Silverfort](./add-application-portal-setup-oidc-sso.md)
