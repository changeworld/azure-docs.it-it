...
1. Verificare che sia applicato un criterio di dominio che limita la [dimensione massima dei token Kerberos pubblicati](/archive/blogs/askds/maxtokensize-and-windows-8-and-windows-server-2012). Questo criterio impedisce che il connettore riceva un token se il valore della dimensione è eccessivo.
