...
ms.locfileid: "107377141"
---
# <a name="get-all-application-proxy-apps-published-with-no-certificate-uploaded"></a>Ottenere tutte le Application Proxy pubblicate senza certificato caricato
