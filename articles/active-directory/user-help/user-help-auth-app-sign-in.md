...
> [!NOTE]
> Microsoft non supporta una combinazione di registrazione del dispositivo e autenticazione basata su certificati in Authenticator in iOS. Al contrario, l'utente deve registrare il dispositivo manualmente tramite le impostazioni di autenticazione prima di effettuare l'accesso.
