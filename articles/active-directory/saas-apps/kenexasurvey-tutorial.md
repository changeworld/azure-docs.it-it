...
* IBM Kenexa Survey Enterprise supporta l'accesso SSO avviato da **IDP**
...
2. **[Configurare l'accesso Single Sign-On di IBM Kenexa Survey Enterprise](#configure-ibm-kenexa-survey-enterprise-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di IBM Kenexa Survey Enterprise](#create-ibm-kenexa-survey-enterprise-test-user)**: per avere una controparte di Britta Simon in IBM Kenexa Survey Enterprise collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di IBM Kenexa Survey Enterprise](common/idp-intiated.png)

    a. Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `https://surveys.kenexa.com/<companycode>`
    ...
    > [!NOTE]
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori contattare il [team di supporto clienti di IBM Kenexa Survey Enterprise](https://www.ibm.com/support/home/?lnk=fcw). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
7. Nella sezione **Configura IBM Kenexa Survey Enterprise** copiare gli URL appropriati in base alle esigenze.
...
2. Nell'elenco delle applicazioni selezionare **IBM Kenexa Survey Enterprise**.
