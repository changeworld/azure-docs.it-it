...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Phraseanet con gli account Azure AD personali.
...
* Sottoscrizione di Phraseanet abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Phraseanet supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **Phraseanet**, selezionare **Phraseanet** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Phraseanet nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Phraseanet usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Phraseanet.
...
2. **[Configurare l'accesso Single Sign-On di Phraseanet](#configure-phraseanet-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Phraseanet](#create-phraseanet-test-user)**: per avere una controparte di Britta Simon in Phraseanet collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Phraseanet](common/sp-signonurl.png)
...
6. Nella sezione **Configura Phraseanet** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-phraseanet-single-sign-on"></a>Configurare l'accesso Single Sign-On di Phraseanet

Per configurare l'accesso Single Sign-On sul lato **Phraseanet**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Phraseanet](mailto:support@alchemy.fr). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Phraseanet**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Phraseanet**.

    ![Collegamento di Phraseanet nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-phraseanet-test-user"></a>Creare l'utente di test di Phraseanet
...
Quando si fa clic sul riquadro di Phraseanet nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Phraseanet per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
