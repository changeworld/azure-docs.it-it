---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con EAB Navigate | Microsoft Docs'
...
ms.locfileid: "92454440"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-eab-navigate"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con EAB Navigate
...
- [Come proteggere EAB Navigate con visibilità e controlli avanzati](/cloud-app-security/proxy-intro-aad)