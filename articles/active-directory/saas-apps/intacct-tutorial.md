...
Per configurare e testare Azure AD SSO con Sage Intacct, attenersi alla procedura seguente:
...
1. Nella pagina di integrazione dell'applicazione **Sage Intacct** del portale di Azure individuare la sezione **Gestisci** e selezionare **Single Sign-on**.
