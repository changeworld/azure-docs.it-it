---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Sigstr | Microsoft Docs'
...
ms.locfileid: "92516011"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-sigstr"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Sigstr
...
Quando si fa clic sul riquadro di Sigstr nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Sigstr per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
