...
Questa esercitazione descrive come integrare Novatus con Azure Active Directory (Azure AD).
...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Novatus con gli account Azure AD personali.
...
* Novatus supporta l'accesso SSO avviato da **SP**

* Novatus supporta il provisioning utenti **JIT**
...
4. Nella casella di ricerca digitare **Novatus**, selezionare **Novatus** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Novatus nell'elenco risultati](common/search-new-app.png)
...
1. Nella pagina di integrazione dell'applicazione **Novatus** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Novatus](common/sp-signonurl.png)

    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://sso.novatuscontracts.com/<companyname>`

    > [!NOTE]
    > Poiché non è reale, è necessario aggiornare questo valore con l'URL di accesso effettivo. Per ottenere il valore, contattare il [team di supporto clienti di Novatus](mailto:jvinci@novatusinc.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-novatus-single-sign-on"></a>Configurare l'accesso Single Sign-On per Novatus
...
Quando si seleziona il riquadro di Novatus nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Novatus per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
