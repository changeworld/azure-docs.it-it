...
3. Determinare quali dati eseguire il [mapping tra Azure ad e analizzabili](../app-provisioning/customize-application-attributes.md). 
...
Aggiungere l'analizzabile dalla raccolta di applicazioni Azure AD per iniziare a gestire il provisioning in analizzabile. Se in precedenza è stato eseguito l'installazione dell'oggetto analizzabile per SSO, è possibile usare la stessa applicazione. È tuttavia consigliabile creare un'app separata per il test iniziale dell'integrazione. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](../manage-apps/add-application-portal.md). 
