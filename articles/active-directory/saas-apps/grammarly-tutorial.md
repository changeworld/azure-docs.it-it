---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Grammarly | Microsoft Docs"
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory e Grammarly.
...
Questa esercitazione descrive come integrare Grammarly con Azure Active Directory (Azure AD). Integrando Grammarly con Azure AD, è possibile:

* Controllare in Azure AD chi può accedere a Grammarly.
* Abilitare gli utenti per l'accesso automatico a Grammarly con gli account Azure AD personali.
...
* Sottoscrizione di Grammarly abilitata per l'accesso Single Sign-On (SSO).

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Grammarly supporta l'accesso SSO avviato da **IDP.**
* Grammarly supporta il provisioning **utenti JUST-In-Time.**

> [!NOTE]
> Dal momento che l'identificatore di questa applicazione è un valore stringa fisso, è possibile configurare una sola istanza in un solo tenant.

## <a name="add-grammarly-from-the-gallery"></a>Aggiungere Grammarly dalla raccolta
...
1. **[Configurare l'accesso Single Sign-On di Grammarly](#configure-grammarly-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di Grammarly](#create-grammarly-test-user)** : per avere una controparte di B.Simon in Grammarly collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella sezione **Configura Grammarly** copiare gli URL appropriati in base alle esigenze.
...
In questa sezione viene creato un utente di nome B.Simon in Grammarly. Grammarly supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Grammarly, ne viene creato uno nuovo dopo l'autenticazione.

## <a name="test-sso"></a>Testare l'accesso SSO 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD con le opzioni seguenti.

* Fare clic su Test this application (Testa questa applicazione) portale di Azure per accedere automaticamente all'applicazione Grammarly per cui si è configurato l'accesso SSO.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro Grammarly nel App personali, si dovrebbe accedere automaticamente all'applicazione Grammarly per cui si è configurato l'accesso SSO. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## <a name="next-steps"></a>Passaggi successivi

Dopo aver configurato Grammarly, è possibile applicare il controllo sessione che consente di proteggere in tempo reale l'esfiltrazione e l'infiltrazione dei dati sensibili dell'organizzazione. Il controllo sessione costituisce un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
