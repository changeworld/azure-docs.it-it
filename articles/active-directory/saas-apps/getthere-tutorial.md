---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con GetThere | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-getthere"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con GetThere
