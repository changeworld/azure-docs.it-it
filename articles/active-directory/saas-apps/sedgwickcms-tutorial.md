...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Sedgwick CMS con gli account Azure AD personali.
...
* Sedgwick CMS supporta l'accesso SSO avviato da **IDP**
...
4. Nella casella di ricerca digitare **Sedgwick CMS**, selezionare **Sedgwick CMS** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Sedgwick CMS nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato Azure AD Single Sign-On con Sedgwick CMS in base a un utente test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Sedgwick CMS.
...
2. **[Configurare l'accesso Single Sign-On di Sedgwick CMS](#configure-sedgwick-cms-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Sedgwick CMS](#create-sedgwick-cms-test-user)**: per avere una controparte di Britta Simon in Sedgwick CMS collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con Sedgwick CMS, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **Sedgwick CMS** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Sedgwick CMS](common/idp-intiated.png)
...
### <a name="configure-sedgwick-cms-single-sign-on"></a>Configurare l'accesso Single Sign-On di Sedgwick CMS

Per configurare l'accesso Single Sign-On sul lato **Sedgwick CMS**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Sedgwick CMS](https://www.sedgwick.com/help). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Sedgwick CMS**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Sedgwick CMS**.

    ![Collegamento a Sedgwick CMS nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-sedgwick-cms-test-user"></a>Creare un utente di test di Sedgwick CMS
...
Quando si fa clic sul riquadro di Sedgwick CMS nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Sedgwick CMS per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
