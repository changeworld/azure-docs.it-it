---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Nintex Promapp | Microsoft Docs'
...
ms.locfileid: "92505885"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-nintex-promapp"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Nintex Promapp
...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti se si vuole configurare l'applicazione in modalità avviata da **IDP**:
    ...
    1. Nella casella **Identificatore** immettere un URL nel formato seguente:
       ...
       > [!NOTE]
       > L'integrazione di Azure AD con Nintex Promapp è configurata solo per l'autenticazione avviata dal servizio, Ovvero, se si passa a un URL Promapp di Nintex, viene avviato il processo di autenticazione. Tuttavia, il campo **URL di risposta** è un campo obbligatorio.
...
1. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    Nella casella **URL di accesso** immettere un URL in questo modello: `https://<DOMAINNAME>.promapp.com/TENANTNAME/saml/authenticate`
