---
title: 'Esercitazione: Integrazione Azure Active Directory con OutSystems Azure AD | Microsoft Docs'
...
* OutSystems Azure AD supporta l'accesso SSO avviato da **SP e IDP** e il provisioning utenti **JIT**.

## <a name="add-outsystems-azure-ad-from-the-gallery"></a>Aggiungere OutSystems Azure AD dalla raccolta
...
## <a name="configure-and-test-azure-ad-sso-for-outsystems-azure-ad"></a>Configurare e testare l Azure AD SSO for OutSystems Azure AD

Configurare e testare Azure AD SSO con OutSystems Azure AD usando un utente di test di **nome B.Simon**. Per consentire il funzionamento dell'accesso Single Sign-On, è necessario stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in OutSystems Azure AD.

Per configurare e testare Azure AD SSO con OutSystems Azure AD, seguire questa procedura:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-sso)** : per consentire agli utenti di usare questa funzionalità.
    1. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente B.Simon.
    1. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare B.Simon all'uso dell'accesso Single Sign-On di Azure AD.
1. **[Configurare l'accesso Azure AD Single Sign-On di OutSystems:](#configure-outsystems-azure-ad-sso)** per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. Creare un utente di test di **[OutSystems Azure AD:](#create-outsystems-azure-ad-test-user)** per avere una controparte di B.Simon in OutSystems Azure AD collegata alla Azure AD dell'utente.
...
1. Nella pagina portale di Azure'applicazione **OutSystems Azure AD** individuare la **sezione** Gestione e selezionare **Single Sign-On.**
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendo l'accesso a OutSystems Azure AD.
...
## <a name="configure-outsystems-azure-ad-sso"></a>Configurare l'accesso Single Sign-On Azure AD OutSystems
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà reindirizzato a OutSystems Azure AD'URL di accesso da cui è possibile avviare il flusso di accesso.  

* Passare direttamente a OutSystems Azure AD'URL di accesso e avviare il flusso di accesso da questa pagina.

#### <a name="idp-initiated"></a>Avviato da IDP:

* Fare clic **su Test this application** (Testa questa applicazione) portale di Azure per accedere automaticamente all'applicazione OutSystems Azure AD per cui si è configurato l'accesso SSO. 

È anche possibile usare App personali Microsoft per testare l'applicazione in qualsiasi modalità. Quando si fa clic sul riquadro outsystems Azure AD nel App personali, se configurato in modalità SP si verrà reindirizzati alla pagina di accesso dell'applicazione per avviare il flusso di accesso e, se configurato in modalità IDP, si dovrebbe accedere automaticamente all'istanza di OutSystems Azure AD per cui si è configurato l'accesso SSO. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## <a name="next-steps"></a>Passaggi successivi

Dopo aver configurato OutSystems Azure AD è possibile applicare il controllo sessione che consente di proteggere in tempo reale l'esfiltrazione e l'infiltrazione dei dati sensibili dell'organizzazione. Il controllo sessione costituisce un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
