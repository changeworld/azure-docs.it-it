...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Rally software in base a un utente test di nome **Britta Simon**.
...
1. Nella pagina di integrazione dell'applicazione **Rally Software** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
2. Nella barra degli strumenti nella parte superiore, fare clic su **Installazione**, quindi selezionare **Sottoscrizione**.
...
4. Nella finestra di dialogo **Subscription** (Sottoscrizione) eseguire la procedura seguente, quindi fare clic su **Save & Close** (Salva e chiudi):
    ...
    b. Nella casella di testo **Identity Provider URL (URL provider di identità** ) incollare il valore di **Azure ad identificatore** copiato da portale di Azure. 
...
3. Digitare il nome nella casella di testo relativa al nuovo utente, quindi fare clic su **Add with Details**.
