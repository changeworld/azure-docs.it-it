...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a BGS Online con gli account Azure AD.
...
* BGS Online supporta l'accesso SSO avviato da **IDP**

## <a name="adding-bgs-online-from-the-gallery"></a>Aggiunta di BGS Online dalla raccolta

Per configurare l'integrazione di BGS Online in Azure AD, è necessario aggiungere BGS Online dalla raccolta all'elenco di app SaaS gestite.
...
4. Nella casella di ricerca digitare **BGS Online**, selezionare **BGS Online** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![BGS Online nell'elenco risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in BGS Online.
...
Per configurare l'accesso Single Sign-On di Azure AD con BGS Online, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **BGS Online** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di BGS Online](common/idp-intiated.png)
...
6. Nella sezione **Configura BGS Online** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-bgs-online-single-sign-on"></a>Configurare l'accesso Single Sign-On per BGS Online

Per configurare l'accesso Single Sign-On sul lato **BGS Online**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di BGS Online](mailto:bgsdashboardteam@millwardbrown.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a BGS Online.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **BGS Online**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **BGS Online**.

    ![Collegamento di BGS Online nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-bgs-online-test-user"></a>Creare l'utente di test di BGS Online

In questa sezione viene creato un utente di nome Britta Simon in BGS Online. Collaborare con il [team di supporto di BGS Online](mailto:bgsdashboardteam@millwardbrown.com) per aggiungere gli utenti alla piattaforma BGS Online. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di BGS Online nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione BGS Online per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
