...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Gra-Pe con gli account Azure AD personali.
...
* Sottoscrizione di Gra-Pe abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Gra-Pe supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **Gra-Pe**, selezionare **Gra-Pe** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Gra-Pe nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Gra-Pe usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Gra-Pe.
...
2. **[Configurare l'accesso Single Sign-On per Gra-Pe](#configure-gra-pe-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Gra-Pe](#create-gra-pe-test-user)**: per avere una controparte di Britta Simon in Gra-Pe collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Gra-Pe](common/sp-signonurl.png)

    Nella casella di testo **URL di accesso** digitare un URL: `https://btm.tts.co.jp/portal/apl/SSOLogin.aspx`

5. Nella pagina **Configura l'accesso Single Sign-On con SAML**, nella sezione **Certificato di firma SAML**, fare clic su **Scarica** per scaricare il **Certificato (Base64)** definito dalle opzioni specificate in base ai propri requisiti e salvarlo in questo computer.

    ![Collegamento di download del certificato](common/certificatebase64.png)

6. Nella sezione **Configura Gra-Pe** copiare gli URL appropriati in base alle esigenze.
...
Per configurare l'accesso Single Sign-On sul lato **Gra-Pe** è necessario inviare il file **Certificato (Base64)** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Gra-Pe](https://www.toppantravel.com/inquiry/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
2. Nell'elenco delle applicazioni, selezionare **Gra-Pe**.
    ...
    ![Collegamento di Gra-Pe nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-gra-pe-test-user"></a>Creare l'utente di test di Gra-Pe
...
Quando si fa clic sul riquadro di Gra-Pe nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Gra-Pe per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
