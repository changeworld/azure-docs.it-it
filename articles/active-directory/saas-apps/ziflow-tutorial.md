...
3. Fare clic su **Add** (Aggiungi) e quindi su **Add user** (Aggiungi utente).
    ...
    ![Screenshot che mostra l'opzione Add user selezionata.](./media/ziflow-tutorial/tutorial_ziflow_add.png)

4. Nella sezione **Add a user** (Aggiungi un utente) seguire questa procedura:

    ![Screenshot che mostra la finestra di dialogo Add a User in cui è possibile immettere i valori indicati.](./media/ziflow-tutorial/tutorial_ziflow_adduser.png)
