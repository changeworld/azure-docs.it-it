...
In questa sezione viene creato un utente di nome B.Simon in Mobile Locker. Collaborare con il [team di supporto di Mobile Locker](mailto:support@mobilelocker.com) per aggiungere gli utenti alla piattaforma Mobile Locker. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
