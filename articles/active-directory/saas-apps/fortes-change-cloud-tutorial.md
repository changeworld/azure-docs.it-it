---
title: "Esercitazione: Integrazione dell'accesso Single Sign-On (SSO) di Azure Active Directory con Fortes Change Cloud | Microsoft Docs"
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory e Fortes Change Cloud.
...
Questa esercitazione descrive come integrare Fortes Change Cloud con Azure Active Directory (Azure AD). Integrando Fortes Change Cloud con Azure AD, è possibile:
...
* Sottoscrizione di Fortes Change Cloud abilitata per l'accesso Single Sign-On (SSO).
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a Fortes Change Cloud.
...
In questa sezione viene creato un utente di nome Britta Simon in Fortes Change Cloud. Collaborare con il [team di supporto di Fortes Change Cloud](mailto:support@fortes.nl) per aggiungere gli utenti alla piattaforma Fortes Change Cloud. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
