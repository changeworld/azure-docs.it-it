...
## <a name="configure-and-test-azure-ad-sso-for-askyourteam"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per AskYourTeam
...
Per configurare e testare l'accesso SSO di Azure AD con AskYourTeam, seguire questa procedura:
...
1. **[Configurare l'accesso Single Sign-On di AskYourTeam](#configure-askyourteam-sso)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
    1. **[Creare l'utente di test di AskYourTeam](#create-askyourteam-test-user)** : per avere una controparte di B.Simon in AskYourTeam collegata alla rappresentazione dell'utente in Azure AD.
...
1. Per automatizzare la configurazione all'interno di AskYourTeam, è necessario installare l'**estensione del browser per l'accesso sicuro ad App personali** facendo clic su **Installa l'estensione**.

    ![Estensione MyApps](common/install-myappssecure-extension.png)

2. Dopo aver aggiunto l'estensione al browser, fare clic su **Configura AskYourTeam** per passare direttamente all'applicazione AskYourTeam. Specificare quindi le credenziali di amministratore per accedere ad AskYourTeam. L'estensione del browser configurerà automaticamente l'applicazione per l'utente e automatizzerà i passaggi da 3 a 7.

    ![Eseguire la configurazione](common/setup-sso.png)

3. Se si vuole configurare AskYourTeam manualmente, in un'altra finestra del Web browser accedere al sito aziendale di AskYourTeam come amministratore.

1. Fare clic su **My Organization** (La mia organizzazione).

    ![Screenshot che mostra il collegamento My Organization.](./media/askyourteam-tutorial/user1.png)
...
1. Fare clic su **My Organization** (La mia organizzazione).
    ...
    ![Screenshot che mostra il collegamento My Organization che consente di avviare questa attività.](./media/askyourteam-tutorial/user1.png)
...
* Dopo aver fatto clic su **Test this application** (Testa questa applicazione) nel portale di Azure, si dovrebbe accedere automaticamente all'istanza di AskYourTeam per cui si è configurato l'accesso SSO
