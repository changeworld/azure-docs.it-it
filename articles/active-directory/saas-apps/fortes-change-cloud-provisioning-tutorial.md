...
In questa esercitazione vengono descritti i passaggi da eseguire in entrambe le fortezze Change cloud e Azure Active Directory (Azure AD) per configurare il provisioning utenti automatico. Quando la configurazione viene eseguita, Azure AD esegue automaticamente il provisioning e il deprovisioning di utenti e gruppi a [Forts change Cloud](https://fortesglobal.com/) usando il servizio di provisioning Azure ad. Per informazioni dettagliate sul funzionamento di questo servizio e domande frequenti, vedere [Automatizzare il provisioning e il deprovisioning utenti in applicazioni SaaS con Azure Active Directory](../manage-apps/user-provisioning.md). 
...
3. Determinare quali dati eseguire il [mapping tra Azure ad e i forti cambiano cloud](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
Aggiungere fortezze change Cloud dalla raccolta di applicazioni di Azure AD per iniziare a gestire il provisioning in un cloud con modifiche dei forti. Se in precedenza è stata eseguita l'installazione di Forts Change cloud per SSO, è possibile usare la stessa applicazione. È tuttavia consigliabile creare un'app separata per il test iniziale dell'integrazione. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
9. Esaminare gli attributi utente sincronizzati da Azure AD a Forts Change cloud nella sezione **attribute-mapping** . Gli attributi selezionati come proprietà **corrispondenti** vengono usati per trovare le corrispondenze con gli account utente in Forts Change cloud per le operazioni di aggiornamento. Se si sceglie di modificare l' [attributo di destinazione corrispondente](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes), è necessario assicurarsi che l'API del cloud Change Forts supporti i filtri degli utenti in base a tale attributo. Selezionare il pulsante **Salva** per eseguire il commit delle modifiche.
