...
1. Nella sezione **Access page** (Pagina di accesso) fare clic su **Setup** (Configura).

    ![Screenshot che mostra la sezione "Access Page" con il pulsante "Setup" selezionato.](./media/screencast-tutorial/tutorial_screencast_setup.png)

1. In **Setup Access Page** (Pagina di accesso di configurazione) seguire questa procedura.

1. Nella sezione **Access URL** (URL di accesso) digitare il nome dell'istanza nella casella di testo specificata.

    ![Screenshot che mostra la sezione "Access URL" con la casella di testo del nome dell'istanza evidenziata.](./media/screencast-tutorial/tutorial_screencast_access.png)
