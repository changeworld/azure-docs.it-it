...
Per configurare e testare l'accesso SSO di Azure AD con SuccessFactors, seguire questa procedura:
...
1. Nella pagina di integrazione dell'applicazione **SuccessFactors** del portale di Azure individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
3. Inserire un valore qualsiasi in **Reset Token** (Reimposta token) e fare clic su **Save Token** (Salva token) per abilitare SSO SAML.
    ...
    ![Screenshot che mostra la scheda Application Security con le funzionalità Single Sign On selezionate in cui è possibile immettere un token.][11]
...
4. Nella schermata sottostante eseguire le azioni seguenti:
    ...
    ![Screenshot che mostra il riquadro SAML-based SSO in cui è possibile immettere i valori indicati.][12]
...
5. Passare a SAML V2 e seguire questa procedura:
    ...
    ![Screenshot che mostra il riquadro SAML v2 SP initiated logout in cui è possibile immettere i valori indicati.][13]
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di SuccessFactors, in cui è possibile avviare il flusso di accesso. 

* Passare direttamente all'URL di accesso di SuccessFactors e avviare il flusso di accesso da questa posizione.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro di SuccessFactors in App personali, verrà eseguito il reindirizzamento all'URL di accesso di SuccessFactors. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](../user-help/my-apps-portal-end-user-access.md).
