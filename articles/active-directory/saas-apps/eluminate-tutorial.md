...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a eLuminate con gli account Azure AD personali.
...
* eLuminate supporta l'accesso SSO avviato da **SP**
...
4. Nella casella di ricerca digitare **eLuminate**, selezionare **eLuminate** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![eLuminate nell'elenco dei risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in eLuminate.
...
2. **[Configurare l'accesso Single Sign-On per eLuminate](#configure-eluminate-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di eLuminate](#create-eluminate-test-user)**: per avere una controparte di Britta Simon in eLuminate collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con eLuminate, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **eLuminate** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `Eluminate/ClientShortName`

    > [!NOTE]
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'ID e l'URL di accesso effettivi. Per ottenere questi valori contattare il [team di supporto clienti di eLuminate](mailto:support@intellimedia.ca). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-eluminate-single-sign-on"></a>Configurare l'accesso Single Sign-On per eLuminate

Per configurare l'accesso Single Sign-On in **eLuminate**, è necessario inviare l'**URL dei metadati di federazione dell'app** al [team di supporto di eLuminate](mailto:support@intellimedia.ca). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
In questa sezione si abilita Britta Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a eLuminate.

1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **eLuminate**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **eLuminate**.

    ![Collegamento di eLuminate nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-eluminate-test-user"></a>Creare l'utente di test di eLuminate
...
Quando si fa clic sul riquadro di eLuminate nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione eLuminate per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
