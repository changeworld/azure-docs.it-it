...
1. Per automatizzare la configurazione all'interno di Slack, è necessario installare l'**estensione del browser per l'accesso sicuro ad App personali** facendo clic su **Installa l'estensione**.

    ![Estensione MyApps](common/install-myappssecure-extension.png)

2. Dopo aver aggiunto l'estensione al browser, fare clic su **Configura Slack** per passare direttamente all'applicazione Slack. Specificare quindi le credenziali di amministratore per accedere a Slack. L'estensione del browser configurerà automaticamente l'applicazione e automatizzerà i passaggi da 3 a 6.

    ![Eseguire la configurazione](common/setup-sso.png)

3. Se si vuole configurare Slack manualmente, in un'altra finestra del Web browser accedere al sito aziendale di Slack come amministratore.
...
* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro di Slack in App personali, verrà eseguito il reindirizzamento all'URL di accesso di Slack. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](../user-help/my-apps-portal-end-user-access.md).
