...
4. Nella casella di ricerca digitare **yonyx Interactive Guides Interactive Guide**, selezionare **Yonyx Interactive Guides Interactive Guide** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

     ![Yonyx Interactive Guides nell'elenco dei risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato Azure AD Single Sign-On con guide interattive di Yonyx Interactive Guides in base a un utente test di nome **Britta Simon**.
