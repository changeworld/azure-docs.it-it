---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Drift | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-drift"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Drift
...
1. Nella pagina di integrazione dell'applicazione **Drift** del [portale di Azure](https://portal.azure.com/)individuare la sezione **Gestisci** e selezionare **Single Sign-on**.
...
1. Nella sezione **Configurazione SAML di base** l'applicazione è preconfigurata in modalità avviata da **IDP** e gli URL necessari sono già prepopolati con Azure. L'utente deve salvare la configurazione facendo clic sul pulsante **Salva**.
    ...
    c. Se si vuole configurare l'applicazione in modalità avviata da **SP** , seguire questa procedura:
...
4. Sul lato sinistro della barra dei menu fare clic su **Impostazioni icona**  >  **impostazioni app**  >  **autenticazione** e seguire questa procedura:
