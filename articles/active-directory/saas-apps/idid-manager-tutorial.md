...
In questa sezione viene creato un utente di nome Britta Simon in iDiD Manager. Collaborare con il [team di supporto di iDiD Manager](mailto:support@idid.fi) per aggiungere gli utenti alla piattaforma iDiD Manager. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
