...
In questa sezione viene configurato e testato Azure AD Single Sign-On con SkillPort in base a un utente test di nome **Britta Simon**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    1. Nella casella di testo **URL di accesso** digitare l'URL: 

        Data center UE: `https://adfs.skillport.eu`

        Data center USA: `https://sso.skillport.com`

    1. Nella casella **Identificatore** digitare l'URL 

        Data center UE: `http://adfs.skillport.eu/adfs/services/trust`

        Data center USA: `https://sso.skillport.com`

    1. Nella casella di testo **URL di risposta** digitare il valore 
