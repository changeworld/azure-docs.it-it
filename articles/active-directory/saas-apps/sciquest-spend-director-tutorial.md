...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a SciQuest Spend Director con gli account Azure AD personali.
...
* SciQuest Spend Director supporta l'accesso SSO avviato da **SP**
* SciQuest Spend Director supporta il provisioning utenti **JIT**
...
**Per aggiungere SciQuest Spend Director dalla raccolta, seguire questa procedura:**
...
4. Nella casella di ricerca digitare **SciQuest Spend Director**, selezionare **SciQuest Spend Director** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![SciQuest Spend Director nell'elenco dei risultati](common/search-new-app.png)
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in SciQuest Spend Director.
...
2. **[Configurare l'accesso Single Sign-On di SciQuest Spend Director](#configure-sciquest-spend-director-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di SciQuest Spend Director](#create-sciquest-spend-director-test-user)**: per avere una controparte di Britta Simon in SciQuest Spend Director collegata alla rappresentazione dell'utente in Azure AD.
...
Per configurare l'accesso Single Sign-On di Azure AD con SciQuest Spend Director, seguire questa procedura:

1. Nella pagina di integrazione dell'applicazione **SciQuest Spend Director** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di SciQuest Spend Director](common/sp-identifier-reply.png)

    a. Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://<companyname>.sciquest.com/apps/Router/SAMLAuth/<instancename>`

    b. Nella casella di testo **Identificatore** digitare un URL nel formato seguente: `https://<companyname>.sciquest.com`

    c. Nella casella di testo **URL di risposta** digitare un URL nel formato seguente: `https://<companyname>.sciquest.com/apps/Router/ExternalAuth/Login/<instancename>`

    > [!NOTE]
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di accesso effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di SciQuest Spend Director](https://www.jaggaer.com/contact-us/). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.

5. Nella pagina **Configura l'accesso Single Sign-On con SAML**, nella sezione **Certificato di firma SAML**, fare clic su **Scarica** per scaricare il file **XML metadati federazione** definito dalle opzioni specificate in base ai propri requisiti e salvarlo in questo computer.

    ![Collegamento di download del certificato](common/metadataxml.png)

6. Nella sezione **Configura SciQuest Spend Director** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-sciquest-spend-director-single-sign-on"></a>Configurare l'accesso Single Sign-On di SciQuest Spend Director

Per configurare l'accesso Single Sign-On sul lato **SciQuest Spend Director**, è necessario inviare il file di **XML metadati federazione** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di SciQuest Spend Director](https://www.jaggaer.com/contact-us/). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **SciQuest Spend Director**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **SciQuest Spend Director**.

    ![Collegamento di SciQuest Spend Director nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-sciquest-spend-director-test-user"></a>Creare l'utente di test di SciQuest Spend Director
...
Quando si fa clic sul riquadro di SciQuest Spend Director nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione SciQuest Spend Director per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
