...
1. Oltre alla precedente, JFrog Artifactory prevede che venga restituito un certo numero di attributi aggiuntivi nella risposta SAML. Nella sezione **Attributi e attestazioni utente** della finestra di dialogo **Attestazioni gruppo (Anteprima)** seguire questa procedura:
    ...
    ![Screenshot che mostra il riquadro Attributi utente e attestazioni con l'icona di modifica selezionata.](./media/jfrog-artifactory-tutorial/config04.png)

    ![Screenshot che mostra la sezione Attestazioni di gruppo con l'opzione Tutti i gruppi selezionata.](./media/jfrog-artifactory-tutorial/config05.png)
...
Tutti gli elementi necessari per configurare Single Sign-On sul lato **JFrog Artifactory** sono configurabili dall'amministratore di Artifactory nella schermata SAML configugration.
