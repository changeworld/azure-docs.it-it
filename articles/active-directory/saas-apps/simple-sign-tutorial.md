...
In questa sezione viene creato un utente di nome Britta Simon in Simple Sign. Collaborare con il [team di supporto di Simple Sign](mailto:info@simplesign.io) per aggiungere gli utenti alla piattaforma Simple Sign. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
