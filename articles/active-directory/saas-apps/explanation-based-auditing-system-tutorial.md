---
title: 'Esercitazione: integrazione di Azure Active Directory con Explanation-Based controllo del sistema | Microsoft Docs'
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory ed Explanation-Based Auditing System.
...
ms.locfileid: "92453706"
---
# <a name="tutorial-azure-active-directory-integration-with-explanation-based-auditing-system"></a>Esercitazione: integrazione di Azure Active Directory con Explanation-Based il sistema di controllo

Questa esercitazione descrive come integrare Explanation-Based Auditing System con Azure Active Directory (Azure AD).
L'integrazione di Explanation-Based Auditing System con Azure AD offre i vantaggi seguenti:
...
## <a name="adding-explanation-based-auditing-system-from-the-gallery"></a>Aggiunta di Explanation-Based Auditing System dalla raccolta
...
4. Nella casella di ricerca digitare **Explanation-Based Auditing System**, selezionare **Explanation-Based Auditing System** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Explanation-Based Auditing System nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Explanation-Based Auditing System con un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato nel sistema Explanation-Based Auditing System.
...
2. **[Configurare l'accesso Single Sign-On di Explanation-Based Auditing System](#configure-explanation-based-auditing-system-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Explanation-Based Auditing System](#create-explanation-based-auditing-system-test-user)**: per avere una controparte di Britta Simon in Explanation-Based Auditing System collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Explanation-Based Auditing System** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni sull'accesso Single Sign-On al dominio e agli URL di Explanation-Based Auditing System](common/sp-signonurl.png)
...
### <a name="configure-explanation-based-auditing-system-single-sign-on"></a>Configurare l'accesso Single Sign-On di Explanation-Based Auditing System
...
2. Nell'elenco delle applicazioni, selezionare **Explanation-Based Auditing System**.
    ...
    ![Collegamento di Explanation-Based Auditing System nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-explanation-based-auditing-system-test-user"></a>Creare un utente test di Explanation-Based Auditing System
