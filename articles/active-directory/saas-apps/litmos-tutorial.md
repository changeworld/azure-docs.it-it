---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Litmos | Microsoft Docs'
...
ms.locfileid: "92458452"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-litmos"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Litmos
...
5. Selezionare **genera automaticamente utenti**
...
Quando si fa clic sul riquadro di Litmos nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Litmos per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
