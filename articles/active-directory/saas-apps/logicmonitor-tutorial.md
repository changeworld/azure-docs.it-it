...
Questa esercitazione illustra come integrare LogicMonitor con Azure Active Directory (Azure AD). Quando si integra LogicMonitor con Azure AD, è possibile:

* Controllare in Azure AD chi può accedere a LogicMonitor.
* Abilitare gli utenti per l'accesso automatico a LogicMonitor con i propri account Azure AD.
...
* Sottoscrizione di LogicMonitor Single Sign-On abilitata.
...
## <a name="add-logicmonitor-from-the-gallery"></a>Aggiungere LogicMonitor dalla raccolta
...
1. Nella sezione **Aggiungi dalla raccolta** digitare **LogicMonitor** nella casella di ricerca.
1. Selezionare **LogicMonitor** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.

## <a name="configure-and-test-azure-ad-sso-for-logicmonitor"></a>Configurare e testare Azure AD SSO per LogicMonitor

Configurare e testare Azure AD SSO con LogicMonitor usando un utente di test di nome **B. Simon**. Per il funzionamento dell'accesso SSO, è necessario stabilire una relazione di collegamento tra un utente Azure AD e l'utente correlato in LogicMonitor.

Per configurare e testare Azure AD SSO con LogicMonitor, seguire questa procedura:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-sso)** : per consentire agli utenti di usare questa funzionalità.
    1. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente B.Simon.
    1. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare B.Simon all'uso dell'accesso Single Sign-On di Azure AD.
1. **[Configurare LOGICMONITOR SSO](#configure-logicmonitor-sso)** : per configurare le impostazioni di Single Sign-on sul lato applicazione.
    1. **[Creare un utente di test di LogicMonitor](#create-logicmonitor-test-user)** : per avere una controparte di B. Simon in LogicMonitor collegata alla rappresentazione Azure ad dell'utente.
...
1. Nella pagina di integrazione dell'applicazione **LogicMonitor** del portale di Azure individuare la sezione **Gestisci** e selezionare **Single Sign-on**.
...
4. Nella sezione **Single Sign-on (SSO) settings** eseguire la procedura seguente:
    ...
    b. In **Default Role Assignment** selezionare **readonly**.

    c. Aprire il file di metadati scaricato nel Blocco note e quindi incollare il contenuto del file nella casella di testo **Identity Provider Metadata**.
...
2. Nel menu in alto fare clic su **Settings** e quindi su **Roles and Users**.

    ![Ruoli e utenti](./media/logicmonitor-tutorial/ic790056.png "Ruoli e utenti")

3. Fare clic su **Aggiungi**.

4. Nella sezione **Add an account** eseguire la procedura seguente:

    ![Aggiungi un account](./media/logicmonitor-tutorial/ic790057.png "Aggiungi un account")

    a. Digitare i valori di **nome utente**, **indirizzo di posta elettronica**, **password** e digitare di nuovo la **password** dell'utente Azure Active Directory di cui si vuole eseguire il provisioning nelle caselle di testo correlate.

    b. Selezionare **ruoli**, **Visualizza autorizzazioni** e **stato**.
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di LogicMonitor, in cui è possibile avviare il flusso di accesso. 

* Passare direttamente all'URL di accesso di LogicMonitor e avviare il flusso di accesso da qui.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro LogicMonitor in My Apps (app personali), si dovrebbe accedere automaticamente al LogicMonitor per il quale si configura l'accesso SSO. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Passaggi successivi

Dopo aver configurato LogicMonitor, è possibile applicare il controllo della sessione, che protegge exfiltration e infiltrando i dati sensibili dell'organizzazione in tempo reale. Il controllo sessione costituisce un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).