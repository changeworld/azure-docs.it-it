...
* È possibile abilitare gli utenti per l'accesso automatico a Imagineer WebVision (Single Sign-On) con gli account Azure AD personali.
...
* Imagineer WebVision supporta l'accesso SSO avviato da **provider di servizi**
...
4. Nella casella di ricerca digitare **Imagineer WebVision**, selezionare **Imagineer WebVision** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
    ...
    ![Imagineer WebVision nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato Azure AD Single Sign-On con Imagine WebVision in base a un utente test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Imagineer WebVision.
...
2. **[Configurare l'accesso Single Sign-On per Imagineer WebVision](#configure-imagineer-webvision-single-sign-on)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare un utente di test di Imagineer WebVision](#create-imagineer-webvision-test-user)**: per avere una controparte di Britta Simon in Imagineer WebVision collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Imagineer WebVision** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Imagineer WebVision](common/sp-identifier.png)

    a. Nella casella di testo **URL di accesso** digitare un URL nel formato seguente: `https://<YOUR SERVER URL>/<yourapplicationloginpage>`

    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://<YOUR SERVER URL>/<yourapplicationloginpage>`

    > [!NOTE]
    > Poiché questi non sono i valori reali, è necessario aggiornarli con l'ID e l'URL di accesso effettivi. Per ottenere questi valori contattare il [team di supporto clienti di Imagineer WebVision](mailto:support@itgny.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-imagineer-webvision-single-sign-on"></a>Configurare l'accesso Single Sign-On per Imagineer WebVision

Per configurare l'accesso Single Sign-On sul lato **Imagineer WebVision**, è necessario inviare l'**URL dei metadati di federazione dell'app** al [team di supporto di Imagineer WebVision](mailto:support@itgny.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Imagineer WebVision**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco di applicazioni selezionare **Imagineer WebVision**.

    ![Collegamento di Imagineer WebVision nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-imagineer-webvision-test-user"></a>Creare un utente di test di Imagineer WebVision
...
Quando si fa clic sul riquadro di Imagineer WebVision nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Imagineer WebVision per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
