---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Firmex VDR | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-firmex-vdr"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Firmex VDR
...
Avviso: fino a quando l'amministratore del sito non configura i domini richiesti, gli utenti della società non saranno in grado di accedere a VDR. Gli utenti non aziendali, ovvero gli utenti guest, possono comunque accedere usando l'indirizzo di posta elettronica e la password. La configurazione dovrebbe richiedere qualche minuto.
...
1. Selezionare la scheda  **SSO**  . Quindi selezionare  **configurazione SSO**. Fare clic sul dominio da configurare.
...
1. Chiedere all'amministratore IT di compilare i campi seguenti. I valori dei campi devono essere ricavati dal provider di identità:  
    ...
    b. Nella casella di testo **Identity Provider URL (URL provider di identità** ) incollare il valore dell' **URL di accesso** copiato dal portale di Azure.
