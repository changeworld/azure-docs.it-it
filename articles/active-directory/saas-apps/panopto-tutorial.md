...
2. Sulla barra degli strumenti a sinistra fare clic su **System**, quindi su **Identity Providers**.
...
4. Nella sezione del provider SAML, eseguire la procedura seguente:
    ...
    a. Dall'elenco **tipo provider** selezionare **SAML20**.    
    
    b. Digitare un nome per l'istanza nella casella di testo **Instance Name**.

    c. Digitare una descrizione nella casella di testo **Friendly Description**.
...
Quando si fa clic sul riquadro di Panopto nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Panopto per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
