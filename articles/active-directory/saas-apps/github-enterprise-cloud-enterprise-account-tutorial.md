...
* Un [account github Enterprise](https://docs.github.com/en/free-pro-team@latest/github/setting-up-and-managing-your-enterprise/about-enterprise-accounts).
...
* GitHub Enterprise Cloud: l'account Enterprise supporta il protocollo SSO avviato da **SP** e **IDP** .
* GitHub Enterprise Cloud-Enterprise account supporta il provisioning degli utenti **just-in-Time** .
...
Per configurare e testare Azure AD SSO con GitHub Enterprise Cloud-Enterprise account, seguire questa procedura:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-sso)** : per consentire agli utenti di usare questa funzionalità.
    1. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente B.Simon.
    1. **[Assegnare l'account utente di Azure AD e l'account utente di test all'app GitHub](#assign-your-azure-ad-user-and-the-test-user-account-to-the-github-app)** : per abilitare l'account utente e l'utente di test `B.Simon` per l'uso dell'accesso Single Sign-On di Azure AD.
1. **[Abilitare e testare SAML per Enterprise Account e le rispettive organizzazioni](#enable-and-test-saml-for-the-enterprise-account-and-its-organizations)** : per configurare le impostazioni dell'accesso Single Sign-On sul lato applicazione.
    1. **[Testare l'accesso Single Sign-On con un altro proprietario Enterprise Account o account membro dell'organizzazione](#test-sso-with-another-enterprise-account-owner-or-organization-member-account)** : per verificare se la configurazione funziona.

## <a name="configure-azure-ad-sso"></a>Configurare l'accesso SSO di Azure AD

Per abilitare l'accesso Single Sign-On di Azure AD nel portale di Azure, seguire questa procedura.

1. Nella pagina di integrazione dell'applicazione **GitHub Enterprise Cloud-Enterprise account** del portale di Azure trovare la sezione **Gestisci** e selezionare **Single Sign-on**.
