---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con bonifica Enterprise | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-terraform-enterprise"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con bonifica Enterprise
