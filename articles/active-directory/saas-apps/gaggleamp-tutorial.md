...
1. In un'altra istanza del browser, passare alla pagina SAML SSO creata automaticamente dal team di supporto di Gaggle (ad esempio: *https://accounts.gaggleamp.com/saml_configurations/oXH8sQcP79dOzgFPqrMTyw/edit* ).
...
2. Nella pagina **SAML SSO** seguire questa procedura:  
    ...
    b. Nella casella di testo **autorità di certificazione del provider di identità** incollare il valore dell'identificatore di **Azure Ad** copiato da portale di Azure.
