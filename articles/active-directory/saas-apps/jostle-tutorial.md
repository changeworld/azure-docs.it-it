...
* Jostle supporta l'accesso SSO avviato da **SP**
...
5. **[Creare un utente di test di Jostle](#create-jostle-test-user)** : per avere una controparte di Britta Simon in Jostle collegata alla rappresentazione dell'utente in Azure AD.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Jostle](common/sp-identifier-reply.png)
...
6. Nella sezione **Configura Huddle** copiare gli URL appropriati in base alle esigenze.
