...
* Google Cloud (G Suite) Connector supporta il [provisioning utenti **automatico**](./g-suite-provisioning-tutorial.md)
...
Per configurare e testare l'accesso SSO di Azure AD con Google Cloud (G Suite) Connector, seguire questa procedura:
...
1. Nella pagina di integrazione dell'applicazione **Google Cloud (G Suite) Connector** del portale di Azure individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Google Cloud (G Suite) Connector supporta anche il provisioning utenti automatico. Per configurare questa funzionalità, è prima necessario [configurare Google Cloud (G Suite) Connector per il provisioning utenti automatico](./g-suite-provisioning-tutorial.md).
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di Google Cloud (G Suite) Connector, in cui è possibile avviare il flusso di accesso. 

* Passare direttamente all'URL di accesso di Google Cloud (G Suite) Connector e avviare il flusso di accesso da questa posizione.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro di Google Cloud (G Suite) Connector in App personali, verrà eseguito il reindirizzamento all'URL di accesso di Google Cloud (G Suite) Connector. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
