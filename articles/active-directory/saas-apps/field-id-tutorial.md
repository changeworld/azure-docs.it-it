...
Quando si seleziona il riquadro di Field iD nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Field iD per cui si è configurato l'accesso SSO. Per altre informazioni, vedere [Accedere e avviare app dal portale App personali](../user-help/my-apps-portal-end-user-access.md).
...
- [Come proteggere Field iD con visibilità e controlli avanzati](/cloud-app-security/proxy-intro-aad)