...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di Palo Alto Networks - Admin UI, in cui è possibile avviare il flusso di accesso. 

* Passare direttamente all'URL di accesso di Palo Alto Networks - Admin UI e avviare il flusso di accesso da questa posizione.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro di Palo Alto Networks - Admin UI in App personali, si dovrebbe accedere automaticamente all'istanza di Palo Alto Networks - Admin UI per cui si è configurato l'accesso SSO. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](../user-help/my-apps-portal-end-user-access.md).
