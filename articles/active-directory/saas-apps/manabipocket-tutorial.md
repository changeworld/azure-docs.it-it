...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Manabi Pocket in base a un utente test di nome **Britta Simon**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per Single Sign-On di Manabi Pocket](common/sp-identifier.png)
