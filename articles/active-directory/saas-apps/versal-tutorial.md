---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Versal | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-versal"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Versal
...
Per istruzioni su come incorporare un corso Versal con supporto per Azure AD Single Sign-On, vedere la Guida all' [incorporamento dei corsi organizzativi](https://support.versal.com/hc/articles/203271866-Embedding-organizational-courses) SAML per il supporto **Single Sign-on** . 
