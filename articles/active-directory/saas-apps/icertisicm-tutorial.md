...
In questa sezione viene configurata e testata Azure AD Single Sign-On con la piattaforma di gestione del contratto Icertis Contract in base a un utente test di nome **Britta Simon**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://<company name>.icertis.com`
