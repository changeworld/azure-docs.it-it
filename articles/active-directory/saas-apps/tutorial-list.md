...
Per semplificare l'integrazione delle applicazioni [software come un servizio (SaaS)](https://azure.microsoft.com/overview/what-is-saas/) abilitate per il cloud con Azure Active Directory, è stata sviluppata una raccolta di esercitazioni che descrivono ogni passaggio della configurazione.
...
Usare il [portale di rete delle applicazioni](../develop/v2-howto-app-gallery-listing.md) per richiedere l'aggiunta di un'applicazione abilitata per [SCIM](../app-provisioning/use-scim-to-provision-users-and-groups.md) alla raccolta per il provisioning automatico oppure l'aggiunta di un'applicazione abilitata per SAML/OIDC alla raccolta per l'accesso Single Sign-On.
...
| :--- | :--- | :--- |
| ![Logo - Atlassian Cloud](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian Cloud](atlassian-cloud-tutorial.md)| [Atlassian Cloud - Provisioning utenti](atlassian-cloud-provisioning-tutorial.md)|
...
| ![Logo - Workday](./media/tutorial-list/active-directory-saas-workday-tutorial.png)| [Workday](workday-tutorial.md)| [Workday - Provisioning utente](workday-inbound-tutorial.md)|

Per trovare altre esercitazioni, usare il sommario a sinistra.

## <a name="cloud-integrations"></a>Integrazioni cloud

| Logo | Esercitazione di applicazione per Single Sign-On | Esercitazione di applicazione per il provisioning utente |
| :--- | :--- | :--- |
| ![Logo - Amazon Web Services (AWS) Console](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Amazon Web Services (AWS) Console](amazon-web-service-tutorial.md)| [Amazon Web Services (AWS) Console - Provisioning dei ruoli](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
| ![Logo - Alibaba Cloud Service (Role-based SSO)](./media/tutorial-list/active-directory-saas-alibaba-tutorial.png)| [Alibaba Cloud Service (Role-based SSO)](alibaba-cloud-service-role-based-sso-tutorial.md)| |
| ![Logo - Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform - Provisioning utenti](g-suite-provisioning-tutorial.md) |
...
## <a name="oneclick-sso"></a>SSO con un clic

| Logo | Esercitazione di applicazione per Single Sign-On |
| :--- | :--- |
...
| ![Integrazione di logo-kendis-Azure AD](./media/tutorial-list/active-directory-saas-kendis-azure-ad-integration.png)| [Integrazione di kendis-Azure AD](kendis-scaling-agile-platform-tutorial.md)|
...
| ![logo-perimetrale 81](./media/tutorial-list/active-directory-saas-perimeter-81-tutorial.png)| [Perimeter 81](perimeter-81-tutorial.md)|
...
Per altre informazioni sulla gestione delle applicazioni, vedere [Che cos'è la gestione delle applicazioni](../manage-apps/what-is-application-management.md).