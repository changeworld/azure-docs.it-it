...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Insight4GRC con gli account Azure AD personali.
...
* Insight4GRC supporta l'accesso SSO avviato da **SP e IDP**
* Insight4GRC supporta il provisioning utenti **JIT**
...
4. Nella casella di ricerca digitare **Insight4GRC**, selezionare **Insight4GRC** dal pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
...
1. Nella pagina di integrazione dell'applicazione **Insight4GRC** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    > [!NOTE]
    > Poiché questi non sono i valori reali, aggiornarli con l'identificatore, l'URL di risposta e l'URL di accesso effettivi. Per ottenere questi valori contattare il [team di supporto clienti di Insight4GRC](mailto:support.ss@rsmuk.com). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
### <a name="configure-insight4grc-single-sign-on"></a>Configurare l'accesso Single Sign-On di Insight4GRC
...
### <a name="create-insight4grc-test-user"></a>Creare l'utente di test di Insight4GRC

In questa sezione viene creato un utente di nome Britta Simon in Insight4GRC. Insight4GRC supporta il provisioning utenti JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Insight4GRC, ne viene creato uno nuovo dopo l'autenticazione.
...
Quando si fa clic sul riquadro di Insight4GRC nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Insight4GRC per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
