...
Per configurare Azure AD l'integrazione con Splunk Enterprise e Splunk cloud, sono necessari gli elementi seguenti:
...
* Sottoscrizione di Splunk Enterprise e Splunk cloud Single Sign-On abilitata.
