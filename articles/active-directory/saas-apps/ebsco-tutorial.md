---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con EBSCO | Microsoft Docs'
...
ms.locfileid: "92454338"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-ebsco"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con EBSCO
