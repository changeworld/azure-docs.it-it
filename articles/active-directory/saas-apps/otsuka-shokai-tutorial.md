---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Otsuka Shokai | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-otsuka-shokai"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Otsuka Shokai
...
* Otsuka Shokai supporta SSO avviato da **IDP**
...
1. Nella pagina di integrazione dell'applicazione **Otsuka Shokai** del [portale di Azure](https://portal.azure.com/)individuare la sezione **Gestisci** e selezionare **Single Sign-on**.
