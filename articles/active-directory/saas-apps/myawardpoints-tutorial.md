...
* My Award Points Top Sub/Top Team supporta l'accesso Single Sign-On avviato da **SP**
...
4. Nella casella di ricerca digitare **My Award Points Top Sub/Top Team**, selezionare **My Award Points Top Sub/Top Team** nel pannello dei risultati quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![My Award Points Top Sub/Top Team nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurata e testata Azure AD Single Sign-On con il team Top Sub/top dei punti premio in base a un utente test di nome **Britta Simon**.
...
1. Nella pagina di integrazione dell'applicazione [My Award Points Top Sub/Top Team](https://portal.azure.com/) del **portale di Azure** selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di My Award Points Top Sub/Top Team](common/sp-signonurl.png)

    Nella casella di testo **URL accesso** digitare un URL nel formato seguente: `https://microsoftrr.performnet.com/biwv1auth/Shibboleth.sso/Login?providerId=<Azure AD Identifier>`

    > [!NOTE]
    > Poiché non è reale, Si otterrà il valore `<Azure AD Identifier>` più avanti nell'esercitazione.
...
6. Nella sezione **Set up My Award Points Top Sub/Top Team** (Configura My Award Points Top Sub/Top Team) copiare gli URL appropriati in base alle proprie esigenze. 
    ...
    >[!NOTE]
    >Accodare il valore copiato dell'identificatore Azure AD con l'URL di accesso al posto di `<Azure AD Identifier>` nella sezione **Configurazione SAML di base** del portale di Azure.

### <a name="configure-my-award-points-top-subtop-team-single-sign-on"></a>Configurare l'accesso Single Sign-On di My Award Points Top Sub/Top Team
...
2. Nell'elenco delle applicazioni selezionare **My Award Points Top Sub/Top Team**.
    ...
    ![Collegamento di My Award Points Top Sub/Top Team nell'elenco delle applicazioni](common/all-applications.png)
