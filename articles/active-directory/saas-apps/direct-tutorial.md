...
2. Se si vuole testare in **modalità avviata da SP**:
    ...
    b. Digitare il valore di `subdomain` nella casella di testo visualizzata e selezionare **Next** (Avanti) per accedere automaticamente all'applicazione **direct**.
