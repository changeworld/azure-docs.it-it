...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Skills Manager con gli account Azure AD personali.
...
* Skills Manager supporta l'accesso SSO avviato da **IDP**
...
4. Nella casella di ricerca digitare **Skills Manager**, selezionare **Skills Manager** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Skills Manager nell'elenco risultati](common/search-new-app.png)
...
4. Nella pagina **Configura l'accesso Single Sign-On con SAML** eseguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Skills Manager](common/idp-intiated.png)
...
### <a name="configure-skills-manager-single-sign-on"></a>Configurare l'accesso Single Sign-On per Skills Manager
...
Quando si fa clic sul riquadro di Skills Manager nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Skills Manager per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
