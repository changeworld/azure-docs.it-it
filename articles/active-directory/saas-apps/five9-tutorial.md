...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Five9 Plus Adapter (CTI, Contact Center Agents) in base a un utente test di nome **Britta Simon**.
