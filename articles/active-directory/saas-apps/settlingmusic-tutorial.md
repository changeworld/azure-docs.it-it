...
In questa sezione viene configurata e testata Azure AD Single Sign-On con la musica di sedimentazione basata su un utente test di nome **Britta Simon**.
