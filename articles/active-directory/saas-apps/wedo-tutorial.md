---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con WEDO | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-wedo"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con WEDO
...
* [Una volta configurata la Wedo, è possibile applicare i controlli della sessione, che proteggono exfiltration e infiltrano i dati sensibili dell'organizzazione in tempo reale. I controlli della sessione si estendono dall'accesso condizionale. Informazioni su come applicare il controllo della sessione con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).
...
1. Nella pagina **SAML Authentication** (Autenticazione SAML) seguire questa procedura:
   ...
   a. Abilitare **l'autenticazione SAML**.
