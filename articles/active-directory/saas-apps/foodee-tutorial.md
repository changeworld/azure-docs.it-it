---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con foodee | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-foodee"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con foodee
