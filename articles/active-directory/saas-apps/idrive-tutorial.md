...
In questa sezione si crea un utente di nome Britta Simon in IDrive. Collaborare con il [team di supporto di IDrive](https://www.idrive.com/support) per aggiungere gli utenti alla piattaforma IDrive. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Facendo clic sul riquadro IDrive nel pannello di accesso si dovrebbe accedere automaticamente all'applicazione IDrive per cui è stato configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
