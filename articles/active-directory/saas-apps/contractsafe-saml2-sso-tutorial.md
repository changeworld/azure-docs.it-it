---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con ContractSafe Saml2 SSO | Microsoft Docs'
...
ms.locfileid: "92455314"
---
# <a name="tutorial-integrate-azure-active-directory-single-sign-on-sso-with-contractsafe-saml2-sso"></a>Esercitazione: integrare Azure Active Directory Single Sign-On (SSO) con ContractSafe Saml2 SSO
...
1. [Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-sso): per consentire agli utenti di usare questa funzionalità.
   ...
   * [Assegnare l'utente test di Azure ad](#assign-the-azure-ad-test-user) per consentire a **B. Simon** di usare Azure ad SSO.
...
In questa sezione verrà creato un utente di test nella portale di Azure denominata **B. Simon**.
...
- [ Elenco delle esercitazioni sull'integrazione di app SaaS con Azure Active Directory](./tutorial-list.md)
