...
> [!NOTE]
> Per creare un utente manualmente è necessario contattare il [team di supporto di Degreed](mailto:sso@degreed.com).
...
Quando si fa clic sul riquadro di Degreed nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Degreed per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
