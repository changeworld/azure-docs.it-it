---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con CylancePROTECT | Microsoft Docs'
...
ms.locfileid: "92454967"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-cylanceprotect"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con CylancePROTECT
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cylanceprotect"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per CylancePROTECT
...
Per configurare e testare l'accesso SSO di Azure AD con CylancePROTECT, completare le procedure di base seguenti:
...
1. **[Configurare l'accesso Single Sign-On di CylancePROTECT](#configure-cylanceprotect-sso)**: per configurare le impostazioni di Single Sign-On sul lato applicazione.
    * **[Creare l'utente di test di CylancePROTECT](#create-cylanceprotect-test-user)**: per avere una controparte di B.Simon in CylancePROTECT collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **CylancePROTECT** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
Quando si fa clic sul riquadro di CylancePROTECT nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione CylancePROTECT per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
...
- [Provare CylancePROTECT con Azure AD](https://aad.portal.azure.com/)