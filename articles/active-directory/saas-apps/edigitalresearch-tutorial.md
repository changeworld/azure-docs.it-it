...
In questa sezione viene creato un utente chiamato Britta Simon in eDigitalResearch. Collaborare con il [team di supporto di eDigitalResearch](https://www.maruedr.com/contact) per aggiungere gli utenti alla piattaforma eDigitalResearch. Gli utenti devono essere creati e attivati prima di usare l'accesso Single Sign-On.
