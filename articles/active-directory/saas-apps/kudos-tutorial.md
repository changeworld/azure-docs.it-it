...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Kudos in base a un utente test di nome **Britta Simon**.
...
1. Fare clic su **Integrations > SSO** (Integrazione > SSO) e seguire questa procedura:
    ...
    b. Aprire il certificato con codifica in base 64 nel Blocco note, copiarne il contenuto negli Appunti e quindi incollarlo nella casella di testo **Certificato X.509**.
    ...
    d. Nella casella di testo **Your Kudos URL** immettere il nome della propria azienda.
...
1. Fare clic sulla scheda **utenti** e quindi su **Aggiungi un utente**.

   ![Amministratore utenti](./media/kudos-tutorial/ic787809.png "User Admin")

1. Nella sezione **Add User** eseguire la procedura seguente:

    ![Add a User](./media/kudos-tutorial/ic787810.png "Aggiungi un utente")

    a. Digitare i valori **First Name**, **Last Name**, **Email** e altri dettagli di un account Azure Active Directory valido di cui si vuole effettuare il provisioning nelle caselle di testo correlate.
