---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Blink | Microsoft Docs'
...
ms.locfileid: "92457011"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blink"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con Blink
...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://api.joinblink.com/saml/o-<TENANTID>`
...
Quando si fa clic sul riquadro di Blink nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Blink per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
