...
* Zoom supporta il [provisioning utenti **automatizzato**](./zoom-provisioning-tutorial.md).
...
## <a name="configure-and-test-azure-ad-sso-for-zoom"></a>Configurare e testare l'accesso SSO di Azure AD per Zoom
...
Per configurare e testare l'accesso SSO di Azure AD con Zoom, completare la procedura seguente:
...
1. Nella pagina di integrazione dell'applicazione **Zoom** del portale di Azure individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
> [!NOTE]
> Per informazioni su come configurare il ruolo in Azure AD, vedere [Configurare l'attestazione basata su ruolo rilasciata nel token SAML per applicazioni aziendali](../develop/active-directory-enterprise-app-role-management.md).
...
1. Per automatizzare la configurazione all'interno di Zoom, è necessario installare l'**estensione del browser per l'accesso sicuro ad App personali** facendo clic su **Installa l'estensione**.

    ![Estensione MyApps](common/install-myappssecure-extension.png)

2. Dopo aver aggiunto l'estensione al browser, fare clic su **Configura Zoom** per passare direttamente all'applicazione Zoom. Nell'applicazione fornire le credenziali di amministratore per accedere a Zoom. L'estensione del browser configurerà automaticamente l'applicazione e automatizzerà i passaggi da 3 a 6.

    ![Eseguire la configurazione](common/setup-sso.png)

3. Per configurare Zoom manualmente, in un'altra finestra del Web browser accedere al sito aziendale di Zoom come amministratore.
...
Questa sezione descrive come creare un utente di nome B.Simon in Zoom. Zoom supporta il provisioning utenti automatico, che è abilitato per impostazione predefinita. Altri dettagli su come configurare il provisioning utenti automatico sono disponibili [qui](./zoom-provisioning-tutorial.md).
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di Zoom, in cui è possibile avviare il flusso di accesso.
...
Dopo aver configurato Zoom in Azure AD, è possibile applicare il controllo sessione che consente di proteggere in tempo reale l'esfiltrazione e l'infiltrazione dei dati sensibili dell'organizzazione. Il controllo sessione costituisce un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad)