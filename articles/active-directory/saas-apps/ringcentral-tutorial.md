...
* RingCentral supporta SSO avviato da **IDP** .
...
## <a name="configure-and-test-azure-ad-sso-for-ringcentral"></a>Configurare e testare Azure AD SSO per RingCentral
...
Per configurare e testare Azure AD SSO con RingCentral, seguire questa procedura:
...
1. Nella pagina di integrazione dell'applicazione **RingCentral** del portale di Azure individuare la sezione **Gestisci** e selezionare **Single Sign-on**.
...
1. Se non si dispone del **file di metadati del provider di servizi**, immettere i valori per i campi seguenti:
    ...
    a. Nella casella di testo **identificatore** Digitare uno degli URL:
    ...
    b. Nella casella di testo **URL di risposta** Digitare uno degli URL:
...
In questa sezione si consentirà a B. Simon di usare Azure Single Sign-On concedendo l'accesso a RingCentral.
...
1. In alto fare clic su **Tools** (Strumenti).
    ...
    ![Screenshot che mostra la voce di menu Tools selezionata nel sito aziendale di RingCentral.](./media/ringcentral-tutorial/ringcentral-1.png)

1. Passare a **Single Sign-on**.

    ![Screenshot che mostra l'opzione Single Sign-On selezionata nel menu Tools.](./media/ringcentral-tutorial/ringcentral-2.png)
...
1. Nella pagina **Single Sign-on**, nella sezione **SSO Configuration** (Configurazione SSO), fare clic sul pulsante **Edit** (Modifica) relativo a **Step 1** (Passaggio 1) e seguire questa procedura:
    ...
    ![Screenshot che mostra la pagina SSO Configuration in cui è possibile selezionare Edit.](./media/ringcentral-tutorial/ringcentral-3.png)

1. Nella pagina **Set up Single Sign-on** (Configura Single Sign-On) seguire questa procedura:

    ![Screenshot che mostra la pagina Set up Single Sign-On in cui è possibile caricare i metadati del provider di servizi.](./media/ringcentral-tutorial/ringcentral-4.png)
    ...
    ![Screenshot che mostra la pagina SSO Configuration in cui è possibile selezionare Download.](./media/ringcentral-tutorial/ringcentral-6.png) 

    f. Nella stessa pagina, passare alla sezione **Enable SSO** (Abilita SSO) e seguire questa procedura:

    ![Screenshot che mostra la sezione Enable SSO in cui è possibile completare la configurazione.](./media/ringcentral-tutorial/ringcentral-5.png)
...
* Fare clic su test questa applicazione in portale di Azure e si dovrebbe accedere automaticamente al RingCentral per il quale si configura l'accesso SSO.

* È possibile usare App personali Microsoft. Quando si fa clic sul riquadro RingCentral in My Apps (app personali), si dovrebbe accedere automaticamente al RingCentral per il quale si configura l'accesso SSO. Per altre informazioni su App personali, vedere l'[introduzione ad App personali](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## <a name="next-steps"></a>Passaggi successivi

Dopo aver configurato RingCentral, è possibile applicare il controllo della sessione, che protegge exfiltration e infiltrando i dati sensibili dell'organizzazione in tempo reale. Il controllo sessione costituisce un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).