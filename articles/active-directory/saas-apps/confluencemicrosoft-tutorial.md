...
## <a name="configure-and-test-azure-ad-sso-for-confluence-saml-sso-by-microsoft"></a>Configurare e testare l'accesso SSO di Azure AD per Confluence SAML SSO by Microsoft
...
Per configurare e testare l'accesso SSO di Azure AD con Confluence SAML SSO by Microsoft, seguire questa procedura:
...
1. Nella pagina di integrazione dell'applicazione **Confluence SAML SSO by Microsoft** del portale di Azure individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
* Fare clic su **Test this application** (Testa questa applicazione) nel portale di Azure. Verrà eseguito il reindirizzamento all'URL di accesso di Confluence SAML SSO by Microsoft, in cui è possibile avviare il flusso di accesso. 
