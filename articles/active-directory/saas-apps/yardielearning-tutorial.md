...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Yardi eLearning in base a un utente test di nome **Britta Simon**.
...
1. **[Configurare Azure ad Single Sign-on](#configure-azure-ad-single-sign-on)** : per abilitare gli utenti all'uso di questa funzionalità.
