...
In questa sezione viene configurato e testato Azure AD Single Sign-On con un SSO di amministratore in base a un utente test di nome **Britta Simon**.
