...
1. Creare un nuovo provider di identità attendibili in SharePoint Server 2016.
    ...
    > [!TIP]
    > Se non si ha familiarità con l'uso di PowerShell o per altre informazioni sul funzionamento di PowerShell, vedere [SharePoint PowerShell](/powershell/sharepoint/overview).
