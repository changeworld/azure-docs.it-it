...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Workrite in base a un utente test di nome **Britta Simon**.
...
4. Nella finestra di dialogo **Create User** eseguire la procedura seguente:
