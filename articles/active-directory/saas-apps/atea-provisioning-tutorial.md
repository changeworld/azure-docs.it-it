...
Questa esercitazione descrive i passaggi da eseguire sia in atea che in Azure Active Directory (Azure AD) per configurare il provisioning utenti automatico. Se configurato, Azure AD esegue automaticamente il provisioning e il deprovisioning di utenti e gruppi in [atea](https://www.atea.com/) usando il servizio di provisioning Azure ad. Per informazioni dettagliate sul funzionamento di questo servizio e domande frequenti, vedere [Automatizzare il provisioning e il deprovisioning utenti in applicazioni SaaS con Azure Active Directory](../manage-apps/user-provisioning.md). 
...
Per configurare atea per il supporto del provisioning con Azure AD, inviare un messaggio di posta elettronica servicedesk@atea.dk .
...
Aggiungere atea dalla raccolta di applicazioni Azure AD per iniziare a gestire il provisioning in atea. Se in precedenza è stato configurato atea per SSO, è possibile usare la stessa applicazione. È tuttavia consigliabile creare un'app separata per il test iniziale dell'integrazione. Per altre informazioni su come aggiungere un'applicazione dalla raccolta, fare clic [qui](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
...
14. Definire gli utenti e/o i gruppi di cui si vuole eseguire il provisioning in atea selezionando i valori desiderati in **ambito** nella sezione **Impostazioni** .
