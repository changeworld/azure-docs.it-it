...
description: Informazioni sulla procedura da eseguire per integrare GoToMeeting con Azure Active Directory (Azure AD).
...
Questa esercitazione descrive come integrare GoToMeeting con Azure Active Directory (Azure AD). Integrando GoToMeeting con Azure AD, è possibile:

* Controllare in Azure AD chi può accedere a GoToMeeting.
* Abilitare gli utenti per l'accesso automatico a GoToMeeting con gli account Azure AD personali.
...
* Sottoscrizione di GoToMeeting abilitata per l'accesso Single Sign-On (SSO).
...
* Dopo aver configurato GoToMeeting, è possibile applicare i controlli sessione che consentono di proteggere in tempo reale l'esfiltrazione e l'infiltrazione dei dati sensibili dell'organizzazione. I controlli sessione costituiscono un'estensione dell'accesso condizionale. [Informazioni su come applicare il controllo sessione con Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad)
...
1. Nella sezione **Aggiungi dalla raccolta** digitare **GoToMeeting** nella casella di ricerca.
1. Selezionare **GoToMeeting** nel pannello dei risultati e quindi aggiungere l'app. Attendere alcuni secondi che l'app venga aggiunta al tenant.


## <a name="configure-and-test-azure-ad-single-sign-on-for-gotomeeting"></a>Configurare e testare l'accesso Single Sign-On di Azure AD per GoToMeeting

Configurare e testare l'accesso SSO di Azure AD con GoToMeeting usando un utente di test di nome **B.Simon**. Per consentire il funzionamento dell'accesso Single Sign-On, è necessario stabilire una relazione di collegamento tra un utente di Azure AD e l'utente correlato in GoToMeeting.
...
1. Nella pagina di integrazione dell'applicazione **GoToMeeting** del [portale di Azure](https://portal.azure.com/) individuare la sezione **Gestione** e selezionare **Single Sign-On**.
...
1. Nella sezione **Configurazione SAML di base** immettere i valori per i campi seguenti:
   ...
   - Per GoToAssist usare `https://app.gotoassist.com`
     ...
     > [!NOTE]
     > Poiché questi non sono i valori reali, è necessario aggiornarli con l'identificatore e l'URL di risposta effettivi. Per ottenere questi valori, contattare il [team di supporto clienti di GoToMeeting](../manage-apps/view-applications-portal.md). È anche possibile fare riferimento ai modelli mostrati nella sezione **Configurazione SAML di base** del portale di Azure.
...
In questa sezione si abiliterà B.Simon all'uso dell'accesso Single Sign-On di Azure concedendole l'accesso a GoToMeeting.

1. Nel portale di Azure selezionare **Applicazioni aziendali** e quindi **Tutte le applicazioni**.
1. Nell'elenco delle applicazioni selezionare **GoToMeeting**.
...
## <a name="configure-gotomeeting-sso"></a>Configurare l'accesso Single Sign-On di GoToMeeting
...
- [Provare GoToMeeting con Azure AD](https://aad.portal.azure.com/)

- [Informazioni sul controllo sessioni in Microsoft Cloud App Security](/cloud-app-security/proxy-intro-aad)

- [Come proteggere GoToMeeting con visibilità e controlli avanzati](/cloud-app-security/proxy-intro-aad)