...
Quando si seleziona il riquadro di Predictix Ordering nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Predictix Ordering per cui si è configurato l'accesso SSO. Per altre informazioni, vedere [Accedere e usare le app nel portale App personali](../user-help/my-apps-portal-end-user-access.md).
