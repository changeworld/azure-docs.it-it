---
title: 'Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con workteam | Microsoft Docs'
...
ms.locfileid: "92520048"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-workteam"></a>Esercitazione: integrazione di Azure Active Directory Single Sign-On (SSO) con workteam
...
Quando si fa clic sul riquadro di Workteam nel pannello di accesso, si dovrebbe accedere automaticamente all'istanza di Workteam per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
