---
title: 'Esercitazione: Integrazione di Azure Active Directory con Acadia | Microsoft Docs'
description: Informazioni su come configurare l'accesso Single Sign-On tra Azure Active Directory e Acadia.
...
Questa esercitazione descrive come integrare Acadia con Azure Active Directory (Azure AD).
L'integrazione di Acadia con Azure AD offre i vantaggi seguenti:

* È possibile controllare in Azure AD chi può accedere ad Acadia.
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) ad Acadia con gli account Azure AD personali.
...
Per configurare l'integrazione di Azure AD con Acadia, sono necessari gli elementi seguenti:

* Una sottoscrizione di Azure AD. Se non si dispone di un ambiente Azure AD, è possibile ottenere una versione di valutazione di un mese [qui](https://azure.microsoft.com/pricing/free-trial/)
* Sottoscrizione di Acadia abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Acadia supporta l'accesso SSO avviato da **SP e IDP**
* Acadia supporta il provisioning utenti **JIT**

## <a name="adding-acadia-from-the-gallery"></a>Aggiunta di Acadia dalla raccolta

Per configurare l'integrazione di Acadia in Azure AD, è necessario aggiungere Acadia dalla raccolta all'elenco di app SaaS gestite.

**Per aggiungere Acadia dalla raccolta, seguire questa procedura:**
...
4. Nella casella di ricerca digitare **Acadia**, selezionare **Acadia** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.

    ![Acadia nell'elenco risultati](common/search-new-app.png)
...
5. Fare clic su **Impostare URL aggiuntivi** e seguire questa procedura se si vuole configurare l'applicazione in modalità avviata da **SP**:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Acadia](common/metadata-upload-additional-signon.png)
...
7. Nella sezione **Set up Acadia** (Configura Acadia) copiare gli URL appropriati in base alle esigenze.
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Acadia**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Acadia**.

    ![Collegamento di Acadia nell'elenco delle applicazioni](common/all-applications.png)
...
### <a name="create-acadia-test-user"></a>Creare l'utente di test di Acadia

In questa sezione viene creato un utente di nome Britta Simon in Acadia. Acadia supporta il provisioning JIT, che è abilitato per impostazione predefinita. Non è necessario alcun intervento dell'utente in questa sezione. Se non esiste già un utente in Acadia, ne viene creato uno nuovo dopo l'autenticazione.

### <a name="test-single-sign-on"></a>Testare l'accesso Single Sign-On 

In questa sezione viene testata la configurazione dell'accesso Single Sign-On di Azure AD usando il pannello di accesso.

Quando si fa clic sul riquadro di Acadia nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Acadia per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
