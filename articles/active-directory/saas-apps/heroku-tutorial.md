...
In questa sezione viene configurato e testato Azure AD Single Sign-On con Heroku in base a un utente test di nome **Britta Simon**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    b. Nella casella di testo **Identificatore (ID entità)** digitare un URL nel formato seguente: `https://sso.heroku.com/saml/<company-name>`
...
Quando si fa clic sul riquadro di Heroku nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Heroku per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
