...
* È possibile abilitare gli utenti per l'accesso automatico (Single Sign-On) a Form.com con gli account Azure AD personali.
...
* Sottoscrizione di Form.com abilitata per l'accesso Single Sign-On
...
4. Nella casella di ricerca digitare **Form.com**, selezionare **Form.com** nel pannello dei risultati e quindi fare clic sul pulsante **Aggiungi** per aggiungere l'applicazione.
     ...
     ![Form.com nell'elenco risultati](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurare e testare l'accesso Single Sign-On di Azure AD

In questa sezione viene configurato e testato l'accesso Single Sign-On di Azure AD con Form.com usando un utente di test di nome **Britta Simon**.
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Form.com.
...
2. **[Configurare l'accesso Single Sign-On per Form.com](#configure-formcom-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Form.com](#create-formcom-test-user)** : per avere una controparte di Britta Simon in Form.com collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Form.com** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Form.com](common/sp-identifier-reply.png)
...
### <a name="configure-formcom-single-sign-on"></a>Configurare l'accesso Single Sign-On per Form.com
...
1. Nel portale di Azure selezionare **Applicazioni aziendali**, quindi **Tutte le applicazioni** e infine **Form.com**.

    ![Pannello delle applicazioni aziendali](common/enterprise-applications.png)

2. Nell'elenco delle applicazioni selezionare **Form.com**.

    ![Collegamento Form.com nell'elenco delle applicazioni](common/all-applications.png)
...
Quando si fa clic sul riquadro di Form.com nel pannello di accesso, si dovrebbe accedere automaticamente all'applicazione Form.com per cui si è configurato l'accesso SSO. Per altre informazioni sul pannello di accesso, vedere [Introduzione al Pannello di accesso](../user-help/my-apps-portal-end-user-access.md).
