...
* Sottoscrizione di Birst Agile Business Analytics abilitata per l'accesso Single Sign-On

## <a name="scenario-description"></a>Descrizione dello scenario

In questa esercitazione vengono eseguiti la configurazione e il test dell'accesso Single Sign-On di Azure AD in un ambiente di test.

* Birst Agile Business Analytics supporta l'accesso SSO avviato da **SP**
...
Per configurare l'integrazione di Birst Agile Business Analytics in Azure AD, è necessario aggiungere Birst Agile Business Analytics dalla raccolta all'elenco di app SaaS gestite.
...
Per il corretto funzionamento dell'accesso Single Sign-On, deve essere stabilita una relazione di collegamento tra un utente di Azure AD e l'utente correlato in Birst Agile Business Analytics.

Per configurare e testare l'accesso Single Sign-On di Azure AD con Birst Agile Business Analytics, è necessario completare le procedure di base seguenti:

1. **[Configurare l'accesso Single Sign-On di Azure AD](#configure-azure-ad-single-sign-on)** : per consentire agli utenti di usare questa funzionalità.
2. **[Configurare l'accesso Single Sign-On per Birst Agile Business Analytics](#configure-birst-agile-business-analytics-single-sign-on)** : per configurare le impostazioni di Single Sign-On sul lato applicazione.
3. **[Creare un utente di test di Azure AD](#create-an-azure-ad-test-user)** : per testare l'accesso Single Sign-On di Azure AD con l'utente Britta Simon.
4. **[Assegnare l'utente di test di Azure AD](#assign-the-azure-ad-test-user)** : per abilitare Britta Simon all'uso dell'accesso Single Sign-On di Azure AD.
5. **[Creare l'utente di test di Birst Agile Business Analytics](#create-birst-agile-business-analytics-test-user)** : per avere una controparte di Britta Simon in Birst Agile Business Analytics collegata alla rappresentazione dell'utente in Azure AD.
...
1. Nella pagina di integrazione dell'applicazione **Birst Agile Business Analytics** del [portale di Azure](https://portal.azure.com/) selezionare **Single Sign-On**.
...
4. Nella sezione **Configurazione SAML di base** seguire questa procedura:
    ...
    ![Informazioni su URL e dominio per l'accesso Single Sign-On di Birst Agile Business Analytics](common/sp-intiated.png)
...
6. Nella sezione **Configura Birst Agile Business Analytics** copiare gli URL appropriati in base alle esigenze.
...
### <a name="configure-birst-agile-business-analytics-single-sign-on"></a>Configurare l'accesso Single Sign-On per Birst Agile Business Analytics

Per configurare l'accesso Single Sign-On sul lato **Birst Agile Business Analytics** è necessario inviare il file **Certificato (Base64)** scaricato e gli URL appropriati copiati dal portale di Azure al [team di supporto di Birst Agile Business Analytics](mailto:info@birst.com). La configurazione viene eseguita in modo che la connessione SSO SAML sia impostata correttamente su entrambi i lati.
...
2. Nell'elenco di applicazioni selezionare **Birst Agile Business Analytics**.
    ...
    ![Collegamento di Birst Agile Business Analytics nell'elenco delle applicazioni](common/all-applications.png)
