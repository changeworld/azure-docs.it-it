...
description: Questa esercitazione illustra come usare PowerShell e un file CSV per inviare inviti in blocco a utenti guest esterni di Collaborazione B2B di Azure AD.
...
![Screenshot che mostra l'output di PowerShell che include l'accettazione dell'utente in sospeso.](media/tutorial-bulk-invite/B2BBulkImport.png)
