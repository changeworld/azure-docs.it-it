...
7. Se l'utente non ha ancora accettato l'invito, nella sezione **Identity** l' **invito accettato** verrà impostato su **No**. Per inviare di nuovo l'invito, selezionare **(Gestisci)**. Quindi, nella pagina **Gestisci inviti** , accanto a * * Invia di nuovo l'invito? " Selezionare **Sì** e fare clic su **fine**.
...
> Inoltre, solo gli utenti con autorizzazioni di invito saranno in grado di inviare di nuovo gli inviti.
