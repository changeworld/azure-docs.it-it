...
- [Proprietà di un utente di Collaborazione B2B di Azure Active Directory](user-properties.md)
- [Che cos'è l'accesso utente guest in Azure Active Directory B2B?](what-is-b2b.md)
- [Azure Active Directory identità esterne: novità](whats-new-docs.md)
- [Consentire o bloccare gli inviti agli utenti B2B di organizzazioni specifiche](allow-deny-list.md)
- [API e personalizzazione per Collaborazione B2B di Azure Active Directory](customize-invitation-api.md)
- [Invitare gli utenti interni alla collaborazione B2B](invite-internal-users.md)
- [Microsoft 365 la condivisione esterna e la collaborazione B2B Azure Active Directory (Azure AD)](o365-external-user.md)
- [Federazione diretta con Active Directory Federation Services (AD FS) e provider di terze parti per utenti guest (anteprima)](direct-federation.md)
...
- [Consentire o bloccare gli inviti agli utenti B2B di organizzazioni specifiche](allow-deny-list.md)
- [Domande frequenti su Collaborazione B2B di Azure Active Directory](faq.md)
- [Documentazione di Identità esterne](index.yml)
- [Riscatto dell'invito di Collaborazione B2B di Azure Active Directory](redemption-experience.md)
- [Aggiungere un flusso di lavoro di approvazione personalizzato all'iscrizione self-service](self-service-sign-up-add-approvals.md)
- [Che cosa sono le identità esterne in Azure Active Directory?](compare-with-b2c.md)
- [Aggiungere un connettore API a un flusso utente](self-service-sign-up-add-api-connector.md)
...
### <a name="updated-articles"></a>Articoli aggiornati
- [Elementi del messaggio di posta elettronica di invito di Collaborazione B2B - Azure Active Directory](invitation-email-elements.md)
- [Risoluzione dei problemi di Azure Active Directory collaborazione B2B](troubleshoot.md)
- [Modello di fatturazione per Azure AD identità esterne](external-identities-pricing.md)
- [Aggiungere Google come provider di identità per utenti guest B2B](google-federation.md)
