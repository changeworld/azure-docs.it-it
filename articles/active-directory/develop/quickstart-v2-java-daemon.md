...
>
> 1. Passare al nuovo riquadro [Portale di Azure - Registrazioni app](https://portal.azure.com/?Microsoft_AAD_RegisteredApps=true#blade/Microsoft_AAD_RegisteredApps/applicationsListBlade/quickStartType/JavaDaemonQuickstartPage/sourceType/docs).
...
#### <a name="step-2-download-your-java-project"></a>Passaggio 2: scaricare il progetto Java
...
> [!div renderon="docs"]
> #### <a name="step-3-configure-your-java-project"></a>Passaggio 3: configurare il progetto Java
>
