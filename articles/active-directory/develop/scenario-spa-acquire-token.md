---
title: Acquisire un token per chiamare un'API Web (app a singola pagina) | Azure
...
Passare all'articolo successivo in questo scenario, [chiamando un'API Web](scenario-spa-call-api.md).