...
Quando si dispone di un tenant, testare l'accesso Single Sign-on e il [provisioning](../app-provisioning/use-scim-to-provision-users-and-groups.md#integrate-your-scim-endpoint-with-the-aad-scim-client). 
