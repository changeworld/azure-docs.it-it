---
title: "Esercitazione: Creare un'app della piattaforma UWP (Universal Windows Platform) che usa Microsoft Identity Platform per l'autenticazione | Azure"
titleSuffix: Microsoft identity platform
description: In questa esercitazione si creerà un'applicazione piattaforma UWP (Universal Windows Platform) che usa Microsoft Identity Platform per consentire l'accesso degli utenti e ottenere un token di accesso per chiamare l'API Microsoft Graph API per loro conto.
...
> [!Tip]
> Per visualizzare una versione completa del progetto creato in questa esercitazione, è possibile [scaricarlo da GitHub](https://github.com/Azure-Samples/active-directory-dotnet-native-uwp-v2/archive/msal3x.zip).
...
1. Tornare nel <a href="https://portal.azure.com/" target="_blank">portale di Azure</a>, quindi in **Gestisci**, selezionare **Autenticazione** > **Aggiungi una piattaforma** e poi **Applicazioni per dispositivi mobili e desktop**.
1. Nella sezione **URI di reindirizzamento** immettere `https://login.microsoftonline.com/common/oauth2/nativeclient`.
...
> [Panoramica di Microsoft Authentication Library (MSAL)](msal-overview.md)
