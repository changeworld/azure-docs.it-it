...
Quando si richiede un token, definire un ambito. L'ambito determina a quali dati può accedere l'app.
...
Passare all'articolo successivo in questo scenario, [chiamando un'API Web](scenario-mobile-call-api.md).