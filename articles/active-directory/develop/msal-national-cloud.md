...
1. Accedere al <a href="https://portal.azure.us/" target="_blank">portale di Azure</a>.
...
1. In **concessione implicita e flussi ibridi** selezionare **token ID** e **token di accesso**. I token ID e i token di accesso sono necessari perché l'app deve eseguire l'accesso degli utenti e chiamare un'API.
1. Selezionare **Salva**.
