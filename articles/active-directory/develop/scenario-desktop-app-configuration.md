...
I parametri di configurazione possono essere caricati da numerose origini, ad esempio un file JSON o dalle variabili di ambiente. Di seguito viene usato un file con *estensione ENV* . 
...
Caricare il file *. env* nelle variabili di ambiente. Il nodo MSAL può essere inizializzato almeno come indicato di seguito. Vedere le [Opzioni di configurazione](https://github.com/AzureAD/microsoft-authentication-library-for-js/blob/dev/lib/msal-node/docs/configuration.md)disponibili.  
