...
Dato che l'app Web ora chiama un'API Web downstream, fornire un segreto client o un certificato client nella *appsettings.jssu* file. È anche possibile aggiungere una sezione che specifichi:
