...
Al termine di questa guida, l'applicazione potrà accettare accessi di account personali, come quelli di outlook.com e live.com. Inoltre, gli account aziendali e dell'Istituto di istruzione di qualsiasi azienda o organizzazione integrata con la piattaforma di identità Microsoft potranno accedere all'app.
...
1. Nella sezione **concessione implicita e flussi ibridi** selezionare **token ID** e quindi fare clic su **Salva**.
...
Per ulteriori informazioni, vedere [autorizzazioni e consenso nella piattaforma di identità Microsoft](./v2-permissions-and-consent.md).
...
Per impostazione predefinita, quando si crea l'applicazione seguendo questa guida, questa potrà accettare accessi sia di account personali (ad esempio, outlook.com, live.com e altri) sia di account aziendali o di istituti di istruzione di proprietà di aziende o di organizzazioni che hanno eseguito l'integrazione con Microsoft Identity Platform. Si tratta di un'opzione consigliata per le applicazioni SaaS.
