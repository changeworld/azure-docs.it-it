---
title: Video su Microsoft Identity Platform | Azure
description: Elenco di video sulla moderna autenticazione e su Microsoft Identity Platform
...
ms.locfileid: "98116118"
---
# <a name="microsoft-identity-platform-videos"></a>Video su Microsoft Identity Platform

Informazioni sulle nozioni di base relative alla moderna autenticazione, alla piattaforma di Microsoft Identity e alle Microsoft Authentication Library (MSAL).

## <a name="microsoft-identity-platform-for-developers"></a>Microsoft Identity Platform per sviluppatori

Informazioni sui componenti e le funzionalità principali della piattaforma di identità Microsoft.

___

:::row:::
  :::column:::
        <a href="https://www.youtube.com/watch?v=tkQJSHFsduY" target="_blank">Nozioni di base sull'autenticazione moderna-piattaforma <span class="docon docon-navigate-external x-hidden-focus"></span> di identità Microsoft</a> (12:28)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=7_vxnHiUA1M" target="_blank">Autenticazione moderna: come è disponibile la piattaforma <span class="docon docon-navigate-external x-hidden-focus"></span> Microsoft Identity</a> (15:47)
    :::column-end:::
    :::column:::
...
:::row:::
  :::column:::
        <a href="https://www.youtube.com/watch?v=JpeMeTjQJ04" target="_blank">Panoramica: implementazione di Single Sign-on nelle applicazioni per dispositivi mobili- <span class="docon docon-navigate-external x-hidden-focus"></span> piattaforma di identità Microsoft</a> (20:30)
    :::column-end:::
    :::column:::
...
## <a name="developer-training-series"></a>Serie di formazione per sviluppatori

Nella serie di video Identity per sviluppatori, Matthijs Hoekstra e Kyle Marsh offrono un'introduzione guidata a Microsoft Identity Platform. Informazioni sui componenti e le funzionalità principali della piattaforma e su come usare le Authentication Library per iniziare ad aggiungere un'autenticazione moderna e sicura alle app.

Grazie al contenuto curato e affinato durante le numerose sessioni di training svolte, questa serie rappresenta un punto di partenza ideale per gli sviluppatori che si accingono a usare l'identità in Azure.
___

:::row:::
    :::column:::
        1- <a href="https://www.youtube.com/watch?v=zjezqZPPOfc&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=1" target="_blank">Panoramica della piattaforma di identità Microsoft per gli <span class="docon docon-navigate-external x-hidden-focus"></span> sviluppatori</a> (33:55)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        2- <a href="https://www.youtube.com/watch?v=Mtpx_lpfRLs&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=2" target="_blank">come autenticare gli utenti delle app con la piattaforma <span class="docon docon-navigate-external x-hidden-focus"></span> di identità Microsoft</a> (29:09)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3- <a href="https://www.youtube.com/watch?v=toAWRNqqDL4&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=3" target="_blank">Framework <span class="docon docon-navigate-external x-hidden-focus"></span> di consenso e autorizzazioni della piattaforma Microsoft identity</a> (45:08)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        4- <a href="https://www.youtube.com/watch?v=IIQ7QW4bYqA&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=4" target="_blank">come proteggere le API usando la piattaforma <span class="docon docon-navigate-external x-hidden-focus"></span> Microsoft identity</a> (33:17)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5- <a href="https://www.youtube.com/watch?v=-BK2iBDrmNo&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=5" target="_blank">ruoli applicazione e gruppi di sicurezza sulla piattaforma <span class="docon docon-navigate-external x-hidden-focus"></span> di identità Microsoft</a> (15:52)
    :::column-end:::
    :::column:::
...
Se non si ha familiarità con concetti quali provider di identità, token di sicurezza, attestazioni e destinatari, questa serie di video può essere utile per chiarire nozioni e componenti nell'autenticazione moderna.
___

:::row:::
    :::column:::
        1- <a href="https://www.youtube.com/watch?v=fbSVgC8nGz4&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=1" target="_blank">nozioni fondamentali: concetti di autenticazione <span class="docon docon-navigate-external x-hidden-focus"></span> moderna</a> (4:33)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        2- <a href="https://www.youtube.com/watch?v=tCNcG1lcCHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=2" target="_blank">autenticazione moderna per le applicazioni <span class="docon docon-navigate-external x-hidden-focus"></span> web</a> (6:02)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3- <a href="https://www.youtube.com/watch?v=51B-jSOBF8U&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=3" target="_blank">Single Sign-on <span class="docon docon-navigate-external x-hidden-focus"></span> Web</a> (4:13)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        4- <a href="https://www.youtube.com/watch?v=CjarTgjKcX8&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=4" target="_blank">autenticazione <span class="docon docon-navigate-external x-hidden-focus"></span> Web federata</a> (6:19)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5- <a href="https://www.youtube.com/watch?v=OGMDnuDrAcQ&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=5" target="_blank">applicazioni client native-parte 1 <span class="docon docon-navigate-external x-hidden-focus"></span> </a> (8:12)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        6- <a href="https://www.youtube.com/watch?v=2RE6IhXfmHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=6" target="_blank">applicazioni client native-parte 2 <span class="docon docon-navigate-external x-hidden-focus"></span> </a> (5:33)
    :::column-end:::
    :::column:::
...
## <a name="microsoft-identity-platform-basics"></a>Nozioni di base di Microsoft Identity Platform

Informazioni sui componenti di Microsoft Identity Platform, sulle Microsoft Authentication Library (MSAL) e sul modo in cui questi componenti interagiscono con Azure Active Directory. I video One Dev Question hanno una durata di 1-2 minuti.
___

:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=bNlcFuIo3r8" target="_blank">Panoramica della piattaforma di identità Microsoft <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=apbbx2n4tnU" target="_blank">Microsoft Graph e Microsoft Authentication Library (MSAL) <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=yLVEBU9Z96Q" target="_blank">Che cos'è la famiglia di librerie MSAL? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=eiPHOoLmGJs" target="_blank">Descrizione degli ambiti <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=Zd_Uubnu0U0" target="_blank">Cosa sono i broker <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=znSN_3JAuoU" target="_blank">Quali sono gli URI di Reindirizzamento <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=mDhT4Zv1fZU" target="_blank">Descrizione tenant <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=zDEC7A5ZS2Q" target="_blank">Ruolo di Azure AD <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=HEpq_YSmuWw" target="_blank">Ruolo degli oggetti app di Azure AD <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=E2OUluQQKSk" target="_blank">Differenze tra account Microsoft organizzative e personali <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=ZJirt7eTVw8" target="_blank">Differenze tra app Web e SPA <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=6R3W9T01gdE" target="_blank">Che cosa sono le autorizzazioni dell'applicazione rispetto alle autorizzazioni delegate? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=Gm6sALdXtpg" target="_blank">Che cos'è Microsoft Identity Platform OpenID Connect Certified? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=NrydwrckYaw" target="_blank">Quali sono i diversi tipi di app Azure Active Directory e come si confrontano? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=cZKgTqF4o88" target="_blank">Se si usa MSAL, quali concetti di protocollo essenziali è necessario conoscere? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=41vmzPdbfXM" target="_blank">Qual è la differenza tra i token ID, i token di accesso, i token di aggiornamento e i token di sessione? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=jEEwN7XAtUo" target="_blank">Qual è la relazione tra una richiesta di autorizzazione e i token? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=4pwuRYcZbz4" target="_blank">Quali aspetti dell'uso dei protocolli sono più semplici per le librerie MSAL? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
Informazioni sulla migrazione alla versione più recente di Microsoft Identity Platform, incluso il passaggio da Active Directory Authentication Library (ADAL) a MSAL.
___

:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=qpdC45tZYDg" target="_blank">Perché eseguire la migrazione da ADAL a MSAL <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        <a href="https://www.youtube.com/watch?v=xgL_z9yCnrE" target="_blank">Migrazione della codebase ADAL a MSAL <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=q-TDszj2O-4" target="_blank">Vantaggi di MSAL su ADAL <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=aBMUxC4evhU" target="_blank">Quali sono le differenze tra l'autenticazione V1 e V2? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
