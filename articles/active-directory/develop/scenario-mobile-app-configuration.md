...
## <a name="microsoft-libraries-supporting-mobile-apps"></a>Librerie Microsoft che supportano le app per dispositivi mobili
...
- [Aggiornare il manifesto Android](msal-net-xamarin-android-considerations.md#update-the-android-manifest-for-system-webview-support)
