...
| Valore | Obbligatorio | Description |
|:----- | :------: | :---------- |
| ID applicazione (client) | Obbligatorio | GUID che identifica in modo univoco l'applicazione all'interno della piattaforma di identità Microsoft. |
