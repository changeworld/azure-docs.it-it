...
- Tramite la sottoscrizione di Azure o Microsoft 365 esistente
...
## <a name="sign-up-using-your-existing-azure-or-microsoft-365-subscription"></a>Iscriversi usando la sottoscrizione di Azure o Microsoft 365 esistente
Gli abbonati Azure o Microsoft 365 possono acquistare le edizioni di Azure Active Directory Premium online. Per i passaggi dettagliati, vedere [Come acquistare Azure Active Directory Premium - Nuovi clienti](https://channel9.msdn.com/Series/Azure-Active-Directory-Videos-Demos/How-to-Purchase-Azure-Active-Directory-Premium-New-Customers).
