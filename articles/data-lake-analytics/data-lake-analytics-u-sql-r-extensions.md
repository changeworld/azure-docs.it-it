...
* Utilizzo di frame di dati denominati denominati `inputFromUSQL` e `outputToUSQL` rispettivamente per passare dati tra U-SQL e R. i nomi degli identificatori di frame di dati di input e output sono fissi, ovvero gli utenti non possono modificare questi nomi predefiniti di identificatori di frame di dati di input e output.
