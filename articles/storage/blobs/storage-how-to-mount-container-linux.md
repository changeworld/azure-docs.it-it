...
Blobfuse supporta l'installazione in Ubuntu 14,04, 16,04, 18,04 e 20,04. Eseguire questo comando per verificare che sia stata distribuita una di tali versioni:
```
lsb_release -a
```
