...
Per leggere le pagine, usare il metodo [PageBlobClient. download](/dotnet/api/azure.storage.blobs.specialized.blobbaseclient.downloadto) per leggere un intervallo di byte dal BLOB di pagine. 
