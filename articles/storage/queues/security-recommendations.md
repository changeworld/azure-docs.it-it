...
| Recommendation | Commenti | Centro sicurezza |
|-|----|--|
| Usare Azure Active Directory (Azure AD) per autorizzare l'accesso ai dati della coda | Azure AD offre sicurezza e facilità d'uso superiori rispetto all'autorizzazione chiave condivisa per l'autorizzazione delle richieste all'archiviazione code. Per altre informazioni, vedere [autorizzare l'accesso a BLOB e code di Azure usando Azure Active Directory](../common/storage-auth-aad.md). | - |
...
| Recommendation | Commenti | Centro sicurezza |
|-|----|--|
| Tenere traccia del modo in cui le richieste sono autorizzate | Abilitare la registrazione di archiviazione di Azure per tenere traccia del modo in cui ogni richiesta effettuata nell'archiviazione di Azure è stata autorizza I log indicano se una richiesta è stata effettuata in modo anonimo, usando un token OAuth 2,0, usando una chiave condivisa o usando una firma di accesso condiviso (SAS). Per altre informazioni, vedere [registrazione di analisi archiviazione di Azure](../common/storage-analytics-logging.md). | - |
