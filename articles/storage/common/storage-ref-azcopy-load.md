---
title: carico azcopy | Microsoft Docs
titleSuffix: Azure Storage
description: Questo articolo contiene informazioni di riferimento per il comando azcopy Load.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
...
Sottocomandi correlati al trasferimento di dati in formati specifici, ad esempio il formato CLFS (Microsoft havee cloud FileSystem).
...
|Opzione|Descrizione|
|--|--|
|-h, --help|Visualizza il contenuto della Guida per il comando Load.|
