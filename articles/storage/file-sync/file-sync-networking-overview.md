...
description: Informazioni su come configurare la rete per usare Sincronizzazione file di Azure per memorizzare nella cache i file in locale.
author: roygara
ms.service: storage
ms.topic: conceptual
ms.date: 04/13/2021
...
Per altre informazioni su come configurare Sincronizzazione file di Azure con un server proxy, vedere [Configurazione di Sincronizzazione file di Azure con un server proxy](file-sync-firewall-and-proxy.md).
...
Per altre informazioni su come usare l'API dei tag di servizio per recuperare gli indirizzi dei servizi, vedere [Elenco di elementi consentiti per gli indirizzi IP di Sincronizzazione file di Azure](file-sync-firewall-and-proxy.md#allow-list-for-azure-file-sync-ip-addresses).
...
Per creare un endpoint privato, vedere [Configurazione di endpoint privati per Sincronizzazione file di Azure](file-sync-networking-endpoints.md).
