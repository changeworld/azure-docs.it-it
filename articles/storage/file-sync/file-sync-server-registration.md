...
L'articolo seguente illustra come registrare e gestire un server con un servizio di sincronizzazione archiviazione. Per informazioni sulla distribuzione di Sincronizzazione file di Azure end-to-end, vedere [Come distribuire Sincronizzazione file di Azure](file-sync-deployment-guide.md).
...
* Il server deve eseguire una versione supportata di Windows Server. Per altre informazioni, vedere [Requisiti di sistema e interoperabilità di Sincronizzazione file di Azure](file-sync-planning.md#windows-file-server-considerations).
* Verificare che sia stato distribuito un servizio di sincronizzazione archiviazione. Per altre informazioni sulla distribuzione di un servizio di sincronizzazione archiviazione, vedere [Come distribuire Sincronizzazione file di Azure](file-sync-deployment-guide.md).
