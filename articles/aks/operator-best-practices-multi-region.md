...
Se si usa Managed Disks di Azure, sono disponibili alcune opzioni che è possibile usare per gestire la replica e il ripristino di emergenza. [Velero in Azure][velero] e [Kasten][kasten] eseguono il backup di soluzioni native a Kubernetes, ma non sono supportate.
