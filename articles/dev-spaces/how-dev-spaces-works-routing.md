...
Per un esempio di come Azure Dev Spaces usa il routing per fornire iterazioni e sviluppo rapidi, vedere [come funziona il debug remoto del codice con Azure Dev Spaces][how-it-works-remote-debugging].
