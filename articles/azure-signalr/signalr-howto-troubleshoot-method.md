...
Prima di tutto, è necessario verificare dalla portale di Azure quale [ServiceMode](./concept-service-mode.md) è il servizio Azure SignalR (noto anche come **ASRS**) configurato per.
...
L'acquisizione del traffico in corso è il modo più semplice per circoscrivere il problema. È possibile acquisire le [tracce di rete](/aspnet/core/signalr/diagnostics#network-traces) usando le opzioni descritte di seguito:

* [Raccogliere una traccia di rete con Fiddler](/aspnet/core/signalr/diagnostics#network-traces)

* [Raccogliere una traccia di rete con tcpdump](/aspnet/core/signalr/diagnostics#collect-a-network-trace-with-tcpdump-macos-and-linux-only)

* [Raccogliere una traccia di rete nel browser](/aspnet/core/signalr/diagnostics#collect-a-network-trace-in-the-browser)
...
Con la traccia della rete lato client, controllare la richiesta con esito negativo con il codice di stato e la risposta e cercare soluzioni nella [Guida alla risoluzione dei problemi](./signalr-howto-troubleshoot-guide.md).
...
* [Registrazione client JavaScript](/aspnet/core/signalr/diagnostics#javascript-client-logging)

* [Registrazione client .NET](/aspnet/core/signalr/diagnostics#net-client-logging)
...
* [Abilitazione della traccia nei client Windows Phone 8](/aspnet/signalr/overview/testing-and-debugging/enabling-signalr-tracing#enabling-tracing-in-windows-phone-8-clients)

* [Abilitazione della traccia nel client JavaScript](/aspnet/signalr/overview/testing-and-debugging/enabling-signalr-tracing#enabling-tracing-in-the-javascript-client)
...
È anche possibile [abilitare i log di diagnostica](./signalr-howto-diagnostic-logs.md) per il servizio Azure SignalR. questi log forniscono informazioni dettagliate su tutte le connessioni connesse al servizio Azure SignalR.
