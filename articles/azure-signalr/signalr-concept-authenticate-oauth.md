---
title: Guida all'autenticazione dei client del servizio Azure SignalR
description: Come implementare la propria autenticazione e integrarla con il servizio Azure SignalR seguendo l'esempio E2E.
author: sffamily
ms.service: signalr
ms.topic: conceptual
ms.date: 11/13/2019
...
- [Azure cloud Shell](/azure/cloud-shell/quickstart) configurata per l'ambiente bash.
...
4. Avviare una finestra del browser e passare a `http://localhost:5000`. Fare clic sul collegamento **qui** nella parte superiore per eseguire l'accesso con GitHub.
    ...
    ![Autorizzare l'app OAuth](media/signalr-concept-authenticate-oauth/signalr-authorize-oauth-app.png)
    ...
    ![Account identificato](media/signalr-concept-authenticate-oauth/signalr-oauth-account-identified.png)
...
> [Esempi dell'interfaccia della riga di comando di Azure SignalR](./signalr-reference-cli.md)
