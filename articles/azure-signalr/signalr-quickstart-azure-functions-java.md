...
- [Azure Functions Core Tools](https://github.com/Azure/azure-functions-core-tools#installing). Usato per eseguire le app Funzioni di Azure in locale.
   ...
   > [!NOTE]
   > Per installare le estensioni, Azure Functions Core Tools richiede che sia installato [.NET Core SDK](https://dotnet.microsoft.com/download). Tuttavia, non è necessaria alcuna conoscenza di .NET per compilare le app per le funzioni di Azure per JavaScript.
...
> [Creare la prima funzione con Java e Maven](../azure-functions/create-first-function-cli-csharp.md?pivots=programming-language-java%2cprogramming-language-java)
