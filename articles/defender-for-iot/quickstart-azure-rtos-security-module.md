...
description: Questa Guida introduttiva illustra come eseguire l'onboarding e abilitare il servizio Defender-RTO-micro-Agent per Azure nell'hub Azure.
