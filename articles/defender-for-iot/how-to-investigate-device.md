...
Il Defender per gli avvisi del servizio Internet fornisce indicazioni chiare quando si sospetta che i dispositivi Internet siano coinvolti in attività sospette o quando sono presenti indicazioni per la compromissione di un dispositivo.
...
Per impostazione predefinita, Defender per le cose archivia gli avvisi di sicurezza e le raccomandazioni nell'area di lavoro Log Analytics. È anche possibile scegliere di archiviare i dati di sicurezza non elaborati.
