...
- Per accedere al manuale dell'utente di CyberX dalla console di CyberX, selezionare :::image type="icon" source="media/references-horizon-api/profile-icon.png"::: e quindi selezionare **Scarica manuale dell'utente**.
