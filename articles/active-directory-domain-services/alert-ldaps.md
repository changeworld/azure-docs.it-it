...
1. Selezionare **+ Aggiungi** per creare una regola per la porta TCP 636. Se necessario, selezionare **Avanzate** nella finestra per creare una regola.
