...
Se necessario, è possibile [creare il gruppo di sicurezza di rete e le regole necessari usando Azure PowerShell](powershell-create-instance.md#create-a-network-security-group).
