...
![Screenshot del controllo per passare da un tenant all'altra nel portale di Azure Lab Services.](../media/multi-tenant-support/picker.png)

Dopo aver scelto un tenant di Azure AD, passare all'account Lab selezionando il controllo in alto a sinistra.
