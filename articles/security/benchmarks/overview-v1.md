---
title: Panoramica del benchmark di sicurezza di Azure V1
description: Panoramica di Azure Security benchmark V1
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
> [!NOTE]
> Il benchmark di sicurezza di Azure più aggiornato è disponibile [qui](overview.md).
