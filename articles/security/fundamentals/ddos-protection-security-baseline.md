...
Questa linea di base di sicurezza applica le linee guida del [benchmark di sicurezza di Azure versione 1,0](../benchmarks/overview-v1.md) ad Azure DDoS Protection standard. Azure Security Benchmark offre consigli sulla protezione delle soluzioni cloud in Azure. Il contenuto viene raggruppato in base ai **controlli di sicurezza** definiti dal benchmark di sicurezza di Azure e alle linee guida correlate applicabili a protezione DDoS di Azure standard. I **controlli** non applicabili a protezione DDoS di Azure standard, o per i quali la responsabilità è Microsoft, sono stati esclusi.

Per informazioni sul modo in cui la protezione DDoS di Azure standard è completamente mappata al benchmark di sicurezza di Azure, vedere il [file di mapping di base di protezione DDoS standard](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines)di Azure.
...
- [Informazioni su come accedere ai dati di telemetria, ai log e all'analisi degli attacchi per il servizio DDoS Protection standard](/azure/ddos-protection/telemetry-monitoring-alerting#configure-alerts-for-ddos-protection-metrics)
...
Inoltre, Azure Active Directory (Azure AD) dispone di ruoli predefiniti che devono essere assegnati in modo esplicito e possono essere sottoposte a query. Usare il modulo Azure AD PowerShell per eseguire query ad hoc per individuare gli account che sono membri di gruppi amministrativi.
...
- [Come abilitare Azure Active Directory Multi-Factor Authentication](../../active-directory/authentication/howto-mfa-getstarted.md)
...
**Linee guida**: usare una workstation protetta gestita da Azure con Azure Active Directory multi-factor authentication abilitata per l'accesso e la configurazione delle richieste di Customer Lockbox di Azure.

- [Distribuire una workstation protetta gestita da Azure](/security/compass/overview)
...
- [Informazioni sul rilevamento del rischio Azure AD](../../active-directory/identity-protection/overview-identity-protection.md)
...
**Linee guida**: usare le località denominate Azure Active Directory (Azure ad) per consentire l'accesso al portale di Azure solo da specifici raggruppamenti logici di intervalli di indirizzi IP o paesi/aree geografiche.
...
- [Gestisci RBAC di Azure in protezione DDoS di Azure](/azure/virtual-network/manage-ddos-protection)
