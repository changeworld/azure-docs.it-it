...
## <a name="wcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug"></a>WCF - non includere il nodo serviceDebug nel file di configurazione
...
## <a name="wcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata"></a>WCF - non includere il nodo serviceMetadata nel file di configurazione
...
## <a name="do-not-expose-security-details-in-error-messages"></a><a id="messages"></a>Non esporre informazioni di sicurezza nei messaggi di errore
...
## <a name="implement-default-error-handling-page"></a><a id="default"></a>Implementare la pagina di gestione degli errori predefiniti
...
| **Tecnologie applicabili** | Generico |
| **Attributes (Attributi)**              | N/D  |
| **Riferimenti**              | [Esito negativo in modo sicuro](https://owasp.org/www-community/Fail_securely) |
