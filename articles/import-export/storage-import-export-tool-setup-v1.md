...
* [Anteprima dell'uso del disco per un processo di esportazione](/previous-versions/azure/storage/common/storage-import-export-tool-previewing-drive-usage-export-v1)   
