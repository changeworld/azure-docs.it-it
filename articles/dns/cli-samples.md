---
title: Esempi dell'interfaccia della riga di comando per DNS - DNS di Azure
description: Con questo esempio usare l'interfaccia della riga di comando di Azure per creare zone e record DNS in DNS di Azure.
services: dns
author: rohinkoul
ms.service: dns
ms.topic: sample
