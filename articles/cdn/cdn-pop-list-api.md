...
description: Informazioni su come ottenere i server POP usando l'API REST. I server POP effettuano richieste ai server di origine associati agli endpoint della rete per la distribuzione di contenuti di Azure.
services: cdn
documentationcenter: ''
author: asudbring
manager: danielgi
...
Per la sintassi dell'operazione dell'API REST per il recupero dell'elenco POP, vedere [Edge Nodes - List](/rest/api/cdn/cdn/edgenodes/list) (Nodi perimetrali - Elenco).
...
Per informazioni sull'API REST, vedere [API REST della rete CDN di Azure](/rest/api/cdn/).