...
* [Azure CDN REST API reference: Pre-load content on an endpoint](/rest/api/cdn/cdn/endpoints/loadcontent) (Riferimento API REST della rete CDN di Azure: Precacaricare contenuto su un endpoint)
* [Azure CDN REST API reference: Pre-load content on an endpoint](/rest/api/cdn/cdn/endpoints/purgecontent) (Riferimento API REST della rete CDN di Azure: Ripulire contenuto da un endpoint)