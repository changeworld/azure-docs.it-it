---
title: Formato di telemetria del Publisher Microsoft OPC
description: Questo articolo fornisce una panoramica del file delle impostazioni di configurazione
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787553"
---
# <a name="opc-publisher-telemetry-format"></a>Formato di telemetria del server di pubblicazione OPC

Il server di pubblicazione OPC 2,6 e versioni successive supportano il formato JSON UA PubSub standardizzato, come specificato nella [parte 14 della specifica OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) e ha un aspetto simile al seguente:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Inoltre, tutte le versioni di OPC Publisher supportano un formato di telemetria JSON semplice e non standardizzato, che è compatibile con [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) e ha un aspetto simile al seguente:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Formato del file di configurazione della telemetria del Publisher OPC
```
