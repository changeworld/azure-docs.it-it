...
1. Quando gli aggiornamenti sono disponibili per il dispositivo, viene visualizzata una notifica. Selezionare la notifica o la barra dei comandi superiore, **Aggiorna dispositivo**. Questo consentirà di applicare gli aggiornamenti software del dispositivo.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con le opzioni panoramica e Aggiorna dispositivo riportate.](./media/data-box-gateway-apply-updates/portal-apply-update-01a.png)
...
3. Viene avviato il download degli aggiornamenti. Viene visualizzata una notifica che indica che il download è in corso.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con l'opzione panoramica e il banner di notifica di download degli aggiornamenti.](./media/data-box-gateway-apply-updates/portal-apply-update-08a.png)
...
4. Al termine del download, il banner di notifica viene aggiornato per indicare il completamento. Se si sceglie di scaricare e installare gli aggiornamenti, l'installazione verrà avviata automaticamente.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con l'opzione panoramica e il banner di notifica degli aggiornamenti scaricati chiamato.](./media/data-box-gateway-apply-updates/portal-apply-update-10a.png)
...
5. Viene visualizzata una notifica che indica che l'installazione è in corso.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con l'opzione panoramica e il messaggio di stato download e installazione denominato.](./media/data-box-gateway-apply-updates/portal-apply-update-12a.png)
...
6. Poiché si tratta di un dispositivo a 1 nodo, il dispositivo verrà riavviato dopo l'installazione degli aggiornamenti. L'avviso critico durante il riavvio indicherà che l'heartbeat del dispositivo è andato perso.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con l'opzione panoramica e il banner di notifica di avviso critico chiamato.](./media/data-box-gateway-apply-updates/portal-apply-update-19a.png)
...
7. Lo stato del dispositivo viene aggiornato a **online** dopo l'installazione degli aggiornamenti.
    ...
    ![Screenshot della Home page di Azure Data Box Gateway con l'opzione panoramica e lo stato online denominato out.](./media/data-box-gateway-apply-updates/portal-apply-update-23a.png)
