...
Servizi cloud (supporto esteso) fornisce due percorsi per la migrazione da [Service Manager di Azure](/powershell/azure/servicemanagement/overview) a [Azure Resource Manager](../azure-resource-manager/management/overview.md). 
