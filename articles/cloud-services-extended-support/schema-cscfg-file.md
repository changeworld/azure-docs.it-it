---
title: Schema di definizione di servizi cloud di Azure (supporto esteso) (file con estensione cscfg) | Microsoft Docs
description: Informazioni correlate allo schema di definizione per i servizi cloud (supporto esteso)
ms.topic: article
...
Il modello di servizio è descritto dallo [schema di definizione del servizio cloud (supporto esteso)](schema-csdef-file.md).
...
Per altre informazioni sulla configurazione dei ruoli in un servizio, vedere [Cos'è il modello del servizio cloud](../cloud-services/cloud-services-model-and-package.md).
