...
1. `GET` dettagli per un'istanza specifica del set di scalabilità di macchine virtuali.
    ...
    *Il codice seguente è stato semplificato per mostrare solo i parametri di rete per questo esempio.*
