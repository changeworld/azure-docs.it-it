...
Usare [az vmss update](/cli/azure/vmss#az_vmss_update) per applicare la protezione da riduzione all'istanza del set di scalabilità.
...
Usare il cmdlet [az vmss update](/cli/azure/vmss#az_vmss_update) per applicare la protezione dalle azioni del set di scalabilità all'istanza del set di scalabilità.
