...
Usare il cmdlet [Get-AzVmss](/powershell/module/az.compute/get-azvmss) con il parametro *InstanceView* per visualizzare il *ServiceState* per le riparazioni automatiche dell'istanza.
