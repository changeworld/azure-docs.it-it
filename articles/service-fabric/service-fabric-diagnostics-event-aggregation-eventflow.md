...
* `Microsoft.Diagnostics.EventFlow.Inputs.EventSource`per acquisire dati dalla classe EventSource del servizio e da EventSources standard, ad esempio *Microsoft-ServiceFabric-Services* e *Microsoft-ServiceFabric-Actors*
