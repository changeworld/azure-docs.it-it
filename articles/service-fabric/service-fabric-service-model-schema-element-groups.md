---
title: Modello di servizio di Azure Service Fabric XML Schema gruppi di elementi
description: Informazioni sui gruppi di elementi nell'XML Schema del modello di servizio di Azure Service Fabric.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "84700869"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Elementi XML Schema del modello di servizio Service Fabric

## <a name="partitiondescriptiongroup-group"></a>Gruppo PartitionDescriptionGroup
Definisce lo schema di partizione per un servizio.

|Attributo|Valore|
|---|---|
|contenuto|3 elementi|
...
## <a name="scalingpolicymechanismgroup-group"></a>Gruppo ScalingPolicyMechanismGroup
Definisce il meccanismo di ridimensionamento.

|Attributo|Valore|
|---|---|
|contenuto|2 elementi|
...
## <a name="scalingpolicytriggergroup-group"></a>Gruppo ScalingPolicyTriggerGroup
Definisce il trigger di ridimensionamento.
