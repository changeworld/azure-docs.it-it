...
* Se si prevede di usare PowerShell, [installare](/cli/azure/install-azure-cli) l'interfaccia della riga di comando di Azure per eseguire i comandi di riferimento cli.
...
Infine, aggiungere le `vmManagedIdentity` `userAssignedIdentities` proprietà e alla definizione del tipo di nodo del cluster gestito. Assicurarsi di usare **2021-01-01-Preview** o versione successiva per il `apiVersion` .
