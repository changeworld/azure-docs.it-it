...
Le rotture del servizio possono includere quanto segue:

- Versioni che *non* usano la modalità di **apertura** : il cluster resterà attivo, ma la modalità di **apertura** smetterà di funzionare, causando interruzioni del servizio per i carichi di lavoro.

- Versioni che *usano la modalità di* **apertura** : il cluster potrebbe non essere più disponibile e smetterà di funzionare, causando interruzioni del servizio per i carichi di lavoro.
...
| 7,2 RTO | 7.2.413.9590 | Non applicabile|
