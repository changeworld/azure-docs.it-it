...
Il nome del driver per il plug-in del volume File di Azure è **sfazurefile**. Questo valore è impostato per l'attributo **driver** dell'elemento tag del **volume** nel manifesto dell'applicazione.
