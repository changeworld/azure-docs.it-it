---
title: Eseguire query per gli eventi cluster usando le API EventStore
...
È anche possibile eseguire query su EventStore a livello di codice, tramite la [libreria client di Service Fabric](/dotnet/api/overview/azure/service-fabric#client-library).
...
Attualmente, gli eventi dei report sull'integrità per i servizi sono inclusi come eventi `DeployedServicePackageNewHealthReport` nell'entità applicazione corrispondente. Per visualizzare l'integrità dei servizi per "App1", usare la query seguente: `https://mycluster.cloudapp.azure.com:19080/EventsStore/Applications/myapp/$/Events?api-version=6.4&starttimeutc=2017-04-22T17:01:51Z&endtimeutc=2018-04-29T17:02:51Z&EventsTypesFilter=DeployedServicePackageNewHealthReport`
