...
Installare quindi il certificato nel cluster remoto usando gli [script di PowerShell forniti](./scripts/service-fabric-powershell-add-application-certificate.md).
