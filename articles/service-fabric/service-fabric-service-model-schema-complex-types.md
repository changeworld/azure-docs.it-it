---
title: Modello di servizio Service Fabric di Azure XML Schema tipi complessi
...
Questo valore definisce la protezione del valore dell'attributo. Può essere SecretsStoreRef/Encrypted/testo normale.
Se impostato su SecretsStoreRef, il valore fa riferimento a un segreto archiviato crittografato nel SecureStore del cluster, a cui viene fatto riferimento e decrittografato al momento dell'attivazione.
Se è impostato su crittografato, lo sviluppatore dell'applicazione è responsabile della creazione di un certificato e dell'utilizzo del cmdlet Invoke-ServiceFabricEncryptSecret per crittografare le informazioni riservate.
...
Tipo per la variabile di ambiente. Può essere testo normale/crittografato/SecretsStoreRef.
...
Descrive le informazioni di infrastruttura necessarie.
...
Questo valore definisce il tipo di password specificato nell'attributo ' password '. Può essere SecretsStoreRef/Encrypted/testo normale.
Se impostato su SecretsStoreRef, il valore di riferimento viene recuperato da SecretStore.
Se è impostato su crittografato, lo sviluppatore dell'applicazione è responsabile della creazione di un certificato e dell'utilizzo del cmdlet Invoke-ServiceFabricEncryptSecret per crittografare le informazioni riservate.
...
Diritti da concedere: lettura, modifica o completa. Il valore predefinito è Read.
