---
title: Tipi complessi di XML Schema del modello di servizio azure Service Fabric
...
|Attributo|Valore|
|---|---|
|contenuto|1 elemento, 1 attributo|
...
|Attributo|Valore|
|---|---|
|contenuto|2 elementi, 2 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|4 elementi, 1 attributo|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|9 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|4 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 3 attributi|
|defined|a livello globale|
|name|AzureRoleType|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 4 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|4 elementi, 3 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|3 elementi, 2 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 8 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 2 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|10 elementi, 8 attributi|
|defined|a livello globale|
...
Modalità di isolamento per il contenitore. I valori validi sono default, process o Hyper-V (supportato solo per i contenitori Windows).
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 1 attributo|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|1 elemento, 4 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|4 elementi, 10 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|2 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|3 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|2 elementi, 1 attributo|
|defined|a livello globale|
...
Questo valore definisce la protezione del valore dell'attributo. Può essere SecretsStoreRef/Encrypted/PlainText.
Se impostato su SecretsStoreRef, il valore fa riferimento a un segreto archiviato crittografato nell'securestore del cluster, che viene decrittografato e decrittografato all'attivazione.
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 6 attributi|
|defined|a livello globale|
...
Tipo per la variabile di ambiente. Può essere PlainText/Encrypted/SecretsStoreRef.
...
|Attributo|Valore|
|---|---|
|contenuto|1 elemento, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 5 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|21 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|1 elemento, 2 attributi|
|defined|a livello globale|
|name|FileStoreType|
...
Descrive le informazioni necessarie per l'infrastruttura.

|Attributo|Valore|
|---|---|
|contenuto|2 elementi, 7 attributi|
|defined|a livello globale|
...
Questo valore definisce il tipo di password specificato nell'attributo 'Password'. Può essere SecretsStoreRef/Encrypted/PlainText.
Se impostato su SecretsStoreRef, il valore di riferimento viene recuperato da SecretStore.
Se impostato su Encrypted, lo sviluppatore dell'applicazione è responsabile della creazione di un certificato e dell'uso del cmdlet Invoke-ServiceFabricEncryptSecret per crittografare le informazioni riservate.
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 12 attributi|
|defined|a livello globale|
...
Diritti da concedere: Lettura, Modifica o Completo. Il valore predefinito è Read.
...
|Attributo|Valore|
|---|---|
|contenuto|4 elementi, 2 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|11 elementi, 0 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|7 elementi, 1 attributo|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|11 elementi, 4 attributi|
|defined|a livello globale|
...
|Attributo|Valore|
|---|---|
|contenuto|5 elementi, 2 attributi|
|defined|a livello globale|
|name|ServiceType|
...
Dichiara i tag necessari per il posizionamento di un servizio. Utile per influenzare dinamicamente il posizionamento del servizio. 
...
Dichiara i tag necessari per il posizionamento e l'esecuzione di un servizio. Utile per influenzare dinamicamente il posizionamento e l'esecuzione del servizio. 
...
|Attributo|Valore|
|---|---|
|contenuto|0 elementi, 11 attributi|
|defined|a livello globale|
