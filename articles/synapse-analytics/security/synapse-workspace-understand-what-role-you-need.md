...
Creare un notebook o una definizione di processo|Utente sinapsi o </br>Proprietario, collaboratore o lettore di Azure nell'area di lavoro</br> *Per eseguire, pubblicare o eseguire il commit delle modifiche sono necessarie autorizzazioni aggiuntive*|leggere</br></br></br></br></br> 
...
Creare una pipeline |Utente sinapsi</br>*Per eseguire il debug, aggiungere trigger, pubblicare o eseguire il commit delle modifiche sono necessarie autorizzazioni sinapsi aggiuntive*|leggere
Creare un flusso di dati o un set di dati |Utente sinapsi</br>*Per pubblicare o eseguire il commit delle modifiche sono necessarie autorizzazioni sinapsi aggiuntive*|leggere
...
SERVIZI COLLEGATI|
Creare un servizio collegato (incluso l'assegnazione di una credenziale)|Utente sinapsi</br>*Sono necessarie autorizzazioni aggiuntive per usare un servizio collegato con credenziali oppure per pubblicare o eseguire il commit delle modifiche*|leggere
