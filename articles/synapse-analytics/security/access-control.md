...
description: Informazioni su come gestire il controllo di accesso per aree di lavoro, dati e pipeline in Azure Synapse Analytics.
...
ms.locfileid: "96461357"
---
# <a name="manage-access-to-workspaces-data-and-pipelines"></a>Gestire l'accesso ad aree di lavoro, dati e pipeline

Informazioni su come gestire il controllo di accesso per aree di lavoro, dati e pipeline in Azure Synapse Analytics.
