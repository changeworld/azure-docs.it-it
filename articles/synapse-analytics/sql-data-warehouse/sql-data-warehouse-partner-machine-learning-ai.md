---
title: Partner per Machine Learning e intelligenza artificiale
description: Elenchi di partner di apprendimento automatico e intelligenza artificiale di terze parti con soluzioni che supportano Azure sinapsi Analytics.
...
Questo articolo illustra i partner Microsoft con strumenti di apprendimento automatico e soluzioni di intelligenza artificiale che supportano l'analisi delle sinapsi di Azure.

## <a name="machine-learning-and-ai-partners"></a>Partner per Machine Learning e intelligenza artificiale
...
Per ulteriori informazioni su altri partner, vedere partner di [Business Intelligence](sql-data-warehouse-partner-business-intelligence.md), [partner di integrazione dei dati](sql-data-warehouse-partner-data-integration.md) e [partner gestione dati](sql-data-warehouse-partner-data-management.md).
