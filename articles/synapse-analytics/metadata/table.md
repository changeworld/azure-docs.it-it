...
description: Azure Synapse Analytics offre un modello di metadati condivisi per cui la creazione di una tabella nel pool di Apache Spark serverless la renderà accessibile dal pool SQL serverless e dal pool SQL dedicato senza duplicazione dei dati.
