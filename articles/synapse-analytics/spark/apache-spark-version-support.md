---
title: Supporto della versione di Apache Spark
description: Versioni supportate di Spark, scala, Python, .NET
...
Il servizio Apache Spark in Azure Synapse Analytics supporta vari runtime e servizi diversi. Questo documento elenca le versioni.

## <a name="spark-version"></a>Versione di Spark

Spark 2.4 è la versione attualmente supportata.

## <a name="operating-system-version"></a>Versione del sistema operativo

Apache Spark in Azure Synapse viene eseguito in Ubuntu versione 16.04.
...
Apache Spark in Azure Synapse include Scala 2.11.12
...
Apache Spark in Azure Synapse include un'installazione di Python versione 3.6.1

## <a name="scala-and-java-libraries"></a>Librerie Scala e Java
...
iperspazio-core_2.11-0.3.2. jar
...
sinapsi-Spark-telemetry_2.11-0.0.1. jar
...
azureml-pipeline-passaggi = = 1.16.0
...
azureml-Train-restclients-iperpropulsore = = 1.16.0
...
non ottimizzare = = 0.8.4

mleap = = 0.16.1

mlflow = = 1.11.0

altro-itertools = = 8.6.0
...
Prometeo-client = = 0.8.0

Prometeo-Flask-Exporter = = 0.18.1
...
Transformatori = = 3.4.0

digitato-AST = = 1.4.1

digitazione-Extensions = = 3.7.4.3
...
- [Concetti di Apache Spark](apache-spark-concepts.md)
