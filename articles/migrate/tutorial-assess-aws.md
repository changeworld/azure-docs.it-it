---
title: Valutare le istanze di AWS per la migrazione ad Azure con Azure Migrate
description: Informazioni su come accedere alle istanze di AWS per la migrazione ad Azure con Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Questo articolo illustra come valutare le istanze di Amazon Web Services (AWS) per la migrazione ad Azure usando lo strumento Azure Migrate: Discovery and Assessment.
...
- Assicurarsi che nelle istanze di AWS non sia in esecuzione Windows Server 2003 o SUSE Linux. La valutazione non è supportata per questi server.
