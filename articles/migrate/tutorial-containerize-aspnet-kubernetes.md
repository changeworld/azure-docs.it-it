---
title: Distribuire ASP.NET Applications e migrate to Azure Kubernetes Service
description: Informazioni su come distribuire le applicazioni ASP.NET ed eseguire la migrazione al servizio Azure Kubernetes.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
