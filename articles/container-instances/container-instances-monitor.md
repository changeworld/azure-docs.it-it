...
- **Utilizzo della CPU** misurato in **millicore**. 
  - Uno millicore è 1/1000 di un core CPU, quindi 500 millicore rappresenta l'utilizzo di 0,5 core CPU.
...
In un gruppo di contenitori che contiene più contenitori, usare una [dimensione][monitor-dimension] per visualizzare le metriche in base al contenitore. Per creare un grafico con le metriche di un singolo contenitore, eseguire la procedura seguente:
