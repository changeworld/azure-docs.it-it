...
Per verificare che l'immagine sia stata archiviata nel registro, eseguire il comando [az acr repository show](/cli/azure/acr/repository#az_acr_repository_show):
