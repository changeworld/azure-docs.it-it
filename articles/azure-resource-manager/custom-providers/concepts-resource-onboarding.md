...
L'endpoint deve rispondere con un'applicazione/JSON `Content-Type` e un corpo della risposta JSON valido. I campi restituiti nell'oggetto **Properties** di JSON verranno aggiunti alla risposta return dell'associazione.
