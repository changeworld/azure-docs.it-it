...
description: Questo articolo include script di esempio dell'interfaccia della riga di comando di Azure da usare con le applicazioni gestite di Azure.
author: tfitzmac
ms.topic: sample
ms.date: 10/25/2017
ms.author: tomfitz
