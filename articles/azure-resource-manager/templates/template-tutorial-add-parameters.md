...
description: Aggiungere parametri al modello di Azure Resource Manager (modello di ARM) per renderlo riutilizzabile.
author: mumian
ms.date: 03/31/2020
ms.topic: tutorial
ms.author: jgao
