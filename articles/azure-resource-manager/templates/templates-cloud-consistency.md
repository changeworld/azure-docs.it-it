...
1. Importare il modulo psm1 ed eseguire il cmdlet Test-AzureRmTemplateFunctions:
...
Le stesse modifiche si applicano anche ai [dischi di dati](../../virtual-machines/using-managed-disks-template-deployments.md).
...
* [Procedure consigliate per i modelli ARM](template-syntax.md)
