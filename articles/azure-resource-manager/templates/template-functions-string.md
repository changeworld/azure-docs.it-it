...
Per semplificare la concatenazione di stringhe, bicipite supporta una sintassi di [interpolazione di stringhe](https://en.wikipedia.org/wiki/String_interpolation#) .
