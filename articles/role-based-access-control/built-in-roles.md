...
> | **Web** |  |  |
> | [Collaboratore dati di Azure Maps](#azure-maps-data-contributor) | Concede l'accesso per l'accesso in lettura, scrittura ed eliminazione per eseguire il mapping dei dati correlati da un account Azure maps. | 8f5e0ce6-4f7b-4dcf-bddf-e6f48634a204 |
...
> | [Lettore dati cloud Spring di Azure](#azure-spring-cloud-data-reader) | Consenti l'accesso in lettura ai dati del cloud Spring di Azure | b5537268-8956-4941-a8f0-646150406f0c |
...
> | [CosmosRestoreOperator](#cosmosrestoreoperator) | È possibile eseguire un'azione di ripristino per Cosmos DB account di database con modalità di backup continuo | 5432c526-bc82-444a-b7ba-57c5b0b5b34f |
...
> | [Curatore dei dati di competenza](#purview-data-curator) | Il responsabile dati Microsoft. di competenza può creare, leggere, modificare ed eliminare oggetti dati del catalogo e stabilire relazioni tra oggetti. Questo ruolo è in anteprima e soggetto a modifiche. | 8a3c2885-9b38-4fd2-9d99-91af537c1347 |
> | [Lettore dati di competenza](#purview-data-reader) | Il lettore dati Microsoft. di competenza può leggere gli oggetti dati del catalogo. Questo ruolo è in anteprima e soggetto a modifiche. | ff100721-1b9d-43d8-af52-42b69c1272db |
> | [Amministratore origine dati di competenza](#purview-data-source-administrator) | L'amministratore dell'origine dati Microsoft. competenza può gestire le origini dati e le analisi dei dati. Questo ruolo è in anteprima e soggetto a modifiche. | 200bba9e-f0c8-430f-892b-6f0794863803 |
...
> | [Collaboratore Visione personalizzata di servizi cognitivi](#cognitive-services-custom-vision-contributor) | Accesso completo al progetto, inclusa la possibilità di visualizzare, creare, modificare o eliminare progetti. | c1ff6cc2-C111-46FE-8896-e0ef812ad9f3 |
> | [Distribuzione Visione personalizzata di servizi cognitivi](#cognitive-services-custom-vision-deployment) | Pubblica, Annulla la pubblicazione o Esporta modelli. La distribuzione può visualizzare il progetto, ma non aggiornarlo. | 5c4089e1-6d96-4d2f-b296-c1bc7137275f |
> | [Etichetta Visione personalizzata di servizi cognitivi](#cognitive-services-custom-vision-labeler) | Visualizzare, modificare le immagini di training e creare, aggiungere, rimuovere o eliminare i tag di immagine. Gli etichettatori possono visualizzare il progetto, ma non possono aggiornare nient'altro che i tag e le immagini di training. | 88424f51-ebe7-446f-bc41-7fa16989e96c |
> | [Lettore di Visione personalizzata di servizi cognitivi](#cognitive-services-custom-vision-reader) | Azioni di sola lettura nel progetto. I lettori non possono creare o aggiornare il progetto. | 93586559-C37d-4a6b-BA08-b9f0940c2d73 |
> | [Istruttore Visione personalizzata di servizi cognitivi](#cognitive-services-custom-vision-trainer) | Consente di visualizzare, modificare i progetti ed eseguire il training dei modelli, inclusa la possibilità di pubblicare, annullare la pubblicazione ed esportare i modelli. I trainer non possono creare o eliminare il progetto. | 0a5ae4ab-0d65-4eeb-be61-29fc9b54394b |
...
> | [Amministratore di metrica di servizi cognitivi](#cognitive-services-metrics-advisor-administrator) | Accesso completo al progetto, inclusa la configurazione a livello di sistema. | cb43c632-a144-4ec5-977c-e80c4affc34a |
> | [Editor QnA Maker di servizi cognitivi](#cognitive-services-qna-maker-editor) | Consente di creare, modificare, importare ed esportare un KB. Non è possibile pubblicare o eliminare una KB. | f4cc2bf9-21be-47a1-bdf1-5c5804381025 |
> | [Lettore di QnA Maker di servizi cognitivi](#cognitive-services-qna-maker-reader) | Consente di leggere e testare solo una KB. | 466ccd10-b268-4a11-b098-b4849f024126 |
...
> | **Internet delle cose** |  |  |
> | [Amministratore degli aggiornamenti del dispositivo](#device-update-administrator) | Consente l'accesso completo alle operazioni di gestione e contenuto | 02ca0879-e8e4-47a5-a61e-5c618b76e64a |
> | [Amministratore contenuto aggiornamento dispositivo](#device-update-content-administrator) | Consente l'accesso completo alle operazioni sul contenuto | 0378884a-3af5-44ab-8323-f5b22f9f3c98 |
> | [Lettore contenuto aggiornamento dispositivo](#device-update-content-reader) | Consente l'accesso in lettura alle operazioni sul contenuto, ma non consente di apportare modifiche | d1ee9a80-8b14-47f0-bdc2-f4a351625a7b |
> | [Amministratore delle distribuzioni degli aggiornamenti del dispositivo](#device-update-deployments-administrator) | Consente l'accesso completo alle operazioni di gestione | e4237640-0e3d-4a46-8fda-70bc94856432 |
> | [Lettore di distribuzioni di aggiornamenti del dispositivo](#device-update-deployments-reader) | Consente l'accesso in lettura alle operazioni di gestione, ma non consente di apportare modifiche | 49e2f5d2-7741-4835-8efa-19e1fe35e47f |
> | [Lettore di aggiornamento dispositivo](#device-update-reader) | Consente l'accesso in lettura alle operazioni di gestione e contenuto, ma non consente di apportare modifiche | e9dba6fb-3d52-4cf0-bce3-f06ce71b9e0f |
> | **Realtà mista** |  |  |
...
> | **Sicurezza** |  |  |
> | [Collaboratore attestazione](#attestation-contributor) | Può leggere scrivere o eliminare l'istanza del provider di attestazione | bbf86eb8-f7b4-4cce-96e4-18cddf81d86e |
> | [Lettore di attestazione](#attestation-reader) | Consente di leggere le proprietà del provider di attestazione | fd1bd22b-8476-40bc-a0bc-69b95687b9f3 |
> | [Collaboratore automazione sentinella di Azure](#azure-sentinel-automation-contributor) | Collaboratore automazione sentinella di Azure | f4c81013-99ee-4d62-a7ee-b3f1f648599a |
...
> | [Agente di crittografia Key Vault](#key-vault-crypto-officer) | Eseguire qualsiasi azione sulle chiavi di un insieme di credenziali delle chiavi, eccetto le autorizzazioni Manage. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | 14b46e9e-c2b7-41b4-b07b-48a6ebf60603 |
> | [Utente crittografia servizio Key Vault Crypto](#key-vault-crypto-service-encryption-user) | Legge i metadati delle chiavi ed esegue operazioni di wrapping/Unwrap. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | e147488a-f6f5-4113-8e2d-b22465e65bf6 |
> | [Utente di crittografia Key Vault](#key-vault-crypto-user) | Eseguire operazioni di crittografia usando chiavi. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | 12338af0-0e69-4776-bea7-57ae8d297424 |
> | [Lettore di Key Vault](#key-vault-reader) | Leggere i metadati di insiemi di credenziali delle chiavi e i relativi certificati, chiavi e segreti. Non è possibile leggere i valori sensibili come il contenuto del segreto o il materiale della chiave. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | 21090545-7ca7-4776-b22c-e363652d74d2 |
> | [Amministratore di Key Vault Secrets](#key-vault-secrets-officer) | Eseguire qualsiasi azione sui segreti di un insieme di credenziali delle chiavi, eccetto le autorizzazioni di gestione. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | b86a8fe4-44CE-4948-aee5-eccb2c155cd7 |
> | [Utente di Key Vault Secrets](#key-vault-secrets-user) | Leggere il contenuto del segreto. Funziona solo per gli insiemi di credenziali delle chiavi che usano il modello di autorizzazione "controllo degli accessi in base al ruolo di Azure". | 4633458b-17de-408a-b874-0445c86b69e6 |
> | [Collaboratore HSM gestito](#managed-hsm-contributor) | Consente di gestire i pool HSM gestiti, ma non di accedervi. | 18500a29-7fe2-46b2-a342-b16a415e101d |
...
> | [Ruolo utente cluster Kubernetes abilitato per Azure Arc](#azure-arc-enabled-kubernetes-cluster-user-role) | Azione elenca le credenziali utente del cluster. | 00493d72-78f6-4148-b6c5-d3ce8e4799dd |
> | [Amministratore di Azure Arc Kubernetes](#azure-arc-kubernetes-admin) | Consente di gestire tutte le risorse in cluster/spazio dei nomi, ad eccezione di Aggiorna o Elimina le quote e gli spazi dei nomi delle risorse. | dffb1e0c-446f-4dde-a09f-99eb5cc68b96 |
> | [Amministrazione cluster Azure Arc Kubernetes](#azure-arc-kubernetes-cluster-admin) | Consente di gestire tutte le risorse del cluster. | 8393591c-06b9-48a2-a542-1bd6b377f6a2 |
> | [Visualizzatore Azure Arc Kubernetes](#azure-arc-kubernetes-viewer) | Consente di visualizzare tutte le risorse in cluster/spazio dei nomi, eccetto i segreti. | 63f0a09d-1495-4db4-a681-037d84835eb4 |
> | [Azure Arc Kubernetes writer](#azure-arc-kubernetes-writer) | Consente di aggiornare tutti gli elementi in cluster/spazio dei nomi, eccetto i ruoli (cluster) e le associazioni di ruolo (cluster). | 5b999177-9696-4545-85c7-50de3797e5a1 |
...
> | [Operatore di richiesta di quota](#quota-request-operator) | Leggere e creare richieste di quota, ottenere lo stato della richiesta di quota e creare ticket di supporto. | 0e5f05e5-9ab9-446b-b98d-1e2157c94125 |
> | [Acquirente prenotazione](#reservation-purchaser) | Consente di acquistare prenotazioni | f7b75c60-3036-4b75-91c3-6b41c27c1689 |
...
> | [Collaboratore del gruppo di applicazioni di virtualizzazione desktop](#desktop-virtualization-application-group-contributor) | Collaboratore del gruppo di applicazioni di virtualizzazione desktop. | 86240b0e-9422-4c43-887b-b61143f32ba8 |
> | [Lettore del gruppo di applicazioni di virtualizzazione desktop](#desktop-virtualization-application-group-reader) | Lettore del gruppo di applicazioni di virtualizzazione desktop. | aebf23d0-b568-4e86-b8f9-fe83a2c6ab55 |
> | [Collaboratore di virtualizzazione desktop](#desktop-virtualization-contributor) | Collaboratore della virtualizzazione desktop. | 082f0a83-3be5-4ba1-904c-961cca79b387 |
> | [Collaboratore pool host di virtualizzazione desktop](#desktop-virtualization-host-pool-contributor) | Collaboratore del pool di host di virtualizzazione desktop. | e307426c-f9b6-4e81-87de-d99efb3c32bc |
> | [Lettore pool host di virtualizzazione desktop](#desktop-virtualization-host-pool-reader) | Lettore del pool di host di virtualizzazione desktop. | ceadfde2-b300-400a-ab7b-6143895aa822 |
...
> | [Operatore host sessione di virtualizzazione desktop](#desktop-virtualization-session-host-operator) | Operatore dell'host della sessione di virtualizzazione desktop. | 2ad6aaab-ead9-4eaa-8ac5-da422f562408 |
...
> | [Operatore di sessione utente di virtualizzazione desktop](#desktop-virtualization-user-session-operator) | Operatore della sessione uesr di virtualizzazione desktop. | ea4bfff8-7fb4-485a-aadd-d4129a0ffaa6 |
> | [Collaboratore area di lavoro Desktop Virtualization](#desktop-virtualization-workspace-contributor) | Collaboratore dell'area di lavoro di virtualizzazione desktop. | 21efdde3-836f-432b-bf3d-3e8e734d4b2b |
> | [Lettore area di lavoro di virtualizzazione desktop](#desktop-virtualization-workspace-reader) | Lettore dell'area di lavoro di virtualizzazione desktop. | 0fa44ee9-7a7d-466b-9bb2-2bf446b1204d |
> | [Lettore di backup su disco](#disk-backup-reader) | Fornisce le autorizzazioni per l'insieme di credenziali di backup per eseguire il backup su disco. | 3e5e47e6-65f7-47ef-90b5-e5dd4d455f24 |
> | [Operatore di ripristino disco](#disk-restore-operator) | Fornisce le autorizzazioni per l'insieme di credenziali di backup per eseguire il ripristino del disco. | b50d9833-a0cb-478e-945f-707fcc997c13 |
> | [Collaboratore snapshot del disco](#disk-snapshot-contributor) | Fornisce le autorizzazioni per l'insieme di credenziali di backup per gestire gli snapshot del disco. | 7efff54f-a5b4-42b5-a1c5-5411624893ce |
...
> | [Operatore Hub servizi](#services-hub-operator) | Operatore di hub servizi consente di eseguire tutte le operazioni di lettura, scrittura ed eliminazione correlate ai connettori dell'hub servizi. | 82200a5b-e217-47a5-b665-6d8765ee745b |
...
> | [Microsoft. Compute](resource-provider-operations.md#microsoftcompute)/Galleries/Share/Action | Condivide una raccolta con ambiti diversi |
> | **DataActions** |  |
> | *nessuna* |  |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
> | [Microsoft. RecoveryServices](resource-provider-operations.md#microsoftrecoveryservices)/Vaults/backupFabrics/protectionContainers/protectedItems/recoveryPoints/AccessToken/Action | Ottenere AccessToken per il ripristino tra aree. |
...
> | [Microsoft. RecoveryServices](resource-provider-operations.md#microsoftrecoveryservices)/locations/backupPreValidateProtection/Action |  |
> | [Microsoft. RecoveryServices](resource-provider-operations.md#microsoftrecoveryservices)/locations/backupValidateFeatures/Action | Convalida le funzioni |
> | [Microsoft. RecoveryServices](resource-provider-operations.md#microsoftrecoveryservices)/locations/backupAadProperties/Read | Ottenere le proprietà di AAD per l'autenticazione nella terza area per il ripristino tra più aree. |
...
> | [Microsoft. RecoveryServices](resource-provider-operations.md#microsoftrecoveryservices)/locations/backupCrossRegionRestore/Action | Attivare il ripristino tra più aree. |
...
### <a name="azure-maps-data-contributor"></a>Collaboratore dati di Azure Maps

Concede l'accesso per l'accesso in lettura, scrittura ed eliminazione per eseguire il mapping dei dati correlati da un account Azure maps. [Scopri di più](../azure-maps/azure-maps-authentication.md)
...
### <a name="azure-spring-cloud-data-reader"></a>Lettore dati cloud Spring di Azure

Consenti l'accesso in lettura ai dati del cloud Spring di Azure [altre informazioni](../spring-cloud/how-to-access-data-plane-azure-ad-rbac.md)
...
È possibile eseguire un'azione di ripristino per Cosmos DB account di database con modalità di backup continuo
...
> | [Microsoft.DocumentDB](resource-provider-operations.md#microsoftdocumentdb)/locations/restorableDatabaseAccounts/Read | Lettura di un account di database ripristinabile o elenco di tutti gli account di database ripristinabili |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
> | *nessuna* |  |
...
### <a name="purview-data-curator"></a>Curatore dei dati di competenza

Il responsabile dati Microsoft. di competenza può creare, leggere, modificare ed eliminare oggetti dati del catalogo e stabilire relazioni tra oggetti. Questo ruolo è in anteprima e soggetto a modifiche.

> [!div class="mx-tableFixed"]
> | Azioni | Descrizione |
> | --- | --- |
> | [Microsoft. competenze](resource-provider-operations.md#microsoftpurview)/Accounts/Read | Leggere la risorsa account per Microsoft. |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft. competenze](resource-provider-operations.md#microsoftpurview)/accounts/data/read | Leggere gli oggetti dati. |
> | [Microsoft. competenze](resource-provider-operations.md#microsoftpurview)/Accounts/Data/Write | Creazione, aggiornamento ed eliminazione di oggetti dati. |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
### <a name="purview-data-reader"></a>Lettore dati di competenza

Il lettore dati Microsoft. di competenza può leggere gli oggetti dati del catalogo. Questo ruolo è in anteprima e soggetto a modifiche.
...
### <a name="purview-data-source-administrator"></a>Amministratore origine dati di competenza

L'amministratore dell'origine dati Microsoft. competenza può gestire le origini dati e le analisi dei dati. Questo ruolo è in anteprima e soggetto a modifiche.
...
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft. competenze](resource-provider-operations.md#microsoftpurview)/accounts/Scan/Read | Leggere le origini dati e le analisi. |
> | [Microsoft. competenze](resource-provider-operations.md#microsoftpurview)/accounts/Scan/Write | Creazione, aggiornamento ed eliminazione di origini dati e gestione di analisi. |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
### <a name="cognitive-services-custom-vision-contributor"></a>Collaboratore Visione personalizzata di servizi cognitivi
...
### <a name="cognitive-services-custom-vision-deployment"></a>Distribuzione Visione personalizzata di servizi cognitivi

Pubblica, Annulla la pubblicazione o Esporta modelli. La distribuzione può visualizzare il progetto, ma non aggiornarlo. [Scopri di più](../cognitive-services/custom-vision-service/role-based-access-control.md)
...
### <a name="cognitive-services-custom-vision-labeler"></a>Etichetta Visione personalizzata di servizi cognitivi

Visualizzare, modificare le immagini di training e creare, aggiungere, rimuovere o eliminare i tag di immagine. Gli etichettatori possono visualizzare il progetto, ma non possono aggiornare nient'altro che i tag e le immagini di training. [Scopri di più](../cognitive-services/custom-vision-service/role-based-access-control.md)
...
> | **DataActions** |  |
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/CustomVision/*/Read |  |
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/CustomVision/Projects/Predictions/query/Action | Ottiene le immagini inviate all'endpoint di stima. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/CustomVision/Projects/tagsandregions/suggestions/Action | Questa API riceve i tag e le aree suggeriti per un array/batch di immagini senza tag insieme alle confidenze per i tag. Restituisce una matrice vuota se non viene trovato alcun tag. |
> | **NotDataActions** |  |
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/CustomVision/Projects/Export/Read | Esporta un progetto. |
...
### <a name="cognitive-services-custom-vision-reader"></a>Lettore di Visione personalizzata di servizi cognitivi
...
### <a name="cognitive-services-custom-vision-trainer"></a>Istruttore Visione personalizzata di servizi cognitivi

Consente di visualizzare, modificare i progetti ed eseguire il training dei modelli, inclusa la possibilità di pubblicare, annullare la pubblicazione ed esportare i modelli. I trainer non possono creare o eliminare il progetto. [Scopri di più](../cognitive-services/custom-vision-service/role-based-access-control.md)
...
### <a name="cognitive-services-metrics-advisor-administrator"></a>Amministratore di metrica di servizi cognitivi
...
### <a name="cognitive-services-qna-maker-editor"></a>Editor QnA Maker di servizi cognitivi

Consente di creare, modificare, importare ed esportare un KB. Non è possibile pubblicare o eliminare una KB. [Scopri di più](../cognitive-services/qnamaker/reference-role-based-access-control.md)
...
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker/KnowledgeBases/Read | Ottiene l'elenco di Knowledge base o i dettagli di un Knowledge base specifico. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker/KnowledgeBases/generateanswer/Action | Chiamata GenerateAnswer per eseguire una query sulla Knowledge base. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker/alterations/Read | Scarica le modifiche dal runtime. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker/endpointkeys/refreshkeys/Action | Genera nuovamente una chiave dell'endpoint. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker/endpointsettings/Write | Aggiornare l'endpoint seettings per un endpoint. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker.V2/KnowledgeBases/Read | Ottiene l'elenco di Knowledge base o i dettagli di un Knowledge base specifico. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker.V2/KnowledgeBases/generateanswer/Action | Chiamata GenerateAnswer per eseguire una query sulla Knowledge base. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker.V2/alterations/Read | Scarica le modifiche dal runtime. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/QnAMaker.V2/endpointsettings/Write | Aggiornare l'endpoint seettings per un endpoint. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/TextAnalytics/QnAMaker/KnowledgeBases/Read | Ottiene l'elenco di Knowledge base o i dettagli di un Knowledge base specifico. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/TextAnalytics/QnAMaker/KnowledgeBases/generateanswer/Action | Chiamata GenerateAnswer per eseguire una query sulla Knowledge base. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/TextAnalytics/QnAMaker/alterations/Read | Scarica le modifiche dal runtime. |
...
> | [Microsoft. CognitiveServices](resource-provider-operations.md#microsoftcognitiveservices)/accounts/TextAnalytics/QnAMaker/endpointsettings/Write | Aggiornare l'endpoint seettings per un endpoint. |
...
### <a name="cognitive-services-qna-maker-reader"></a>Lettore di QnA Maker di servizi cognitivi

Consente di leggere e testare solo una KB. [Scopri di più](../cognitive-services/qnamaker/reference-role-based-access-control.md)
...
### <a name="device-update-administrator"></a>Amministratore degli aggiornamenti del dispositivo

Consente di accedere in modo completo alle operazioni di gestione e contenuto ulteriori [informazioni](../iot-hub-device-update/device-update-control-access.md)
...
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Updates/Read | Esegue un'operazione di lettura relativa agli aggiornamenti |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Updates/Write | Esegue un'operazione di scrittura relativa agli aggiornamenti |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Updates/Delete | Esegue un'operazione di eliminazione relativa agli aggiornamenti |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Management/Read | Esegue un'operazione di lettura relativa alla gestione |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Management/Write | Esegue un'operazione di scrittura relativa alla gestione |
> | [Microsoft. DeviceUpdate](resource-provider-operations.md#microsoftdeviceupdate)/accounts/instances/Management/Delete | Esegue un'operazione di eliminazione relativa alla gestione |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
### <a name="device-update-content-administrator"></a>Amministratore contenuto aggiornamento dispositivo

Consente l'accesso completo alle operazioni sul contenuto [altre informazioni](../iot-hub-device-update/device-update-control-access.md)
...
### <a name="device-update-content-reader"></a>Lettore contenuto aggiornamento dispositivo

Consente l'accesso in lettura alle operazioni sul contenuto, ma non consente di apportare modifiche ulteriori [informazioni](../iot-hub-device-update/device-update-control-access.md)
...
### <a name="device-update-deployments-administrator"></a>Amministratore delle distribuzioni degli aggiornamenti del dispositivo

Consente di accedere in modo completo alle operazioni di gestione. [altre informazioni](../iot-hub-device-update/device-update-control-access.md)
...
### <a name="device-update-deployments-reader"></a>Lettore di distribuzioni di aggiornamenti del dispositivo

Consente l'accesso in lettura alle operazioni di gestione, ma non consente di apportare modifiche ulteriori [informazioni](../iot-hub-device-update/device-update-control-access.md)
...
### <a name="device-update-reader"></a>Lettore di aggiornamento dispositivo

Consente l'accesso in lettura alle operazioni di gestione e contenuto, ma non consente di apportare modifiche ulteriori [informazioni](../iot-hub-device-update/device-update-control-access.md)
...
> | --- | --- |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/*/Read | Leggere i ruoli e le assegnazioni di ruoli |
> | [Microsoft. EventGrid](resource-provider-operations.md#microsofteventgrid)/* | Creare e gestire le risorse di griglia di eventi |
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/alertRules/* | Creare e gestire un avviso classico per le metriche |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/Deployments/* | Creare e gestire una distribuzione |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
> | [Microsoft. support](resource-provider-operations.md#microsoftsupport)/* | Creare e aggiornare un ticket di supporto |
...
> | --- | --- |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/*/Read | Leggere i ruoli e le assegnazioni di ruoli |
> | [Microsoft. EventGrid](resource-provider-operations.md#microsofteventgrid)/eventSubscriptions/* | Creazione e gestione di sottoscrizioni di eventi regionali |
...
Il ruolo consente all'utente o all'entità di accesso completo ai dati di FHIR [altre informazioni](../healthcare-apis/fhir/configure-azure-rbac.md)
...
Il ruolo consente all'utente o all'entità di leggere ed esportare i dati di FHIR [altre informazioni](../healthcare-apis/fhir/configure-azure-rbac.md)
...
Il ruolo consente all'utente o all'entità di leggere i dati di FHIR [altre informazioni](../healthcare-apis/fhir/configure-azure-rbac.md)
...
Il ruolo consente all'utente o all'entità di leggere e scrivere i dati di FHIR [altre informazioni](../healthcare-apis/fhir/configure-azure-rbac.md)
...
È possibile leggere scrivere o eliminare l'istanza del provider di attestazione ulteriori [informazioni](../attestation/quickstart-powershell.md)
...
È possibile leggere le proprietà del provider di attestazioni [ulteriori informazioni](../attestation/troubleshoot-guide.md)
...
### <a name="azure-sentinel-automation-contributor"></a>Collaboratore automazione sentinella di Azure

Collaboratore di automazione sentinella di Azure [altre informazioni](../sentinel/roles.md)
...
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/myworkbooks/Read | Leggi una cartella di lavoro privata |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/*/Read | Leggere i ruoli e le assegnazioni di ruoli |
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/alertRules/* | Creare e gestire un avviso classico per le metriche |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/Deployments/* | Creare e gestire una distribuzione |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
...
### <a name="key-vault-administrator"></a>Amministratore Key Vault
...
### <a name="key-vault-certificates-officer"></a>Ufficiale certificati Key Vault
...
### <a name="key-vault-crypto-officer"></a>Agente di crittografia Key Vault
...
### <a name="key-vault-crypto-service-encryption-user"></a>Utente crittografia servizio Key Vault Crypto
...
> | [Microsoft. EventGrid](resource-provider-operations.md#microsofteventgrid)/eventSubscriptions/Write | Creare o aggiornare un oggetto eventSubscription |
> | [Microsoft. EventGrid](resource-provider-operations.md#microsofteventgrid)/eventSubscriptions/Read | Leggere un oggetto eventSubscription |
> | [Microsoft. EventGrid](resource-provider-operations.md#microsofteventgrid)/eventSubscriptions/Delete | Eliminare un sottoscrizione evento |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
...
> | [Microsoft./Vaults/Keys/wrap/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Esegue il wrapping di una chiave simmetrica con una chiave Key Vault. Si noti che se la chiave di Key Vault è asimmetrica, questa operazione può essere eseguita dalle entità con accesso in lettura. |
> | [Microsoft./Vaults/Keys/Unwrap/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Annullare il wrapping di una chiave simmetrica con una chiave Key Vault. |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
### <a name="key-vault-crypto-user"></a>Utente di crittografia Key Vault
...
> | [Microsoft./Vaults/Keys/backup/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Crea il file di backup di una chiave. Il file può essere usato per ripristinare la chiave in un Key Vault della stessa sottoscrizione. Potrebbero essere applicate le restrizioni. |
> | [Microsoft./Vaults/Keys/Encrypt/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Crittografa il testo non crittografato con una chiave. Si noti che, se la chiave è asimmetrica, questa operazione può essere eseguita dalle entità con accesso in lettura. |
> | [Microsoft./Vaults/Keys/Decrypt/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Decrittografa il testo crittografato con una chiave. |
> | [Microsoft./Vaults/Keys/wrap/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Esegue il wrapping di una chiave simmetrica con una chiave Key Vault. Si noti che se la chiave di Key Vault è asimmetrica, questa operazione può essere eseguita dalle entità con accesso in lettura. |
> | [Microsoft./Vaults/Keys/Unwrap/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Annullare il wrapping di una chiave simmetrica con una chiave Key Vault. |
> | [Microsoft./Vaults/Keys/Sign/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Firma un digest del messaggio (hash) con una chiave. |
> | [Microsoft./Vaults/Keys/Verify/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Verifica la firma di un digest del messaggio (hash) con una chiave. Si noti che, se la chiave è asimmetrica, questa operazione può essere eseguita dalle entità con accesso in lettura. |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
### <a name="key-vault-reader"></a>Lettore di Key Vault
...
### <a name="key-vault-secrets-officer"></a>Amministratore di Key Vault Secrets
...
### <a name="key-vault-secrets-user"></a>Utente di Key Vault Secrets
...
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft./Vaults/Secrets/getSecret/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Ottiene il valore di un segreto. |
> | [Microsoft./Vaults/Secrets/readMetadata/Action Vault](resource-provider-operations.md#microsoftkeyvault) | Elencare o visualizzare le proprietà di un segreto ma non il relativo valore. |
> | **NotDataActions** |  |
> | *nessuna* |  |
...
Consente di gestire i pool HSM gestiti, ma non di accedervi. [Scopri di più](../key-vault/managed-hsm/secure-your-managed-hsm.md)
...
> | [Microsoft. Security](resource-provider-operations.md#microsoftsecurity)/iotDefenderSettings/packageDownloads/Action | Ottiene informazioni sui pacchetti scaricabili di Internet Information Defender |
> | [Microsoft. Security](resource-provider-operations.md#microsoftsecurity)/iotDefenderSettings/downloadManagerActivation/Action | File di attivazione di download manager con dati quota di sottoscrizione |
> | [Microsoft. Security](resource-provider-operations.md#microsoftsecurity)/iotSensors/downloadResetPassword/Action | Download del file di reimpostazione della password per i sensori Internet |
> | [Microsoft. Management](resource-provider-operations.md#microsoftmanagement)/managementGroups/Read | Elenca i gruppi di gestione per l'utente autenticato. |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
...
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/generateLiveToken/Read | Token get di metriche attive |
...
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/Topology/Read | Lettura topologia |
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/Transactions/Read | Transazioni di lettura |
...
### <a name="azure-arc-enabled-kubernetes-cluster-user-role"></a>Ruolo utente cluster Kubernetes abilitato per Azure Arc

Azione elenca le credenziali utente del cluster.
...
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/Read | Ottiene l'elenco delle sottoscrizioni. |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/listClusterUserCredentials/Action | Elencare le credenziali clusterUser |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/*/Read | Leggere i ruoli e le assegnazioni di ruoli |
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/alertRules/* | Creare e gestire un avviso classico per le metriche |
> | [Microsoft. support](resource-provider-operations.md#microsoftsupport)/* | Creare e aggiornare un ticket di supporto |
> | **NotActions** |  |
...
### <a name="azure-arc-kubernetes-admin"></a>Amministratore di Azure Arc Kubernetes

Consente di gestire tutte le risorse in cluster/spazio dei nomi, ad eccezione di Aggiorna o Elimina le quote e gli spazi dei nomi delle risorse. [Scopri di più](../azure-arc/kubernetes/azure-rbac.md)
...
> | *nessuna* |  |
> | **DataActions** |  |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Apps/controllerrevisions/Read | Legge controllerrevisions |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Events.K8S.io/Events/Read | Letture eventi |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Events/Read | Letture eventi |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/limitranges/Read | Legge limitranges |
...
### <a name="azure-arc-kubernetes-cluster-admin"></a>Amministrazione cluster Azure Arc Kubernetes

Consente di gestire tutte le risorse del cluster. [Scopri di più](../azure-arc/kubernetes/azure-rbac.md)
...
### <a name="azure-arc-kubernetes-viewer"></a>Visualizzatore Azure Arc Kubernetes

Consente di visualizzare tutte le risorse in cluster/spazio dei nomi, eccetto i segreti. [Scopri di più](../azure-arc/kubernetes/azure-rbac.md)
...
> | **DataActions** |  |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Apps/controllerrevisions/Read | Legge controllerrevisions |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Apps/daemonsets/Read | Legge gli elementi daemonset |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Apps/ReplicaSets/Read | Legge ReplicaSets |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Apps/statefulsets/Read | Legge statefulsets |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/configmaps/Read | Legge configmaps |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Events.K8S.io/Events/Read | Letture eventi |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Events/Read | Letture eventi |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Extensions/daemonsets/Read | Legge gli elementi daemonset |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Extensions/ingresses/Read | Letture in ingresso |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Extensions/ReplicaSets/Read | Legge ReplicaSets |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/limitranges/Read | Legge limitranges |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/Namespaces/Read | Legge gli spazi dei nomi |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/networking.K8S.io/ingresses/Read | Letture in ingresso |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/networking.K8S.io/networkpolicies/Read | Legge networkpolicies |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/pods/Read | Esegue la lettura di Pod |
...
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/replicationcontrollers/Read | Legge replicationcontrollers |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/replicationcontrollers/Read | Legge replicationcontrollers |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/resourcequotas/Read | Legge resourcequotas |
> | [Microsoft. Kubernetes](resource-provider-operations.md#microsoftkubernetes)/connectedClusters/ServiceAccounts/Read | Legge ServiceAccounts |
...
Consente di aggiornare tutti gli elementi in cluster/spazio dei nomi, eccetto i ruoli (cluster) e le associazioni di ruolo (cluster). [Scopri di più](../azure-arc/kubernetes/azure-rbac.md)
...
> | [Microsoft. HybridCompute](resource-provider-operations.md#microsofthybridcompute)/privateLinkScopes/Read | Leggi tutti i privateLinkScopes di Azure Arc |
...
### <a name="quota-request-operator"></a>Operatore di richiesta di quota
...
> | Azioni | Descrizione |
> | --- | --- |
> | [Microsoft. Capacity](resource-provider-operations.md#microsoftcapacity)/resourceProviders/locations/serviceLimits/Read | Ottenere il limite di servizio o la quota corrente della risorsa e della località specificate |
> | [Microsoft. Capacity](resource-provider-operations.md#microsoftcapacity)/resourceProviders/locations/serviceLimits/Write | Crea il limite di servizio o la quota per la risorsa e il percorso specificati |
...
### <a name="reservation-purchaser"></a>Acquirente prenotazione

Consente di acquistare prenotazioni [ulteriori informazioni](../cost-management-billing/reservations/prepare-buy-reservation.md)
...
> | [Microsoft. consumer](resource-provider-operations.md#microsoftconsumption)/Register/Action | Esegue la registrazione nel provider di risorse Consumption |
> | [Microsoft. Capacity](resource-provider-operations.md#microsoftcapacity)/Catalogs/Read | Legge il catalogo delle prenotazioni |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/roleAssignments/Read | Ottiene informazioni su un'assegnazione di ruolo. |
> | [Microsoft. consumer](resource-provider-operations.md#microsoftconsumption)/reservationRecommendations/Read | Elenca le raccomandazioni singole o condivise relative alle istanze riservate per una sottoscrizione. |
> | [Microsoft. support](resource-provider-operations.md#microsoftsupport)/supporttickets/Write | Consente di creare e aggiornare un ticket di supporto |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
> | *nessuna* |  |
...
### <a name="desktop-virtualization-application-group-contributor"></a>Collaboratore del gruppo di applicazioni di virtualizzazione desktop

Collaboratore del gruppo di applicazioni di virtualizzazione desktop. [Scopri di più](../virtual-desktop/rbac.md)

> [!div class="mx-tableFixed"]
> | Azioni | Descrizione |
> | --- | --- |
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/applicationgroups/* |  |
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/hostpools/Read | Leggi hostpools |
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/hostpools/sessionhosts/Read | Lettura di hostpools/sessionhosts |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/Deployments/* | Creare e gestire una distribuzione |
> | [Microsoft. Authorization](resource-provider-operations.md#microsoftauthorization)/*/Read | Leggere i ruoli e le assegnazioni di ruoli |
> | [Microsoft. Insights](resource-provider-operations.md#microsoftinsights)/alertRules/* | Creare e gestire un avviso classico per le metriche |
...
### <a name="desktop-virtualization-application-group-reader"></a>Lettore del gruppo di applicazioni di virtualizzazione desktop
...
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/applicationgroups/Read | Leggi applicationgroups |
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/hostpools/Read | Leggi hostpools |
> | [Microsoft. DesktopVirtualization](resource-provider-operations.md#microsoftdesktopvirtualization)/hostpools/sessionhosts/Read | Lettura di hostpools/sessionhosts |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/Deployments/Read | Ottiene o elenca le distribuzioni. |
...
Collaboratore della virtualizzazione desktop. [Scopri di più](../virtual-desktop/rbac.md)
...
### <a name="desktop-virtualization-host-pool-contributor"></a>Collaboratore pool host di virtualizzazione desktop
...
### <a name="desktop-virtualization-host-pool-reader"></a>Lettore pool host di virtualizzazione desktop
...
Operatore dell'host della sessione di virtualizzazione desktop. [Scopri di più](../virtual-desktop/rbac.md)
...
### <a name="desktop-virtualization-user-session-operator"></a>Operatore di sessione utente di virtualizzazione desktop
...
### <a name="desktop-virtualization-workspace-contributor"></a>Collaboratore area di lavoro Desktop Virtualization

Collaboratore dell'area di lavoro di virtualizzazione desktop. [Scopri di più](../virtual-desktop/rbac.md)
...
### <a name="desktop-virtualization-workspace-reader"></a>Lettore area di lavoro di virtualizzazione desktop

Lettore dell'area di lavoro di virtualizzazione desktop. [Scopri di più](../virtual-desktop/rbac.md)
...
### <a name="disk-backup-reader"></a>Lettore di backup su disco

Fornisce le autorizzazioni per l'insieme di credenziali di backup per eseguire il backup su disco. [Scopri di più](../backup/disk-backup-faq.md)
...
### <a name="disk-restore-operator"></a>Operatore di ripristino disco

Fornisce le autorizzazioni per l'insieme di credenziali di backup per eseguire il ripristino del disco. [Scopri di più](../backup/restore-managed-disks.md)
...
### <a name="disk-snapshot-contributor"></a>Collaboratore snapshot del disco

Fornisce le autorizzazioni per l'insieme di credenziali di backup per gestire gli snapshot del disco. [Scopri di più](../backup/backup-managed-disks.md)
...
Operatore di hub servizi consente di eseguire tutte le operazioni di lettura, scrittura ed eliminazione correlate ai connettori dell'hub servizi. [Scopri di più](/services-hub/health/sh-connector-roles)
...
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/subscriptions/resourceGroups/Read | Ottiene o elenca i gruppi di risorse. |
> | [Microsoft. resources](resource-provider-operations.md#microsoftresources)/Deployments/* | Creare e gestire una distribuzione |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/Connectors/Write | Creare o aggiornare un connettore di hub servizi |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/Connectors/Read | Visualizzare o elencare i connettori dell'hub servizi |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/Connectors/Delete | Elimina connettori hub servizi |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/Connectors/checkAssessmentEntitlement/Action | Elenca i diritti di valutazione per un'area di lavoro dell'hub servizi specificata |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/supportOfferingEntitlement/Read | Visualizzare i diritti dell'offerta di supporto per un'area di lavoro di hub servizi specificata |
> | [Microsoft. ServicesHub](resource-provider-operations.md#microsoftserviceshub)/Workspaces/Read | Elencare le aree di lavoro dell'hub servizi per un determinato utente |
> | **NotActions** |  |
> | *nessuna* |  |
> | **DataActions** |  |
> | *nessuna* |  |
