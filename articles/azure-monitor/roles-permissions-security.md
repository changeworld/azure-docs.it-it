...
* Visualizzare le regole di avviso definite in [Avvisi di Azure](alerts/alerts-overview.md)
* Eseguire query per le metriche usando l'[API REST di Monitoraggio di Azure](/rest/api/monitor/metrics), i [cmdlet di PowerShell](powershell-samples.md) o l'[interfaccia della riga di comando multipiattaforma](cli-samples.md).
...
* Visualizzare le [impostazioni di diagnostica](essentials/diagnostic-settings.md) per una risorsa.
* Visualizzare il [profilo di registro](essentials/activity-log.md#legacy-collection-methods) per una sottoscrizione.
...
* Configurare le [impostazioni di diagnostica](essentials/diagnostic-settings.md) per una risorsa.\*
* Impostare il [profilo di registro](essentials/activity-log.md#legacy-collection-methods) per una sottoscrizione.\*
* Configurare le attività e le impostazioni delle regole di avviso tramite [Avvisi di Azure](alerts/alerts-overview.md).
