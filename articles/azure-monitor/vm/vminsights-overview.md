...
- [Creare Log Analytics area di lavoro.](../insights/vminsights-configure-workspace.md#create-log-analytics-workspace)
- [Aggiungere la soluzione VMInsights all'area di lavoro.](../insights/vminsights-configure-workspace.md#add-vminsights-solution-to-workspace)
- [Installare gli agenti nella macchina virtuale e nel set di scalabilità di macchine virtuali da monitorare.](../insights/vminsights-enable-overview.md)



## <a name="next-steps"></a>Passaggi successivi

- Vedere [distribuire monitoraggio di Azure per le macchine virtuali](../insights/vminsights-enable-overview.md) per i requisiti e i metodi che consentono il monitoraggio delle macchine virtuali.
