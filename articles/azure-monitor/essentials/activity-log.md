...
![Elenco di cronologia modifiche per un evento](media/activity-log/change-history-event.png)
...
![Pagina della cronologia delle modifiche che mostra le differenze](media/activity-log/change-history-event-details.png)
...
3. Fare clic su **Impostazioni di diagnostica**.
   ...
   ![Impostazioni di diagnostica](media/activity-log/diagnostic-settings.png)

4. Fare clic sul banner viola per l'esperienza legacy.

    ![Esperienza legacy](media/activity-log/legacy-experience.png)
...
1. Fare clic sulla sottoscrizione che si desidera connettere.
    ...
    ![Screenshot Mostra Log Analytics area di lavoro con un log attività di Azure selezionato.](media/activity-log/workspaces.png)

2. Fare clic su **Connetti** per connettere il log attività nella sottoscrizione all'area di lavoro selezionata. Se la sottoscrizione è già connessa a un'altra area di lavoro, fare clic su **Disconnetti** prima per disconnetterla.

    ![Connettere le aree di lavoro](media/activity-log/connect-workspace.png)
...
![Riquadro Log attività di Azure](media/activity-log/azure-activity-logs-tile.png)
...
![Dashboard Log attività di Azure](media/activity-log/activity-log-dash.png)
