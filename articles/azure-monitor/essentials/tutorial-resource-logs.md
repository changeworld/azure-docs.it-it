...
6. Per un'esercitazione sulla scrittura di query su log, vedere [Introduzione alle query su log in Monitoraggio di Azure](../logs/get-started-queries.md).
...
> [Introduzione alle query su log in Monitoraggio di Azure](../logs/get-started-queries.md)