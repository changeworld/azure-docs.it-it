...
![Screenshot che illustra come aprire la selezione dell'ambito delle risorse.](./media/metrics-dynamic-scope/019.png)
...
![Screenshot che mostra un menu di risorse compatibili con più risorse.](./media/metrics-dynamic-scope/020.png)
...
![Screenshot che illustra come selezionare più risorse.](./media/metrics-dynamic-scope/021.png)
...
![Screenshot che illustra come eseguire una query su più gruppi di risorse.](./media/metrics-dynamic-scope/022.png)

Selezionare un tipo di risorsa e un percorso. 

![Screenshot che mostra i gruppi di risorse selezionati.](./media/metrics-dynamic-scope/023.png)

È possibile espandere gli ambiti selezionati per verificare le risorse alle quali si applicano le selezioni.

![Screenshot che mostra le risorse selezionate all'interno dei gruppi.](./media/metrics-dynamic-scope/024.png)
...
![Screenshot che illustra come usare la suddivisione per visualizzare la percentuale di CPU tra le macchine virtuali.](./media/metrics-dynamic-scope/026.png)
...
![Screenshot che illustra come filtrare in base al gruppo di risorse.](./media/metrics-dynamic-scope/027.png)

## <a name="pin-multiple-resource-charts"></a>Aggiungere grafici a più risorse 

Per i grafici a più risorse che visualizzano le metriche tra gruppi di risorse e sottoscrizioni, è necessario che l'utente disponga dell'autorizzazione *monitoraggio lettura* a livello di sottoscrizione. Assicurarsi che tutti gli utenti dei dashboard a cui vengono aggiunti i grafici a più risorse dispongano di autorizzazioni sufficienti. Per altre informazioni, vedere [assegnare i ruoli di Azure usando il portale di Azure](../../role-based-access-control/role-assignments-portal.md).

Per aggiungere il grafico a più risorse a un dashboard, vedere [aggiunta ai dashboard](../essentials/metrics-charts.md#pinning-to-dashboards). 

## <a name="next-steps"></a>Passaggi successivi

* [Risolvere i problemi di Esplora metriche](../essentials/metrics-troubleshoot.md)
