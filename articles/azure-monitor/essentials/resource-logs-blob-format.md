...
* Questa modifica interessa i tipi di dati seguenti:
  ...
  * [Metriche delle risorse di Azure esportate da impostazioni di diagnostica](../essentials/diagnostic-settings.md)
...
![Pannello Impostazioni di diagnostica di Monitoraggio di Azure](media/resource-logs-blob-format/portal-diag-settings.png)
...
![Account di archiviazione abilitato](media/resource-logs-blob-format/portal-storage-enabled.png)
