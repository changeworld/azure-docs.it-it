...
![Screenshot del portale di Azure che mostra "aree di lavoro log analytics" nella casella di ricerca e le aree di lavoro Log Analytics evidenziate in Servizi.](../logs/media/quick-create-workspace/azure-portal-01.png)
