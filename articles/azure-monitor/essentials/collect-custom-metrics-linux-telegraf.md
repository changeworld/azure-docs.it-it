...
> [!NOTE]  
> Le metriche personalizzate non sono supportate in tutte le aree. Le aree supportate sono elencate [qui](./metrics-custom-overview.md#supported-regions)
