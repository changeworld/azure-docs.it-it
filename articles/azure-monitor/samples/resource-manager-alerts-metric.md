...
Questo articolo fornisce esempi dell'uso di [modelli di Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md) per configurare le [regole di avviso delle metriche](../platform/alerts-metric-near-real-time.md) in Monitoraggio di Azure. Ogni esempio include un file modello e un file di parametri con valori di esempio da fornire al modello.
