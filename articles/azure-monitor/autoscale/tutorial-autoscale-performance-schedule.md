---
title: Scalabilità automatica delle risorse di Azure in base ai dati o alla pianificazione
...
Per altre informazioni sulle impostazioni di scalabilità automatica procedere con la [panoramica sulla scalabilità automatica](../autoscale/autoscale-overview.md).

> [!div class="nextstepaction"]
> [Archiviare i dati di monitoraggio](../essentials/platform-logs-overview.md)
