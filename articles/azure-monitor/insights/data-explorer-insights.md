---
title: Monitorare il cluster di Azure Esplora dati con monitoraggio di Azure per Esplora dati di Azure (anteprima) | Microsoft Docs
...
ms.locfileid: "97901730"
---
# <a name="monitoring-your-azure-data-explorer-cluster-with-azure-monitor-for-azure-data-explorer-preview"></a>Monitoraggio del cluster di Azure Esplora dati con monitoraggio di Azure per Esplora dati di Azure (anteprima)
...
![Screenshot dell'esperienza di panoramica con più grafici](./media/data-explorer-insights/insights-hub.png)
...
![Screenshot della scheda prestazioni query](./media/data-explorer-insights/query-performance.png)
...
[![Screenshot della scheda prestazioni inserimento](./media/data-explorer-insights/ingestion-performance.png)](./media/data-explorer-insights/ingestion-performance.png#lightbox)
...
![Screenshot del pulsante blu che Visualizza il testo "Abilita log per il monitoraggio"](./media/data-explorer-insights/enable-logs.png)
...
[![Screenshot della visualizzazione da una risorsa cluster di Azure Esplora dati](./media/data-explorer-insights/overview.png)](./media/data-explorer-insights/overview.png#lightbox)
...
[![Screenshot della visualizzazione errori](./media/data-explorer-insights/key-metrics.png)](./media/data-explorer-insights/key-metrics.png#lightbox)
...
[![Screenshot della visualizzazione delle operazioni con grafici ad anello dell'applicazione principale per numero di comandi e query, principali entità per comando e conteggio di query e comandi principali in base ai tipi di comando](./media/data-explorer-insights/usage.png)](./media/data-explorer-insights/usage.png#lightbox)

[![Screenshot della visualizzazione operazioni con grafici a linee del numero di query per applicazione, memoria totale per applicazione e CPU totale per applicazione](./media/data-explorer-insights/usage-2.png)](./media/data-explorer-insights/usage-2.png#lightbox)
...
[![Schermata dei dettagli della cache](./media/data-explorer-insights/cache-tab.png)](./media/data-explorer-insights/cache-tab.png#lightbox)
...
![Screenshot dell'icona della puntina da disegno selezionata](./media/data-explorer-insights/pin.png)
...
![Screenshot del pulsante personalizza](./media/data-explorer-insights/customize.png)
...
![Screenshot della raccolta di cartelle di lavoro](./media/data-explorer-insights/gallery.png)
...
### <a name="why-do-i-not-see-any-data-for-my-azure-data-explorer-cluster-under-the-usage-tables-or-cache-sections"></a>Perché non vengono visualizzati dati per il cluster di Esplora dati Azure nelle sezioni utilizzo, tabelle o cache
