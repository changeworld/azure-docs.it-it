...
|---|---|---|
| [Agenti di Windows](../agents/agent-windows.md) | Sì | La soluzione raccoglie informazioni su capacità e prestazioni dagli agenti Windows. |
| [Agenti Linux](../vm/quick-collect-linux-computer.md) | No    | La soluzione non raccoglie informazioni su capacità e prestazioni dagli agenti Linux diretti.|
| [Gruppo di gestione SCOM](../agents/om-agents.md) | Sì |La soluzione raccoglie dati su capacità e prestazioni dagli agenti in un gruppo di gestione SCOM connesso. Non è necessaria una connessione diretta dall'agente SCOM a Log Analytics.|
| [Account di archiviazione di Azure](../essentials/resource-logs.md#send-to-log-analytics-workspace) | No | Archiviazione di Azure non include dati di capacità e prestazioni.|
...
- Aggiungere la soluzione Capacità e prestazioni all'area di lavoro Log Analytics usando la procedura descritta nell'articolo [Aggiungere soluzioni di Log Analytics dalla Raccolta soluzioni](./solutions.md).
...
* Per visualizzare informazioni dettagliate su capacità e prestazioni, usare [Ricerche log in Log Analytics](../logs/log-query-overview.md).
