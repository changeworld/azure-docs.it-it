...
Monitoraggio di Azure per le reti può visualizzare le risorse solo per cinque sottoscrizioni alla volta. 

### <a name="how-do-i-make-changes-or-add-visualizations-to-azure-monitor-for-networks"></a>Ricerca per categorie apportare modifiche o aggiungere visualizzazioni a monitoraggio di Azure per le reti?
...
Il monitoraggio di Azure per le reti usa il tempo di granularità **automatico** , quindi l'intervallo di tempo è basato sull'intervallo di tempo selezionato.
...
### <a name="what-if-i-want-to-see-other-data-or-make-my-own-visualizations-how-can-i-make-changes-to-azure-monitor-for-networks"></a>È possibile vedere altri dati o creare visualizzazioni personali? Come è possibile apportare modifiche a monitoraggio di Azure per le reti?
