---
title: Informazioni dettagliate sulla rete di monitoraggio di Azure
description: Panoramica di Azure monitor network Insights, che offre una visualizzazione completa dell'integrità e delle metriche per tutte le risorse di rete distribuite senza alcuna configurazione.
ms.topic: conceptual
author: KumudD
ms.author: kumud
ms.date: 11/25/2020
...
[![Screenshot che mostra i risultati della ricerca di Azure monitor network Insights.](media/network-insights-overview/search.png)](media/network-insights-overview/search.png#lightbox)
...
![Screenshot che mostra l'integrità delle risorse e le metriche in monitoraggio di Azure Network Insights.](media/network-insights-overview/resource-health.png)

Se si selezionano le connessioni ER e VPN non disponibili, verrà visualizzata una visualizzazione metrica: 

![Screenshot che mostra la visualizzazione delle metriche in monitoraggio di Azure Network Insights.](media/network-insights-overview/metric-view.png)
...
![Sreenshot che mostra la visualizzazione del gateway applicazione in Azure monitor network Insights.](media/network-insights-overview/application-gateway.png)
...
[![Screenshot che mostra la visualizzazione delle dipendenze in monitoraggio di Azure Network Insights.](media/network-insights-overview/dependency-view.png)](media/network-insights-overview/dependency-view.png#lightbox)
...
![Screenshot che mostra il menu visualizzazione dipendenze in Azure monitor network Insights.](media/network-insights-overview/dependency-view-menu.png)
...
![Screenshot che mostra un esempio di ricerca in Azure monitor network Insights.](media/network-insights-overview/search-example.png)
...
![Screenshot che mostra la scheda connettività in monitoraggio di Azure Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tab.png)
...
[![Screenshot che mostra i test di connettività in Azure monitor network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png#lightbox)

È possibile selezionare qualsiasi riquadro di origine o di destinazione per aprire una visualizzazione metrica:

[![Screenshot che mostra le metriche di connettività in monitoraggio di Azure Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png#lightbox)
...
[![Screenshot che mostra la scheda traffico in Azure monitoraggio Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png#lightbox)
...
[![Screenshot che mostra la visualizzazione dell'area di traffico in monitoraggio di Azure Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png#lightbox)
...
Questa sezione consente di diagnosticare e risolvere alcuni problemi comuni che possono verificarsi quando si usa Azure monitor network Insights. 
...
Per informazioni sulla risoluzione dei problemi correlati alla rete identificati con Azure monitor network Insights, vedere la documentazione sulla risoluzione dei problemi per la risorsa non funzionante. 
...
Azure monitor network Insights può visualizzare le risorse solo per cinque sottoscrizioni alla volta. 

### <a name="how-do-i-make-changes-or-add-visualizations-to-azure-monitor-network-insights"></a>Ricerca per categorie apportare modifiche o aggiungere visualizzazioni a Network Insights di monitoraggio di Azure?
...
Azure monitor network Insights usa il fuso orario **automatico** , quindi l'intervallo di tempo è basato sull'intervallo di tempo selezionato.
...
### <a name="what-if-i-want-to-see-other-data-or-make-my-own-visualizations-how-can-i-make-changes-to-azure-monitor-network-insights"></a>È possibile vedere altri dati o creare visualizzazioni personali? Come è possibile apportare modifiche a Azure monitor network Insights?
