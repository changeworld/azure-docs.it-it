...
|Orchestrazione Docker | ACS | Linux | Windows | Contenitore<br>Argomento | Immagine<br>Argomento | Nodo<br>Argomento | Contenitore<br>Prestazioni | Contenitore<br>Event | Event<br>Log | Contenitore<br>Log |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
| Kubernetes | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; | &#8226; |
...
2. Installare e usare Docker con un agente di Log Analytics. In base al sistema operativo e all'agente di orchestrazione Docker, è possibile usare i metodi seguenti per configurare l'agente.
   - Per gli host autonomi:
     - Nei sistemi operativi Linux supportati installare ed eseguire Docker, quindi installare e configurare l'[agente di Log Analytics per Linux](../vm/quick-collect-linux-computer.md).  
...
- Per altre informazioni e per la procedura di installazione dell'agente di Log Analytics per Linux, vedere [Panoramica dell'agente di Log Analytics](../agents/log-analytics-agent.md).
...
* [Installare l'agente di log Analytics per Linux](../vm/quick-collect-linux-computer.md) direttamente in ogni nodo OpenShift  
* [Abilitare l'estensione della macchina virtuale di Log Analytics](../vm/quick-collect-azurevm.md) in ogni nodo OpenShift che risiede in Azure  
...
Per abilitare il monitoraggio dei contenitori Windows e Hyper-V, installare Microsoft Monitoring Agent (MMA) nei computer Windows che sono host del contenitore. Per i computer che eseguono Windows nell'ambiente locale, vedere [connettere computer Windows a monitoraggio di Azure](../agents/agent-windows.md). Per le macchine virtuali in esecuzione in Azure, connetterle a monitoraggio di Azure usando l' [estensione della macchina virtuale](../vm/quick-collect-azurevm.md).

È possibile monitorare i contenitori Windows in esecuzione in Service Fabric. Solo le [macchine virtuali in esecuzione in Azure](../vm/quick-collect-azurevm.md) e i [computer che eseguono Windows nell'ambiente locale](../agents/agent-windows.md), tuttavia, sono attualmente supportati da Service Fabric.
...
- [Agente di Log Analytics per Linux](../vm/quick-collect-linux-computer.md)
- [Agente di Windows](../agents/agent-windows.md)
- [Estensione della macchina virtuale Log Analytics](../vm/quick-collect-azurevm.md)
...
A questo punto è possibile modificare la query di ricerca per trovare specifiche informazioni di interesse. Per altre informazioni sulle query di log, vedere [query di log in monitoraggio di Azure](../logs/log-query-overview.md).
...
[Log di query](../logs/log-query-overview.md) per visualizzare i record dettagliati dei dati del contenitore.
