...
Attualmente non è disponibile un'interfaccia utente del portale per la creazione delle risorse del modello di cartella di lavoro. l'unico modo per crearli è [tramite Azure Resource Manager le distribuzioni](../visualize/workbooks-automate.md)del modello ARM. Di conseguenza, il modo più semplice per spostare un modello consiste nel riutilizzare il modello ARM precedente e aggiornarlo in modo che venga distribuito nella nuova area.
