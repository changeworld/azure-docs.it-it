...
[Documentazione di Azure Resource Graph](../../governance/resource-graph/overview.md)
...
6. Impostare facoltativamente `Include only resource types` su _Application Insights_
7. Scegliere ' Salva ' dalla barra degli strumenti per creare il parametro.
