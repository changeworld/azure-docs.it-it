...
* I clienti con un contratto di supporto tecnico di Azure possono aprire una richiesta di supporto nel [portale di Azure](https://azure.microsoft.com/support/options/).
...
| --- | --- |
| NOT_DEFINED | Poiché le dipendenze necessarie non sono installate, il plug-in auoms controllato non verrà installato. L'installazione di auoms non è riuscita. Installare il pacchetto auditd. |
...
2. Installare l'agente seguendo queste [istruzioni](../vm/quick-collect-linux-computer.md).
