...
* Un [agente log Analytics per Windows](../agents/agent-windows.md) configurato per la segnalazione alla stessa area di lavoro degli agenti che comunicano tramite il gateway
...
[Aggiungere origini dati](./../agents/agent-data-sources.md) per raccogliere dati da origini connesse e archiviare i dati nell'area di lavoro log Analytics.
