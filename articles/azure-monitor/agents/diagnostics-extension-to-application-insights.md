...
![Configurazione pubblica di Diagnostica](media/diagnostics-extension-to-application-insights/AzDiag_Channels_App_Insights.png)
...
![Configurazione dei sink di diagnostica con Application Insights](media/diagnostics-extension-to-application-insights/Azure_Diagnostics_Sinks.png)
