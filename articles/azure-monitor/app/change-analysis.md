...
## <a name="enable-change-analysis-at-scale-for-web-app-in-guest-file-and-environment-variable-changes"></a>Abilitare l'analisi delle modifiche su larga scala per le modifiche alle variabili di ambiente e di file nel Guest app Web
