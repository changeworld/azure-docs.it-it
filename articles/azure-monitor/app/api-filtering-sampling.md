...
L'inizializzatore di esempio seguente legge i dati da [`HttpContext`](/aspnet/core/fundamentals/http-context) e li aggiunge a un' `RequestTelemetry` istanza di. `IHttpContextAccessor`Viene fornito automaticamente tramite l'inserimento di dipendenze del costruttore.
