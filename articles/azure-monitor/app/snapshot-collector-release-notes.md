...
Per segnalazioni di bug e commenti e suggerimenti, aprire un problema in GitHub all'indirizzo https://github.com/microsoft/ApplicationInsights-SnapshotCollector
...
- La destinazione netcoreapp 3.0 dipende ora da Microsoft. ApplicationInsights. AspNetCore >= 2.1.1 (in precedenza >= 2.1.2).
