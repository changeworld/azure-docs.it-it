...
| context.user.authAcquisitionDate |string |[Utente autenticato](./api-custom-events-metrics.md#authenticated-users) |
...
| Percorso | Type | Note |
| --- | --- | --- |
| event [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
...
| basicException [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
...
| remoteDependency [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
...
| Percorso | Type | Note |
| --- | --- | --- |
| request [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
...
| Percorso | Type | Note |
| --- | --- | --- |
| view [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
...
| availability [0] count |numero intero |100/(frequenza di[campionamento](./sampling.md) ). Ad esempio, 4 =&gt; 25%. |
