...
1. Abilitare Application Insights e Profiler in startup. cs:
...
Per altre opzioni di distribuzione, vedere la [documentazione del servizio app](../../app-service/index.yml).
