...
> [!NOTE]
> A partire dalla versione 3.0.1-BETA, se si aggiunge una dimensione personalizzata denominata `service.version` , il valore verrà archiviato nella `application_Version` colonna della tabella Application Insights logs anziché come dimensione personalizzata.
...
A partire dalla versione 3.0.1-BETA. 2, i dati di telemetria raccolti automaticamente specifici possono essere eliminati usando le opzioni di configurazione seguenti:
