...
> [!NOTE]
> Se al logger viene passata un'eccezione, il messaggio di log (e l'eccezione) verrà visualizzato nel portale di Azure sotto la `exceptions` tabella anziché nella `traces` tabella.
