...
>[!NOTE]
> Con il supporto delle [query tra risorse](../logs/cross-workspace-query.md), la soluzione di gestione Connettore di Application Insights non è più necessaria. È stata quindi deprecata e rimossa da Azure Marketplace, insieme al portale OMS che è stato deprecato il 15 gennaio 2019 per il cloud commerciale di Azure. Verrà ritirata il 30 marzo 2019 dal cloud Azure US Government.
>
...
| --- | --- | --- |
| [Agenti di Windows](./../agents/agent-windows.md) | No | La soluzione non raccoglie le informazioni dagli agenti di Windows. |
| [Agenti Linux](../vm/quick-collect-linux-computer.md) | No | La soluzione non raccoglie le informazioni dagli agenti di Linux. |
| [Gruppo di gestione SCOM](../agents/om-agents.md) | No | La soluzione non raccoglie le informazioni dagli agenti in un gruppo di gestione SCOM connesso. |
| [Account di archiviazione di Azure](../essentials/resource-logs.md#send-to-log-analytics-workspace) | No | La soluzione non raccoglie le informazioni da Archiviazione di Azure. |
...
- Eccezioni
- Requests
- Visualizzazioni di pagine: per l'area di lavoro per la ricezione di visualizzazioni di pagina, è necessario configurare le app per raccogliere tali informazioni. Per altre informazioni, vedere [PageViews](../app/api-custom-events-metrics.md#page-views).
- Eventi personalizzati: per l'area di lavoro per la ricezione di eventi personalizzati, è necessario configurare le app per raccogliere tali informazioni. Per altre informazioni, vedere [TrackEvent](../app/api-custom-events-metrics.md#trackevent).
