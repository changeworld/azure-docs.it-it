...
L'esempio seguente aggiunge una raccolta di [eventi di Windows](../agents/data-sources-windows-events.md) a un'area di lavoro esistente.
...
L'esempio seguente aggiunge una raccolta di [eventi syslog](../agents/data-sources-syslog.md) a un'area di lavoro esistente.
...
L'esempio seguente aggiunge una raccolta di [contatori delle prestazioni di Windows](../agents/data-sources-performance-counters.md) a un'area di lavoro esistente.
...
L'esempio seguente aggiunge una raccolta di [contatori delle prestazioni di Linux](../agents/data-sources-performance-counters.md) a un'area di lavoro esistente.
...
L'esempio seguente aggiunge una raccolta di [log personalizzati](../agents/data-sources-custom-logs.md) a un'area di lavoro esistente.

### <a name="notes"></a>Note

- La configurazione di delimitatori ed estrazioni può essere complessa. Per semplificarla, è possibile definire un log personalizzato usando il portale di Azure e recuperare la relativa configurazione usando [Get-AzOperationalInsightsDataSource](/powershell/module/az.operationalinsights/get-azoperationalinsightsdatasource) con **-Kind** impostato su **CustomLog**.
...
L'esempio seguente aggiunge una raccolta di [log IIS](../agents/data-sources-iis-logs.md) a un'area di lavoro esistente.
