...
![Panoramica dell'app per la logica](media/logs-export-logic-app/logic-app-overview.png)
...
![Creare l'app per la logica](media/logs-export-logic-app/create-logic-app.png)
...
![Azione di ricorrenza](media/logs-export-logic-app/recurrence-action.png)
...
![Azione log di monitoraggio di Azure](media/logs-export-logic-app/select-azure-monitor-connector.png)

Fare clic su **log Analytics di Azure: eseguire query ed elencare i risultati**.

![Screenshot di una nuova azione aggiunta a un passaggio nella finestra di progettazione dell'app per la logica. Log di monitoraggio di Azure è evidenziato in scegliere un'azione.](media/logs-export-logic-app/select-query-action-list.png)
...
![Screenshot delle impostazioni per la nuova azione log di monitoraggio di Azure denominata Esegui query e visualizza risultati.](media/logs-export-logic-app/run-query-list-action.png)
...
![Selezionare l'attività analizza JSON](media/logs-export-logic-app/select-parse-json.png)
...
[![Selezionare il corpo](media/logs-export-logic-app/select-body.png)](media/logs-export-logic-app/select-body.png#lightbox)
...
![Analizza payload JSON](media/logs-export-logic-app/parse-json-payload.png)
...
![Selezionare l'azione Componi](media/logs-export-logic-app/select-compose.png)
...
[![Selezionare il corpo per l'azione Componi](media/logs-export-logic-app/select-body-compose.png)](media/logs-export-logic-app/select-body-compose.png#lightbox)
...
![Selezionare Crea BLOB](media/logs-export-logic-app/select-create-blob.png)
...
[![Espressione BLOB](media/logs-export-logic-app/blob-expression.png)](media/logs-export-logic-app/blob-expression.png#lightbox)
...
![Crea espressione BLOB](media/logs-export-logic-app/create-blob.png)
...
[![Cronologia esecuzioni](media/logs-export-logic-app/runs-history.png)](media/logs-export-logic-app/runs-history.png#lightbox)
...
[![Dati BLOB](media/logs-export-logic-app/blob-data.png)](media/logs-export-logic-app/blob-data.png#lightbox)
