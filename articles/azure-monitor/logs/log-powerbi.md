...
:::image type="content" source="media/log-powerbi/export-query2.png" alt-text="Log Analytics query che mostra l'opzione di esportazione menu a discesa" border="true":::
