...
È anche possibile creare funzioni usando l' [API REST](/rest/api/loganalytics/savedsearches/createorupdate) o [PowerShell](/powershell/module/az.operationalinsights/new-azoperationalinsightssavedsearch).
