...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Modello per numero di risultati (fino alla versione 2018-04-16)
L'esempio seguente viene creata una [regola di avviso Numero di risultati](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Note

- Questo esempio include un [payload del webhook](../alerts/alerts-log-webhook.md). Se la regola di avviso non deve attivare un webhook, rimuovere l'elemento **customWebhookPayload**.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Modello per unità di misura della metrica (fino alla versione 2018-04-16)
L'esempio seguente crea una [regola di avviso Unità di misura della metrica](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Modello per tutti i tipi di risorsa (a partire dalla versione 2020-05-01-preview)
