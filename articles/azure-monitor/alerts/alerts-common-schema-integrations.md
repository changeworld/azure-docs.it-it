...
* Impostazione delle regole di avviso ([metrica](../alerts/alerts-metric.md), [log](../platform/alerts-log.md), [log attività](../platform/alerts-activity-log.md))
* Configurazione di [gruppi di azioni](../platform/action-groups.md)
