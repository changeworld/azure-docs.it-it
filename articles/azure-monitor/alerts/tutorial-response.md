...
Per completare l'esempio contenuto in questa esercitazione, è necessario disporre di una macchina virtuale esistente [connessa all'area di lavoro Log Analytics](../vm/quick-collect-azurevm.md).  
...
5. Configurare l'avviso con le informazioni seguenti:  
   a. Dall'elenco **a discesa basato su** selezionare **misurazione metrica**.  Un'unità di misura della metrica creerà un avviso per ogni oggetto nella query con un valore che supera la soglia specificata.  
