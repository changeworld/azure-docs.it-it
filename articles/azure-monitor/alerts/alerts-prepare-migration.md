...
1. Usare il modello "monitoraggio di Azure-gestore avvisi metriche". Questo modello include un trigger di **richiesta http** con lo schema appropriato definito.
    ...
    ![Screenshot mostra due pulsanti, app per la logica vuota e monitoraggio di Azure-gestore avvisi metrica.](media/alerts-prepare-migration/logic-app-template.png "Modello di avviso della metrica")
