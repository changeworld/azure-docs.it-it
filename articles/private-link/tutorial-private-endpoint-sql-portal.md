---
title: 'Esercitazione: connettersi a un server SQL di Azure tramite un endpoint privato di Azure-portale'
...
ms.locfileid: "102554973"
---
# <a name="tutorial-connect-to-an-azure-sql-server-using-an-azure-private-endpoint---azure-portal"></a>Esercitazione: connettersi a un server SQL di Azure usando un endpoint privato di Azure-portale di Azure
