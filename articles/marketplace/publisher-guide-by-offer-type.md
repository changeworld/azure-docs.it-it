...
> [!NOTE]
> Dopo aver selezionato un tipo di offerta, non è possibile modificare l'offerta in un altro tipo. Per creare un tipo di offerta diverso, è necessario creare una nuova offerta.
