...
1. Nel menu di spostamento a sinistra, selezionare **Commercial Marketplace**  >  **Overview**.
    > [!TIP]
    > Se il **Marketplace commerciale** non è visibile nel percorso di navigazione a sinistra, [creare un account Marketplace commerciale nel centro](./partner-center-portal/create-account.md) per i partner e assicurarsi che l'account sia registrato nel programma commerciale Marketplace.
...
### <a name="select-solution-areas"></a>Selezionare le aree della soluzione

Le aree della soluzione consentono di definire ulteriormente la soluzione. Questo consente ai team di vendita Microsoft di trovare e comprendere la proposta di valore della soluzione. È necessario selezionare almeno uno e un massimo di tre aree della soluzione per l'offerta. Per ogni area della soluzione è possibile scegliere un massimo di due sottoaree della soluzione.

1. Selezionare il collegamento **+ Aggiungi area soluzione (3 max)** .
1. Selezionare un'area della soluzione nell'elenco a discesa visualizzato.
1. Selezionare almeno una e fino a due sottoaree della soluzione. Per selezionare più aree secondarie, usare la `Ctrl` chiave (in Windows) o la `Command` chiave (in MacOS).
1. Per aggiungere un'altra area della soluzione, ripetere i passaggi da 1 a 3.

## <a name="upload-documents"></a>Caricamento di documenti

È necessario fornire documenti collaterali che forniscano dettagli sull'offerta. I team di vendita Microsoft usano queste informazioni per valutare se l'offerta è adatta alle esigenze dei clienti per consigliare e vendere l'offerta. Maggiore è la quantità di informazioni fornite, maggiori sono le informazioni che i team di vendita Microsoft dovranno comprendere e promuovere il prodotto.

I tipi di file supportati sono. pdf,. ppt,. pptx,. doc,. docx,. xls,. xlsx,. jpg,. png e. MP4. I modelli per alcuni documenti sono riportati nella tabella 2 riportata di seguito.

> [!NOTE]
> Il deck della **soluzione/offerta con un cercapersone** e **soluzione/offerta** è necessario per ottenere lo stato pronto per il co-selling. Sono anche prerequisiti per alcune offerte come co-selling IP di Azure incentivate. Il diagramma dell'architettura di riferimento è necessario anche per lo stato di incentivate di co-selling IP di Azure. Gli altri documenti descritti in questa tabella sono facoltativi ma consigliati.

***Tabella 2: documenti che supportano la co-selling***

| **Documents** (Documenti)    | **Descrizione**  |
| :------------------- | :-------------------|
| *Soluzione/offerta un cercapersone (obbligatorio)* | Riconosci la consapevolezza tra i potenziali clienti con un cercapersone progettato professionalmente che mostra la proposta di valore della soluzione.<br><br>È possibile usare uno dei modelli pertinenti per fornire una descrizione dell'offerta per i clienti:<br><ul><li> [Microsoft Azure modello a un cercapersone](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Microsoft Dynamics 365 1-modello di cercapersone](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Microsoft 365 1-modello di cercapersone](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Windows 10 1-modello di cercapersone](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> I team di vendita Microsoft possono condividere queste informazioni con i clienti per determinare se l'offerta potrebbe essere una scelta ottimale e per assicurarsi che sia pronta per i clienti. |
| *Soluzione/offerta pitch deck (obbligatorio)* | È possibile usare il [modello di presentazione del cliente](https://aka.ms/GTMServices_CustomerPresentation) per creare il mazzo di piazzole. Questo deck dovrebbe fare riferimento al [diagramma dell'architettura di riferimento](reference-architecture-diagram.md). Lo scopo di questa diapositiva è quello di inserire l'offerta e la relativa proposta di valore. Dopo aver verificato che l'offerta sia pronta per il cliente, i team di vendita Microsoft possono condividere questa presentazione con i clienti per esprimere il valore che l'azienda e Microsoft portano durante la distribuzione di una soluzione congiunta. La presentazione deve comprendere il funzionamento dell'offerta, il modo in cui può aiutare i clienti, i settori per cui l'offerta è pertinente e il modo in cui viene confrontata con le soluzioni in competizione. |
| *Case study cliente* (facoltativo)| Usare il [modello Case Study](https://aka.ms/GTM_Case_Study_Template) per creare la case study del cliente. Queste informazioni mostrano un potenziale cliente in cui l'utente e Microsoft hanno distribuito correttamente l'offerta nei casi precedenti. |
| *WINS del cliente verificabile* (facoltativo) | Fornire esempi specifici di successi dei clienti dopo che l'offerta è stata distribuita. |
| *Deck pitch deck* (facoltativo) | Un deck con informazioni che consentono ai rivenditori di canale di ottenere ulteriori informazioni sull'offerta e di preparare i team addetti alla vendita. Questo mazzo include in genere un passo di ascensore, informazioni sui clienti di destinazione, domande per chiedere ai clienti, punti di discussione e collegamenti a video, documentazione e informazioni di supporto. |
| *Diagramma dell'architettura di riferimento* (obbligatorio per lo stato di incentivate di co-selling IP di Azure) | Diagramma che rappresenta l'offerta e la relativa relazione con i servizi cloud Microsoft. Potrebbe anche dimostrare il modo in cui l'offerta soddisfa i requisiti tecnici per lo stato incentivate di co-selling IP di Azure. [Altre informazioni sul diagramma dell'architettura di riferimento.](reference-architecture-diagram.md) |
| *Altri documenti* (facoltativo) | È possibile caricare fino a cinque documenti o video aggiuntivi per aiutare i team di vendita Microsoft e i rivenditori di canale a scoprire di più sull'offerta, sull'organizzazione e su come è diversa dalle altre offerte. |
|||

- Dopo aver creato i documenti, trascinarli nella casella appropriata in **documenti** o selezionare **Sfoglia i file** per caricare un documento dal computer.

    [![Viene illustrata la sezione relativa alla documentazione di co-selling della scheda co-selling with Microsoft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)

## <a name="product-landing-page"></a>Pagina di destinazione del prodotto
...
1. Aprire. File CSV in un'applicazione, ad esempio Microsoft Excel, quindi compilare ogni riga con le informazioni sul contatto.
    ...
    ***Tabella 3: Descrizione dei ruoli***
    ...
    - Paesi/aree geografiche (obbligatorio): quando si compila il modello, usare i [codici paese e regione di co-selling](commercial-marketplace-co-sell-countries.md)di due lettere. Se il contatto copre tutti i paesi e le aree geografiche, usare il codice "OOO" di tre lettere. Se un contatto copre più di un paese o di un'area, immettere ognuno dei due codici letterali separati da una virgola. Ad esempio, immettere "US, CA, FR" senza virgolette nel modello.
        ...
        I paesi e le aree devono riflettere il territorio di ogni contatto. I team di vendita Microsoft e i rivenditori di canale utilizzeranno queste informazioni quando richiederanno informazioni o collaboreranno sulle vendite all'interno di un determinato paese o area geografica.
