...
Per ulteriori informazioni sull'aggiunta di domini personalizzati in Azure Active Directory, vedere [aggiungere o associare un dominio nel Azure ad](/azure/active-directory/fundamentals/add-custom-domain).
...
![Diagramma per la risoluzione dei problemi di accesso dell'account di lavoro](./media/manage-accounts/onboarding-aad-flow.png)
