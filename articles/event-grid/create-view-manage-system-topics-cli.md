...
- Per creare prima un argomento di sistema in un'origine di Azure e quindi creare una sottoscrizione di eventi per tale argomento, vedere gli argomenti di riferimento seguenti:
    ...
    - [AZ eventgrid System-topic Event-Subscription create](/cli/azure/ext/eventgrid/eventgrid/system-topic/event-subscription#ext-eventgrid-az-eventgrid-system-topic-event-subscription-create)
        ...
        ```
- Per creare un argomento di sistema (in modo implicito) quando si crea una sottoscrizione di eventi per un'origine di Azure, usare il metodo [AZ eventgrid Event-Subscription create](/cli/azure/ext/eventgrid/eventgrid/event-subscription#ext-eventgrid-az-eventgrid-event-subscription-create) . Ecco un esempio:
...
- [AZ eventgrid System-elenco di argomenti](/cli/azure/ext/eventgrid/eventgrid/system-topic#ext-eventgrid-az-eventgrid-system-topic-list)
