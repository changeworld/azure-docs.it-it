...
> [!NOTE]
> Per altre informazioni sul modo in cui la residenza dei dati si riferisce alla gestione degli eventi, vedere la [documentazione concettuale relativa alla residenza dei dati](../communication-services/concepts/privacy.md)
...
| Microsoft. Communication. ChatParticipantAddedToThreadWithUser|  Pubblicata per un utente quando viene aggiunto un nuovo partecipante a un thread di chat, di cui l'utente fa parte.|
| Microsoft. Communication. ChatParticipantRemovedFromThreadWithUser |  Pubblicata per un utente quando un partecipante viene rimosso da un thread di chat, di cui l'utente fa parte. |
| Microsoft. Communication. ChatThreadCreated  | Pubblicata quando viene creato un thread di chat  |
| Microsoft. Communication. ChatThreadDeleted| Pubblicato quando un thread di chat viene eliminato  |
| Microsoft. Communication. ChatThreadParticipantAdded | Pubblicato quando un nuovo partecipante viene aggiunto a un thread di chat  |
| Microsoft. Communication. ChatThreadParticipantRemoved | Pubblicato quando un nuovo partecipante viene aggiunto a un thread di chat.  |  
| Microsoft. Communication. ChatMessageReceivedInThread | Pubblicato quando un messaggio viene ricevuto in un thread di chat  |    
| Microsoft. Communication. ChatThreadPropertiesUpdated| Pubblicata quando vengono aggiornate le proprietà di un thread di chat come l'argomento.|    
| Microsoft. Communication. ChatMessageEditedInThread | Pubblicato quando un messaggio viene modificato in un thread di chat |  
| Microsoft. Communication. ChatMessageDeletedInThread | Pubblicato quando un messaggio viene eliminato in un thread di chat  |  

È possibile usare il portale di Azure o l'interfaccia della riga di comando di Azure per effettuare la sottoscrizione agli eventi generati dalla risorsa di Servizi di comunicazione. Per iniziare a gestire gli eventi, vedere [Come gestire gli eventi SMS in Servizi di comunicazione](../communication-services/quickstarts/telephony-sms/handle-sms-events.md)
...
## <a name="quickstarts-and-how-tos"></a>Avvii rapidi e procedure

| Titolo | Descrizione |
| --- | --- |
| [Come gestire gli eventi SMS in Servizi di comunicazione](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Gestione di tutti gli eventi SMS ricevuti dal servizio di comunicazione tramite webhook. |
