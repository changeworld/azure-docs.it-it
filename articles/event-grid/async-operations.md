...
* Per informazioni sulla distribuzione di modelli tramite l'API REST di Gestione risorse, vedere [distribuire risorse con modelli di gestione risorse e gestione risorse API REST](../azure-resource-manager/templates/deploy-rest.md).