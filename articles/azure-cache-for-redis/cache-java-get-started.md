...
Se si vuole passare direttamente al codice, vedere la guida [introduttiva a Java](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/java) in GitHub.
