...
Per passare direttamente al codice, vedere la [Guida introduttiva di Java](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/java) su GitHub.
