...
New-AzRedisCache
   ...
   [<CommonParameters>]
```
Per ulteriori informazioni sulla creazione di un'istanza della cache in PowerShell, vedere il [riferimento Azure PowerShell](/powershell/module/az.rediscache/new-azrediscache). 
...
Import-AzRedisCache
      ...
      [<CommonParameters>]
```
Per ulteriori informazioni sull'importazione in PowerShell, vedere il [riferimento Azure PowerShell](/powershell/module/az.rediscache/import-azrediscache). 
