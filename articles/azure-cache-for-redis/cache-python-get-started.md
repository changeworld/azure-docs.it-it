...
Se si vuole passare direttamente al codice, vedere la guida [introduttiva a Python](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/python) in GitHub.
