...
Per passare direttamente al codice, vedere la [Guida introduttiva di Python](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/python) su GitHub.
