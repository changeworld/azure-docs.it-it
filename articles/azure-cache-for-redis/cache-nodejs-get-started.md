---
title: 'Avvio rapido: Usare la cache di Azure per Redis in Node.js'
...
ms.locfileid: "102121253"
---
# <a name="quickstart-use-azure-cache-for-redis-in-nodejs"></a>Avvio rapido: Usare la cache di Azure per Redis in Node.js
...
Per passare direttamente al codice, vedere la [ Guida introduttivaNode.js](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/nodejs) su GitHub.
...
Le build più recenti di [node_redis](https://github.com/mranney/node_redis) includono il supporto per la connessione a Cache di Azure per Redis con TLS. L'esempio seguente mostra come connettersi a Cache di Azure per Redis usando l'endpoint TLS 6380. 
...
Creare un nuovo file script denominato *redistest.js*. Per installare i pacchetti necessari, usare il comando`npm install redis bluebird`.
...
![App Cache Redis completata](./media/cache-nodejs-get-started/redis-cache-app-complete.png)
...
![Eliminare il gruppo di risorse di Azure](./media/cache-nodejs-get-started/redis-cache-delete-resource-group.png)
