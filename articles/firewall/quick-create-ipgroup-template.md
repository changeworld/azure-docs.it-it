...
description: Questo argomento di avvio rapido illustra come usare un modello di Azure Resource Manager per creare un'istanza di Firewall di Azure e gruppi di indirizzi IP.
services: firewall
author: vhorne
ms.service: firewall
ms.topic: quickstart
