...
Per ulteriori informazioni, vedere un elenco di [tutte le metriche della piattaforma supportate in monitoraggio di Azure](../azure-monitor/platform/metrics-supported.md).
