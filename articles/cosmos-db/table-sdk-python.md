...
|**Documentazione sull'API**|[Documentazione di riferimento delle API di Python](/python/api/overview/azure/cosmosdb)|
...
|**Piattaforma attualmente supportata**|[Python 2,7](https://www.python.org/downloads/) o [Python 3.6 +](https://www.python.org/downloads/)|
