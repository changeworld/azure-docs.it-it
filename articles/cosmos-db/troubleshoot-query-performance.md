...
Di seguito sono riportate alcune funzioni di sistema comuni che non utilizzano l'indice e che devono caricare ciascun documento se utilizzato in una `WHERE` clausola:
...
* [Ottimizzazione delle prestazioni delle query con Azure Cosmos DB](./sql-api-query-metrics.md)
* [Suggerimenti sulle prestazioni per .NET SDK](performance-tips.md)
* [Suggerimenti sulle prestazioni per Java v4 SDK](performance-tips-java-sdk-v4-sql.md)