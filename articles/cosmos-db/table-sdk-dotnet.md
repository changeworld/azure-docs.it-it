...
description: Informazioni sulle Azure Cosmos DB API Tabella per .NET, incluse le date di rilascio, le date di ritiro e le modifiche apportate tra le singole versioni.
author: sakash279
ms.author: akshanka
