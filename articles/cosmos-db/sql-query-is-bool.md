...
## <a name="examples"></a>Esempi
  ...
  L'esempio seguente controlla gli oggetti di tipo booleano JSON, numero, stringa, null, oggetto, matrice e non definito usando la `IS_BOOL` funzione.  
