...
3. **Modalità di ridimensionamento** automatico: in questa modalità è possibile scalare automaticamente e immediatamente la velocità effettiva (UR/sec) del database o del contenitore in base all'utilizzo, senza alcun effetto sulla disponibilità, sulla latenza, sulla velocità effettiva o sulle prestazioni del carico di lavoro. Questa modalità è particolarmente adatta per i carichi di lavoro cruciali con modelli di traffico variabili o imprevedibili e richiede contratti di Service su scala e prestazioni elevate. Per altre informazioni, vedere l'articolo sulla [velocità effettiva di scalabilità](provision-throughput-autoscale.md) automatica. 
