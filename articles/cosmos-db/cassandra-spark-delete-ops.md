...
Questo articolo descrive come eliminare i dati nelle tabelle nell'API Cassandra di Azure Cosmos DB da Spark.
...
## <a name="sample-data-generator"></a>Generatore di dati di esempio
...
### <a name="delete-rows-that-match-a-condition"></a>Elimina le righe che soddisfano una condizione
...
### <a name="delete-all-the-rows-in-the-table"></a>Elimina tutte le righe nella tabella
...
### <a name="delete-specific-columns"></a>Elimina colonne specifiche
