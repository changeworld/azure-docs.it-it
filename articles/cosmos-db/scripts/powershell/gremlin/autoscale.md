---
title: Script di PowerShell per creare un database e un grafo con scalabilità automatica dell'API Gremlin di Azure Cosmos DB
description: "Script di Azure PowerShell: creare un database e un grafo con scalabilità automatica dell'API Gremlin per Azure Cosmos DB"
author: markjbrown
...
ms.locfileid: "98679259"
---
# <a name="create-a-database-and-graph-with-autoscale-for-azure-cosmos-db---gremlin-api"></a>Creare un database e un grafo con scalabilità automatica per Azure Cosmos DB: API Gremlin
