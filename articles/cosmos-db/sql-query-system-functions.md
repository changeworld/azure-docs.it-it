...
|[Funzioni per i valori stringa](sql-query-string-functions.md)|Le funzioni stringa eseguono un'operazione su un valore di stringa di input e restituiscono una stringa, il valore numerico o booleano. | [Concat](sql-query-concat.md), [Contains](sql-query-contains.md), [ENDSWITH](sql-query-endswith.md), [INDEX_OF](sql-query-index-of.md), [Left](sql-query-left.md), [length](sql-query-length.md), [Lower](sql-query-lower.md), [LTrim](sql-query-ltrim.md), [REGEXMATCH](sql-query-regexmatch.md)[Replace](sql-query-replace.md), [replicate](sql-query-replicate.md), [Reverse](sql-query-reverse.md), [right](sql-query-right.md), [RTRIM](sql-query-rtrim.md), [STARTSWITH](sql-query-startswith.md) [, StringToArray, StringToBoolean](sql-query-stringtoarray.md) [, StringToNull](sql-query-stringtoboolean.md) [, StringToNumber](sql-query-stringtonull.md) [,](sql-query-stringtonumber.md) [StringToObject](sql-query-stringtoobject.md), [](sql-query-tostring.md) [substring, ToString](sql-query-substring.md), [Trim](sql-query-trim.md), [Upper](sql-query-upper.md) |
