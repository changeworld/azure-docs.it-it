...
Vedere [creare un account di Azure Cosmos DB con modelli di Azure Resource Manager](./manage-with-templates.md)
...
:::image type="content" source="./media/how-to-manage-database-account/single-to-multi-master.png" alt-text="Screenshot di Azure Cosmos configura le Scritture in più aree":::
...
> [!NOTE]
> Non è possibile eseguire manualmente il failover degli account con più aree di scrittura. Per le applicazioni che usano Azure Cosmos SDK, l'SDK rileva quando un'area non è più disponibile, quindi reindirizza automaticamente all'area successiva più vicina.
