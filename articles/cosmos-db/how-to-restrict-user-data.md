...
- uso di [chiavi](database-security.md#primary-keys) Azure Cosmos DB o [token di risorsa](secure-access-to-data.md#resource-tokens) quando si inviano chiamate da API e SDK.
