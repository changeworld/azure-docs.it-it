---
title: Esempi dell'interfaccia della riga di comando di Azure per l'API Tabella di Azure Cosmos DB
description: Esempi dell'interfaccia della riga di comando di Azure per l'API Tabella di Azure Cosmos DB
author: markjbrown
