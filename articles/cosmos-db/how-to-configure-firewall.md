...
Per automatizzare l'elenco, vedere [usare l'API di individuazione dei tag di servizio (anteprima pubblica)](../virtual-network/service-tags-overview.md#use-the-service-tag-discovery-api-public-preview).
