...
> [!NOTE]
> La versione 3,2 dell'API Cosmos DB per MongoDB non prevede alcun piano corrente per la fine del ciclo di vita (EOL). Il preavviso minimo per una futura EOL è di tre anni.
