...
1. Passare al sito Web di gestione applicazioni di Azure IoT Central. Selezionare **Compila** dalla barra di spostamento a sinistra e quindi fare clic sulla scheda **Retail**.
    ...
    :::image type="content" source="media/tutorial-iot-central-smart-inventory-management/iotc_retail_homepage.png" alt-text="Screenshot che mostra come selezionare il modello di applicazione Gestione inventario intelligente":::
...
3. **Crea app** consente di aprire il modulo Nuova applicazione e di specificare i dettagli richiesti, come illustrato di seguito.
    ...
    **Creazione**: Selezionare Crea nella parte inferiore della pagina per distribuire l'applicazione.
    ...
    :::image type="content" source="media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_app_create.png" alt-text="Screenshot che mostra come creare un'app dal modello di applicazione Gestione inventario intelligente":::

    :::image type="content" source="media/tutorial-iot-central-smart-inventory-management/smart-inventory-management-app-create-billinginfo.png" alt-text="Screenshot che mostra le opzioni di fatturazione quando si crea l'applicazione":::
...
> ![Screenshot della metà superiore del dashboard di Gestione inventario intelligente](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_dashboard1.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot della metà inferiore del dashboard Gestione inventario intelligente](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_dashboard2.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot che mostra il modello di dispositivo gateway di inventario nell'applicazione](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_devicetemplate1.png)


**Gateway Commands** (Comandi gateway): questa interfaccia organizza tutte le funzionalità dei comandi del gateway

> [!div class="mx-imgBorder"]
> ![Screenshot che mostra l'interfaccia di comandi gateway nel modello di dispositivo gateway di inventario](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_devicetemplate2.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot dell'elenco di regole nell'applicazione Gestione inventario intelligente](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_rules.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot dell'elenco di processi nell'applicazione Gestione inventario intelligente](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_jobs.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot che mostra come eliminare l'applicazione quando non serve più](./media/tutorial-iot-central-smart-inventory-management/smart_inventory_management_cleanup.png)

## <a name="next-steps"></a>Passaggi successivi

Scopri di più su Smart Inventory Management:

> [!div class="nextstepaction"]
> [Concetti della gestione inventario intelligente](./architecture-smart-inventory-management.md)
