...
1. La pagina offre un'opzione per **creare un modello personalizzato** _ o _ *_usare un modello di dispositivo preconfigurato_**
...
3. Fare ora clic su **Visualizza chiavi** e prendere nota della  
