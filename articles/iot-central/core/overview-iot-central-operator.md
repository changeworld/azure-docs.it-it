...
ms.locfileid: "104609569"
---
# <a name="iot-central-operator-guide"></a>Guida dell'operatore IoT Central

In questo articolo viene fornita una panoramica del ruolo Operatore in IoT Central. Un operatore gestisce i dispositivi connessi all'applicazione.
...
:::image type="content" source="media/overview-iot-central-tour/iot-central-homepage.png" alt-text="Screenshot della Home page di IoT Central":::
...
1. Nel riquadro di destra della pagina **dispositivi** viene visualizzato un elenco di dispositivi creati da tale modello di dispositivo. Scegliere un singolo dispositivo per visualizzare la pagina dei dettagli dispositivo per questo dispositivo:
    ...
    ![Screenshot della pagina dei dettagli del dispositivo](./media/overview-iot-central-operator/device-list.png)
...
1. Selezionare **Importa**.
    ...
    ![Screenshot dell'azione di importazione](./media/overview-iot-central-operator/bulk-import-1-a.png)
...
1. Al termine dell'importazione, nel pannello operazioni dispositivo viene visualizzato un messaggio di operazione completata.
    ...
    ![Screenshot dell'importazione riuscita](./media/overview-iot-central-operator/bulk-import-3-a.png)
...
1. Nel pannello sinistro scegliere **tutti i dispositivi**:
    ...
    ![Screenshot dei dispositivi non associati](./media/overview-iot-central-operator/unassociated-devices-2-a.png)
...
1. Selezionare **Esegui migrazione**:
    ...
    ![Screenshot di associare i dispositivi](./media/overview-iot-central-operator/unassociated-devices-1-a.png)
...
1. Selezionare i dispositivi che si desidera esportare, quindi selezionare l'azione **Esporta** .
    ...
    ![Screenshot dell'esportazione](./media/overview-iot-central-operator/export-1-a.png)
...
1. Selezionare il collegamento **Scarica file** per scaricare il file in una cartella locale sul disco.
    ...
    ![Screenshot dell'esportazione riuscita](./media/overview-iot-central-operator/export-2-a.png)
