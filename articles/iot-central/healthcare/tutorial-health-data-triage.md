---
title: 'Esercitazione: creare un dashboard di valutazione dei dati di integrità con Azure IoT Central | Microsoft Docs'
description: 'Esercitazione: informazioni su come creare un dashboard di valutazione dei dati di integrità usando i modelli di applicazione IoT Central di Azure.'
author: philmea
ms.author: philmea
ms.date: 12/11/2020
ms.topic: tutorial
...
> [Indicazioni sull'architettura di monitoraggio paziente continuo](concept-continuous-patient-monitoring-architecture.md)