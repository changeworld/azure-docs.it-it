...
È possibile trasmettere gli indicatori di minaccia ad Azure Sentinel usando uno dei prodotti integrati della piattaforma di intelligence per le minacce (TIP) elencati nella sezione successiva, connessione ai server TAXI o usando l'integrazione diretta con l' [API tiIndicators di sicurezza di Microsoft Graph](/graph/api/resources/tiindicator).
...
- [Anomali ThreatStream](https://www.anomali.com/products/threatstream)
    ...
    Per scaricare ThreatStream Integrator ed estensioni e le istruzioni per connettere ThreatStreamna Intelligence all'API di sicurezza Microsoft Graph, vedere la pagina di [download di ThreatStream](https://ui.threatstream.com/downloads) .
...
- [Piattaforma EclecticIQ](https://www.eclecticiq.com/solutions)

- [Piattaforma di intelligence per le minacce ThreatQ](https://www.threatq.com/)

    Per informazioni e istruzioni guidate, vedere [Microsoft Sentinel Connector per l'integrazione con ThreatQ](https://appsource.microsoft.com/product/web-apps/threatquotientinc1595345895602.microsoft-sentinel-connector-threatq?src=health&tab=Overview).
