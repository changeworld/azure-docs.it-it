...
| **Network** | Cisco | Potenza   | CommonSecurityLog | [Messaggi syslog di Cisco fuoco Threat Defense](https://www.cisco.com/c/en/us/td/docs/security/firepower/Syslogs/b_fptd_syslog_guide.html)    |
...
> [!NOTE]
> Per ulteriori informazioni, vedere anche [CEF e mapping di campi CommonSecurityLog](cef-name-mapping.md).
> 
