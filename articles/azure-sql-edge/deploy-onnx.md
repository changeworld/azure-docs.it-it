...
ms.locfileid: "100653211"
---
# <a name="deploy-and-make-predictions-with-an-onnx-model-and-sql-machine-learning"></a>Distribuire ed eseguire stime con un modello ONNX e SQL Machine Learning
...
* Installare [Azure Data Studio](/sql/azure-data-studio/download).

* Installare i pacchetti Python necessari per questa Guida introduttiva:

  1. Aprire il [nuovo notebook](/sql/azure-data-studio/sql-notebooks) connesso al kernel Python 3. 
