...
Nella portale di Azure **aprire gli**  >  account di archiviazione dell'infrastruttura di **backup** dell'insieme di credenziali  >  . Selezionare **Annulla registrazione** per rimuovere gli account di archiviazione dall'insieme di credenziali di servizi di ripristino.
