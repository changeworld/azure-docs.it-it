...
La passphrase deve usare caratteri del set di caratteri ASCII, con [valori ASCII minori o uguali a 127](/office/vba/language/reference/user-interface-help/character-set-0127).
