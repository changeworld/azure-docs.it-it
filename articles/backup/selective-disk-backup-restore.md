...
Durante l'operazione di configurazione della protezione, è necessario specificare l'impostazione dell'elenco di dischi con un parametro di esclusione dell' **inclusione**  /   , assegnando i numeri LUN dei dischi da includere o escludere nel backup.
...
Durante l'operazione di configurazione della protezione, è necessario specificare l'impostazione dell'elenco di dischi con un parametro di inclusione/esclusione, che consente di includere o escludere nel backup i numeri LUN dei dischi.
...
- [Domande frequenti-eseguire il backup di macchine virtuali di Azure](backup-azure-vm-backup-faq.yml)
