...
Per istruzioni sull'associazione TLS, vedere [Come configurare SSL in IIS 7](/iis/manage/configuring-security/how-to-set-up-ssl-on-iis#create-an-ssl-binding-1).
