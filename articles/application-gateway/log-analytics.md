---
title: Esaminare i log di WAF con Azure Log Analytics
titleSuffix: Azure Application Gateway
description: Questo articolo illustra come usare Azure Log Analytics per esaminare i log del Web Application Firewall (WAF) del gateway applicazione.
...
Per importare i log del firewall in Log Analytics, vedere [integrità back-end, log di diagnostica e metriche per il gateway applicazione](application-gateway-diagnostics.md#diagnostic-logging). Quando i log del firewall si trovino nell'area di lavoro Log Analytics, è possibile visualizzare i dati, scrivere query, creare visualizzazioni e aggiungerle al dashboard del portale.
