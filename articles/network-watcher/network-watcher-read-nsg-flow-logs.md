...
description: Informazioni su come usare Azure PowerShell per analizzare i log dei flussi dei gruppi di sicurezza di rete, che vengono creati ogni ora e aggiornati a intervalli di pochi minuti in Azure Network Watcher.
