...
description: Informazioni su come usare Power BI per visualizzare i log di flusso dei gruppi di sicurezza di rete per consentire di visualizzare informazioni sul traffico IP in Azure Network Watcher.
