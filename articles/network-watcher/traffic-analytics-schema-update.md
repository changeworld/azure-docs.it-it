...
Lo [schema del log analisi del traffico](./traffic-analytics-schema.md) include i nuovi campi seguenti: **SrcPublicIPs_s**, **DestPublicIPs_s** **NSGRule_s**. I nuovi campi forniscono informazioni sugli IP di origine e di destinazione e semplificano le query.
