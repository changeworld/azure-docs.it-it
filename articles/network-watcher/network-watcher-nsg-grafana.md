...
Per altre informazioni sull'installazione vedere [Installing on Debian / Ubuntu](https://docs.grafana.org/installation/debian/) (Installazione su Debian/Ubuntu).
