...
La documentazione completa per le API del servizio Device provisioning è disponibile all'indirizzo [https://docs.microsoft.com/rest/api/iot-dps](/rest/api/iot-dps) .
