...
* Vedere l'articolo [PowerShell del servizio migrazione del database di Azure](/powershell/module/azurerm.datamigration/?view=azurermps-6.13.0&preserve-view=true#data_migration).
