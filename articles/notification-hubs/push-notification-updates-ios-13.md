...
Un'altra modifica secondaria, ma una che richiede una modifica all'applicazione back-end che invia le notifiche, è il requisito che per le notifiche in background l' `apns-priority` intestazione deve essere impostata su 5. Molte applicazioni impostano l' `apns-priority` intestazione su 10 (che indica il recapito immediato) o non lo impostano e ottengono il valore predefinito (che è anche 10).
