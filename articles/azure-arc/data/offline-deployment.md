...
Uno [script di esempio](https://raw.githubusercontent.com/microsoft/azure_arc/main/arc_data_services/deploy/scripts/pull-and-push-arc-data-services-images-to-private-registry.py) è disponibile nel repository GitHub di Azure Arc.
...
|Specificare il nome DNS o l'indirizzo IP del registro contenitori di destinazione:|TARGET_DOCKER_REGISTRY|Il nome DNS o l'indirizzo IP del registro di sistema di destinazione.  Si tratta del registro _di sistema in_ cui verrà eseguito il push delle immagini.|
