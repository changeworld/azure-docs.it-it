...
Passare all'articolo successivo per informazioni su come usare Helm con le configurazioni.
> [!div class="nextstepaction"]
> [Usare Helm con le configurazioni](./use-gitops-with-helm.md)
