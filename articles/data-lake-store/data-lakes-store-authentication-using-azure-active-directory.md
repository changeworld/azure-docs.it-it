---
title: Autenticazione-Data Lake Storage Gen1 con Azure AD
description: Informazioni su come eseguire l'autenticazione con Azure Data Lake Storage Gen1 usando Azure Active Directory.
author: twooley
...
Per altre informazioni su come usare Azure Active Directory per l'autenticazione, vedere [Scenari di autenticazione per Azure AD](../active-directory/develop/authentication-vs-authorization.md).
