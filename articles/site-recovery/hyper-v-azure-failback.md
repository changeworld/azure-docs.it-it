...
3. In   >  **gruppo protezione** elementi protetti  >  \<ProtectionGroupName>  ->  \<VirtualMachineName> selezionare la macchina virtuale di cui si vuole eseguire il failback e quindi selezionare **failover pianificato**.
