...
1. In **scegliere il tipo di programma da creare** pagina selezionare **programma standard**  >  **Avanti**.
   ...
   ![Screenshot della creazione guidata pacchetto e programma che mostra l'opzione del programma standard.](./media/vmware-azure-mobility-install-configuration-mgr/sccm-standard-program.png)
...
1. Nella pagina **specificare le informazioni su questo programma standard** specificare i valori seguenti:
   ...
   ![Screenshot che mostra le informazioni che è possibile specificare per il programma standard.](./media/vmware-azure-mobility-install-configuration-mgr/sccm-program-properties.png)
...
1. Al termine della distribuzione del pacchetto, fare clic con il pulsante destro del mouse sul pacchetto > **Distribuisci**.
   ...
   ![Screenshot della console di Configuration Manager che mostra l'opzione di menu Distribuisci.](./media/vmware-azure-mobility-install-configuration-mgr/sccm_deploy.png)
