...
## <a name="november-2020-round-trip-latency-figures"></a>Cifre della latenza di round trip di novembre 2020

I tempi di round trip della media mensile tra le aree di Azure per gli ultimi 30 giorni (che terminano il 30 novembre 2020) sono riportati di seguito. Le misurazioni seguenti sono basate su [ThousandEyes](https://thousandeyes.com).
