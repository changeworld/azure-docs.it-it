...
| [az webapp create](/cli/azure/webapp?view=azure-cli-latest#az-webapp-create) | Consente di creare un'App Web di Azure all'interno del piano di servizio app. |
