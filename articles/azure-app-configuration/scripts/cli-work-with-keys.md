...
| Comando | Note |
|---|---|
| [az appconfig kv set](/cli/azure/appconfig/kv#az_appconfig_kv_set) | Crea o aggiorna una coppia chiave-valore. |
| [az appconfig kv list](/cli/azure/appconfig/kv#az_appconfig_kv_list) | Elenca le coppie chiave-valore in un archivio di Configurazione app. |
| [az appconfig kv delete](/cli/azure/appconfig/kv#az_appconfig_kv_delete) | Elimina una coppia chiave-valore. |
