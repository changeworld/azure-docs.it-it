...
- Python 2,7 o 3,6 o versione successiva: per informazioni sulla configurazione di Python in Windows, vedere la [documentazione di Python in Windows]( https://docs.microsoft.com/windows/python/)
