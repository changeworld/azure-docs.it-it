...
description: Informazioni sulle Border Gateway Protocol (BGP) in VPN di Azure, il protocollo Internet standard per lo scambio di informazioni di routing e raggiungibilità tra le reti.
