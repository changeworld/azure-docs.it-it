...
* [Reti virtuali che si trovano nella stessa sottoscrizione:](#samesub) I passaggi per questa configurazione usano TestVNet1 e TestVNet4.
  ...
  ![Diagramma che illustra i passaggi V NET-to-V NET per le reti V che risiedono nella stessa sottoscrizione.](./media/vpn-gateway-howto-vnet-vnet-cli/v2vrmps.png)
...
## <a name="connect-vnets-that-are-in-the-same-subscription"></a><a name="samesub"></a>Connettere reti virtuali che si trovano nella stessa sottoscrizione
...
### <a name="plan-your-ip-address-ranges"></a><a name="Plan"></a>Pianificare gli intervalli di indirizzi IP
...
### <a name="step-1---connect-to-your-subscription"></a><a name="Connect"></a>Passaggio 1: Connettersi alla sottoscrizione

[!INCLUDE [CLI login](../../includes/vpn-gateway-cli-login-numbers-include.md)]

### <a name="step-2---create-and-configure-testvnet1"></a><a name="TestVNet1"></a>Passaggio 2: Creare e configurare TestVNet1
...
### <a name="step-3---create-and-configure-testvnet4"></a><a name="TestVNet4"></a>Passaggio 3 - Creare e configurare TestVNet4
...
### <a name="step-4---create-the-connections"></a><a name="createconnect"></a>Passaggio 4: Creare le connessioni
...
### <a name="to-connect-vnets-that-reside-in-different-resource-groups"></a><a name="diffrg"></a>Per connettere reti virtuali che si trovano in gruppi di risorse diversi
...
### <a name="to-connect-vnets-that-reside-in-the-same-resource-group"></a><a name="samerg"></a>Per connettere reti virtuali che si trovano nello stesso gruppo di risorse
...
## <a name="connect-vnets-that-are-in-different-subscriptions"></a><a name="difsub"></a>Connettere reti virtuali che si trovano in sottoscrizioni diverse
...
## <a name="verify-the-connections"></a><a name="verify"></a>Verificare le connessioni
