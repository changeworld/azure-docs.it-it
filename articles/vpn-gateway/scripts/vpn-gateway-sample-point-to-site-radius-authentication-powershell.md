---
title: Esempio di script di Azure PowerShell-configurare la VPN P2S con l'autenticazione RADIUS
titleSuffix: Azure VPN Gateway
description: Esempio di PowerShell per configurare una VPN da punto a sito con autenticazione con nome utente/password RADIUS
...
ms.locfileid: "100385813"
---
# <a name="create-a-vpn-gateway-with-p2s-radius-authentication---powershell-script-sample"></a>Creare un gateway VPN con l'autenticazione RADIUS P2S-esempio di script di PowerShell

Questo script di esempio crea un gateway VPN basato su Route e aggiunge la configurazione da punto a sito usando l'autenticazione con nome utente/password RADIUS.
