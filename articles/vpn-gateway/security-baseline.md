...
> [!NOTE]
> I **controlli** non applicabili al gateway VPN o per i quali la responsabilità è Microsoft sono stati esclusi. Per informazioni sul mapping completo del gateway VPN al benchmark di sicurezza di Azure, vedere il **[file di mapping di base di sicurezza del gateway VPN completo](https://github.com/MicrosoftDocs/SecurityBenchmarks/raw/master/Azure%20Offer%20Security%20Baselines/1.1/vpn-gateway-security-baseline-v1.1.xlsx)**.
...
- [Creare un gateway VPN basato su route usando il portale di Azure](/azure/vpn-gateway/create-routebased-vpn-gateway-portal)
...
- [Come visualizzare e recuperare gli eventi del log attività di Azure](/azure/azure-monitor/essentials/activity-log-view)
...
- [Introduzione alle query di Log Analytics](/azure/azure-monitor/logs/get-started-portal) 
...
- [Informazioni sui tipi di VPN](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-gateway-settings#vpntype)

- [Informazioni sui dispositivi VPN e sui parametri IPsec/IKE per connessioni del Gateway VPN da sito a sito](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-devices#ipsec)
...
Azure Resource Manager è in grado di esportare il modello in JavaScript Object Notation (JSON), che deve essere esaminato per assicurarsi che le configurazioni soddisfino o superino i requisiti di sicurezza per l'organizzazione.
...
- [Configurare l'autenticazione a più fattori](openvpn-azure-ad-mfa.md)
