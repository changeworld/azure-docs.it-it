...
- [Creare un gateway VPN basato su route usando il portale di Azure](./tutorial-create-gateway-portal.md)
...
- [Esempi di criteri di Azure predefiniti per la rete virtuale](../virtual-network/policy-reference.md)
