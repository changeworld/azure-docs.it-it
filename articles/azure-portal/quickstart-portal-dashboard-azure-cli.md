...
Un dashboard nel portale di Azure offre una visualizzazione mirata e organizzata delle risorse cloud. Questo articolo illustra il processo di uso dell'interfaccia della riga di comando di Azure per creare un dashboard.
