...
In questa guida si è appreso come configurare e usare le revisioni dallo [strumento content moderator Review](https://contentmoderator.cognitive.microsoft.com). Vedere quindi la [Guida alla console API](../try-review-api-review.md) o la Guida [introduttiva di .NET SDK](../client-libraries.md?pivots=programming-language-csharp%253fpivots%253dprogramming-language-csharp) per informazioni su come creare recensioni a livello di codice.