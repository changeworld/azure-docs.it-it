...
:::row:::
    :::column span="3":::
        Xamarin.Mac espone la versione completa di macOS SDK per gli sviluppatori .NET per creare applicazioni Mac native con C#. Per altre informazioni, vedere <a href="/xamarin/mac/" target="_blank">Novell. Mac </a>.
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">
