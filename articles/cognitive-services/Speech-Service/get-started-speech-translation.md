---
title: Guida introduttiva alla traduzione vocale-servizio riconoscimento vocale
titleSuffix: Azure Cognitive Services
description: Informazioni su come usare l'SDK di riconoscimento vocale per tradurre la voce. Questa Guida introduttiva illustra la creazione di oggetti, i formati di input audio supportati e le opzioni di configurazione per la traduzione vocale.
...
* [Usare formati di input audio compressi](how-to-use-codec-compressed-audio-input-streams.md)
