...
Ogni training genererà automaticamente 100 audio di esempio per consentire il test del modello. Al termine della compilazione del modello vocale, è possibile testarlo prima di distribuirlo per l'utilizzo.
