---
title: Integrare più risorse dello strumento di lettura immersiva
...
ms.locfileid: "102620071"
---
# <a name="integrate-multiple-immersive-reader-resources"></a>Integrare più risorse dello strumento di lettura immersiva

Nella [panoramica](./overview.md) si è appreso che cos'è lo strumento di lettura immersiva e come questo strumento implementa tecniche comprovate per migliorare la comprensione della lettura per studenti di lingue, lettori emergenti e studenti con differenze nell'apprendimento. Nella [Guida introduttiva](./quickstarts/client-libraries.md)si è appreso come usare un lettore immersivo con una singola risorsa. Questa esercitazione illustra come integrare più risorse dello strumento di lettura immersiva nella stessa applicazione. In questa esercitazione verranno illustrate le procedure per:
