...
## <a name="create-the-view-controllers-and-add-sample-content"></a>Creare il controller di visualizzazione di avvio e aggiungere il contenuto di esempio
...
Aggiungere un nuovo file alla cartella radice del progetto denominato *ImmersiveReaderViewController.swift* e aggiungere il codice seguente.
...
Aggiungere un altro nuovo file alla cartella radice del progetto denominato *LaunchImmersiveReader.swift* e aggiungere il codice seguente.
...
Aggiungere un file alla cartella *Resources* denominato *iFrameMessaging.js* e aggiungere il codice seguente.
