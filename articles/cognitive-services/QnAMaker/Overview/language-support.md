...
QnA Maker dipende dagli [analizzatori del linguaggio ricerca cognitiva di Azure](/rest/api/searchservice/language-support) per fornire i risultati.
...
> [Selezione della lingua](../index.yml)