...
Una metrica è una misura quantificabile utilizzata per monitorare e valutare lo stato di un processo di business specifico. Può essere una combinazione di più valori di serie temporali divisi in dimensioni. Una metrica di *integrità Web* , ad esempio, può contenere dimensioni per il *numero di utenti* e il *mercato en-US*.
