...
* La migrazione a una risorsa E0 verrà bloccata. Gli utenti saranno in grado di eseguire la migrazione delle proprie app alle risorse F0. Dopo aver eseguito la migrazione di una risorsa esistente a F0, è possibile creare una nuova risorsa nel livello E0. Altre informazioni sulla [migrazione](./luis-migration-authoring.md)sono disponibili qui.  
