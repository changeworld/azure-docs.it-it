...
* Nelle [**guide introduttive**](luis-get-started-create-app.md) vengono fornite istruzioni introduttive per l'esecuzione di richieste al servizio.  
* Le [**guide alle procedure**](luis-how-to-start-new-app.md) contengono istruzioni per l'uso del servizio in modi più specifici o personalizzati.  
* I [**concetti**](artificial-intelligence.md) forniscono spiegazioni approfondite delle funzionalità e delle funzionalità del servizio.  
...
Per familiarizzare con LUIS, usare le guide di avvio rapido pratiche mediante il [portale](get-started-portal-build-app.md "portal") e le [librerie client SDK](./client-libraries-rest-api.md?pivots=rest-api "librerie client SDK").
