...
#### <a name="3-geography-subtypes"></a>Tre sottotipi di geografia

Entità predefinita   |   Espressione di esempio   |   JSON
------|------|------|
...
## <a name="encyclopedia-culture"></a>Impostazioni cultura di enciclopedia
...
Entità predefinita   |   Entità predefinita (sottotipi)   |   Espressione di esempio
------|------|------|
