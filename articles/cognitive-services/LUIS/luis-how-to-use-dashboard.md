...
![Screenshot mostra le stime per finalità con diversi risultati non chiari o stimati in modo errato.](./media/luis-how-to-use-dashboard/utterance-per-intent-shows-data-imbalance.png)

Passare il mouse sulla barra di ogni finalità per ottenere informazioni sullo scopo.

![Screenshot mostra le stime per finalità con dettagli relativi a risultati non chiari o stimati in modo errato.](./media/luis-how-to-use-dashboard/utterances-per-intent-with-details-of-errors.png)
