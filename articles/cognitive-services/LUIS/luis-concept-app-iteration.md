...
Il tipo di schema Intent può avere entità se aiuta LUIS a determinare l'intenzione dell'utente. Ad esempio, un'entità shipping, come una _funzionalità di apprendimento automatico_ a scopo, aiuta Luis a determinare un'intenzione di spedizione.
