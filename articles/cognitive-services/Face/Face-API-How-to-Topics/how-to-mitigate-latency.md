...
- Se le latenze più lunghe influiscano sull'esperienza utente, scegliere una soglia di timeout, ad esempio il numero massimo di 5s, prima di ritentare la chiamata API.
