...
Per informazioni generali sui concetti di Rilevamento anomalie, vedere l'articolo [Panoramica](../../overview.md).
...
## <a name="detect-anomalies-for-an-entire-series"></a>Rilevare le anomalie per un'intera serie
...
- Un file JSON valido di dati di serie temporali per verificare la presenza di anomalie. Se non è disponibile un file, è possibile creare un file sample.json dall'[esempio di corpo della richiesta](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).
...
Per un esempio con tutti i valori popolati:
...
Per altre informazioni, vedere le [informazioni di riferimento sull'API REST Rilevamento anomalie](https://westus2.dev.cognitive.microsoft.com/docs/services/AnomalyDetector/operations/post-timeseries-entire-detect).
