...
È anche possibile usare l'operazione Analizza per rilevare le informazioni personali, riconoscere le entità collegate e l'estrazione di frasi chiave. Vedere gli esempi di Analizza per [JavaScript](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/textanalytics/ai-text-analytics/samples/v5/javascript) e [TypeScript](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/textanalytics/ai-text-analytics/samples/v5/typescript/src) in GitHub.
