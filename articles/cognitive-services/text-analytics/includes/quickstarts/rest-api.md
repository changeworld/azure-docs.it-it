...
> [!NOTE]
> L'esempio seguente include una richiesta per la funzionalità Opinion Mining di Analisi del sentiment usando il parametro , che fornisce informazioni granulari sulle valutazioni (aggettivi) correlate alle destinazioni `opinionMining=true` (sostantivi) nel testo.
