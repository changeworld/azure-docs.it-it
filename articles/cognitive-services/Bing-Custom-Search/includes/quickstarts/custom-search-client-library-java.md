...
[Documentazione di riferimento](/java/api/overview/azure/cognitiveservices/client/bingcustomsearch) | [Codice sorgente della libreria](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/cognitiveservices/Search.BingCustomSearch) | [Artefatto (Maven)](https://search.maven.org/artifact/com.microsoft.azure.cognitiveservices/azure-cognitiveservices-customsearch/) | [Esempi](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples)
...
Dopo aver ottenuto una chiave dalla risorsa, [creare una variabile di ambiente](../../../cognitive-services-apis-create-account.md#configure-an-environment-variable-for-authentication) per la chiave denominata `AZURE_BING_CUSTOM_SEARCH_API_KEY`.
...
Il client di Ricerca personalizzata Bing è un oggetto [BingCustomSearchAPI](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) creato dal metodo [authenticate()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager.authenticate) dell'oggetto [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager). È possibile inviare una richiesta di ricerca usando il metodo [BingCustomInstances.search()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustominstances.search#com_microsoft_azure_cognitiveservices_search_customsearch_BingCustomInstances_search__) del client.

La risposta dell'API è un oggetto [SearchResponse](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.models.searchresponse) contenente le informazioni sulla query di ricerca e i risultati della ricerca.
...
Il metodo main deve includere un oggetto [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) che accetta la chiave e chiama il relativo metodo `authenticate()`.
