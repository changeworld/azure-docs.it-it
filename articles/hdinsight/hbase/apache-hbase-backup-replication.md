...
Se il cluster di destinazione è un cluster ADLS di generazione 2, modificare il comando precedente per adattarlo alle configurazioni usate da ADLS gen 2:
