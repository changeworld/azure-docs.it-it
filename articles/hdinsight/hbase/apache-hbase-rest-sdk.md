...
:::image type="content" source="./media/apache-hbase-rest-sdk/hdinsight-table-roles.png" alt-text="Output dei dati di esempio di Apache HBase" border="true":::
