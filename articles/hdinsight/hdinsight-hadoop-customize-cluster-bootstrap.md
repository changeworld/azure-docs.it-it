...
Vedere [Azure HDINSIGHT SDK per .NET](/dotnet/api/overview/azure/hdinsight).
...
:::image type="content" source="./media/hdinsight-hadoop-customize-cluster-bootstrap/hdinsight-customize-cluster-bootstrap-arm.png" alt-text="Hadoop Personalizza il modello di Azure Resource Manager bootstrap del cluster":::
