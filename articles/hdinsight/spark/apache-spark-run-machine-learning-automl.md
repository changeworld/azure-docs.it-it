...
> [!Note]
> I pacchetti di Azure Machine Learning vengono installati nell'ambiente Conda Python3 Il Jupyter Notebook installato deve essere eseguito usando il kernel PySpark3.
