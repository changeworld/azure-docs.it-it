...
Active Directory gli utenti possono accedere ai nodi del cluster usando le credenziali di dominio. Possono anche usare le proprie credenziali di dominio per autenticare le interazioni tra cluster con altri endpoint approvati, ad esempio [Hue](https://gethue.com/), viste AMBARI, ODBC, JDBC, PowerShell e le API REST.
...
Se non è già stato fatto, seguire [queste istruzioni](./domain-joined/apache-domain-joined-configure-using-azure-adds.md) per effettuare il provisioning di un nuovo cluster ESP.
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/manage-apache-ambari.png" alt-text="Gestione del dashboard di Apache Ambari":::
...
1. Nella pagina di gestione selezionare **utenti**.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-management-page-users.png" alt-text="Utenti della pagina di gestione di Apache Ambari":::
...
1. Nella pagina di gestione selezionare il collegamento **Views** (Viste) nell'intestazione del menu **Views** (Viste) a sinistra.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png" alt-text="Collegamenti alla visualizzazione viste di Apache Ambari":::
...
2. Nella pagina Views (Viste) espandere la riga **HIVE**. È disponibile una vista Hive predefinita creata quando il servizio Hive viene aggiunto al cluster. È anche possibile creare più istanze di viste Hive in base alle esigenze. Selezionare una vista Hive:
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-hive-view.png" alt-text="Viste HDInsight-visualizzazione Apache Hive":::
...
**Grant permission to these users** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/hdi-add-user-to-view.png" alt-text="Grant permission to these users"::: (Concedi autorizzazione a questi utenti)

**Grant permission to these groups** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/add-group-to-view-permission.png" alt-text="Grant permission to these groups"::: (Concedi autorizzazione a questi gruppi)
...
1. Per aggiungere un utente, selezionare il pulsante **Add User** (Aggiungi utente).
   ...
   * Iniziare a digitare il nome utente. Verrà visualizzato un elenco a discesa dei nomi definiti in precedenza.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-autocomplete.png" alt-text="Completamento automatico dell'utente di Apache Ambari":::
   ...
   * Per salvare le modifiche, selezionare la **casella di controllo blu**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png" alt-text="Autorizzazioni utente per la concessione di Apache Ambari":::
...
1. Per aggiungere un gruppo, selezionare il pulsante **Add Group** (Aggiungi gruppo).
   ...
   * Per salvare le modifiche, selezionare la **casella di controllo blu**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png" alt-text="Autorizzazioni di concessione di Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-tez-view.png" alt-text="Viste HDInsight-visualizzazione Apache Tez":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/cluster-roles-menu-link.png" alt-text="Collegamenti al menu ruoli di Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-menu-permissions.png" alt-text="Autorizzazioni per il collegamento di menu ruoli di Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png" alt-text="Visualizzazione blocco ruoli di Apache Ambari":::
...
* La categoria Users (Utenti) visualizza un elenco di tutti gli utenti, che consente di selezionare un ruolo per ogni utente nell'elenco a discesa.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-users.png" alt-text="Visualizzazione elenco ruoli di Apache Ambari-utenti":::
...
* La categoria Groups (Gruppi) visualizza tutti i gruppi e il ruolo e il ruolo assegnato a ogni gruppo. In questo esempio l'elenco di gruppi è sincronizzato da gruppi di Azure AD specificati nella proprietà **Access user group** (Gruppo utenti di accessi) delle impostazioni di dominio del cluster. Vedere [Creazione di un cluster HDInsight con ESP abilitato](./domain-joined/apache-domain-joined-configure-using-azure-adds.md#create-an-hdinsight-cluster-with-esp).
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-groups.png" alt-text="Visualizzazione elenco ruoli di Apache Ambari-gruppi":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png" alt-text="Utente Apache Ambari con solo visualizzazioni":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-cluster-user-role.png" alt-text="Visualizzazione del dashboard di Apache Ambari":::
