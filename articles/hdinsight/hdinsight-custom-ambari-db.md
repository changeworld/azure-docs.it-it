...
## <a name="database-sizing"></a>Dimensionamento database

La tabella seguente fornisce linee guida su quale livello del database SQL di Azure selezionare in base alle dimensioni del cluster HDInsight.

| Numero di nodi del ruolo di lavoro | Livello database obbligatorio |
|---|---|
| <= 4 | S0 |
| >4 && <= 8 | S1 |
| >8 && <= 16 | S2 |
...
| >32 && <= 64 | S4 |
| >64 && <= 128 | P2 |
| >128 | Contattare il supporto tecnico |
