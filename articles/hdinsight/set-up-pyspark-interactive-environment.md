...
In Linux, se viene riportato il messaggio di errore seguente, installare i pacchetti necessari eseguendo i due comandi seguenti.
   ...
   :::image type="content" source="./media/set-up-pyspark-interactive-environment/install-libkrb5-package.png" alt-text="Installare il pacchetto libkrb5 per Python" border="true":::
