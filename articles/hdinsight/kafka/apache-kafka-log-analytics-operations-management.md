...
1. Creare un'area di lavoro Log Analytics. Per altre informazioni, vedere il documento [log in monitoraggio di Azure](../../azure-monitor/logs/data-platform-logs.md) .
