...
| Esempi di Azure | [Esempi di Azure HDInsight](/samples/browse/?products=azure-hdinsight) |
...
| SDK (.NET, Python, Java) | [.NET](/dotnet/api/overview/azure/hdinsight), [Python](/python/api/overview/azure/hdinsight?preserve-view=true&view=azure-python), [Java](/java/api/overview/azure/hdinsight), [go](./hdinsight-go-sdk-overview.md) |
...
| Problemi relativi al servizio, manutenzione pianificata, avvisi di sicurezza & di integrità | [Sottoscrivere gli avvisi di integrità del servizio specifici della sottoscrizione](../service-health/alerts-activity-log-service-notifications-portal.md) |
