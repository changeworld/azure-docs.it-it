...
* Per informazioni su HDInsight .NET SDK, vedere [HDInsight .NET SDK reference](/dotnet/api/overview/azure/hdinsight) (Informazioni di riferimento su HDInsight .NET SDK).
