...
* La vista hive è disponibile solo nei cluster HDInsight 4,0 con un numero di versione maggiore o uguale a 4,1. Questo numero di versione è disponibile nelle versioni Ambari admin->.
...
* Azure Data Lake Storage Gen2 non può salvare Jupyter notebook in un cluster Spark.
...
* [Guida alla migrazione di HBase](./hbase/apache-hbase-migrate-new-version.md)
* [Guida alla migrazione di hive](./interactive-query/apache-hive-migrate-workloads.md)
* [Guida alla migrazione di Kafka](./kafka/migrate-versions.md)
* [Guida alla migrazione di Spark](./spark/migrate-versions.md)
