---
title: Versioni ritirate di Azure HDInsight
description: Informazioni sulle versioni ritirate in Azure HDInsight.
...
ms.locfileid: "103490246"
---
# <a name="retired-hdinsight-versions"></a>Versioni HDInsight ritirate

In questo articolo vengono fornite informazioni sulle versioni ritirate in HDInsight.

## <a name="retired-version-list"></a>Elenco versioni ritirate

La tabella seguente elenca le versioni ritirate di HDInsight.
...
- [Componenti e versioni di Apache supportati in HDInsight](./hdinsight-component-versioning.md)
