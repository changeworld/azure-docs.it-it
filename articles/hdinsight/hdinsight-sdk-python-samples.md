---
title: 'Azure HDInsight: esempi di Python'
...
ms.locfileid: "98931884"
---
# <a name="azure-hdinsight-python-samples"></a>Azure HDInsight: esempi di Python
...
> [!Important]
> Python 2.7 verrà deprecato il 1° gennaio 2020. Se si usa ancora Python 2.7, eseguire l'aggiornamento alla versione 3.7 per usare HDInsight SDK per Python.  
...
[Azure HDInsight SDK per Python](/python/api/overview/azure/hdinsight#sdk-installation)
...
I frammenti di codice per questa funzionalità aggiuntiva dell'SDK sono disponibili nella [documentazione di riferimento di HDInsight SDK per Python](/python/api/overview/azure/hdinsight).