---
title: Note sulla versione di Hortonworks associate alle versioni di Azure HDInsight
...
## <a name="current-versions"></a>Versioni correnti
...
* [Componenti Apache Hadoop in HDInsight](./hdinsight-component-versioning.md)
