...
:::image type="content" source="./media/hdinsight-security-options-for-hive/security-options-hive.png " alt-text="' Opzioni di sicurezza per hive '" border="true":::
