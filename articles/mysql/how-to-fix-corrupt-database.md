...
---
# <a name="troubleshoot-database-corruption-in-azure-database-for-mysql"></a>Risolvere i problemi di danneggiamento del database in Database di Azure per MySQL
