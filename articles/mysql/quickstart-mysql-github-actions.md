...
**SI APPLICA A**: :::image type="icon" source="./media/applies-to/yes.png" border="false":::Database di Azure per MySQL - Server singolo :::image type="icon" source="./media/applies-to/yes.png" border="false":::Database di Azure per MySQL - Server flessibile
