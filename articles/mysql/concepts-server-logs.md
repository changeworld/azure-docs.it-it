...
Quando si accede alla risorsa di archiviazione locale del server, i log sono disponibili per un massimo di sette giorni dalla loro creazione. Se la dimensione totale dei log disponibili è superiore a 7 GB, i file meno recenti vengono eliminati fino a quando non è disponibile spazio. Il limite di archiviazione di 7 GB per i log del server è disponibile gratuitamente e non può essere esteso. 
