...
Un'API personalizzata funziona meglio con le app per la logica quando l'API include anche un [documento Swagger](https://swagger.io/specification/) che descrive le operazioni e i parametri dell'API.
