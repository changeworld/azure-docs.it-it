...
1. Nella raccolta aggiungere una regola che consenta il traffico verso il sistema di destinazione.
   ...
   **Proprietà della raccolta regole di rete**
   ...
   | **Priorità** | <*livello di priorità*> | Ordine di priorità da utilizzare per l'esecuzione della raccolta regole. Per altre informazioni, vedere [quali sono alcuni concetti di Azure firewall](../firewall/firewall-faq.yml#what-are-some-azure-firewall-concepts)? |
   ...
   * [INTERFACCIA della riga di comando di Azure: AZ Network Firewall Network-Rule](/cli/azure/ext/azure-firewall/network/firewall/network-rule#ext-azure-firewall-az-network-firewall-network-rule-create)
