...
|Prezzi:|I due piani che formano **Azure Defender per SQL** vengono fatturati come indicato nei [prezzi del Centro sicurezza](https://azure.microsoft.com/pricing/details/security-center/)|
