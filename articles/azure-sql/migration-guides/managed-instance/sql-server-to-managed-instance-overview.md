...
Verificare che il Istanza gestita SQL di destinazione disponga Azure AD accesso in lettura, che può essere configurato tramite il portale di Azure da un utente con il ruolo di **amministratore globale** .
