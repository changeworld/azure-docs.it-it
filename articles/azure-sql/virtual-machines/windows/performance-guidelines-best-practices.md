...
La [serie M](/azure/virtual-machines/m-series) offre conteggi di vCore e memoria per alcuni dei più grandi SQL Server carichi di lavoro.  
...
Il [Standard_M64ms](/azure/virtual-machines/m-series) ha un rapporto da 28 a vCore, ad esempio.
...
Ad esempio, [M64-32ms standard](../../../virtual-machines/constrained-vcpu.md) richiede la gestione delle licenze solo 32 SQL Server Vcore con memoria, i/o e velocità effettiva di [M64ms](/azure/virtual-machines/m-series) e [M64-16ms standard](../../../virtual-machines/constrained-vcpu.md) richiedono solo 16 Vcore per la gestione delle licenze.  Sebbene il [M64-16ms standard](../../../virtual-machines/constrained-vcpu.md) abbia un trimestre del costo della licenza SQL Server della M64ms, il costo di calcolo della macchina virtuale sarà lo stesso.
