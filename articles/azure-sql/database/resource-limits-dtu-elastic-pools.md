...
> [!NOTE]
> Per informazioni sui `tempdb` limiti, vedere [limiti di tempdb](/sql/relational-databases/databases/tempdb-database#tempdb-database-in-sql-database).
