---
title: 'PowerShell: Sincronizzare i dati tra database SQL e SQL Server'
description: Usare uno script di esempio di Azure PowerShell per sincronizzare i dati tra il database SQL di Azure e SQL Server.
...
ms.locfileid: "92792872"
---
# <a name="use-powershell-to-sync-data-between-sql-database-and-sql-server"></a>Usare PowerShell per sincronizzare i dati tra database SQL e SQL Server

[!INCLUDE[appliesto-sqldb](../../includes/appliesto-sqldb.md)]

Questo esempio di Azure PowerShell consente di configurare la sincronizzazione dati per sincronizzare i dati tra il database SQL di Azure e SQL Server. 
...
- Creare un database in un'istanza di SQL Server come database membro.
...
- Configurare la sincronizzazione dati
    - Usare il portale di Azure: [Esercitazione: Configurare la sincronizzazione dati SQL per sincronizzare i dati tra un database nel database SQL di Azure e un database locale di SQL Server](../sql-data-sync-sql-server-configure.md)
    - Usare PowerShell: [Usare PowerShell per eseguire la sincronizzazione tra più database nel database SQL di Azure](sql-data-sync-sync-data-between-sql-databases.md)
