...
- Creare tre database nel database SQL di Azure
...
- [Che cos'è un pool elastico di Azure?](elastic-pool-overview.md)
...
- [Applicazione Tailspin Surveys](/azure/architecture/multitenant-identity/tailspin)

## <a name="questions-and-feature-requests"></a>Domande e richieste di funzionalità

Per domande, Contattaci nella pagina Microsoft domande e risposte [&per il database SQL](/answers/topics/azure-sql-database.html). Aggiungere una richiesta di funzionalità nel [forum dei commenti e suggerimenti sul database SQL](https://feedback.azure.com/forums/217321-sql-database/).
