...
> [!TIP]
> Per ripristinare a livello di codice un database da un backup, vedere [ripristino a livello di codice tramite backup automatici](recovery-using-backups.md).
