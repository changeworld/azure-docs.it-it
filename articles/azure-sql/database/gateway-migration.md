...
I clienti riceveranno una notifica tramite le notifiche sull'integrità del servizio prima di qualsiasi modifica ai gateway disponibili in ogni area. I clienti possono [usare la portale di Azure per configurare gli avvisi del log attività](../../service-health/alerts-activity-log-service-notifications-portal.md).

Le informazioni più aggiornate verranno mantenute nella tabella degli [indirizzi IP del gateway del database SQL di Azure](connectivity-architecture.md#gateway-ip-addresses) .
...
- Stati Uniti orientali 2:40.70.144.193 questo gateway SQL inizierà ad accettare il traffico dei clienti il 30 aprile 2021.

Nuovi gateway SQL vengono aggiunti alle aree seguenti:
- Norvegia orientale: 51.120.96.33
- Asia orientale sud: 13.67.16.193
- Sudafrica settentrionale: 102.133.152.32
- Corea meridionale: 52.231.151.96
- Centro-Nord: Stati Uniti 52.162.105.9
- Australia sud-orientale: 13.77.49.32 

Questi gateway SQL dovranno iniziare ad accettare il traffico dei clienti il 5 aprile 2021.

## <a name="march-2021"></a>Marzo 2021
I seguenti gateway SQL in più aree sono in fase di disattivazione:
...
- Asia sudorientale: 23.100.117.95
- Europa occidentale: 191.237.232.75
- Stati Uniti occidentali: 23.99.34.75

Non è previsto alcun effetto sul cliente poiché questi gateway (in esecuzione su hardware meno recenti) non instradano il traffico dei clienti. Gli indirizzi IP per questi gateway verranno disattivati il 15 marzo 2021.
...
Questi gateway SQL dovranno iniziare ad accettare il traffico dei clienti il 28 febbraio 2021.
