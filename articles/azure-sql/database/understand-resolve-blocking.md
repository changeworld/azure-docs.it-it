...
* [Monitoraggio e ottimizzazione delle prestazioni del database SQL di Azure e di Istanza gestita di SQL di Azure](/azure/azure-sql/database/monitor-tune-overview)
