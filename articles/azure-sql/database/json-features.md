...
description: Il database SQL di Azure e Azure SQL Istanza gestita consentono di analizzare, eseguire query e formattare i dati in notazione JavaScript Object Notation (JSON).
...
ms.locfileid: "92782801"
---
# <a name="getting-started-with-json-features-in-azure-sql-database-and-azure-sql-managed-instance"></a>Introduzione alle funzionalità JSON nel database SQL di Azure e in Azure SQL Istanza gestita
[!INCLUDE[appliesto-sqldb-sqlmi](../includes/appliesto-sqldb-sqlmi.md)]

Il database SQL di Azure e Azure SQL Istanza gestita consentono di analizzare ed eseguire query sui dati rappresentati in formato JavaScript Object Notation [(JSON)](https://www.json.org/) ed esportare i dati relazionali come testo JSON. Sono disponibili gli scenari JSON seguenti:
...
In questo esempio viene restituito un singolo oggetto JSON anziché un array, specificando l'opzione [WITHOUT_ARRAY_WRAPPER](/sql/relational-databases/json/remove-square-brackets-from-json-without-array-wrapper-option). È possibile usare questa opzione se è noto che si sta restituendo un oggetto singolo come risultato della query.
...
JSON è un formato testuale che può essere usato come qualsiasi altro tipo di stringa nel database SQL di Azure e in Azure SQL Istanza gestita. È possibile inviare o archiviare i dati JSON come NVARCHAR standard:
...
Le funzioni JSON disponibili nel database SQL di Azure e in Azure SQL Istanza gestita consentono di trattare i dati formattati come JSON come qualsiasi altro tipo di dati SQL. È facilmente possibile estrarre i valori dal testo JSON e usare dati JSON in qualsiasi query:
...
Il database SQL di Azure e Azure SQL Istanza gestita consentono anche di trasformare le raccolte JSON in formato tabulare e caricare o eseguire query sui dati JSON.
...
![JSON tabulare](./media/json-features/image_2.png)
