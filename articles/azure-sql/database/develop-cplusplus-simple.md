...
* [Sviluppo di Linux per Visual Studio](/cpp/linux/). Se si esegue lo sviluppo su Linux, è anche necessario installare l'estensione di Visual Studio per Linux.
