...
È possibile scaricare le utilità bcp e SQLCMD dalla [documentazione di Microsoft sqlcmd](/sql/tools/sqlcmd-utility?view=sql-server-ver15&preserve-view=true).
