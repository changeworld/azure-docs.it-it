...
description: Informazioni su come creare e gestire gli oggetti di ricerca in un'applicazione .NET usando C# e Microsoft. Azure. search (versione 10) di .NET SDK. I frammenti di codice illustrano la connessione al servizio, la creazione di indici e query.
manager: nitinme
author: brjohnstmsft
ms.author: brjohnst
ms.devlang: dotnet
...
ms.locfileid: "92681603"
---
# <a name="how-to-use-microsoftazuresearch-in-a-c-net-application"></a>Come usare Microsoft. Azure. search in un'applicazione .NET C#

Questo articolo illustra come creare e gestire gli oggetti di ricerca usando C# e la libreria client legacy, [**Microsoft. Azure. search**](/dotnet/api/overview/azure/search/client10) (versione 10) in Azure SDK per .NET. 

La versione 10 è l'ultima versione del pacchetto Microsoft. Azure. search. Per andare avanti, verranno implementate nuove funzionalità in [**Azure.Search.Documents**](/dotnet/api/overview/azure/search.documents-readme) dal team di Azure SDK.

> [!NOTE]
> Se si dispone di progetti di sviluppo esistenti o Inflight, è possibile continuare a usare la versione 10. Per i nuovi progetti o per usare nuove funzionalità, è necessario passare alla [nuova libreria](/dotnet/api/overview/azure/search.documents-readme).

## <a name="about-version-10"></a>Informazioni sulla versione 10
...
.NET SDK è la versione [ `2019-05-06` di destinazione dell'API REST di Azure ricerca cognitiva](https://github.com/Azure/azure-rest-api-specs/tree/master/specification/search/data-plane/Microsoft.Azure.Search.Data/stable/2019-05-06). Questa versione include il supporto per i [tipi complessi](search-howto-complex-data-types.md), l' [arricchimento di intelligenza artificiale](cognitive-search-concept-intro.md), il [completamento automatico](/rest/api/searchservice/autocomplete)e la [modalità di analisi JsonLines](search-howto-index-json-blobs.md) durante l'indicizzazione dei BLOB di Azure. 

Questo SDK non supporta [operazioni di gestione](/rest/api/searchmanagement/), come la creazione e la scalabilità di servizi di ricerca e la gestione delle chiavi API. Se è necessario gestire le risorse di ricerca da un'applicazione .NET, è possibile usare [Azure ricerca cognitiva .NET Management SDK](/dotnet/api/overview/azure/search/management).

## <a name="upgrade-to-v10"></a>Eseguire l'aggiornamento a V10
