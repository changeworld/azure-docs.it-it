...
Provare questi concetti distribuendo il primo modulo IoT Edge in un dispositivo:

<!-- 1.1 -->
:::moniker range="iotedge-2018-06"

* [Distribuire moduli in un dispositivo IoT Edge Linux](quickstart-linux.md)
* [Distribuire moduli in un dispositivo Windows IoT Edge](quickstart.md)
...
[Distribuire moduli in un dispositivo IoT Edge](quickstart-linux.md)
