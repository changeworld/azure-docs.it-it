...
description: In questa esercitazione viene sviluppata una funzione di Azure come modulo IoT Edge e quindi viene distribuita in un dispositivo IoT Edge.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 07/29/2020
