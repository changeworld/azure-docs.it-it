...
ms.locfileid: "107304112"
---
# <a name="publish-and-subscribe-with-azure-iot-edge-preview"></a>Pubblicare e sottoscrivere con Azure IoT Edge (anteprima)
...
Per autorizzare il server di pubblicazione e il Sottoscrittore, modificare il gemello dell'hub IoT Edge creando una distribuzione IoT Edge tramite l'interfaccia della riga di comando di Azure, Visual Studio o Visual Studio Code per includere i criteri di autorizzazione seguenti:
