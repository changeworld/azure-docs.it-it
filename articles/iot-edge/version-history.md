...
* **IoT Edge 1,2 (anteprima)** contiene contenuti aggiuntivi per le funzionalità e le funzionalità disponibili nella versione di anteprima più recente: [1,2-RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2.0-rc1)
  * Mentre IoT Edge 1,2 è in anteprima, è necessario installare le versioni di release candidate. Per ulteriori informazioni, vedere [installazione di versioni offline o specifiche](how-to-install-iot-edge.md?tabs=linux#offline-or-specific-version-installation-optional).
...
| Note sulla versione e asset | Type | Data | Elementi di rilievo |
| ------------------------ | ---- | ---- | ---------- |
