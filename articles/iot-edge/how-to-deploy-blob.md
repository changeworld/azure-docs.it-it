...
2. Nella scheda **Impostazioni modulo** immettere un nome per il modulo e quindi specificare l'URI dell'immagine del contenitore:
   ...
   ![Screenshot mostra la scheda Impostazioni modulo della pagina Add I o T Edge Module.](./media/how-to-deploy-blob/addmodule-tab1.png)
...
3. Aprire la scheda **Opzioni di creazione del contenitore** .
   ...
   ![Screenshot mostra la scheda Crea opzioni del contenitore della pagina Aggiungi modulo di I o T Edge.](./media/how-to-deploy-blob/addmodule-tab3.png)
...
5. Nella scheda **Impostazioni dispositivi gemelli del modulo** copiare il codice JSON seguente e incollarlo nella casella.
   ...
   ![Screenshot mostra la scheda delle impostazioni del modulo gemello della pagina Add I o T Edge Module.](./media/how-to-deploy-blob/addmodule-tab4.png)
...
Modificare le **Opzioni di creazione del contenitore** (nel portale di Azure) o il campo **createOptions** (nel *deployment.template.jssu* file in Visual Studio Code) per modificare il `HostPort` valore:
...
1. Aggiungere `HTTPS_PROXY` per il **nome** e l'URL del proxy per il **valore**.
      ...
      ![Screenshot Visualizza il riquadro modulo aggiornamento I o T Edge in cui è possibile immettere i valori specificati.](./media/how-to-deploy-blob/https-proxy-config.png)
...
1. Verificare l'impostazione selezionando il modulo dalla pagina dei dettagli del dispositivo e nella parte inferiore della pagina dei **Dettagli dei moduli IOT Edge** selezionare la scheda **variabili di ambiente** .
      ...
      ![Screenshot mostra la scheda variabili di ambiente.](./media/how-to-deploy-blob/verify-proxy-config.png)
