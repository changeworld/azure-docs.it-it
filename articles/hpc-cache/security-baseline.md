...
- [Come usare le chiavi di crittografia gestite dal cliente con la cache HPC di Azure](./hpc-cache-create.md?tabs=azure-portal#enable-azure-key-vault-encryption-optional)
...
- [Come eseguire il backup di chiavi di Key Vault in Azure](/powershell/module/az.keyvault/backup-azkeyvaultkey?preserve-view=true&view=azps-5.1.0)
...
- [Come ripristinare chiavi di Key Vault in Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey?preserve-view=true&view=azps-5.1.0)
