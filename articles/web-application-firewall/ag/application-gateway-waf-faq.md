...
## <a name="what-content-types-does-waf-support"></a>Quali tipi di contenuto sono supportati da WAF?

Il gateway applicazione WAF supporta i tipi di contenuto seguenti per le regole gestite:
