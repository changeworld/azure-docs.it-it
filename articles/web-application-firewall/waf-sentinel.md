...
:::image type="content" source="media//waf-sentinel/top-50-event-trigger.png" alt-text="Primi 50 eventi":::

:::image type="content" source="media//waf-sentinel/attack-events.png" alt-text="Eventi di attacco":::

:::image type="content" source="media//waf-sentinel/top-10-attacking-ip-address.png" alt-text="Primi 10 indirizzi IP di attacco":::
...
3. Nella pagina delle impostazioni di diagnostica:
   ...
   :::image type="content" source="media//waf-sentinel/diagnostics-setting.png" alt-text="Impostazione di diagnostica":::

4. Nel home page di Azure, digitare **Azure Sentinel** nella barra di ricerca e selezionare la risorsa **Azure Sentinel** . 
2. Selezionare un'area di lavoro già attiva o creare una nuova area di lavoro. 
...
4. Cercare **microsoft Web Application Firewall** e selezionare **Microsoft Web Application Firewall (WAF)**. Selezionare **Apri connettore** nella parte inferiore destra.
   ...
   :::image type="content" source="media//waf-sentinel/data-connectors.png" alt-text="Connettori dati":::
...
6. Al termine della configurazione delle singole risorse di WAF, selezionare la scheda **passaggi successivi** . Selezionare una delle cartelle di lavoro consigliate. Questa cartella di lavoro userà tutti i dati analitici di log abilitati in precedenza. È ora disponibile una cartella di lavoro WAF funzionante per le risorse di WAF.
   ...
   :::image type="content" source="media//waf-sentinel/waf-workbooks.png" alt-text="Cartelle di lavoro di WAF":::
