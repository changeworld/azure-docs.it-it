...
Questo controllo verifica che l'agente di Log Analytics per Linux sia installato. Per istruzioni su come installarlo, vedere [Installare l'agente per Linux](../../azure-monitor/vm/quick-collect-linux-computer.md#install-the-agent-for-linux).
