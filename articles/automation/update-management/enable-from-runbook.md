...
ms.locfileid: "100575882"
---
# <a name="enable-update-management-from-a-runbook"></a>Abilitare Gestione aggiornamenti da un runbook

Questo articolo descrive come usare un runbook per abilitare la funzionalità [Gestione aggiornamenti](overview.md) per le VM dell'ambiente. Per abilitare le macchine virtuali di Azure su larga scala, è necessario abilitare una macchina virtuale esistente con Gestione aggiornamenti.
...
* [area di lavoro Log Analytics](../../azure-monitor/logs/design-logs-deployment.md)
...
3. Selezionare l'area di lavoro Log Analytics, quindi fare clic su **Abilita**. Quando Gestione aggiornamenti viene abilitato, viene visualizzato un banner.
    ...
    ![Abilitare la gestione degli aggiornamenti](media/enable-from-runbook/enable-update-management.png)
...
3. Scegliere la macchina virtuale dall'elenco e fare clic su **Abilita** per configurare la macchina virtuale per la gestione.
   ...
   ![Abilitare Gestione aggiornamenti per la macchina virtuale](media/enable-from-runbook/enable-update-management-vm.png)
