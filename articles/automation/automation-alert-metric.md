...
ms.locfileid: "100593957"
---
# <a name="monitor-runbooks-with-metric-alerts"></a>Monitorare i runbook con avvisi delle metriche

In questo articolo viene illustrato come creare un avviso di [metrica](../azure-monitor/alerts/alerts-metric-overview.md) basato sullo stato di completamento di Runbook.
