---
title: Disabilitare l'Automazione di Azure gestita dell'account utente
...
ms.locfileid: "107495054"
---
# <a name="disable-your-azure-automation-account-managed-identity"></a>Disabilitare l'Automazione di Azure gestita dell'account utente
...
- Per altre informazioni sull'abilitazione dell'identità gestita in Automazione di Azure, vedere Abilitare e [usare l'identità gestita per Automazione.](enable-managed-identity-for-automation.md)
