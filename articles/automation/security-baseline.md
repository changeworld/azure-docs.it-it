...
- [Distribuire un account di automazione usando un modello di Azure Resource Manager](/azure/automation/quickstart-create-account-template#deploy-the-template)
